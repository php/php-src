...
#define php_win32_cp_thread_to_w(path) php_win32_cp_thread_to_w_full(path, PHP_WIN32_CP_IGNORE_LEN, PHP_WIN32_CP_IGNORE_LEN_P)
PW32CP wchar_t *php_win32_cp_ascii_to_w_full(const char* path, size_t path_len, size_t *pathw_len);
#define php_win32_cp_ascii_to_w(path) php_win32_cp_ascii_to_w_full(path, PHP_WIN32_CP_IGNORE_LEN, PHP_WIN32_CP_IGNORE_LEN_P)
