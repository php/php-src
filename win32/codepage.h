...
__forceinline static wchar_t *php_win32_cp_do_any_to_w(const char* in, size_t in_len, size_t *out_len)
{/*{{{*/
	wchar_t *ret = NULL;
...
#define php_win32_cp_any_to_w(in) php_win32_cp_do_any_to_w(in, PHP_WIN32_CP_IGNORE_LEN, PHP_WIN32_CP_IGNORE_LEN_P)
