...
?>
--EXPECTF--
Warning: file_get_contents(): failed to open stream (http://%s/..\CREDITS): HTTP request failed! HTTP/1.0 404 Not Found
 in %sbug70264.php on line %d

Warning: file_get_contents(): failed to open stream (http://%s/..%5CCREDITS): HTTP request failed! HTTP/1.0 404 Not Found
 in %sbug70264.php on line %d
