...
if test "$PHP_CGI" != "no"; then
    ...
    case $host_alias in
      *aix*)
        ...
        ;;
      *)
        BUILD_CGI="\$(LINK_SAPI) \$(PHP_GLOBAL_OBJS:.lo=.o) \$(PHP_BINARY_OBJS:.lo=.o) \$(PHP_FASTCGI_OBJS:.lo=.o) \$(PHP_CGI_OBJS:.lo=.o) \$(EXTRA_LIBS) \$(ZEND_EXTRA_LIBS) -o \$(SAPI_CGI_PATH)"
      ;;
    esac
