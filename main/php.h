...
#define PHP_NATIVE_GINIT_FUNCTION       ZEND_NATIVE_GINIT_FUNCTION
#define PHP_GSHUTDOWN_FUNCTION          ZEND_GSHUTDOWN_FUNCTION
#define PHP_NATIVE_GSHUTDOWN_FUNCTION   ZEND_NATIVE_GSHUTDOWN_FUNCTION

#define PHP_MODULE_GLOBALS              ZEND_MODULE_GLOBALS
#define PHP_NATIVE_MODULE_GLOBALS       ZEND_NATIVE_MODULE_GLOBALS
