...
/* PHP error callback API */
#define PHP_ERROR_CB_FUNC_ARGS ZEND_ERROR_CB_FUNC_ARGS
#define PHP_ERROR_CB_FUNC_ARGS_PASSTHRU ZEND_ERROR_CB_FUNC_ARGS_PASSTHRU
#define PHP_ERROR_CB_HOOK_ARGS ZEND_ERROR_CB_HOOK_ARGS
#define PHP_ERROR_CB_HOOK_ARGS_PASSTHRU ZEND_ERROR_CB_HOOK_ARGS_PASSTHRU
