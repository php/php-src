/* Generated by gen_gdb_inlined_script.php */
asm(
    ...
    ".ascii \"\\n\"\n"
    ".ascii \"This is auto-loaded by GDB if Python Auto-loading is enabled (the default).\\n\"\n"
    ".ascii \"See https://sourceware.org/gdb/current/onlinedocs/gdb.html/Python-Auto_002dloading.html\\n\"\n"
    ".ascii \"\\n\"\n"
    ".ascii \"Use\\n\"\n"
    ".ascii \"  (gdb) p /r any_variable\\n\"\n"
    ".ascii \"to print |any_variable| without using any printers.\\n\"\n"
    ".ascii \"\\n\"\n"
    ".ascii \"Use\\n\"\n"
    ".ascii \"  (gdb) source tools/gdb/php_gdb.py\\n\"\n"
    ".ascii \"to reload the script\\n\"\n"
    ".ascii \"\\n\"\n"
    ...
    ".ascii \"                type_name = self.bits.get(bit)\\n\"\n"
    ...
    ".ascii \"\\n\"\n"
    ".ascii \"        self.bits = bits\\n\"\n"
    ".ascii \"        self.types = types\\n\"\n"
