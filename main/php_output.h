...
typedef void (*php_output_handler_func_t)(char *output, php_size_t output_len, char **handled_output, php_size_t *handled_output_len, int mode TSRMLS_DC);
...
typedef int (*php_output_handler_conflict_check_t)(const char *handler_name, php_size_t handler_name_len TSRMLS_DC);
/* ctor for aliases */
typedef struct _php_output_handler *(*php_output_handler_alias_ctor_t)(const char *handler_name, php_size_t handler_name_len, php_size_t chunk_size, int flags TSRMLS_DC);
...
ZEND_BEGIN_MODULE_GLOBALS(output)
	...
	php_size_t output_start_lineno;
...
PHPAPI php_size_t php_output_flush(TSRMLS_D);
...
PHPAPI int php_output_start_user(zval *output_handler, php_size_t chunk_size, int flags TSRMLS_DC);
PHPAPI int php_output_start_internal(const char *name, php_size_t name_len, php_output_handler_func_t output_handler, php_size_t chunk_size, int flags TSRMLS_DC);

PHPAPI php_output_handler *php_output_handler_create_user(zval *handler, php_size_t chunk_size, int flags TSRMLS_DC);
PHPAPI php_output_handler *php_output_handler_create_internal(const char *name, php_size_t name_len, php_output_handler_context_func_t handler, php_size_t chunk_size, int flags TSRMLS_DC);
...
PHPAPI int php_output_handler_started(const char *name, php_size_t name_len TSRMLS_DC);
...
PHPAPI int php_output_handler_conflict(const char *handler_new, php_size_t handler_new_len, const char *handler_set, php_size_t handler_set_len TSRMLS_DC);
PHPAPI int php_output_handler_conflict_register(const char *handler_name, php_size_t handler_name_len, php_output_handler_conflict_check_t check_func TSRMLS_DC);
PHPAPI int php_output_handler_reverse_conflict_register(const char *handler_name, php_size_t handler_name_len, php_output_handler_conflict_check_t check_func TSRMLS_DC);

PHPAPI php_output_handler_alias_ctor_t *php_output_handler_alias(const char *handler_name, php_size_t handler_name_len TSRMLS_DC);
PHPAPI int php_output_handler_alias_register(const char *handler_name, php_size_t handler_name_len, php_output_handler_alias_ctor_t func TSRMLS_DC);
