...
PHP_INI_BEGIN()
	...
	STD_PHP_INI_ENTRY("lingering_time_s",		"-1",	PHP_INI_SYSTEM|PHP_INI_PERDIR,		OnUpdateLong,			lingering_time_s,	php_core_globals,	core_globals)
	STD_PHP_INI_ENTRY("lingering_timeout_ms",   "-1",	PHP_INI_SYSTEM|PHP_INI_PERDIR,		OnUpdateLong,			lingering_timeout_ms,	php_core_globals,	core_globals)
