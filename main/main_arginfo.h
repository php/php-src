 ...
 * Stub hash: 9cdeba665b44478182477d3c2a20fa7343833f69 */
...
static void register_main_symbols(int module_number)
{
	...
	REGISTER_LONG_CONSTANT("PHP_SYS_SIZE", SIZEOF_SIZE_T, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("PHP_STRING_MAX_LENGTH", (SIZEOF_SIZE_T < SIZEOF_ZEND_LONG ? (zend_long) ZSTR_MAX_LEN : ZEND_LONG_MAX), CONST_PERSISTENT);
