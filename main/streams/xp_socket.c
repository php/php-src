...
#define PHP_STREAM_XPORT_IS_UNIX(_stream) \
	(_stream->ops == &php_stream_unix_socket_ops || _stream->ops == &php_stream_unixdg_socket_ops)
#else
...
#define PHP_STREAM_XPORT_IS_TCP(_stream) (!PHP_STREAM_XPORT_IS_UNIX(_stream) && !PHP_STREAM_XPORT_IS_UDP(_stream))
