...
#define convert_to_long_safe(ppzv, errors)		_convert_to_long_safe(ppzv, 0, errors)
#define convert_to_long_base_safe(ppzv, base, errors)	_convert_to_long_base_safe(ppzv, base, 0, errors)
#define convert_to_double_safe(ppzv, errors)		_convert_to_double_safe(ppzv, 0, errors)
...
#define convert_to_long_safe_ex(ppzv, errors)			_convert_to_long_safe(ppzv, 1, errors)
#define convert_to_long_base_safe_ex(ppzv, base, errors)	_convert_to_long_base_safe(ppzv, base, 1, errors)
#define convert_to_double_safe_ex(ppzv, errors)			_convert_to_double_safe(ppzv, 1, errors)
