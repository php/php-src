...
#elif ZEND_VM_KIND == ZEND_VM_KIND_CALL && defined(HAVE_PRESERVE_NONE) && defined(_WIN32)
# define ZEND_OPCODE_HANDLER_CCONV         ZEND_PRESERVE_NONE
# define ZEND_OPCODE_HANDLER_CCONV_EX      ZEND_FASTCALL
# undef ZEND_OPCODE_HANDLER_FUNC_CCONV
# undef ZEND_OPCODE_HANDLER_FUNC_CCONV_EX
