...
static ZEND_COLD void zend_append_type_hint(
		smart_str *str, const zend_class_entry *scope, const HashTable *bound_types_to_scope,
		const zend_arg_info *arg_info, bool return_hint) /* {{{ */
{
...
static ZEND_COLD zend_string *zend_get_function_declaration(
		...
		const HashTable *bound_types_to_scope) /* {{{ */
{
	smart_str str = {0};
