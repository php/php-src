...
zend_op_array *compile_filename(int type, zval *filename)
{
	...
	int i, illegal_script_extension = 1;
	size_t len;
	char *p;
	...
	if (illegal_script_extension) {
		zend_error_noreturn(E_COMPILE_ERROR, "Illegal script extension detected");
	}
