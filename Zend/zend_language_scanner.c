...
ZEND_API void zend_save_lexical_state(zend_lex_state *lex_state TSRMLS_DC)
{
	...
	lex_state->doc_comment_len = CG(doc_comment_len);
	if (CG(doc_comment)) {
		lex_state->doc_comment = estrndup(CG(doc_comment), lex_state->doc_comment_len);
	}
}
...
ZEND_API void zend_restore_lexical_state(zend_lex_state *lex_state TSRMLS_DC)
{
	...
	CG(doc_comment) = lex_state->doc_comment;
	CG(doc_comment_len) = lex_state->doc_comment_len;
}
...
#line 1179 "Zend/zend_language_scanner.c"
yy4:
		YYDEBUG(4, *YYCURSOR);
		yych = *++YYCURSOR;
		goto yy3;
...
#line 1228 "Zend/zend_language_scanner.c"
yy9:
		YYDEBUG(9, *YYCURSOR);
		yych = *++YYCURSOR;
		if (yych == 'C') goto yy11;
