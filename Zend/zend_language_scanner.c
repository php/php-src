...
#line 1795 "Zend/zend_language_scanner.l"
	{
	if (CG(short_tags)) {
		CG(zend_tag_lineno) = CG(zend_lineno);
		BEGIN(ST_IN_SCRIPTING);
...
#line 1236 "Zend/zend_language_scanner.c"
yy8:
	YYDEBUG(8, *YYCURSOR);
	++YYCURSOR;
	YYDEBUG(9, *YYCURSOR);
...
#line 2452 "Zend/zend_language_scanner.c"
yy109:
	...
	while (YYCURSOR < YYLIMIT) {
		switch (*YYCURSOR++) {
			...
			case '\n':
				...
				break;
			case '?':
				if (*YYCURSOR == '>' && (CG(zend_lineno) == CG(zend_tag_lineno))) {
					YYCURSOR--;
					break;
				}
				/* fall through */
