/* Generated by re2c 0.13.5 on Thu Jul  8 15:15:24 2010 */
...
#line 2875 "Zend/zend_language_scanner.c"
yy181:
...
#line 4943 "Zend/zend_language_scanner.c"
yy440:
...
yy478:
		...
		yych = *++YYCURSOR;
		if (yych == 'J') goto yy479;
		if (yych != 'j') goto yy221;
yy479:
...
#line 7791 "Zend/zend_language_scanner.c"
yy853:
...
#line 8214 "Zend/zend_language_scanner.c"
yy909:
...
#line 8437 "Zend/zend_language_scanner.c"
/* *********************************** */
yyc_ST_VAR_OFFSET:
	{
		static const unsigned char yybm[] = {
		...
		if (yych <= '/') {
			if (yych <= ' ') {
				if (yych <= '\f') {
					if (yych <= 0x08) goto yy946;
					if (yych <= '\n') goto yy942;
					goto yy946;
				} else {
					if (yych <= '\r') goto yy942;
					if (yych <= 0x1F) goto yy946;
					goto yy942;
				}
			} else {
				if (yych <= '$') {
...
#line 8602 "Zend/zend_language_scanner.c"
yy944:
