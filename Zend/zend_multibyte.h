...
typedef ZEND_RESULT_CODE (*zend_encoding_list_parser)(const char *encoding_list, size_t encoding_list_len, const zend_encoding ***return_list, size_t *return_size, bool persistent);
typedef const zend_encoding *(*zend_encoding_internal_encoding_getter)(void);
typedef ZEND_RESULT_CODE (*zend_encoding_internal_encoding_setter)(const zend_encoding *encoding);
...
ZEND_API ZEND_RESULT_CODE zend_multibyte_set_functions(const zend_multibyte_functions *functions);
...
ZEND_API ZEND_RESULT_CODE zend_multibyte_set_script_encoding_by_string(const char *new_value, size_t new_value_length);
