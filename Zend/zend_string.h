...
#define ZEND_KNOWN_STRINGS(_) \
	...
	_(TYPE,                   "type") \
	_(OBJECT_OPERATOR,        "->") \
	_(PAAMAYIM_NEKUDOTAYIM,   "::") \
	_(ARGS,                   "args") \
	_(UNKNOWN,                "unknown") \
	_(EVAL,                   "eval") \
	_(INCLUDE,                "include") \
	_(REQUIRE,                "require") \
	_(INCLUDE_ONCE,           "include_once") \
	_(REQUIRE_ONCE,           "require_once") \
	_(SCALAR,                 "scalar") \
	_(ERROR_REPORTING,        "error_reporting") \
	_(STATIC,                 "static") \
	_(THIS,                   "this") \
	_(KEY,                    "key") \
	_(VALUE,                  "value") \
	...
	_(ARRAY,                  "array") \
	_(RESOURCE,               "resource") \
	_(CLOSED_RESOURCE,        "resource (closed)") \
	_(NAME,                   "name") \
	_(ARGV,                   "argv") \
	_(ARGC,                   "argc") \
	_(ARRAY_CAPITALIZED,      "Array") \
	_(BOOL,                   "bool") \
	_(INT,                    "int") \
	_(FLOAT,                  "float") \
	_(CALLABLE,               "callable") \
	...
	_(GET_CHILDREN,           "getchildren") \
	_(GET_HASH,               "gethash") \
	_(GET_ITERATOR,           "getiterator") \
	_(HAS_CHILDREN,           "haschildren") \
	_(NEXT_ELEMENT,           "nextelement") \
	_(OFFSET_EXISTS,          "offsetexists") \
	_(OFFSET_GET,             "offsetget") \
	_(OFFSET_SET,             "offsetset") \
	_(OFFSET_UNSET,           "offsetunset") \

typedef enum _zend_known_string_id {
#define _ZEND_STR_ID(id, str) ZEND_STR_##id,
