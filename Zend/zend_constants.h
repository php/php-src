...
ZEND_API zend_bool zend_verify_const_access(zend_class_constant_info *const_info, zend_class_entry *current_scope);
ZEND_API zval *zend_get_constant(zend_string *name);
ZEND_API zval *zend_get_constant_str(const char *name, size_t name_len);
ZEND_API zval *zend_get_constant_ex(zend_string *name, zend_class_entry *scope, zend_class_entry *current_scope, uint32_t flags);
