...
#define REGISTER_INT_CONSTANT(name, lval, flags)  zend_register_int_constant((name), sizeof(name), (lval), (flags), module_number TSRMLS_CC)
...
#define REGISTER_MAIN_INT_CONSTANT(name, lval, flags)  zend_register_int_constant((name), sizeof(name), (lval), (flags), 0 TSRMLS_CC)
