 ...
 * Stub hash: 923b63f7385bcb1157ac45d8ff15564e57deb085 */
...
static zend_class_entry *register_class_Generator(zend_class_entry *class_entry_Iterator)
{
	...
	zend_string *attribute_name_NonInstantiableClass_class_Generator_0 = zend_string_init_interned("NonInstantiableClass", sizeof("NonInstantiableClass") - 1, true);
	zend_attribute *attribute_NonInstantiableClass_class_Generator_0 = zend_add_class_attribute(class_entry, attribute_name_NonInstantiableClass_class_Generator_0, 1);
	zend_string_release_ex(attribute_name_NonInstantiableClass_class_Generator_0, true);
