...
static ZEND_RESULT_CODE dummy_encoding_list_parser(const char *encoding_list, size_t encoding_list_len, const zend_encoding ***return_list, size_t *return_size, bool persistent)
{
...
static ZEND_RESULT_CODE dummy_internal_encoding_setter(const zend_encoding *encoding)
{
	return FAILURE;
}
...
ZEND_API ZEND_RESULT_CODE zend_multibyte_parse_encoding_list(const char *encoding_list, size_t encoding_list_len, const zend_encoding ***return_list, size_t *return_size, bool persistent)
{
...
ZEND_API ZEND_RESULT_CODE zend_multibyte_set_internal_encoding(const zend_encoding *encoding)
{
