...
/* zend_copy_extra_args is used when the actual passed number of arguments
 ...
 * to the zend_execute_data, and when the executor leaves the function, the
 * args will be freed. (this is defined in the zend_leave_helper in Zend/zend_vm_def.h)
 * */
