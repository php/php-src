...
#define INIT_CLASS_ENTRY_INIT_METHODS(class_container, functions) \
	{															\
		...
		class_container.__add = NULL;							\
		class_container.__sub = NULL;							\
		class_container.__mul = NULL;							\
		class_container.__div = NULL;							\
		class_container.__mod = NULL;							\
		class_container.__pow = NULL;							\
		class_container.__bitwiseand = NULL;					\
		class_container.__bitwiseor = NULL;						\
		class_container.__bitwisexor = NULL;					\
		class_container.__bitwisenot = NULL;					\
		class_container.__bitwiseshiftleft = NULL;				\
		class_container.__bitwiseshiftright = NULL;				\
