...
/* Declaration macros */
#define ZEND_MODULE_STARTUP_D(module)		ZEND_RESULT_CODE ZEND_MODULE_STARTUP_N(module)(INIT_FUNC_ARGS)
#define ZEND_MODULE_SHUTDOWN_D(module)		ZEND_RESULT_CODE ZEND_MODULE_SHUTDOWN_N(module)(SHUTDOWN_FUNC_ARGS)
#define ZEND_MODULE_ACTIVATE_D(module)		ZEND_RESULT_CODE ZEND_MODULE_ACTIVATE_N(module)(INIT_FUNC_ARGS)
#define ZEND_MODULE_DEACTIVATE_D(module)	ZEND_RESULT_CODE ZEND_MODULE_DEACTIVATE_N(module)(SHUTDOWN_FUNC_ARGS)
#define ZEND_MODULE_POST_ZEND_DEACTIVATE_D(module)	ZEND_RESULT_CODE ZEND_MODULE_POST_ZEND_DEACTIVATE_N(module)(void)
...
BEGIN_EXTERN_C()
ZEND_API ZEND_RESULT_CODE _zend_get_parameters_array_ex(uint32_t param_count, zval *argument_array);

/* internal function to efficiently copy parameters when executing __call() */
ZEND_API ZEND_RESULT_CODE zend_copy_parameters_array(uint32_t param_count, zval *argument_array);
...
ZEND_API ZEND_RESULT_CODE zend_parse_parameters(uint32_t num_args, const char *type_spec, ...);
ZEND_API ZEND_RESULT_CODE zend_parse_parameters_ex(int flags, uint32_t num_args, const char *type_spec, ...);
...
ZEND_API ZEND_RESULT_CODE zend_parse_method_parameters(uint32_t num_args, zval *this_ptr, const char *type_spec, ...);
ZEND_API ZEND_RESULT_CODE zend_parse_method_parameters_ex(int flags, uint32_t num_args, zval *this_ptr, const char *type_spec, ...);

ZEND_API ZEND_RESULT_CODE zend_parse_parameter(int flags, uint32_t arg_num, zval *arg, const char *spec, ...);

/* End of parameter parsing API -- andrei */

ZEND_API ZEND_RESULT_CODE zend_register_functions(zend_class_entry *scope, const zend_function_entry *functions, HashTable *function_table, int type);
ZEND_API void zend_unregister_functions(const zend_function_entry *functions, int count, HashTable *function_table);
ZEND_API ZEND_RESULT_CODE zend_startup_module(zend_module_entry *module_entry);
...
ZEND_API ZEND_RESULT_CODE zend_startup_module_ex(zend_module_entry *module);
...
ZEND_API ZEND_RESULT_CODE zend_register_class_alias_ex(const char *name, size_t name_len, zend_class_entry *ce, bool persistent);
...
ZEND_API ZEND_RESULT_CODE zend_disable_class(const char *class_name, size_t class_name_length);
...
ZEND_API ZEND_RESULT_CODE zend_update_class_constants(zend_class_entry *class_type);
...
ZEND_API ZEND_RESULT_CODE zend_update_static_property_ex(zend_class_entry *scope, zend_string *name, zval *value);
...
ZEND_API ZEND_RESULT_CODE zend_update_static_property_null(zend_class_entry *scope, const char *name, size_t name_length);
ZEND_API ZEND_RESULT_CODE zend_update_static_property_bool(zend_class_entry *scope, const char *name, size_t name_length, zend_long value);
ZEND_API ZEND_RESULT_CODE zend_update_static_property_long(zend_class_entry *scope, const char *name, size_t name_length, zend_long value);
ZEND_API ZEND_RESULT_CODE zend_update_static_property_double(zend_class_entry *scope, const char *name, size_t name_length, double value);
ZEND_API ZEND_RESULT_CODE zend_update_static_property_string(zend_class_entry *scope, const char *name, size_t name_length, const char *value);
ZEND_API ZEND_RESULT_CODE zend_update_static_property_stringl(zend_class_entry *scope, const char *name, size_t name_length, const char *value, size_t value_length);
...
ZEND_API ZEND_RESULT_CODE object_init_ex(zval *arg, zend_class_entry *ce);
ZEND_API ZEND_RESULT_CODE object_and_properties_init(zval *arg, zend_class_entry *ce, HashTable *properties);
...
static zend_always_inline ZEND_RESULT_CODE add_index_zval(zval *arg, zend_ulong index, zval *value)
{
	return zend_hash_index_update(Z_ARRVAL_P(arg), index, value) ? SUCCESS : FAILURE;
}

ZEND_API ZEND_RESULT_CODE add_next_index_long(zval *arg, zend_long n);
ZEND_API ZEND_RESULT_CODE add_next_index_null(zval *arg);
ZEND_API ZEND_RESULT_CODE add_next_index_bool(zval *arg, zend_bool b);
ZEND_API ZEND_RESULT_CODE add_next_index_resource(zval *arg, zend_resource *r);
ZEND_API ZEND_RESULT_CODE add_next_index_double(zval *arg, double d);
ZEND_API ZEND_RESULT_CODE add_next_index_str(zval *arg, zend_string *str);
ZEND_API ZEND_RESULT_CODE add_next_index_string(zval *arg, const char *str);
ZEND_API ZEND_RESULT_CODE add_next_index_stringl(zval *arg, const char *str, size_t length);

static zend_always_inline ZEND_RESULT_CODE add_next_index_zval(zval *arg, zval *value)
{
	return zend_hash_next_index_insert(Z_ARRVAL_P(arg), value) ? SUCCESS : FAILURE;
}

ZEND_API ZEND_RESULT_CODE array_set_zval_key(HashTable *ht, zval *key, zval *value);
...
ZEND_API ZEND_RESULT_CODE _call_user_function_impl(zval *object, zval *function_name, zval *retval_ptr, uint32_t param_count, zval params[], HashTable *named_params);
 ...
 */
ZEND_API ZEND_RESULT_CODE zend_fcall_info_init(zval *callable, uint32_t check_flags, zend_fcall_info *fci, zend_fcall_info_cache *fcc, zend_string **callable_name, char **error);
 ...
 */
ZEND_API ZEND_RESULT_CODE zend_fcall_info_args(zend_fcall_info *fci, zval *args);
ZEND_API ZEND_RESULT_CODE zend_fcall_info_args_ex(zend_fcall_info *fci, zend_function *func, zval *args);
 ...
 */
ZEND_API ZEND_RESULT_CODE zend_fcall_info_call(zend_fcall_info *fci, zend_fcall_info_cache *fcc, zval *retval, zval *args);

ZEND_API ZEND_RESULT_CODE zend_call_function(zend_fcall_info *fci, zend_fcall_info_cache *fci_cache);
...
ZEND_API ZEND_RESULT_CODE zend_set_hash_symbol(zval *symbol, const char *name, size_t name_length, zend_bool is_ref, int num_symbol_tables, ...);

ZEND_API ZEND_RESULT_CODE zend_delete_global_variable(zend_string *name);

ZEND_API zend_array *zend_rebuild_symbol_table(void);
ZEND_API void zend_attach_symbol_table(zend_execute_data *execute_data);
ZEND_API void zend_detach_symbol_table(zend_execute_data *execute_data);
ZEND_API ZEND_RESULT_CODE zend_set_local_var(zend_string *name, zval *value, bool force);
ZEND_API ZEND_RESULT_CODE zend_set_local_var_str(const char *name, size_t len, zval *value, bool force);

static zend_always_inline ZEND_RESULT_CODE zend_forbid_dynamic_call(const char *func_name)
{
...
ZEND_API ZEND_RESULT_CODE zend_get_default_from_internal_arg_info(
...
ZEND_API ZEND_RESULT_CODE zend_try_assign_typed_ref_ex(zend_reference *ref, zval *zv, zend_bool strict);
ZEND_API ZEND_RESULT_CODE zend_try_assign_typed_ref(zend_reference *ref, zval *zv);

ZEND_API ZEND_RESULT_CODE zend_try_assign_typed_ref_null(zend_reference *ref);
ZEND_API ZEND_RESULT_CODE zend_try_assign_typed_ref_bool(zend_reference *ref, zend_bool val);
ZEND_API ZEND_RESULT_CODE zend_try_assign_typed_ref_long(zend_reference *ref, zend_long lval);
ZEND_API ZEND_RESULT_CODE zend_try_assign_typed_ref_double(zend_reference *ref, double dval);
ZEND_API ZEND_RESULT_CODE zend_try_assign_typed_ref_empty_string(zend_reference *ref);
ZEND_API ZEND_RESULT_CODE zend_try_assign_typed_ref_str(zend_reference *ref, zend_string *str);
ZEND_API ZEND_RESULT_CODE zend_try_assign_typed_ref_string(zend_reference *ref, const char *string);
ZEND_API ZEND_RESULT_CODE zend_try_assign_typed_ref_stringl(zend_reference *ref, const char *string, size_t len);
ZEND_API ZEND_RESULT_CODE zend_try_assign_typed_ref_arr(zend_reference *ref, zend_array *arr);
ZEND_API ZEND_RESULT_CODE zend_try_assign_typed_ref_res(zend_reference *ref, zend_resource *res);
ZEND_API ZEND_RESULT_CODE zend_try_assign_typed_ref_zval(zend_reference *ref, zval *zv);
ZEND_API ZEND_RESULT_CODE zend_try_assign_typed_ref_zval_ex(zend_reference *ref, zval *zv, zend_bool strict);
