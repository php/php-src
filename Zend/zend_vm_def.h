...
ZEND_VM_HANDLER(27, ZEND_ASSIGN_DIM_OP, VAR|CV, CONST|TMPVAR|UNUSED|NEXT|CV, OP, SPEC(DELAYED))
{
	USE_OPLINE
	zval *var_ptr;
...
ZEND_VM_C_LABEL(assign_dim_op_new_array):
		...
		value = GET_OP_DATA_ZVAL_PTR_DEREF();
...
ZEND_VM_HANDLER(26, ZEND_ASSIGN_OP, VAR|CV, CONST|TMPVAR|CV, OP, SPEC(DELAYED))
{
	USE_OPLINE
	zval *var_ptr;
	zval *value;
...
ZEND_VM_HELPER(zend_pre_inc_helper, VAR|CV, ANY, SPEC(DELAYED))
{
	USE_OPLINE
	zval *var_ptr;
...
ZEND_VM_HOT_HANDLER(34, ZEND_PRE_INC, VAR|CV, ANY, SPEC(DELAYED,RETVAL))
{
	USE_OPLINE
	zval *var_ptr;
...
ZEND_VM_HELPER(zend_pre_dec_helper, VAR|CV, ANY, SPEC(DELAYED))
{
	USE_OPLINE
	zval *var_ptr;
...
ZEND_VM_HOT_HANDLER(35, ZEND_PRE_DEC, VAR|CV, ANY, SPEC(DELAYED,RETVAL))
{
	USE_OPLINE
	zval *var_ptr;
...
ZEND_VM_HELPER(zend_post_inc_helper, VAR|CV, ANY, SPEC(DELAYED))
{
	USE_OPLINE
	zval *var_ptr;
...
ZEND_VM_HOT_HANDLER(36, ZEND_POST_INC, VAR|CV, ANY, SPEC(DELAYED))
{
	USE_OPLINE
	zval *var_ptr;
...
ZEND_VM_HELPER(zend_post_dec_helper, VAR|CV, ANY, SPEC(DELAYED))
{
	USE_OPLINE
	zval *var_ptr;
...
ZEND_VM_HOT_HANDLER(37, ZEND_POST_DEC, VAR|CV, ANY, SPEC(DELAYED))
{
	USE_OPLINE
	zval *var_ptr;
...
ZEND_VM_HELPER(zend_fetch_var_address_helper, CONST|TMPVAR|CV, UNUSED, SPEC(DELAYED), int type)
{
	USE_OPLINE
	zval *varname;
	zval *retval;
	...
	if (OP1_TYPE == IS_CONST || EXPECTED(Z_TYPE_P(varname) == IS_STRING)) {
...
ZEND_VM_HANDLER(83, ZEND_FETCH_W, CONST|TMPVAR|CV, UNUSED, VAR_FETCH, SPEC(DELAYED))
{
	ZEND_VM_DISPATCH_TO_HELPER(zend_fetch_var_address_helper, type, BP_VAR_W);
}

ZEND_VM_HANDLER(86, ZEND_FETCH_RW, CONST|TMPVAR|CV, UNUSED, VAR_FETCH, SPEC(DELAYED))
{
	ZEND_VM_DISPATCH_TO_HELPER(zend_fetch_var_address_helper, type, BP_VAR_RW);
}

ZEND_VM_HANDLER(92, ZEND_FETCH_FUNC_ARG, CONST|TMPVAR|CV, UNUSED, VAR_FETCH, SPEC(DELAYED))
{
	int fetch_type =
...
ZEND_VM_HANDLER(95, ZEND_FETCH_UNSET, CONST|TMPVAR|CV, UNUSED, VAR_FETCH, SPEC(DELAYED))
{
...
ZEND_VM_HANDLER(84, ZEND_FETCH_DIM_W, VAR|CV, CONST|TMPVAR|UNUSED|NEXT|CV, SPEC(DELAYED))
{
	USE_OPLINE
	zval *container;
...
ZEND_VM_HANDLER(87, ZEND_FETCH_DIM_RW, VAR|CV, CONST|TMPVAR|UNUSED|NEXT|CV, SPEC(DELAYED))
{
	USE_OPLINE
	zval *container;
...
ZEND_VM_COLD_CONSTCONST_HANDLER(93, ZEND_FETCH_DIM_FUNC_ARG, CONST|TMP|VAR|CV, CONST|TMPVAR|UNUSED|NEXT|CV, SPEC(DELAYED))
{
#if !ZEND_VM_SPEC
	USE_OPLINE
#endif
...
ZEND_VM_HANDLER(96, ZEND_FETCH_DIM_UNSET, VAR|CV, CONST|TMPVAR|CV, SPEC(DELAYED))
{
	USE_OPLINE
	zval *container;
...
ZEND_VM_HANDLER(85, ZEND_FETCH_OBJ_W, VAR|UNUSED|THIS|CV, CONST|TMPVAR|CV, FETCH_REF|DIM_WRITE|CACHE_SLOT, SPEC(DELAYED))
{
	USE_OPLINE
...
ZEND_VM_HANDLER(88, ZEND_FETCH_OBJ_RW, VAR|UNUSED|THIS|CV, CONST|TMPVAR|CV, CACHE_SLOT, SPEC(DELAYED))
{
	USE_OPLINE
	zval *property, *container, *result;
...
ZEND_VM_COLD_CONST_HANDLER(94, ZEND_FETCH_OBJ_FUNC_ARG, CONST|TMP|VAR|UNUSED|THIS|CV, CONST|TMPVAR|CV, FETCH_REF|CACHE_SLOT, SPEC(DELAYED))
{
#if !ZEND_VM_SPEC
	USE_OPLINE
#endif
...
ZEND_VM_HANDLER(97, ZEND_FETCH_OBJ_UNSET, VAR|UNUSED|THIS|CV, CONST|TMPVAR|CV, CACHE_SLOT, SPEC(DELAYED))
{
	USE_OPLINE
...
ZEND_VM_HANDLER(155, ZEND_FETCH_LIST_W, VAR, CONST|TMPVAR|CV, SPEC(DELAYED))
{
	USE_OPLINE
	zval *container, *dim;
...
ZEND_VM_HANDLER(24, ZEND_ASSIGN_OBJ, VAR|UNUSED|THIS|CV, CONST|TMPVAR|CV, CACHE_SLOT, SPEC(DELAYED,OP_DATA=CONST|TMP|VAR|CV))
{
	USE_OPLINE
...
ZEND_VM_HANDLER(23, ZEND_ASSIGN_DIM, VAR|CV, CONST|TMPVAR|UNUSED|NEXT|CV, SPEC(DELAYED,OP_DATA=CONST|TMP|VAR|CV))
{
	USE_OPLINE
...
ZEND_VM_HANDLER(22, ZEND_ASSIGN, VAR|CV, CONST|TMP|VAR|CV, SPEC(DELAYED,RETVAL))
{
	USE_OPLINE
	zval *value;
	zval *variable_ptr;
...
ZEND_VM_HANDLER(30, ZEND_ASSIGN_REF, VAR|CV, VAR|CV, SRC, SPEC(DELAYED))
{
	USE_OPLINE
	zval *variable_ptr;
	zval *value_ptr;
...
ZEND_VM_HANDLER(32, ZEND_ASSIGN_OBJ_REF, VAR|UNUSED|THIS|CV, CONST|TMPVAR|CV, CACHE_SLOT|SRC, SPEC(DELAYED,OP_DATA=VAR|CV))
{
	USE_OPLINE
...
ZEND_VM_COLD_CONST_HANDLER(111, ZEND_RETURN_BY_REF, CONST|TMP|VAR|CV, ANY, SRC, SPEC(DELAYED,OBSERVER))
{
	USE_OPLINE
	zval *retval_ptr;
	zval *return_value;
...
ZEND_VM_HANDLER(67, ZEND_SEND_REF, VAR|CV, CONST|UNUSED|NUM, SPEC(DELAYED))
{
	USE_OPLINE
	zval *varptr, *arg;
...
ZEND_VM_HOT_SEND_HANDLER(66, ZEND_SEND_VAR_EX, VAR|CV, CONST|UNUSED|NUM, SPEC(DELAYED))
{
	USE_OPLINE
	zval *varptr, *arg;
	uint32_t arg_num;
...
ZEND_VM_HOT_HANDLER(185, ZEND_SEND_FUNC_ARG, VAR, CONST|UNUSED|NUM, SPEC(DELAYED))
{
	USE_OPLINE
	zval *varptr, *arg;
...
ZEND_VM_HANDLER(72, ZEND_ADD_ARRAY_ELEMENT, CONST|TMP|VAR|CV, CONST|TMPVAR|UNUSED|NEXT|CV, REF, SPEC(DELAYED))
{
	USE_OPLINE
...
ZEND_VM_HANDLER(74, ZEND_UNSET_VAR, CONST|TMPVAR|CV, UNUSED, VAR_FETCH, SPEC(DELAYED))
{
	USE_OPLINE
	zval *varname;
	zend_string *name, *tmp_name;
...
ZEND_VM_HANDLER(75, ZEND_UNSET_DIM, VAR|CV, CONST|TMPVAR|CV, SPEC(DELAYED))
{
	USE_OPLINE
	zval *container;
	zval *offset;
...
ZEND_VM_HANDLER(76, ZEND_UNSET_OBJ, VAR|UNUSED|THIS|CV, CONST|TMPVAR|CV, CACHE_SLOT, SPEC(DELAYED))
{
	USE_OPLINE
	zval *container;
	zval *offset;
...
ZEND_VM_HANDLER(140, ZEND_MAKE_REF, VAR|CV, UNUSED, SPEC(DELAYED))
{
	USE_OPLINE
	zval *op1 = EX_VAR(opline->op1.var);
