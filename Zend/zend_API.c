...
static ZEND_RESULT_CODE zend_parse_arg(uint32_t arg_num, zval *arg, va_list *va, const char **spec, int flags) /* {{{ */
{
...
static ZEND_RESULT_CODE zend_parse_va_args(uint32_t num_args, const char *type_spec, va_list *va, int flags) /* {{{ */
{
...
static zend_always_inline ZEND_RESULT_CODE _object_and_properties_init(zval *arg, zend_class_entry *class_type, HashTable *properties) /* {{{ */
{
...
ZEND_API ZEND_RESULT_CODE object_and_properties_init(zval *arg, zend_class_entry *class_type, HashTable *properties) /* {{{ */
{
	return _object_and_properties_init(arg, class_type, properties);
}
/* }}} */

ZEND_API ZEND_RESULT_CODE object_init_ex(zval *arg, zend_class_entry *class_type) /* {{{ */
{
...
ZEND_API ZEND_RESULT_CODE zend_startup_module(zend_module_entry *module) /* {{{ */
{
...
ZEND_API ZEND_RESULT_CODE zend_get_module_started(const char *module_name) /* {{{ */
{
	zend_module_entry *module;
...
ZEND_API ZEND_RESULT_CODE zend_fcall_info_call(zend_fcall_info *fci, zend_fcall_info_cache *fcc, zval *retval_ptr, zval *args) /* {{{ */
{
...
ZEND_API ZEND_RESULT_CODE zend_try_assign_typed_ref_ex(zend_reference *ref, zval *val, zend_bool strict) /* {{{ */
{
...
ZEND_API ZEND_RESULT_CODE zend_try_assign_typed_ref(zend_reference *ref, zval *val) /* {{{ */
{
...
ZEND_API ZEND_RESULT_CODE zend_update_static_property_stringl(zend_class_entry *scope, const char *name, size_t name_length, const char *value, size_t value_len) /* {{{ */
{
	zval tmp;
...
static ZEND_RESULT_CODE get_default_via_ast(zval *default_value_zval, const char *default_value) {
	zend_ast *ast;
