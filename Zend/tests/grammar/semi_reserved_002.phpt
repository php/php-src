...
class Obj
{
    ...
    static function enddeclare()
    {
        echo __METHOD__, PHP_EOL;
    }
    static function endfor()
    {
        echo __METHOD__, PHP_EOL;
    }
    static function endforeach()
    {
        echo __METHOD__, PHP_EOL;
    }
    static function endif()
    {
        echo __METHOD__, PHP_EOL;
    }
    static function endwhile()
    {
        echo __METHOD__, PHP_EOL;
    }
    static function and()
    ...
    static function __CLASS__()
    {
        echo __METHOD__, PHP_EOL;
    }
    static function __TRAIT__()
    {
        echo __METHOD__, PHP_EOL;
    }
    ...
    static function __METHOD__()
    {
        echo __METHOD__, PHP_EOL;
    }
    static function __LINE__()
    {
        echo __METHOD__, PHP_EOL;
    }
    static function __FILE__()
    {
        echo __METHOD__, PHP_EOL;
    }
    static function __DIR__()
    {
        echo __METHOD__, PHP_EOL;
    }
    static function __NAMESPACE__()
    {
        echo __METHOD__, PHP_EOL;
    }
}
