--TEST--
Test string_param ZPP specifier (weak_mode)
--EXTENSIONS--
zend_test
--FILE--
<?php
...
Using zend_string_param:
  ...
  null:            
Deprecated: zend_string_param(): Passing null to parameter #1 ($param) of type string is deprecated in %s on line %d
string(0) ""
  false:           string(0) ""
  true:            string(1) "1"
  42:              string(2) "42"
...
Using zend_string_param_slow_zpp:
  ...
  null:            
Deprecated: zend_string_param_slow_zpp(): Passing null to parameter #1 ($param) of type string is deprecated in %s on line %d
string(0) ""
  false:           string(0) ""
  true:            string(1) "1"
  42:              string(2) "42"
