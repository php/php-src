--TEST--
Test path ZPP specifier (weak_mode)
--EXTENSIONS--
zend_test
--FILE--
<?php
...
Using zend_path:
  ...
  null:            
Deprecated: zend_path(): Passing null to parameter #1 ($param) of type string is deprecated in %s on line %d
string(0) ""
  false:           string(0) ""
  true:            string(1) "1"
  42:              string(2) "42"
...
Using zend_path_slow_zpp:
  ...
  null:            
Deprecated: zend_path_slow_zpp(): Passing null to parameter #1 ($param) of type string is deprecated in %s on line %d
string(0) ""
  false:           string(0) ""
  true:            string(1) "1"
  42:              string(2) "42"
