--TEST--
__equals: Called by array_search which has equality semantics (searching)
--FILE--
<?php
...
var_dump(array_search(new Equatable(1), $array, $strict = false)); // 0
var_dump(array_search(new Equatable(2), $array, $strict = false)); // 1
var_dump(array_search(new Equatable(3), $array, $strict = false)); // 2

/* Not found, because not the same instance */
var_dump(array_search(new Equatable(1), $array, $strict = true)); // false
var_dump(array_search(new Equatable(2), $array, $strict = true)); // false
var_dump(array_search(new Equatable(3), $array, $strict = true)); // false
...
/* Not found */
var_dump(array_search(new Equatable(4), $array, $strict = false)); // false
var_dump(array_search(new Equatable(5), $array, $strict = false)); // false

var_dump(array_search(new Equatable(4), $array, $strict = true)); // false
var_dump(array_search(new Equatable(5), $array, $strict = true)); // false
