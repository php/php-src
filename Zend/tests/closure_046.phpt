...
$d = $nonstaticUnscoped->bindTo(null, "static");
$d();
echo "\n";
$d = $nonstaticScoped->bindTo(null, "static");
var_dump($d);
echo "\n";

echo "After binding, with same-class instance for the bound one", "\n";
$d = $nonstaticUnscoped->bindTo(new A(), "static");
$d();
echo "\n";
$d = $nonstaticScoped->bindTo(new A(), "static");
$d();
echo "\n";

echo "After binding, with different instance for the bound one", "\n";
$d = $nonstaticScoped->bindTo(new B(), "static");
$d();
echo "\n";
