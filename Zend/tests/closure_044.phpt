...
$d = $nonstaticUnscoped->bindTo(null, null);
$d();
echo "\n";
$d = $nonstaticScoped->bindTo(null, null);
var_dump($d);
echo "\n";

echo "After binding, null scope, with instance", "\n";
$d = $nonstaticUnscoped->bindTo(new A(), null);
$d();
echo "\n";
$d = $nonstaticScoped->bindTo(new A(), null);
$d();
echo "\n";

echo "After binding, with scope, no instance", "\n";
$d = $nonstaticUnscoped->bindTo(null, 'A');
$d();
echo "\n";
$d = $nonstaticScoped->bindTo(null, 'A');
var_dump($d);
echo "\n";

echo "After binding, with scope, with instance", "\n";
$d = $nonstaticUnscoped->bindTo(new A(), 'A');
$d();
echo "\n";
$d = $nonstaticScoped->bindTo(new A(), 'A');
$d();
echo "\n";
