...
true + (object) array ( ) = 2 - Notice Object of class stdClass could not be converted to number
true + (object) array ( 'foo' => 1, 'bar' => 2 ) = 2 - Notice Object of class stdClass could not be converted to number
true + (object) array ( 'bar' => 1, 'foo' => 2 ) = 2 - Notice Object of class stdClass could not be converted to number
true + DateTime = 2 - Notice Object of class DateTime could not be converted to number
true + resource = 7
true + NULL = 1
0 + false = 0
0 + true = 1
...
10 + (object) array ( ) = 11 - Notice Object of class stdClass could not be converted to number
10 + (object) array ( 'foo' => 1, 'bar' => 2 ) = 11 - Notice Object of class stdClass could not be converted to number
10 + (object) array ( 'bar' => 1, 'foo' => 2 ) = 11 - Notice Object of class stdClass could not be converted to number
10 + DateTime = 11 - Notice Object of class DateTime could not be converted to number
10 + resource = 16
10 + NULL = 10
0.0 + false = 0.0
0.0 + true = 1.0
...
10.0 + (object) array ( ) = 11.0 - Notice Object of class stdClass could not be converted to number
10.0 + (object) array ( 'foo' => 1, 'bar' => 2 ) = 11.0 - Notice Object of class stdClass could not be converted to number
10.0 + (object) array ( 'bar' => 1, 'foo' => 2 ) = 11.0 - Notice Object of class stdClass could not be converted to number
10.0 + DateTime = 11.0 - Notice Object of class DateTime could not be converted to number
10.0 + resource = 16.0
10.0 + NULL = 10.0
3.14 + false = 3.14
...
3.14 + (object) array ( ) = 4.140000000000001 - Notice Object of class stdClass could not be converted to number
3.14 + (object) array ( 'foo' => 1, 'bar' => 2 ) = 4.140000000000001 - Notice Object of class stdClass could not be converted to number
3.14 + (object) array ( 'bar' => 1, 'foo' => 2 ) = 4.140000000000001 - Notice Object of class stdClass could not be converted to number
3.14 + DateTime = 4.140000000000001 - Notice Object of class DateTime could not be converted to number
3.14 + resource = 9.14
3.14 + NULL = 3.14
'0' + false = 0
'0' + true = 1
...
'010' + '10' = 20
'010' + '010' = 20
'010' + '10 elephants' = 20 - Notice A non well formed numeric value encountered
...
'010' + (object) array ( ) = 11 - Notice Object of class stdClass could not be converted to number
'010' + (object) array ( 'foo' => 1, 'bar' => 2 ) = 11 - Notice Object of class stdClass could not be converted to number
'010' + (object) array ( 'bar' => 1, 'foo' => 2 ) = 11 - Notice Object of class stdClass could not be converted to number
'010' + DateTime = 11 - Notice Object of class DateTime could not be converted to number
'010' + resource = 16
'010' + NULL = 10
...
'10 elephants' + '0' = 10 - Notice A non well formed numeric value encountered
'10 elephants' + '10' = 20 - Notice A non well formed numeric value encountered
'10 elephants' + '010' = 20 - Notice A non well formed numeric value encountered
...
'10 elephants' + (object) array ( ) = 11 - Notice Object of class stdClass could not be converted to number
'10 elephants' + (object) array ( 'foo' => 1, 'bar' => 2 ) = 11 - Notice Object of class stdClass could not be converted to number
'10 elephants' + (object) array ( 'bar' => 1, 'foo' => 2 ) = 11 - Notice Object of class stdClass could not be converted to number
'10 elephants' + DateTime = 11 - Notice Object of class DateTime could not be converted to number
'10 elephants' + resource = 16 - Notice A non well formed numeric value encountered
...
(object) array ( ) + true = 2 - Notice Object of class stdClass could not be converted to number
(object) array ( ) + 0 = 1 - Notice Object of class stdClass could not be converted to number
(object) array ( ) + 10 = 11 - Notice Object of class stdClass could not be converted to number
(object) array ( ) + 0.0 = 1.0 - Notice Object of class stdClass could not be converted to number
(object) array ( ) + 10.0 = 11.0 - Notice Object of class stdClass could not be converted to number
(object) array ( ) + 3.14 = 4.140000000000001 - Notice Object of class stdClass could not be converted to number
(object) array ( ) + '0' = 1 - Notice Object of class stdClass could not be converted to number
(object) array ( ) + '10' = 11 - Notice Object of class stdClass could not be converted to number
(object) array ( ) + '010' = 11 - Notice Object of class stdClass could not be converted to number
...
(object) array ( ) + (object) array ( ) = 2 - Notice Object of class stdClass could not be converted to number
(object) array ( ) + (object) array ( 'foo' => 1, 'bar' => 2 ) = 2 - Notice Object of class stdClass could not be converted to number
(object) array ( ) + (object) array ( 'bar' => 1, 'foo' => 2 ) = 2 - Notice Object of class stdClass could not be converted to number
(object) array ( ) + DateTime = 2 - Notice Object of class DateTime could not be converted to number
(object) array ( ) + resource = 7 - Notice Object of class stdClass could not be converted to number
...
(object) array ( 'foo' => 1, 'bar' => 2 ) + true = 2 - Notice Object of class stdClass could not be converted to number
(object) array ( 'foo' => 1, 'bar' => 2 ) + 0 = 1 - Notice Object of class stdClass could not be converted to number
(object) array ( 'foo' => 1, 'bar' => 2 ) + 10 = 11 - Notice Object of class stdClass could not be converted to number
(object) array ( 'foo' => 1, 'bar' => 2 ) + 0.0 = 1.0 - Notice Object of class stdClass could not be converted to number
(object) array ( 'foo' => 1, 'bar' => 2 ) + 10.0 = 11.0 - Notice Object of class stdClass could not be converted to number
(object) array ( 'foo' => 1, 'bar' => 2 ) + 3.14 = 4.140000000000001 - Notice Object of class stdClass could not be converted to number
(object) array ( 'foo' => 1, 'bar' => 2 ) + '0' = 1 - Notice Object of class stdClass could not be converted to number
(object) array ( 'foo' => 1, 'bar' => 2 ) + '10' = 11 - Notice Object of class stdClass could not be converted to number
(object) array ( 'foo' => 1, 'bar' => 2 ) + '010' = 11 - Notice Object of class stdClass could not be converted to number
...
(object) array ( 'foo' => 1, 'bar' => 2 ) + (object) array ( ) = 2 - Notice Object of class stdClass could not be converted to number
(object) array ( 'foo' => 1, 'bar' => 2 ) + (object) array ( 'foo' => 1, 'bar' => 2 ) = 2 - Notice Object of class stdClass could not be converted to number
(object) array ( 'foo' => 1, 'bar' => 2 ) + (object) array ( 'bar' => 1, 'foo' => 2 ) = 2 - Notice Object of class stdClass could not be converted to number
(object) array ( 'foo' => 1, 'bar' => 2 ) + DateTime = 2 - Notice Object of class DateTime could not be converted to number
(object) array ( 'foo' => 1, 'bar' => 2 ) + resource = 7 - Notice Object of class stdClass could not be converted to number
...
(object) array ( 'bar' => 1, 'foo' => 2 ) + true = 2 - Notice Object of class stdClass could not be converted to number
(object) array ( 'bar' => 1, 'foo' => 2 ) + 0 = 1 - Notice Object of class stdClass could not be converted to number
(object) array ( 'bar' => 1, 'foo' => 2 ) + 10 = 11 - Notice Object of class stdClass could not be converted to number
(object) array ( 'bar' => 1, 'foo' => 2 ) + 0.0 = 1.0 - Notice Object of class stdClass could not be converted to number
(object) array ( 'bar' => 1, 'foo' => 2 ) + 10.0 = 11.0 - Notice Object of class stdClass could not be converted to number
(object) array ( 'bar' => 1, 'foo' => 2 ) + 3.14 = 4.140000000000001 - Notice Object of class stdClass could not be converted to number
(object) array ( 'bar' => 1, 'foo' => 2 ) + '0' = 1 - Notice Object of class stdClass could not be converted to number
(object) array ( 'bar' => 1, 'foo' => 2 ) + '10' = 11 - Notice Object of class stdClass could not be converted to number
(object) array ( 'bar' => 1, 'foo' => 2 ) + '010' = 11 - Notice Object of class stdClass could not be converted to number
...
(object) array ( 'bar' => 1, 'foo' => 2 ) + (object) array ( ) = 2 - Notice Object of class stdClass could not be converted to number
(object) array ( 'bar' => 1, 'foo' => 2 ) + (object) array ( 'foo' => 1, 'bar' => 2 ) = 2 - Notice Object of class stdClass could not be converted to number
(object) array ( 'bar' => 1, 'foo' => 2 ) + (object) array ( 'bar' => 1, 'foo' => 2 ) = 2 - Notice Object of class stdClass could not be converted to number
(object) array ( 'bar' => 1, 'foo' => 2 ) + DateTime = 2 - Notice Object of class DateTime could not be converted to number
(object) array ( 'bar' => 1, 'foo' => 2 ) + resource = 7 - Notice Object of class stdClass could not be converted to number
...
DateTime + true = 2 - Notice Object of class DateTime could not be converted to number
DateTime + 0 = 1 - Notice Object of class DateTime could not be converted to number
DateTime + 10 = 11 - Notice Object of class DateTime could not be converted to number
DateTime + 0.0 = 1.0 - Notice Object of class DateTime could not be converted to number
DateTime + 10.0 = 11.0 - Notice Object of class DateTime could not be converted to number
DateTime + 3.14 = 4.140000000000001 - Notice Object of class DateTime could not be converted to number
DateTime + '0' = 1 - Notice Object of class DateTime could not be converted to number
DateTime + '10' = 11 - Notice Object of class DateTime could not be converted to number
DateTime + '010' = 11 - Notice Object of class DateTime could not be converted to number
...
DateTime + (object) array ( ) = 2 - Notice Object of class stdClass could not be converted to number
DateTime + (object) array ( 'foo' => 1, 'bar' => 2 ) = 2 - Notice Object of class stdClass could not be converted to number
DateTime + (object) array ( 'bar' => 1, 'foo' => 2 ) = 2 - Notice Object of class stdClass could not be converted to number
DateTime + DateTime = 2 - Notice Object of class DateTime could not be converted to number
DateTime + resource = 7 - Notice Object of class DateTime could not be converted to number
...
resource + '10' = 16
resource + '010' = 16
resource + '10 elephants' = 16 - Notice A non well formed numeric value encountered
...
resource + (object) array ( ) = 7 - Notice Object of class stdClass could not be converted to number
resource + (object) array ( 'foo' => 1, 'bar' => 2 ) = 7 - Notice Object of class stdClass could not be converted to number
resource + (object) array ( 'bar' => 1, 'foo' => 2 ) = 7 - Notice Object of class stdClass could not be converted to number
resource + DateTime = 7 - Notice Object of class DateTime could not be converted to number
