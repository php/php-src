...
0.0 | 0.0 - TypeError Unsupported operand types
0.0 | 10.0 - TypeError Unsupported operand types
0.0 | 3.14 - TypeError Unsupported operand types
0.0 | '0' - TypeError Unsupported operand types
0.0 | '10' - TypeError Unsupported operand types
...
10.0 | 0.0 - TypeError Unsupported operand types
10.0 | 10.0 - TypeError Unsupported operand types
10.0 | 3.14 - TypeError Unsupported operand types
10.0 | '0' - TypeError Unsupported operand types
10.0 | '10' - TypeError Unsupported operand types
...
3.14 | 0.0 - TypeError Unsupported operand types
3.14 | 10.0 - TypeError Unsupported operand types
3.14 | 3.14 - TypeError Unsupported operand types
3.14 | '0' - TypeError Unsupported operand types
3.14 | '10' - TypeError Unsupported operand types
