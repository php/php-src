...
3.14 | '10' = 11
3.14 | '010' = 11
3.14 | '10 elephants' = 11 - Notice A non well formed numeric value encountered
3.14 | 'foo' = 3 - Warning A non-numeric value encountered
3.14 | array ( ) = 3
3.14 | array ( 0 => 1 ) = 3
3.14 | array ( 0 => 1, 1 => 100 ) = 3
3.14 | array ( 'foo' => 1, 'bar' => 2 ) = 3
3.14 | array ( 'bar' => 1, 'foo' => 2 ) = 3
3.14 | (object) array ( ) = 3 - Notice Object of class stdClass could not be converted to int
3.14 | (object) array ( 'foo' => 1, 'bar' => 2 ) = 3 - Notice Object of class stdClass could not be converted to int
3.14 | (object) array ( 'bar' => 1, 'foo' => 2 ) = 3 - Notice Object of class stdClass could not be converted to int
3.14 | DateTime = 3 - Notice Object of class DateTime could not be converted to int
3.14 | resource = 7
3.14 | NULL = 3
'0' | false = 0
'0' | true = 1
...
'10 elephants' | 3.14 = 11 - Notice A non well formed numeric value encountered
...
'10 elephants' | resource = 14 - Notice A non well formed numeric value encountered
...
(object) array ( ) | 3.14 = 3 - Notice Object of class stdClass could not be converted to int
(object) array ( ) | '0' = 1 - Notice Object of class stdClass could not be converted to int
(object) array ( ) | '10' = 11 - Notice Object of class stdClass could not be converted to int
...
(object) array ( 'foo' => 1, 'bar' => 2 ) | 3.14 = 3 - Notice Object of class stdClass could not be converted to int
(object) array ( 'foo' => 1, 'bar' => 2 ) | '0' = 1 - Notice Object of class stdClass could not be converted to int
(object) array ( 'foo' => 1, 'bar' => 2 ) | '10' = 11 - Notice Object of class stdClass could not be converted to int
...
(object) array ( 'bar' => 1, 'foo' => 2 ) | 3.14 = 3 - Notice Object of class stdClass could not be converted to int
(object) array ( 'bar' => 1, 'foo' => 2 ) | '0' = 1 - Notice Object of class stdClass could not be converted to int
(object) array ( 'bar' => 1, 'foo' => 2 ) | '10' = 11 - Notice Object of class stdClass could not be converted to int
...
DateTime | 3.14 = 3 - Notice Object of class DateTime could not be converted to int
DateTime | '0' = 1 - Notice Object of class DateTime could not be converted to int
DateTime | '10' = 11 - Notice Object of class DateTime could not be converted to int
...
resource | '10' = 14
resource | '010' = 14
resource | '10 elephants' = 14 - Notice A non well formed numeric value encountered
