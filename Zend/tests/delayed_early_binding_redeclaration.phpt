...
?>
--EXPECTF--
Fatal error: Cannot declare class Bar, because the name is already in use (previously declared in %sdelayed_early_binding_redeclaration-1.inc:2) in %sdelayed_early_binding_redeclaration-2.inc on line %d
