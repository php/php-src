...
typedef ulong (*hash_func_t)(const char *arKey, zend_str_size_uint nKeyLength);
...
static inline ulong zend_inline_hash_func(const char *arKey, zend_str_size_uint nKeyLength)
{
