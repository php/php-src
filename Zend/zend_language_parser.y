...
%token T_EXPECT          "expect (T_EXPECT)"
...
unticked_statement:
	...
	|   T_EXPECT { zend_do_expect_begin(&$$ TSRMLS_CC); } expr expect_optional_reason ';' { zend_do_expect_end(&$2, &$3, &$4, Z_STRVAL($1.u.constant), (const char*) LANG_SCNG(yy_text) TSRMLS_CC); }
