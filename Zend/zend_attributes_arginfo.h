 ...
 * Stub hash: 9d32931d7b2781cdc520ebfa4538f0b19a51097a */
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_class_NonpublicConstructor___construct, 0, 0, 1)
...
static const zend_function_entry class_NonpublicConstructor_methods[] = {
	ZEND_ME(NonpublicConstructor, __construct, arginfo_class_NonpublicConstructor___construct, ZEND_ACC_PUBLIC)
	ZEND_FE_END
};
...
static zend_class_entry *register_class_NonpublicConstructor(void)
{
	zend_class_entry ce, *class_entry;

	INIT_CLASS_ENTRY(ce, "NonpublicConstructor", class_NonpublicConstructor_methods);
	class_entry = zend_register_internal_class_with_flags(&ce, NULL, ZEND_ACC_FINAL|ZEND_ACC_NO_DYNAMIC_PROPERTIES);
	...
	zend_string *attribute_name_Attribute_class_NonpublicConstructor_0 = zend_string_init_interned("Attribute", sizeof("Attribute") - 1, 1);
	zend_attribute *attribute_Attribute_class_NonpublicConstructor_0 = zend_add_class_attribute(class_entry, attribute_name_Attribute_class_NonpublicConstructor_0, 1);
	zend_string_release(attribute_name_Attribute_class_NonpublicConstructor_0);
	zval attribute_Attribute_class_NonpublicConstructor_0_arg0;
	ZVAL_LONG(&attribute_Attribute_class_NonpublicConstructor_0_arg0, ZEND_ATTRIBUTE_TARGET_METHOD);
	ZVAL_COPY_VALUE(&attribute_Attribute_class_NonpublicConstructor_0->args[0].value, &attribute_Attribute_class_NonpublicConstructor_0_arg0);
