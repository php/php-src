...
Warning: ob_start() expects parameter 2 to be integer (or convertible float, convertible string or boolean), string given in %s on line 23
NULL

- Arg 3 wrong type

Warning: ob_start() expects parameter 3 to be integer (or convertible float, convertible string or boolean), string given in %s on line 26
NULL
