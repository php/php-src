...
static const zend_function_entry class_XMLReader_methods[] = {
	ZEND_RAW_FENTRY("close", zim_XMLReader_close, arginfo_class_XMLReader_close, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getAttribute", zim_XMLReader_getAttribute, arginfo_class_XMLReader_getAttribute, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getAttributeNo", zim_XMLReader_getAttributeNo, arginfo_class_XMLReader_getAttributeNo, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getAttributeNs", zim_XMLReader_getAttributeNs, arginfo_class_XMLReader_getAttributeNs, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getParserProperty", zim_XMLReader_getParserProperty, arginfo_class_XMLReader_getParserProperty, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("isValid", zim_XMLReader_isValid, arginfo_class_XMLReader_isValid, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("lookupNamespace", zim_XMLReader_lookupNamespace, arginfo_class_XMLReader_lookupNamespace, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("moveToAttribute", zim_XMLReader_moveToAttribute, arginfo_class_XMLReader_moveToAttribute, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("moveToAttributeNo", zim_XMLReader_moveToAttributeNo, arginfo_class_XMLReader_moveToAttributeNo, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("moveToAttributeNs", zim_XMLReader_moveToAttributeNs, arginfo_class_XMLReader_moveToAttributeNs, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("moveToElement", zim_XMLReader_moveToElement, arginfo_class_XMLReader_moveToElement, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("moveToFirstAttribute", zim_XMLReader_moveToFirstAttribute, arginfo_class_XMLReader_moveToFirstAttribute, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("moveToNextAttribute", zim_XMLReader_moveToNextAttribute, arginfo_class_XMLReader_moveToNextAttribute, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("read", zim_XMLReader_read, arginfo_class_XMLReader_read, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("next", zim_XMLReader_next, arginfo_class_XMLReader_next, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("open", zim_XMLReader_open, arginfo_class_XMLReader_open, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("readInnerXml", zim_XMLReader_readInnerXml, arginfo_class_XMLReader_readInnerXml, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("readOuterXml", zim_XMLReader_readOuterXml, arginfo_class_XMLReader_readOuterXml, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("readString", zim_XMLReader_readString, arginfo_class_XMLReader_readString, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setSchema", zim_XMLReader_setSchema, arginfo_class_XMLReader_setSchema, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setParserProperty", zim_XMLReader_setParserProperty, arginfo_class_XMLReader_setParserProperty, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setRelaxNGSchema", zim_XMLReader_setRelaxNGSchema, arginfo_class_XMLReader_setRelaxNGSchema, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setRelaxNGSchemaSource", zim_XMLReader_setRelaxNGSchemaSource, arginfo_class_XMLReader_setRelaxNGSchemaSource, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("XML", zim_XMLReader_XML, arginfo_class_XMLReader_XML, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("expand", zim_XMLReader_expand, arginfo_class_XMLReader_expand, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};
