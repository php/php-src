...
static zend_class_entry *register_class_XMLReader(void)
{
	...
	zend_string_release_ex(property_attributeCount_name, 1);
	...
	zend_string_release_ex(property_baseURI_name, 1);
	...
	zend_string_release_ex(property_depth_name, 1);
	...
	zend_string_release_ex(property_hasAttributes_name, 1);
	...
	zend_string_release_ex(property_hasValue_name, 1);
	...
	zend_string_release_ex(property_isDefault_name, 1);
	...
	zend_string_release_ex(property_isEmptyElement_name, 1);
	...
	zend_string_release_ex(property_localName_name, 1);
	...
	zend_string_release_ex(property_namespaceURI_name, 1);
	...
	zend_string_release_ex(property_nodeType_name, 1);
	...
	zend_string_release_ex(property_prefix_name, 1);
	...
	zend_string_release_ex(property_xmlLang_name, 1);
