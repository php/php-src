...
ZEND_BEGIN_ARG_WITH_TENTATIVE_RETURN_TYPE_INFO_EX(arginfo_class_Phar_decompressFiles, 0, 0, _IS_BOOL, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_TENTATIVE_RETURN_TYPE_INFO_EX(arginfo_class_Phar_copy, 0, 2, _IS_BOOL, 0)
...
ZEND_BEGIN_ARG_WITH_TENTATIVE_RETURN_TYPE_INFO_EX(arginfo_class_Phar_delete, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, localName, IS_STRING, 0)
ZEND_END_ARG_INFO()
...
#define arginfo_class_Phar_getModified arginfo_class_Phar_decompressFiles
...
#define arginfo_class_Phar_hasMetadata arginfo_class_Phar_decompressFiles

#define arginfo_class_Phar_isBuffering arginfo_class_Phar_decompressFiles
...
#define arginfo_class_Phar_isWritable arginfo_class_Phar_decompressFiles
...
ZEND_BEGIN_ARG_WITH_TENTATIVE_RETURN_TYPE_INFO_EX(arginfo_class_Phar_setStub, 0, 1, _IS_BOOL, 0)
...
#define arginfo_class_PharData_getModified arginfo_class_Phar_decompressFiles
...
#define arginfo_class_PharData_hasMetadata arginfo_class_Phar_decompressFiles

#define arginfo_class_PharData_isBuffering arginfo_class_Phar_decompressFiles
...
#define arginfo_class_PharData_isWritable arginfo_class_Phar_decompressFiles
...
ZEND_BEGIN_ARG_WITH_TENTATIVE_RETURN_TYPE_INFO_EX(arginfo_class_PharFileInfo_compress, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, compression, IS_LONG, 0)
ZEND_END_ARG_INFO()
...
#define arginfo_class_PharFileInfo_hasMetadata arginfo_class_Phar_decompressFiles

ZEND_BEGIN_ARG_WITH_TENTATIVE_RETURN_TYPE_INFO_EX(arginfo_class_PharFileInfo_isCompressed, 0, 0, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, compression, IS_LONG, 1, "null")
ZEND_END_ARG_INFO()

#define arginfo_class_PharFileInfo_isCRCChecked arginfo_class_Phar_decompressFiles
