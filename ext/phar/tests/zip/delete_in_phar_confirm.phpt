...
Warning: include(): failed to open stream (%sdelete_in_phar_confirm.phar.zip/b/c.php): phar error: "b/c.php" is not a file in phar "%sdelete_in_phar_confirm.phar.zip" in %sdelete_in_phar_confirm.php on line %d
