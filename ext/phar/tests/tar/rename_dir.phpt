...
Warning: file_get_contents(): failed to open stream (phar://%srename_dir.phar.tar/a/x): phar error: "a/x" is not a file in phar "%srename_dir.phar.tar" in %srename_dir.php on line %d
