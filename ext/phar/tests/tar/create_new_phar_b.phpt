...
--EXPECTF--
Warning: file_put_contents(): failed to open stream (phar://%screate_new_phar_b.phar.tar/a.php): phar error: write operations disabled by the php.ini setting phar.readonly in %screate_new_phar_b.php on line %d

Warning: include(): failed to open stream (phar://%screate_new_phar_b.phar.tar/a.php): %s in %screate_new_phar_b.php on line %d
