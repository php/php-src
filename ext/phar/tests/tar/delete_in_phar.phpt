...
Warning: include(): failed to open stream (%sdelete_in_phar.phar.tar/b/c.php): phar error: "b/c.php" is not a file in phar "%sdelete_in_phar.phar.tar" in %sdelete_in_phar.php on line %d
