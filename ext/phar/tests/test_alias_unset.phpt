...
Warning: file_get_contents(): failed to open stream (phar://%sfile1.txt): Cannot open archive "%stest_alias_unset.phar.php", alias is already in use by existing archive in %stest_alias_unset.php on line %d
===DONE===
