...
?>
--EXPECTF--
ValueError: Phar::unlinkArchive(): Argument #1 ($filename) must not be empty
...
bool(false)
int(0)
PharException: phar archive "%sphar_unlinkarchive.phar" cannot be unlinked from within itself
