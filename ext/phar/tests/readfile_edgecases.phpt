...
Warning: readfile(): failed to open stream (phar://%sreadfile_edgecases.phar.php/oops): phar error: path "oops" is a directory in phar://%sreadfile_edgecases.phar.php/foo/hi on line %d
===DONE===
