...
PHP_METHOD(Phar, __construct)
{
	...
	zend_call_method_with_2_params_ex(Z_OBJ_P(zobj), Z_OBJCE_P(zobj),
		&spl_ce_RecursiveDirectoryIterator->constructor, ZSTR_KNOWN(ZEND_STR_MAGIC_CONSTRUCT), NULL, &arg1, &arg2);
...
PHP_METHOD(Phar, buildFromDirectory)
{
	...
	zend_call_method_with_2_params_ex(Z_OBJ(iter), spl_ce_RecursiveDirectoryIterator,
			&spl_ce_RecursiveDirectoryIterator->constructor, ZSTR_KNOWN(ZEND_STR_MAGIC_CONSTRUCT), NULL, &arg, &arg2);
	...
	zend_call_method_with_1_params_ex(Z_OBJ(iteriter), spl_ce_RecursiveIteratorIterator,
			&spl_ce_RecursiveIteratorIterator->constructor, ZSTR_KNOWN(ZEND_STR_MAGIC_CONSTRUCT), NULL, &iter);
	...
	if (regex_len > 0) {
		...
		zend_call_method_with_2_params_ex(Z_OBJ(regexiter), spl_ce_RegexIterator,
			&spl_ce_RegexIterator->constructor, ZSTR_KNOWN(ZEND_STR_MAGIC_CONSTRUCT), NULL, &iteriter, &arg2);
		zval_ptr_dtor(&arg2);
	}
...
its_ok:
	...
	zend_call_method_with_1_params_ex(Z_OBJ(ret), ce, &ce->constructor, ZSTR_KNOWN(ZEND_STR_MAGIC_CONSTRUCT), NULL, &arg1);
	zval_ptr_dtor(&arg1);
	return Z_OBJ(ret);
}
/* }}} */
...
PHP_METHOD(PharFileInfo, __construct)
{
	...
	zend_call_method_with_1_params_ex(Z_OBJ_P(zobj), Z_OBJCE_P(zobj),
		&spl_ce_SplFileInfo->constructor, ZSTR_KNOWN(ZEND_STR_MAGIC_CONSTRUCT), NULL, &arg1);
