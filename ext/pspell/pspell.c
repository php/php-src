...
ZEND_BEGIN_ARG_INFO(arginfo_pspell_new_config, 0)
	ZEND_ARG_INFO(0, config)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_pspell_check, 0)
	ZEND_ARG_INFO(0, pspell)
	ZEND_ARG_INFO(0, word)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_pspell_suggest, 0)
	ZEND_ARG_INFO(0, pspell)
	ZEND_ARG_INFO(0, word)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_pspell_store_replacement, 0)
	ZEND_ARG_INFO(0, pspell)
	ZEND_ARG_INFO(0, misspell)
	ZEND_ARG_INFO(0, correct)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_pspell_add_to_personal, 0)
	ZEND_ARG_INFO(0, pspell)
	ZEND_ARG_INFO(0, word)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_pspell_add_to_session, 0)
	ZEND_ARG_INFO(0, pspell)
	ZEND_ARG_INFO(0, word)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_pspell_clear_session, 0)
	ZEND_ARG_INFO(0, pspell)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_pspell_save_wordlist, 0)
	ZEND_ARG_INFO(0, pspell)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(arginfo_pspell_config_runtogether, 0)
	ZEND_ARG_INFO(0, conf)
	ZEND_ARG_INFO(0, runtogether)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_pspell_config_mode, 0)
	ZEND_ARG_INFO(0, conf)
	ZEND_ARG_INFO(0, mode)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_pspell_config_ignore, 0)
	ZEND_ARG_INFO(0, conf)
	ZEND_ARG_INFO(0, ignore)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_pspell_config_personal, 0)
	ZEND_ARG_INFO(0, conf)
	ZEND_ARG_INFO(0, personal)
ZEND_END_ARG_INFO()
