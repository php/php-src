...
#define arginfo_imap_mailboxmsginfo arginfo_imap_num_msg
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_imap_alerts, 0, 0, IS_ARRAY, 0)
ZEND_END_ARG_INFO()

#define arginfo_imap_errors arginfo_imap_alerts

ZEND_BEGIN_ARG_INFO_EX(arginfo_imap_last_error, 0, 0, 0)
ZEND_END_ARG_INFO()
