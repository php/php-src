...
ZEND_BEGIN_ARG_INFO(arginfo_imap_set_quota, 0)
	ZEND_ARG_INFO(0, stream_id)
	ZEND_ARG_INFO(0, qroot)
	ZEND_ARG_INFO(0, mailbox_size)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_imap_setacl, 0)
	ZEND_ARG_INFO(0, stream_id)
	ZEND_ARG_INFO(0, mailbox)
	ZEND_ARG_INFO(0, id)
...
ZEND_BEGIN_ARG_INFO(arginfo_imap_list, 0)
	ZEND_ARG_INFO(0, stream_id)
	ZEND_ARG_INFO(0, ref)
	ZEND_ARG_INFO(0, pattern)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_imap_getmailboxes, 0)
	ZEND_ARG_INFO(0, stream_id)
	ZEND_ARG_INFO(0, ref)
	ZEND_ARG_INFO(0, pattern)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_imap_listscan, 0)
	ZEND_ARG_INFO(0, stream_id)
	ZEND_ARG_INFO(0, ref)
	ZEND_ARG_INFO(0, pattern)
...
ZEND_BEGIN_ARG_INFO(arginfo_imap_rfc822_write_address, 0)
	ZEND_ARG_INFO(0, mailbox)
...
ZEND_BEGIN_ARG_INFO(arginfo_imap_msgno, 0)
	ZEND_ARG_INFO(0, stream_id)
	ZEND_ARG_INFO(0, unique_msg_id)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_imap_status, 0)
	ZEND_ARG_INFO(0, stream_id)
	ZEND_ARG_INFO(0, mailbox)
	ZEND_ARG_INFO(0, options)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_imap_bodystruct, 0)
	ZEND_ARG_INFO(0, stream_id)
	ZEND_ARG_INFO(0, msg_no)
	ZEND_ARG_INFO(0, section)
ZEND_END_ARG_INFO()
