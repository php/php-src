...
require_once dirname(__DIR__) . "/test_setup/test_helpers.inc";
    ...
    $rc = mysqli_query(
        $link,
        "CREATE TABLE test_bind_fetch_varied(col1 tinyint, col2 smallint,
    ...
    $rc = mysqli_query($link, "INSERT INTO test_bind_fetch_varied(col1,col10, col11) VALUES(1,'foo1', 1000),(2,'foo2', 88),(3,'foo3', 389789)");
    if (!$rc)
