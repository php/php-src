...
require_once dirname(__DIR__) . "/test_setup/test_helpers.inc";
    ...
    $rc = mysqli_query($link, "CREATE TABLE test_bind_fetch_varied3(c1 tinyint, c2 smallint,
                                                        c3 int, c4 bigint,
                                                        c5 float, c6 double,
                                                        c7 varbinary(10),
    ...
    if (!mysqli_query($link, "INSERT INTO test_bind_fetch_varied3 VALUES(120,2999,3999,54,
                                                            2.6,58.89,
                                                            '206','6.7')"))
        printf("[003] [%d] %s\n", mysqli_errno($link), mysqli_error($link));
