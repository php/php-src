...
[006] [2000] LOAD DATA LOCAL INFILE is forbidden, check related settings like mysqli.allow_local_infile|local_infile_directory or PDO::MYSQL_ATTR_LOCAL_INFILE|MYSQL_ATTR_LOCAL_INFILE_DIRECTORY
done