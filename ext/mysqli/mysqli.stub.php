...
class mysqli_result implements IteratorAggregate
{
     ...
     */
    public function fetch_object(string $class = "stdClass", ?array $params = null) {}
...
function mysqli_fetch_object(mysqli_result $result, string $class = "stdClass", ?array $params = null): ?object {}
