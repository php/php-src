...
static zend_class_entry *register_class_mysqli_driver(void)
{
	...
	zend_string_release_ex(property_client_info_name, 1);
	...
	zend_string_release_ex(property_client_version_name, 1);
	...
	zend_string_release_ex(property_driver_version_name, 1);
	...
	zend_string_release_ex(property_report_mode_name, 1);
...
static zend_class_entry *register_class_mysqli(void)
{
	...
	zend_string_release_ex(property_affected_rows_name, 1);
	...
	zend_string_release_ex(property_connect_errno_name, 1);
	...
	zend_string_release_ex(property_connect_error_name, 1);
	...
	zend_string_release_ex(property_errno_name, 1);
	...
	zend_string_release_ex(property_error_name, 1);
	...
	zend_string_release_ex(property_error_list_name, 1);
	...
	zend_string_release_ex(property_field_count_name, 1);
	...
	zend_string_release_ex(property_host_info_name, 1);
	...
	zend_string_release_ex(property_info_name, 1);
	...
	zend_string_release_ex(property_insert_id_name, 1);
	...
	zend_string_release_ex(property_server_info_name, 1);
	...
	zend_string_release_ex(property_server_version_name, 1);
	...
	zend_string_release_ex(property_sqlstate_name, 1);
	...
	zend_string_release_ex(property_protocol_version_name, 1);
	...
	zend_string_release_ex(property_thread_id_name, 1);
	...
	zend_string_release_ex(property_warning_count_name, 1);
...
static zend_class_entry *register_class_mysqli_result(zend_class_entry *class_entry_IteratorAggregate)
{
	...
	zend_string_release_ex(property_current_field_name, 1);
	...
	zend_string_release_ex(property_lengths_name, 1);
	...
	zend_string_release_ex(property_num_rows_name, 1);
...
static zend_class_entry *register_class_mysqli_stmt(void)
{
	...
	zend_string_release_ex(property_param_count_name, 1);
