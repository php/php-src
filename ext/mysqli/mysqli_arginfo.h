...
static zend_class_entry *register_class_mysqli_driver(void)
{
	...
	zend_string *property_client_info_name = zend_string_init_interned("client_info", sizeof("client_info") - 1, 1);
	...
	zend_string *property_client_version_name = zend_string_init_interned("client_version", sizeof("client_version") - 1, 1);
	...
	zend_string *property_driver_version_name = zend_string_init_interned("driver_version", sizeof("driver_version") - 1, 1);
	...
	zend_string *property_report_mode_name = zend_string_init_interned("report_mode", sizeof("report_mode") - 1, 1);
...
static zend_class_entry *register_class_mysqli(void)
{
	...
	zend_string *property_affected_rows_name = zend_string_init_interned("affected_rows", sizeof("affected_rows") - 1, 1);
	...
	zend_string *property_connect_errno_name = zend_string_init_interned("connect_errno", sizeof("connect_errno") - 1, 1);
	...
	zend_string *property_connect_error_name = zend_string_init_interned("connect_error", sizeof("connect_error") - 1, 1);
	...
	zend_string *property_errno_name = zend_string_init_interned("errno", sizeof("errno") - 1, 1);
	...
	zend_string *property_error_name = zend_string_init_interned("error", sizeof("error") - 1, 1);
	...
	zend_string *property_error_list_name = zend_string_init_interned("error_list", sizeof("error_list") - 1, 1);
	...
	zend_string *property_field_count_name = zend_string_init_interned("field_count", sizeof("field_count") - 1, 1);
	...
	zend_string *property_host_info_name = zend_string_init_interned("host_info", sizeof("host_info") - 1, 1);
	...
	zend_string *property_info_name = zend_string_init_interned("info", sizeof("info") - 1, 1);
	...
	zend_string *property_insert_id_name = zend_string_init_interned("insert_id", sizeof("insert_id") - 1, 1);
	...
	zend_string *property_server_info_name = zend_string_init_interned("server_info", sizeof("server_info") - 1, 1);
	...
	zend_string *property_server_version_name = zend_string_init_interned("server_version", sizeof("server_version") - 1, 1);
	...
	zend_string *property_sqlstate_name = zend_string_init_interned("sqlstate", sizeof("sqlstate") - 1, 1);
	...
	zend_string *property_protocol_version_name = zend_string_init_interned("protocol_version", sizeof("protocol_version") - 1, 1);
	...
	zend_string *property_thread_id_name = zend_string_init_interned("thread_id", sizeof("thread_id") - 1, 1);
	...
	zend_string *property_warning_count_name = zend_string_init_interned("warning_count", sizeof("warning_count") - 1, 1);
...
static zend_class_entry *register_class_mysqli_result(zend_class_entry *class_entry_IteratorAggregate)
{
	...
	zend_string *property_current_field_name = zend_string_init_interned("current_field", sizeof("current_field") - 1, 1);
	...
	zend_string *property_lengths_name = zend_string_init_interned("lengths", sizeof("lengths") - 1, 1);
	...
	zend_string *property_num_rows_name = zend_string_init_interned("num_rows", sizeof("num_rows") - 1, 1);
...
static zend_class_entry *register_class_mysqli_stmt(void)
{
	...
	zend_string *property_param_count_name = zend_string_init_interned("param_count", sizeof("param_count") - 1, 1);
