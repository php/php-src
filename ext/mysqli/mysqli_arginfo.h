...
static const zend_function_entry ext_functions[] = {
	ZEND_RAW_FENTRY("mysqli_affected_rows", zif_mysqli_affected_rows, arginfo_mysqli_affected_rows, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_autocommit", zif_mysqli_autocommit, arginfo_mysqli_autocommit, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_begin_transaction", zif_mysqli_begin_transaction, arginfo_mysqli_begin_transaction, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_change_user", zif_mysqli_change_user, arginfo_mysqli_change_user, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_character_set_name", zif_mysqli_character_set_name, arginfo_mysqli_character_set_name, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_close", zif_mysqli_close, arginfo_mysqli_close, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_commit", zif_mysqli_commit, arginfo_mysqli_commit, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_connect", zif_mysqli_connect, arginfo_mysqli_connect, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_connect_errno", zif_mysqli_connect_errno, arginfo_mysqli_connect_errno, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_connect_error", zif_mysqli_connect_error, arginfo_mysqli_connect_error, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_data_seek", zif_mysqli_data_seek, arginfo_mysqli_data_seek, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_dump_debug_info", zif_mysqli_dump_debug_info, arginfo_mysqli_dump_debug_info, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_debug", zif_mysqli_debug, arginfo_mysqli_debug, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_errno", zif_mysqli_errno, arginfo_mysqli_errno, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_error", zif_mysqli_error, arginfo_mysqli_error, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_error_list", zif_mysqli_error_list, arginfo_mysqli_error_list, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_execute", zif_mysqli_stmt_execute, arginfo_mysqli_stmt_execute, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_execute", zif_mysqli_stmt_execute, arginfo_mysqli_execute, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_execute_query", zif_mysqli_execute_query, arginfo_mysqli_execute_query, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_fetch_field", zif_mysqli_fetch_field, arginfo_mysqli_fetch_field, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_fetch_fields", zif_mysqli_fetch_fields, arginfo_mysqli_fetch_fields, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_fetch_field_direct", zif_mysqli_fetch_field_direct, arginfo_mysqli_fetch_field_direct, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_fetch_lengths", zif_mysqli_fetch_lengths, arginfo_mysqli_fetch_lengths, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_fetch_all", zif_mysqli_fetch_all, arginfo_mysqli_fetch_all, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_fetch_array", zif_mysqli_fetch_array, arginfo_mysqli_fetch_array, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_fetch_assoc", zif_mysqli_fetch_assoc, arginfo_mysqli_fetch_assoc, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_fetch_object", zif_mysqli_fetch_object, arginfo_mysqli_fetch_object, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_fetch_row", zif_mysqli_fetch_row, arginfo_mysqli_fetch_row, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_fetch_column", zif_mysqli_fetch_column, arginfo_mysqli_fetch_column, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_field_count", zif_mysqli_field_count, arginfo_mysqli_field_count, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_field_seek", zif_mysqli_field_seek, arginfo_mysqli_field_seek, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_field_tell", zif_mysqli_field_tell, arginfo_mysqli_field_tell, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_free_result", zif_mysqli_free_result, arginfo_mysqli_free_result, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_get_connection_stats", zif_mysqli_get_connection_stats, arginfo_mysqli_get_connection_stats, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_get_client_stats", zif_mysqli_get_client_stats, arginfo_mysqli_get_client_stats, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_get_charset", zif_mysqli_get_charset, arginfo_mysqli_get_charset, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_get_client_info", zif_mysqli_get_client_info, arginfo_mysqli_get_client_info, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_get_client_version", zif_mysqli_get_client_version, arginfo_mysqli_get_client_version, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_get_links_stats", zif_mysqli_get_links_stats, arginfo_mysqli_get_links_stats, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_get_host_info", zif_mysqli_get_host_info, arginfo_mysqli_get_host_info, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_get_proto_info", zif_mysqli_get_proto_info, arginfo_mysqli_get_proto_info, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_get_server_info", zif_mysqli_get_server_info, arginfo_mysqli_get_server_info, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_get_server_version", zif_mysqli_get_server_version, arginfo_mysqli_get_server_version, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_get_warnings", zif_mysqli_get_warnings, arginfo_mysqli_get_warnings, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_init", zif_mysqli_init, arginfo_mysqli_init, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_info", zif_mysqli_info, arginfo_mysqli_info, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_insert_id", zif_mysqli_insert_id, arginfo_mysqli_insert_id, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_kill", zif_mysqli_kill, arginfo_mysqli_kill, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_more_results", zif_mysqli_more_results, arginfo_mysqli_more_results, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_multi_query", zif_mysqli_multi_query, arginfo_mysqli_multi_query, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_next_result", zif_mysqli_next_result, arginfo_mysqli_next_result, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_num_fields", zif_mysqli_num_fields, arginfo_mysqli_num_fields, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_num_rows", zif_mysqli_num_rows, arginfo_mysqli_num_rows, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_options", zif_mysqli_options, arginfo_mysqli_options, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_set_opt", zif_mysqli_options, arginfo_mysqli_set_opt, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_ping", zif_mysqli_ping, arginfo_mysqli_ping, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_poll", zif_mysqli_poll, arginfo_mysqli_poll, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_prepare", zif_mysqli_prepare, arginfo_mysqli_prepare, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_report", zif_mysqli_report, arginfo_mysqli_report, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_query", zif_mysqli_query, arginfo_mysqli_query, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_real_connect", zif_mysqli_real_connect, arginfo_mysqli_real_connect, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_real_escape_string", zif_mysqli_real_escape_string, arginfo_mysqli_real_escape_string, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_escape_string", zif_mysqli_real_escape_string, arginfo_mysqli_escape_string, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_real_query", zif_mysqli_real_query, arginfo_mysqli_real_query, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_reap_async_query", zif_mysqli_reap_async_query, arginfo_mysqli_reap_async_query, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_release_savepoint", zif_mysqli_release_savepoint, arginfo_mysqli_release_savepoint, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_rollback", zif_mysqli_rollback, arginfo_mysqli_rollback, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_savepoint", zif_mysqli_savepoint, arginfo_mysqli_savepoint, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_select_db", zif_mysqli_select_db, arginfo_mysqli_select_db, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_set_charset", zif_mysqli_set_charset, arginfo_mysqli_set_charset, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_affected_rows", zif_mysqli_stmt_affected_rows, arginfo_mysqli_stmt_affected_rows, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_attr_get", zif_mysqli_stmt_attr_get, arginfo_mysqli_stmt_attr_get, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_attr_set", zif_mysqli_stmt_attr_set, arginfo_mysqli_stmt_attr_set, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_bind_param", zif_mysqli_stmt_bind_param, arginfo_mysqli_stmt_bind_param, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_bind_result", zif_mysqli_stmt_bind_result, arginfo_mysqli_stmt_bind_result, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_close", zif_mysqli_stmt_close, arginfo_mysqli_stmt_close, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_data_seek", zif_mysqli_stmt_data_seek, arginfo_mysqli_stmt_data_seek, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_errno", zif_mysqli_stmt_errno, arginfo_mysqli_stmt_errno, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_error", zif_mysqli_stmt_error, arginfo_mysqli_stmt_error, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_error_list", zif_mysqli_stmt_error_list, arginfo_mysqli_stmt_error_list, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_fetch", zif_mysqli_stmt_fetch, arginfo_mysqli_stmt_fetch, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_field_count", zif_mysqli_stmt_field_count, arginfo_mysqli_stmt_field_count, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_free_result", zif_mysqli_stmt_free_result, arginfo_mysqli_stmt_free_result, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_get_result", zif_mysqli_stmt_get_result, arginfo_mysqli_stmt_get_result, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_get_warnings", zif_mysqli_stmt_get_warnings, arginfo_mysqli_stmt_get_warnings, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_init", zif_mysqli_stmt_init, arginfo_mysqli_stmt_init, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_insert_id", zif_mysqli_stmt_insert_id, arginfo_mysqli_stmt_insert_id, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_more_results", zif_mysqli_stmt_more_results, arginfo_mysqli_stmt_more_results, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_next_result", zif_mysqli_stmt_next_result, arginfo_mysqli_stmt_next_result, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_num_rows", zif_mysqli_stmt_num_rows, arginfo_mysqli_stmt_num_rows, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_param_count", zif_mysqli_stmt_param_count, arginfo_mysqli_stmt_param_count, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_prepare", zif_mysqli_stmt_prepare, arginfo_mysqli_stmt_prepare, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_reset", zif_mysqli_stmt_reset, arginfo_mysqli_stmt_reset, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_result_metadata", zif_mysqli_stmt_result_metadata, arginfo_mysqli_stmt_result_metadata, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_send_long_data", zif_mysqli_stmt_send_long_data, arginfo_mysqli_stmt_send_long_data, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_store_result", zif_mysqli_stmt_store_result, arginfo_mysqli_stmt_store_result, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stmt_sqlstate", zif_mysqli_stmt_sqlstate, arginfo_mysqli_stmt_sqlstate, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_sqlstate", zif_mysqli_sqlstate, arginfo_mysqli_sqlstate, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_ssl_set", zif_mysqli_ssl_set, arginfo_mysqli_ssl_set, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_stat", zif_mysqli_stat, arginfo_mysqli_stat, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_store_result", zif_mysqli_store_result, arginfo_mysqli_store_result, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_thread_id", zif_mysqli_thread_id, arginfo_mysqli_thread_id, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_thread_safe", zif_mysqli_thread_safe, arginfo_mysqli_thread_safe, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_use_result", zif_mysqli_use_result, arginfo_mysqli_use_result, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_warning_count", zif_mysqli_warning_count, arginfo_mysqli_warning_count, 0, NULL)
	ZEND_RAW_FENTRY("mysqli_refresh", zif_mysqli_refresh, arginfo_mysqli_refresh, 0, NULL)
	ZEND_FE_END
};
...
static const zend_function_entry class_mysqli_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_mysqli___construct, arginfo_class_mysqli___construct, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("autocommit", zif_mysqli_autocommit, arginfo_class_mysqli_autocommit, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("begin_transaction", zif_mysqli_begin_transaction, arginfo_class_mysqli_begin_transaction, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("change_user", zif_mysqli_change_user, arginfo_class_mysqli_change_user, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("character_set_name", zif_mysqli_character_set_name, arginfo_class_mysqli_character_set_name, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("close", zif_mysqli_close, arginfo_class_mysqli_close, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("commit", zif_mysqli_commit, arginfo_class_mysqli_commit, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("connect", zif_mysqli_connect, arginfo_class_mysqli_connect, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("dump_debug_info", zif_mysqli_dump_debug_info, arginfo_class_mysqli_dump_debug_info, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("debug", zif_mysqli_debug, arginfo_class_mysqli_debug, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("get_charset", zif_mysqli_get_charset, arginfo_class_mysqli_get_charset, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("execute_query", zif_mysqli_execute_query, arginfo_class_mysqli_execute_query, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("get_client_info", zif_mysqli_get_client_info, arginfo_class_mysqli_get_client_info, ZEND_ACC_PUBLIC|ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("get_connection_stats", zif_mysqli_get_connection_stats, arginfo_class_mysqli_get_connection_stats, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("get_server_info", zif_mysqli_get_server_info, arginfo_class_mysqli_get_server_info, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("get_warnings", zif_mysqli_get_warnings, arginfo_class_mysqli_get_warnings, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("init", zim_mysqli_init, arginfo_class_mysqli_init, ZEND_ACC_PUBLIC|ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("kill", zif_mysqli_kill, arginfo_class_mysqli_kill, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("multi_query", zif_mysqli_multi_query, arginfo_class_mysqli_multi_query, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("more_results", zif_mysqli_more_results, arginfo_class_mysqli_more_results, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("next_result", zif_mysqli_next_result, arginfo_class_mysqli_next_result, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("ping", zif_mysqli_ping, arginfo_class_mysqli_ping, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("poll", zif_mysqli_poll, arginfo_class_mysqli_poll, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("prepare", zif_mysqli_prepare, arginfo_class_mysqli_prepare, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("query", zif_mysqli_query, arginfo_class_mysqli_query, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("real_connect", zif_mysqli_real_connect, arginfo_class_mysqli_real_connect, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("real_escape_string", zif_mysqli_real_escape_string, arginfo_class_mysqli_real_escape_string, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("reap_async_query", zif_mysqli_reap_async_query, arginfo_class_mysqli_reap_async_query, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("escape_string", zif_mysqli_real_escape_string, arginfo_class_mysqli_escape_string, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("real_query", zif_mysqli_real_query, arginfo_class_mysqli_real_query, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("release_savepoint", zif_mysqli_release_savepoint, arginfo_class_mysqli_release_savepoint, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("rollback", zif_mysqli_rollback, arginfo_class_mysqli_rollback, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("savepoint", zif_mysqli_savepoint, arginfo_class_mysqli_savepoint, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("select_db", zif_mysqli_select_db, arginfo_class_mysqli_select_db, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("set_charset", zif_mysqli_set_charset, arginfo_class_mysqli_set_charset, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("options", zif_mysqli_options, arginfo_class_mysqli_options, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("set_opt", zif_mysqli_options, arginfo_class_mysqli_set_opt, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("ssl_set", zif_mysqli_ssl_set, arginfo_class_mysqli_ssl_set, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("stat", zif_mysqli_stat, arginfo_class_mysqli_stat, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("stmt_init", zif_mysqli_stmt_init, arginfo_class_mysqli_stmt_init, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("store_result", zif_mysqli_store_result, arginfo_class_mysqli_store_result, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("thread_safe", zif_mysqli_thread_safe, arginfo_class_mysqli_thread_safe, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("use_result", zif_mysqli_use_result, arginfo_class_mysqli_use_result, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("refresh", zif_mysqli_refresh, arginfo_class_mysqli_refresh, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};

static const zend_function_entry class_mysqli_result_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_mysqli_result___construct, arginfo_class_mysqli_result___construct, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("close", zif_mysqli_free_result, arginfo_class_mysqli_result_close, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("free", zif_mysqli_free_result, arginfo_class_mysqli_result_free, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("data_seek", zif_mysqli_data_seek, arginfo_class_mysqli_result_data_seek, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fetch_field", zif_mysqli_fetch_field, arginfo_class_mysqli_result_fetch_field, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fetch_fields", zif_mysqli_fetch_fields, arginfo_class_mysqli_result_fetch_fields, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fetch_field_direct", zif_mysqli_fetch_field_direct, arginfo_class_mysqli_result_fetch_field_direct, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fetch_all", zif_mysqli_fetch_all, arginfo_class_mysqli_result_fetch_all, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fetch_array", zif_mysqli_fetch_array, arginfo_class_mysqli_result_fetch_array, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fetch_assoc", zif_mysqli_fetch_assoc, arginfo_class_mysqli_result_fetch_assoc, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fetch_object", zif_mysqli_fetch_object, arginfo_class_mysqli_result_fetch_object, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fetch_row", zif_mysqli_fetch_row, arginfo_class_mysqli_result_fetch_row, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fetch_column", zif_mysqli_fetch_column, arginfo_class_mysqli_result_fetch_column, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("field_seek", zif_mysqli_field_seek, arginfo_class_mysqli_result_field_seek, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("free_result", zif_mysqli_free_result, arginfo_class_mysqli_result_free_result, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getIterator", zim_mysqli_result_getIterator, arginfo_class_mysqli_result_getIterator, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};

static const zend_function_entry class_mysqli_stmt_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_mysqli_stmt___construct, arginfo_class_mysqli_stmt___construct, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("attr_get", zif_mysqli_stmt_attr_get, arginfo_class_mysqli_stmt_attr_get, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("attr_set", zif_mysqli_stmt_attr_set, arginfo_class_mysqli_stmt_attr_set, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("bind_param", zif_mysqli_stmt_bind_param, arginfo_class_mysqli_stmt_bind_param, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("bind_result", zif_mysqli_stmt_bind_result, arginfo_class_mysqli_stmt_bind_result, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("close", zif_mysqli_stmt_close, arginfo_class_mysqli_stmt_close, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("data_seek", zif_mysqli_stmt_data_seek, arginfo_class_mysqli_stmt_data_seek, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("execute", zif_mysqli_stmt_execute, arginfo_class_mysqli_stmt_execute, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fetch", zif_mysqli_stmt_fetch, arginfo_class_mysqli_stmt_fetch, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("get_warnings", zif_mysqli_stmt_get_warnings, arginfo_class_mysqli_stmt_get_warnings, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("result_metadata", zif_mysqli_stmt_result_metadata, arginfo_class_mysqli_stmt_result_metadata, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("more_results", zif_mysqli_stmt_more_results, arginfo_class_mysqli_stmt_more_results, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("next_result", zif_mysqli_stmt_next_result, arginfo_class_mysqli_stmt_next_result, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("num_rows", zif_mysqli_stmt_num_rows, arginfo_class_mysqli_stmt_num_rows, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("send_long_data", zif_mysqli_stmt_send_long_data, arginfo_class_mysqli_stmt_send_long_data, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("free_result", zif_mysqli_stmt_free_result, arginfo_class_mysqli_stmt_free_result, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("reset", zif_mysqli_stmt_reset, arginfo_class_mysqli_stmt_reset, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("prepare", zif_mysqli_stmt_prepare, arginfo_class_mysqli_stmt_prepare, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("store_result", zif_mysqli_stmt_store_result, arginfo_class_mysqli_stmt_store_result, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("get_result", zif_mysqli_stmt_get_result, arginfo_class_mysqli_stmt_get_result, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};

static const zend_function_entry class_mysqli_warning_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_mysqli_warning___construct, arginfo_class_mysqli_warning___construct, ZEND_ACC_PRIVATE, NULL)
	ZEND_RAW_FENTRY("next", zim_mysqli_warning_next, arginfo_class_mysqli_warning_next, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};

static const zend_function_entry class_mysqli_sql_exception_methods[] = {
	ZEND_RAW_FENTRY("getSqlState", zim_mysqli_sql_exception_getSqlState, arginfo_class_mysqli_sql_exception_getSqlState, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};
