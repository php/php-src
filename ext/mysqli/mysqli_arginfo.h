 ...
 * Stub hash: fe89fa11aa3889bdffbb1d0d3a10d8067bcca0da */
...
zend_class_entry *register_class_mysqli_driver()
{
...
zend_class_entry *register_class_mysqli()
{
	zend_class_entry ce, *class_entry;
...
zend_class_entry *register_class_mysqli_result(zend_class_entry *class_entry_IteratorAggregate)
{
	zend_class_entry ce, *class_entry;
...
zend_class_entry *register_class_mysqli_warning()
{
	zend_class_entry ce, *class_entry;
...
zend_class_entry *register_class_mysqli_sql_exception(zend_class_entry *class_entry_RuntimeException)
{
	zend_class_entry ce, *class_entry;
