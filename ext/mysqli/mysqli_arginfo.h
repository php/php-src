 ...
 * Stub hash: c558800738d5e8d2555bb6dcb54645a381e067e4 */

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_mysqli_affected_rows, 0, 1, MAY_BE_LONG|MAY_BE_STRING)
	ZEND_ARG_OBJ_INFO(0, connection, mysqli, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_mysqli_get_client_info, 0, 0, IS_STRING, 1)
	ZEND_ARG_OBJ_INFO_WITH_DEFAULT_VALUE(0, connection, mysqli, 1, "null")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_mysqli_kill, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_OBJ_INFO(0, connection, mysqli, 0)
	ZEND_ARG_TYPE_INFO(0, process, IS_LONG, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(arginfo_mysqli_query, 0, 2, mysqli_result, MAY_BE_BOOL)
	ZEND_ARG_OBJ_INFO(0, connection, mysqli, 0)
	ZEND_ARG_TYPE_INFO(0, query, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, mode, IS_LONG, 0, "MYSQLI_STORE_RESULT")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_mysqli_stmt_bind_param, 0, 2, _IS_BOOL, 0)
	...
	ZEND_ARG_VARIADIC_TYPE_INFO(1, variables, IS_MIXED, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_mysqli_ssl_set, 0, 6, _IS_BOOL, 0)
	...
	ZEND_ARG_TYPE_INFO(0, authority_path, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, trusted_authority_path, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, allowed_ciphers, IS_STRING, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_class_mysqli_ssl_set, 0, 0, 5)
	...
	ZEND_ARG_TYPE_INFO(0, certificatePath, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, authorityPath, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, trustedAuthorityPath, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, allowedCiphers, IS_STRING, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_class_mysqli_result_fetch_all, 0, 0, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, resultType, IS_LONG, 0, "MYSQLI_NUM")
ZEND_END_ARG_INFO()
#endif

ZEND_BEGIN_ARG_INFO_EX(arginfo_class_mysqli_result_fetch_array, 0, 0, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, resultType, IS_LONG, 0, "MYSQLI_BOTH")
ZEND_END_ARG_INFO()
