...
PHP_MINIT_FUNCTION(mysqli)
{
	...
	REGISTER_LONG_CONSTANT("MYSQLI_REFRESH_REPLICA",    REFRESH_REPLICA, CONST_CS | CONST_PERSISTENT);
	/* temporarily for backward compatibility */
	REGISTER_LONG_CONSTANT("MYSQLI_REFRESH_SLAVE",      REFRESH_REPLICA, CONST_CS | CONST_PERSISTENT | CONST_DEPRECATED);
