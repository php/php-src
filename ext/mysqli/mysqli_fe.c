...
ZEND_BEGIN_ARG_INFO(arginfo_mysqli_change_user, 0)
	MYSQLI_ZEND_ARG_OBJ_INFO_LINK()
...
ZEND_BEGIN_ARG_INFO(arginfo_class_mysqli_change_user, 0)
	ZEND_ARG_INFO(0, user)
	ZEND_ARG_INFO(0, password)
	ZEND_ARG_INFO(0, database)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(arginfo_mysqli_options, 0)
	MYSQLI_ZEND_ARG_OBJ_INFO_LINK()
...
ZEND_BEGIN_ARG_INFO(arginfo_mysqli_stmt_attr_set, 0)
	MYSQLI_ZEND_ARG_OBJ_INFO_STMT()
	ZEND_ARG_INFO(0, attribute)
	ZEND_ARG_INFO(0, value)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(arginfo_mysqli_stmt_send_long_data, 0)
	MYSQLI_ZEND_ARG_OBJ_INFO_STMT()
...
ZEND_BEGIN_ARG_INFO(arginfo_mysqli_ssl_set, 0)
	MYSQLI_ZEND_ARG_OBJ_INFO_LINK()
	ZEND_ARG_INFO(0, key)
...
ZEND_BEGIN_ARG_INFO(arginfo_class_mysqli_ssl_set, 0)
	ZEND_ARG_INFO(0, key)
	ZEND_ARG_INFO(0, cert)
	ZEND_ARG_INFO(0, certificate_authority)
	ZEND_ARG_INFO(0, certificate_authority_path)
