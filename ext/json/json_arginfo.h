 ...
 * Stub hash: 0ea2d3c11567e7e344d425092563204f6ee2a93c */
...
static void register_json_symbols(int module_number)
{
	...
	REGISTER_LONG_CONSTANT("JSON_DUPLICATE_KEY_MERGE", PHP_JSON_DUPLICATE_KEY_MERGE, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("JSON_DUPLICATE_KEY_ARRAY", PHP_JSON_DUPLICATE_KEY_ARRAY, CONST_PERSISTENT);
