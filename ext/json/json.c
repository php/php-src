...
static PHP_MINIT_FUNCTION(json)
{
	...
	PHP_JSON_REGISTER_CONSTANT("JSON_ERROR_COLLISIONS", PHP_JSON_ERROR_COLLISIONS);
...
static PHP_FUNCTION(json_last_error_msg)
{
	...
	switch(JSON_G(error_code)) {
		...
		case PHP_JSON_ERROR_COLLISIONS:
			RETURN_STRING("Too many collisions for a same hash offset");
		default:
