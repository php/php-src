...
extern JSON_parser new_JSON_parser(php_int_t depth);
extern int parse_JSON_ex(JSON_parser jp, zval *z, unsigned short utf16_json[], zend_str_size_int length, php_int_t options TSRMLS_DC);
