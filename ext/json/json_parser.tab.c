...
yyreduce:
  ...
  switch (yyn)
    ...
    { ZVAL_COPY_VALUE(&(yyval.value), &(yyvsp[(1) - (2)].value)); ZVAL_COPY_VALUE(parser->return_value, &(yyvsp[(1) - (2)].value)); PHP_JSON_USE((yyvsp[(2) - (2)].value)); YYACCEPT; }
    break;
  ...
  case 11:
    ...
    { php_json_parser_object_update(parser, &(yyvsp[(1) - (3)].value), (yyvsp[(3) - (3)].pair).key, &(yyvsp[(3) - (3)].pair).val); ZVAL_COPY_VALUE(&(yyval.value), &(yyvsp[(1) - (3)].value)); }
    break;
  ...
  case 13:
    ...
    { (yyval.pair).key = Z_STR((yyvsp[(1) - (3)].value)); ZVAL_COPY_VALUE(&(yyval.pair).val, &(yyvsp[(3) - (3)].value)); }
    break;
  ...
  case 16:
    ...
    { PHP_JSON_DEPTH_DEC; ZVAL_COPY_VALUE(&(yyval.value), &(yyvsp[(3) - (4)].value)); }
    break;
  ...
  case 22:
    ...
    { php_json_parser_array_append(&(yyvsp[(1) - (3)].value), &(yyvsp[(3) - (3)].value)); ZVAL_COPY_VALUE(&(yyval.value), &(yyvsp[(1) - (3)].value)); }
    break;
