...
json_validate_trycatchdump("\"a\xb0b\"", 512, JSON_THROW_ON_ERROR);
json_validate_trycatchdump("\"a\xd0\xf2b\"", 512, JSON_THROW_ON_ERROR);
json_validate_trycatchdump("\"\x61\xf0\x80\x80\x41\"", 512, JSON_THROW_ON_ERROR);
json_validate_trycatchdump("[\"\xc1\xc1\",\"a\"]", 512, JSON_THROW_ON_ERROR);
...
json_validate_trycatchdump("\"a\xb0b\"", 512, JSON_THROW_ON_ERROR | JSON_INVALID_UTF8_IGNORE);
json_validate_trycatchdump("\"a\xd0\xf2b\"", 512, JSON_THROW_ON_ERROR | JSON_INVALID_UTF8_IGNORE);
json_validate_trycatchdump("\"\x61\xf0\x80\x80\x41\"", 512, JSON_THROW_ON_ERROR | JSON_INVALID_UTF8_IGNORE);
json_validate_trycatchdump("[\"\xc1\xc1\",\"a\"]", 512, JSON_THROW_ON_ERROR | JSON_INVALID_UTF8_IGNORE);
