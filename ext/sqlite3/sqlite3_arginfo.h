...
static const zend_function_entry class_SQLite3_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_SQLite3_open, arginfo_class_SQLite3___construct, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("open", zim_SQLite3_open, arginfo_class_SQLite3_open, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("close", zim_SQLite3_close, arginfo_class_SQLite3_close, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("version", zim_SQLite3_version, arginfo_class_SQLite3_version, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("lastInsertRowID", zim_SQLite3_lastInsertRowID, arginfo_class_SQLite3_lastInsertRowID, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("lastErrorCode", zim_SQLite3_lastErrorCode, arginfo_class_SQLite3_lastErrorCode, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("lastExtendedErrorCode", zim_SQLite3_lastExtendedErrorCode, arginfo_class_SQLite3_lastExtendedErrorCode, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("lastErrorMsg", zim_SQLite3_lastErrorMsg, arginfo_class_SQLite3_lastErrorMsg, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("changes", zim_SQLite3_changes, arginfo_class_SQLite3_changes, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("busyTimeout", zim_SQLite3_busyTimeout, arginfo_class_SQLite3_busyTimeout, ZEND_ACC_PUBLIC, NULL)
#if !defined(SQLITE_OMIT_LOAD_EXTENSION)
	ZEND_RAW_FENTRY("loadExtension", zim_SQLite3_loadExtension, arginfo_class_SQLite3_loadExtension, ZEND_ACC_PUBLIC, NULL)
#endif
#if SQLITE_VERSION_NUMBER >= 3006011
	ZEND_RAW_FENTRY("backup", zim_SQLite3_backup, arginfo_class_SQLite3_backup, ZEND_ACC_PUBLIC, NULL)
#endif
	ZEND_RAW_FENTRY("escapeString", zim_SQLite3_escapeString, arginfo_class_SQLite3_escapeString, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("prepare", zim_SQLite3_prepare, arginfo_class_SQLite3_prepare, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("exec", zim_SQLite3_exec, arginfo_class_SQLite3_exec, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("query", zim_SQLite3_query, arginfo_class_SQLite3_query, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("querySingle", zim_SQLite3_querySingle, arginfo_class_SQLite3_querySingle, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("createFunction", zim_SQLite3_createFunction, arginfo_class_SQLite3_createFunction, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("createAggregate", zim_SQLite3_createAggregate, arginfo_class_SQLite3_createAggregate, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("createCollation", zim_SQLite3_createCollation, arginfo_class_SQLite3_createCollation, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("openBlob", zim_SQLite3_openBlob, arginfo_class_SQLite3_openBlob, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("enableExceptions", zim_SQLite3_enableExceptions, arginfo_class_SQLite3_enableExceptions, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("enableExtendedResultCodes", zim_SQLite3_enableExtendedResultCodes, arginfo_class_SQLite3_enableExtendedResultCodes, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setAuthorizer", zim_SQLite3_setAuthorizer, arginfo_class_SQLite3_setAuthorizer, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};

static const zend_function_entry class_SQLite3Stmt_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_SQLite3Stmt___construct, arginfo_class_SQLite3Stmt___construct, ZEND_ACC_PRIVATE, NULL)
	ZEND_RAW_FENTRY("bindParam", zim_SQLite3Stmt_bindParam, arginfo_class_SQLite3Stmt_bindParam, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("bindValue", zim_SQLite3Stmt_bindValue, arginfo_class_SQLite3Stmt_bindValue, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("clear", zim_SQLite3Stmt_clear, arginfo_class_SQLite3Stmt_clear, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("close", zim_SQLite3Stmt_close, arginfo_class_SQLite3Stmt_close, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("execute", zim_SQLite3Stmt_execute, arginfo_class_SQLite3Stmt_execute, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getSQL", zim_SQLite3Stmt_getSQL, arginfo_class_SQLite3Stmt_getSQL, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("paramCount", zim_SQLite3Stmt_paramCount, arginfo_class_SQLite3Stmt_paramCount, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("readOnly", zim_SQLite3Stmt_readOnly, arginfo_class_SQLite3Stmt_readOnly, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("reset", zim_SQLite3Stmt_reset, arginfo_class_SQLite3Stmt_reset, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};

static const zend_function_entry class_SQLite3Result_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_SQLite3Result___construct, arginfo_class_SQLite3Result___construct, ZEND_ACC_PRIVATE, NULL)
	ZEND_RAW_FENTRY("numColumns", zim_SQLite3Result_numColumns, arginfo_class_SQLite3Result_numColumns, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("columnName", zim_SQLite3Result_columnName, arginfo_class_SQLite3Result_columnName, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("columnType", zim_SQLite3Result_columnType, arginfo_class_SQLite3Result_columnType, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fetchArray", zim_SQLite3Result_fetchArray, arginfo_class_SQLite3Result_fetchArray, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("reset", zim_SQLite3Result_reset, arginfo_class_SQLite3Result_reset, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("finalize", zim_SQLite3Result_finalize, arginfo_class_SQLite3Result_finalize, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};
