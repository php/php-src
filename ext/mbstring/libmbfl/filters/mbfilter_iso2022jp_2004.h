...
void mbfl_filt_conv_2022jp_2004_wchar(int c, mbfl_convert_filter *filter);
void mbfl_filt_conv_wchar_2022jp_2004(int c, mbfl_convert_filter *filter);
void mbfl_filt_conv_any_2022jp_2004_flush(mbfl_convert_filter *filter);
