...
/* Although a non-terminated Base64 section is illegal for UTF7-IMAP,
 * the 'illegal characters' count is not incremented... because the problem
 * is not the presence of an 'illegal character', but rather the absence of a
 * terminator. So we use 'convertValidString' to test this conversion */
convertValidString("&" . mBase64(utf16BE("ハムサンドイッチ")), "ハムサンドイッチ", 'UTF7-IMAP', 'UTF-8', false);
...
Testing consecutive & sections which should have been merged... yep!
