...
findInvalidChars($validChars, $invalidChars, $truncated, false,
  // Bytes in the range which should start a 2-byte character, though none
  // actually map to anything
  array("\xA9" => true, "\xAA" => true, "\xAB" => true, "\xAC" => true, "\xAE" => true, "\xAF" => true, "\xF5" => true, "\xF6" => true, "\xF7" => true, "\xF8" => true, "\xFD" => true, "\xFE" => true));
