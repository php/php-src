...
--FILE--
<?php
/* We are going to check identification and conversion of EACH AND EVERY
 * character in the JISX-0208 and JISX-0213 charsets, when encoded using
...
$fp = fopen(realpath(__DIR__ . '/../docs/JISX0208.txt'), 'r+');
...
$fp = fopen(realpath(__DIR__ . '/../docs/ISO-2022-JP-2004-JISX0213.txt'), 'r+');
while ($line = fgets($fp, 256)) {
	if ($line[0] == '#')
		continue;
