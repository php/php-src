...
Deprecated: Function mb_regex_encoding() is deprecated since 8.6, mbregex support end PHP 9.0 in %smbstring/tests/mb_ereg_basic.php on line %d
Regex encoding set to utf-8

**-- ASCII String --**
-- Without $regs argument--

Deprecated: Function mb_ereg() is deprecated since 8.6, mbregex support end PHP 9.0 in %smbstring/tests/mb_ereg_basic.php on line %d
bool(true)
