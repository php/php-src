...
/* {{{ arginfo */
ZEND_BEGIN_ARG_INFO(arginfo_shmop_open, 0)
	ZEND_ARG_INFO(0, key)
...
ZEND_BEGIN_ARG_INFO(arginfo_shmop_read, 0)
	ZEND_ARG_INFO(0, shmid)
	ZEND_ARG_INFO(0, start)
	ZEND_ARG_INFO(0, count)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_shmop_close, 0)
	ZEND_ARG_INFO(0, shmid)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_shmop_size, 0)
	ZEND_ARG_INFO(0, shmid)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_shmop_write, 0)
	ZEND_ARG_INFO(0, shmid)
	ZEND_ARG_INFO(0, data)
	ZEND_ARG_INFO(0, offset)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_shmop_delete, 0)
	ZEND_ARG_INFO(0, shmid)
ZEND_END_ARG_INFO()
/* }}} */
