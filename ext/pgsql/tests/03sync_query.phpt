...
pg_fetch_all_columns(): Argument #2 ($index) must be greater than or equal to 0
pg_fetch_all_columns(): Argument #2 ($index) must be less than the number of fields for this result set
...
pg_field_name(): Argument #2 ($index) must be greater than or equal to 0
pg_field_name(): Argument #2 ($index) must be less than the number of fields for this result set
pg_field_table(): Argument #2 ($index) must be greater than or equal to 0
pg_field_table(): Argument #2 ($index) must be less than the number of fields for this result set
array(0) {
}
OK
