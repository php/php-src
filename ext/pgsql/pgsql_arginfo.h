...
static const zend_function_entry ext_functions[] = {
	ZEND_RAW_FENTRY("pg_connect", zif_pg_connect, arginfo_pg_connect, 0, NULL)
	ZEND_RAW_FENTRY("pg_pconnect", zif_pg_pconnect, arginfo_pg_pconnect, 0, NULL)
	ZEND_RAW_FENTRY("pg_connect_poll", zif_pg_connect_poll, arginfo_pg_connect_poll, 0, NULL)
	ZEND_RAW_FENTRY("pg_close", zif_pg_close, arginfo_pg_close, 0, NULL)
	ZEND_RAW_FENTRY("pg_dbname", zif_pg_dbname, arginfo_pg_dbname, 0, NULL)
	ZEND_RAW_FENTRY("pg_last_error", zif_pg_last_error, arginfo_pg_last_error, 0, NULL)
	ZEND_RAW_FENTRY("pg_errormessage", zif_pg_last_error, arginfo_pg_errormessage, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_options", zif_pg_options, arginfo_pg_options, 0, NULL)
	ZEND_RAW_FENTRY("pg_port", zif_pg_port, arginfo_pg_port, 0, NULL)
	ZEND_RAW_FENTRY("pg_tty", zif_pg_tty, arginfo_pg_tty, 0, NULL)
	ZEND_RAW_FENTRY("pg_host", zif_pg_host, arginfo_pg_host, 0, NULL)
	ZEND_RAW_FENTRY("pg_version", zif_pg_version, arginfo_pg_version, 0, NULL)
	ZEND_RAW_FENTRY("pg_parameter_status", zif_pg_parameter_status, arginfo_pg_parameter_status, 0, NULL)
	ZEND_RAW_FENTRY("pg_ping", zif_pg_ping, arginfo_pg_ping, 0, NULL)
	ZEND_RAW_FENTRY("pg_query", zif_pg_query, arginfo_pg_query, 0, NULL)
	ZEND_RAW_FENTRY("pg_exec", zif_pg_query, arginfo_pg_exec, 0, NULL)
	ZEND_RAW_FENTRY("pg_query_params", zif_pg_query_params, arginfo_pg_query_params, 0, NULL)
	ZEND_RAW_FENTRY("pg_prepare", zif_pg_prepare, arginfo_pg_prepare, 0, NULL)
	ZEND_RAW_FENTRY("pg_execute", zif_pg_execute, arginfo_pg_execute, 0, NULL)
	ZEND_RAW_FENTRY("pg_num_rows", zif_pg_num_rows, arginfo_pg_num_rows, 0, NULL)
	ZEND_RAW_FENTRY("pg_numrows", zif_pg_num_rows, arginfo_pg_numrows, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_num_fields", zif_pg_num_fields, arginfo_pg_num_fields, 0, NULL)
	ZEND_RAW_FENTRY("pg_numfields", zif_pg_num_fields, arginfo_pg_numfields, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_affected_rows", zif_pg_affected_rows, arginfo_pg_affected_rows, 0, NULL)
	ZEND_RAW_FENTRY("pg_cmdtuples", zif_pg_affected_rows, arginfo_pg_cmdtuples, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_last_notice", zif_pg_last_notice, arginfo_pg_last_notice, 0, NULL)
	ZEND_RAW_FENTRY("pg_field_table", zif_pg_field_table, arginfo_pg_field_table, 0, NULL)
	ZEND_RAW_FENTRY("pg_field_name", zif_pg_field_name, arginfo_pg_field_name, 0, NULL)
	ZEND_RAW_FENTRY("pg_fieldname", zif_pg_field_name, arginfo_pg_fieldname, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_field_size", zif_pg_field_size, arginfo_pg_field_size, 0, NULL)
	ZEND_RAW_FENTRY("pg_fieldsize", zif_pg_field_size, arginfo_pg_fieldsize, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_field_type", zif_pg_field_type, arginfo_pg_field_type, 0, NULL)
	ZEND_RAW_FENTRY("pg_fieldtype", zif_pg_field_type, arginfo_pg_fieldtype, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_field_type_oid", zif_pg_field_type_oid, arginfo_pg_field_type_oid, 0, NULL)
	ZEND_RAW_FENTRY("pg_field_num", zif_pg_field_num, arginfo_pg_field_num, 0, NULL)
	ZEND_RAW_FENTRY("pg_fieldnum", zif_pg_field_num, arginfo_pg_fieldnum, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_fetch_result", zif_pg_fetch_result, arginfo_pg_fetch_result, 0, NULL)
	ZEND_RAW_FENTRY("pg_result", zif_pg_fetch_result, arginfo_pg_result, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_fetch_row", zif_pg_fetch_row, arginfo_pg_fetch_row, 0, NULL)
	ZEND_RAW_FENTRY("pg_fetch_assoc", zif_pg_fetch_assoc, arginfo_pg_fetch_assoc, 0, NULL)
	ZEND_RAW_FENTRY("pg_fetch_array", zif_pg_fetch_array, arginfo_pg_fetch_array, 0, NULL)
	ZEND_RAW_FENTRY("pg_fetch_object", zif_pg_fetch_object, arginfo_pg_fetch_object, 0, NULL)
	ZEND_RAW_FENTRY("pg_fetch_all", zif_pg_fetch_all, arginfo_pg_fetch_all, 0, NULL)
	ZEND_RAW_FENTRY("pg_fetch_all_columns", zif_pg_fetch_all_columns, arginfo_pg_fetch_all_columns, 0, NULL)
	ZEND_RAW_FENTRY("pg_result_seek", zif_pg_result_seek, arginfo_pg_result_seek, 0, NULL)
	ZEND_RAW_FENTRY("pg_field_prtlen", zif_pg_field_prtlen, arginfo_pg_field_prtlen, 0, NULL)
	ZEND_RAW_FENTRY("pg_fieldprtlen", zif_pg_fieldprtlen, arginfo_pg_fieldprtlen, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_field_is_null", zif_pg_field_is_null, arginfo_pg_field_is_null, 0, NULL)
	ZEND_RAW_FENTRY("pg_fieldisnull", zif_pg_fieldisnull, arginfo_pg_fieldisnull, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_free_result", zif_pg_free_result, arginfo_pg_free_result, 0, NULL)
	ZEND_RAW_FENTRY("pg_freeresult", zif_pg_free_result, arginfo_pg_freeresult, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_last_oid", zif_pg_last_oid, arginfo_pg_last_oid, 0, NULL)
	ZEND_RAW_FENTRY("pg_getlastoid", zif_pg_last_oid, arginfo_pg_getlastoid, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_trace", zif_pg_trace, arginfo_pg_trace, 0, NULL)
	ZEND_RAW_FENTRY("pg_untrace", zif_pg_untrace, arginfo_pg_untrace, 0, NULL)
	ZEND_RAW_FENTRY("pg_lo_create", zif_pg_lo_create, arginfo_pg_lo_create, 0, NULL)
	ZEND_RAW_FENTRY("pg_locreate", zif_pg_lo_create, arginfo_pg_locreate, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_lo_unlink", zif_pg_lo_unlink, arginfo_pg_lo_unlink, 0, NULL)
	ZEND_RAW_FENTRY("pg_lounlink", zif_pg_lo_unlink, arginfo_pg_lounlink, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_lo_open", zif_pg_lo_open, arginfo_pg_lo_open, 0, NULL)
	ZEND_RAW_FENTRY("pg_loopen", zif_pg_lo_open, arginfo_pg_loopen, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_lo_close", zif_pg_lo_close, arginfo_pg_lo_close, 0, NULL)
	ZEND_RAW_FENTRY("pg_loclose", zif_pg_lo_close, arginfo_pg_loclose, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_lo_read", zif_pg_lo_read, arginfo_pg_lo_read, 0, NULL)
	ZEND_RAW_FENTRY("pg_loread", zif_pg_lo_read, arginfo_pg_loread, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_lo_write", zif_pg_lo_write, arginfo_pg_lo_write, 0, NULL)
	ZEND_RAW_FENTRY("pg_lowrite", zif_pg_lo_write, arginfo_pg_lowrite, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_lo_read_all", zif_pg_lo_read_all, arginfo_pg_lo_read_all, 0, NULL)
	ZEND_RAW_FENTRY("pg_loreadall", zif_pg_lo_read_all, arginfo_pg_loreadall, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_lo_import", zif_pg_lo_import, arginfo_pg_lo_import, 0, NULL)
	ZEND_RAW_FENTRY("pg_loimport", zif_pg_lo_import, arginfo_pg_loimport, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_lo_export", zif_pg_lo_export, arginfo_pg_lo_export, 0, NULL)
	ZEND_RAW_FENTRY("pg_loexport", zif_pg_lo_export, arginfo_pg_loexport, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_lo_seek", zif_pg_lo_seek, arginfo_pg_lo_seek, 0, NULL)
	ZEND_RAW_FENTRY("pg_lo_tell", zif_pg_lo_tell, arginfo_pg_lo_tell, 0, NULL)
	ZEND_RAW_FENTRY("pg_lo_truncate", zif_pg_lo_truncate, arginfo_pg_lo_truncate, 0, NULL)
	ZEND_RAW_FENTRY("pg_set_error_verbosity", zif_pg_set_error_verbosity, arginfo_pg_set_error_verbosity, 0, NULL)
	ZEND_RAW_FENTRY("pg_set_client_encoding", zif_pg_set_client_encoding, arginfo_pg_set_client_encoding, 0, NULL)
	ZEND_RAW_FENTRY("pg_setclientencoding", zif_pg_set_client_encoding, arginfo_pg_setclientencoding, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_client_encoding", zif_pg_client_encoding, arginfo_pg_client_encoding, 0, NULL)
	ZEND_RAW_FENTRY("pg_clientencoding", zif_pg_client_encoding, arginfo_pg_clientencoding, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("pg_end_copy", zif_pg_end_copy, arginfo_pg_end_copy, 0, NULL)
	ZEND_RAW_FENTRY("pg_put_line", zif_pg_put_line, arginfo_pg_put_line, 0, NULL)
	ZEND_RAW_FENTRY("pg_copy_to", zif_pg_copy_to, arginfo_pg_copy_to, 0, NULL)
	ZEND_RAW_FENTRY("pg_copy_from", zif_pg_copy_from, arginfo_pg_copy_from, 0, NULL)
	ZEND_RAW_FENTRY("pg_escape_string", zif_pg_escape_string, arginfo_pg_escape_string, 0, NULL)
	ZEND_RAW_FENTRY("pg_escape_bytea", zif_pg_escape_bytea, arginfo_pg_escape_bytea, 0, NULL)
	ZEND_RAW_FENTRY("pg_unescape_bytea", zif_pg_unescape_bytea, arginfo_pg_unescape_bytea, 0, NULL)
	ZEND_RAW_FENTRY("pg_escape_literal", zif_pg_escape_literal, arginfo_pg_escape_literal, 0, NULL)
	ZEND_RAW_FENTRY("pg_escape_identifier", zif_pg_escape_identifier, arginfo_pg_escape_identifier, 0, NULL)
	ZEND_RAW_FENTRY("pg_result_error", zif_pg_result_error, arginfo_pg_result_error, 0, NULL)
	ZEND_RAW_FENTRY("pg_result_error_field", zif_pg_result_error_field, arginfo_pg_result_error_field, 0, NULL)
	ZEND_RAW_FENTRY("pg_connection_status", zif_pg_connection_status, arginfo_pg_connection_status, 0, NULL)
	ZEND_RAW_FENTRY("pg_transaction_status", zif_pg_transaction_status, arginfo_pg_transaction_status, 0, NULL)
	ZEND_RAW_FENTRY("pg_connection_reset", zif_pg_connection_reset, arginfo_pg_connection_reset, 0, NULL)
	ZEND_RAW_FENTRY("pg_cancel_query", zif_pg_cancel_query, arginfo_pg_cancel_query, 0, NULL)
	ZEND_RAW_FENTRY("pg_connection_busy", zif_pg_connection_busy, arginfo_pg_connection_busy, 0, NULL)
	ZEND_RAW_FENTRY("pg_send_query", zif_pg_send_query, arginfo_pg_send_query, 0, NULL)
	ZEND_RAW_FENTRY("pg_send_query_params", zif_pg_send_query_params, arginfo_pg_send_query_params, 0, NULL)
	ZEND_RAW_FENTRY("pg_send_prepare", zif_pg_send_prepare, arginfo_pg_send_prepare, 0, NULL)
	ZEND_RAW_FENTRY("pg_send_execute", zif_pg_send_execute, arginfo_pg_send_execute, 0, NULL)
	ZEND_RAW_FENTRY("pg_get_result", zif_pg_get_result, arginfo_pg_get_result, 0, NULL)
	ZEND_RAW_FENTRY("pg_result_status", zif_pg_result_status, arginfo_pg_result_status, 0, NULL)
	ZEND_RAW_FENTRY("pg_get_notify", zif_pg_get_notify, arginfo_pg_get_notify, 0, NULL)
	ZEND_RAW_FENTRY("pg_get_pid", zif_pg_get_pid, arginfo_pg_get_pid, 0, NULL)
	ZEND_RAW_FENTRY("pg_socket", zif_pg_socket, arginfo_pg_socket, 0, NULL)
	ZEND_RAW_FENTRY("pg_consume_input", zif_pg_consume_input, arginfo_pg_consume_input, 0, NULL)
	ZEND_RAW_FENTRY("pg_flush", zif_pg_flush, arginfo_pg_flush, 0, NULL)
	ZEND_RAW_FENTRY("pg_meta_data", zif_pg_meta_data, arginfo_pg_meta_data, 0, NULL)
	ZEND_RAW_FENTRY("pg_convert", zif_pg_convert, arginfo_pg_convert, 0, NULL)
	ZEND_RAW_FENTRY("pg_insert", zif_pg_insert, arginfo_pg_insert, 0, NULL)
	ZEND_RAW_FENTRY("pg_update", zif_pg_update, arginfo_pg_update, 0, NULL)
	ZEND_RAW_FENTRY("pg_delete", zif_pg_delete, arginfo_pg_delete, 0, NULL)
	ZEND_RAW_FENTRY("pg_select", zif_pg_select, arginfo_pg_select, 0, NULL)
#if defined(HAVE_PG_CONTEXT_VISIBILITY)
	ZEND_RAW_FENTRY("pg_set_error_context_visibility", zif_pg_set_error_context_visibility, arginfo_pg_set_error_context_visibility, 0, NULL)
#endif
	ZEND_FE_END
};
