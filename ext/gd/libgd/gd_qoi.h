...
This copy is vendored for libgd's QOI codec. The upstream MIT license is
also included in docs/QOI-LICENSE.
...
#define qoi_encode gdQoiEncode
#define qoi_decode gdQoiDecode
