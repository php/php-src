 ...
 * Stub hash: 3d12f3cc6b6e47688ad5baf054e15137f2bcc2d4 */
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_imagecompare, 0, 2, IS_LONG, 0)
	ZEND_ARG_OBJ_INFO(0, image1, GdImage, 0)
	ZEND_ARG_OBJ_INFO(0, image2, GdImage, 0)
ZEND_END_ARG_INFO()
...
static const zend_function_entry ext_functions[] = {
	...
	ZEND_FE(imagecompare, arginfo_imagecompare)
	ZEND_FE_END
};
...
static void register_gd_symbols(int module_number)
{
	...
	REGISTER_LONG_CONSTANT("IMG_CMP_IMAGE", GD_CMP_IMAGE, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("IMG_CMP_NUM_COLORS", GD_CMP_NUM_COLORS, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("IMG_CMP_COLOR", GD_CMP_COLOR, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("IMG_CMP_SIZE_X", GD_CMP_SIZE_X, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("IMG_CMP_SIZE_Y", GD_CMP_SIZE_Y, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("IMG_CMP_TRANSPARENT", GD_CMP_TRANSPARENT, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("IMG_CMP_BACKGROUND", GD_CMP_BACKGROUND, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("IMG_CMP_INTERLACE", GD_CMP_INTERLACE, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("IMG_CMP_TRUECOLOR", GD_CMP_TRUECOLOR, CONST_PERSISTENT);
