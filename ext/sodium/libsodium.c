...
ZEND_BEGIN_ARG_INFO(AI_SignatureAndStringAndKey, 0)
...
ZEND_BEGIN_ARG_INFO(AI_LengthAndNonceAndKey, 0)
	ZEND_ARG_INFO(0, length)
	ZEND_ARG_INFO(0, nonce)
	ZEND_ARG_INFO(0, key)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(AI_StringAndNonceAndKey, 0)
	ZEND_ARG_INFO(0, string)
	ZEND_ARG_INFO(0, nonce)
	ZEND_ARG_INFO(0, key)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(AI_StringAndNonceAndKeyPair, 0)
	ZEND_ARG_INFO(0, string)
	ZEND_ARG_INFO(0, nonce)
	ZEND_ARG_INFO(0, key)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(AI_PasswordAndOpsLimitAndMemLimit, 0)
	ZEND_ARG_INFO(0, password)
	ZEND_ARG_INFO(0, opslimit)
	ZEND_ARG_INFO(0, memlimit)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(AI_StringAndADAndNonceAndKey, 0)
	ZEND_ARG_INFO(0, string)
	ZEND_ARG_INFO(0, ad)
	ZEND_ARG_INFO(0, nonce)
	ZEND_ARG_INFO(0, key)
