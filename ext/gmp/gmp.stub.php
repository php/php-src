...
/** @param GMP|string|int|bool $gmpnumber */
...
/**
 * @param GMP|string|int|bool $a
 * @param GMP|string|int|bool $b
 */
...
/** @param GMP|string|int|bool $base */
function gmp_pow($base, int $exp): GMP {}

/**
 * @param GMP|string|int|bool $base
 * @param GMP|string|int|bool $exp
 * @param GMP|string|int|bool $mod
 */
...
/** @param GMP|string|int|bool $seed */
function gmp_random_seed($seed): void {}

function gmp_random_bits(int $bits): GMP {}

/**
 * @param GMP|string|int|bool $min
 * @param GMP|string|int|bool $max
 **/
