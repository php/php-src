...
$c = oci_new_connect('/', 'notemtpy', 'mysql', null, OCI_CRED_EXT);
if (!$c) {
    $m = oci_error();
    var_dump($m);
}
...
$c = oci_new_connect('notemtpy', 'notemtpy', 'mysql', null, OCI_CRED_EXT);
if (!$c) {
    $m = oci_error();
    var_dump($m);
}
...
$c = oci_new_connect('a', 'b', 'mysql', null, OCI_SYSDBA+OCI_SYSOPER);
if (!$c) {
    $m = oci_error();
    var_dump($m);
}
...
$c = oci_new_connect('a', 'b', 'mysql', null, OCI_SYSDBA+OCI_SYSOPER+OCI_CRED_EXT);
if (!$c) {
    $m = oci_error();
    var_dump($m);
}
...
$c = oci_new_connect('/', '', 'mysql', null, OCI_SYSDBA+OCI_CRED_EXT);
if (!$c) {
    $m = oci_error();
    var_dump($m);
}
...
$c = oci_new_connect('/', '', 'mysql', null, OCI_SYSOPER+OCI_CRED_EXT);
if (!$c) {
    $m = oci_error();
    var_dump($m);
}
