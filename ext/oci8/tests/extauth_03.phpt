...
$c = oci_pconnect('/', 'notemtpy', 'mysql', null, OCI_CRED_EXT);
if (!$c) {
    $m = oci_error();
    var_dump($m);
}
...
$c = oci_pconnect('notemtpy', 'notemtpy', 'mysql', null, OCI_CRED_EXT);
if (!$c) {
    $m = oci_error();
    var_dump($m);
}
...
$c = oci_pconnect('a', 'b', 'mysql', null, OCI_SYSDBA+OCI_SYSOPER);
if (!$c) {
    $m = oci_error();
    var_dump($m);
}
...
$c = oci_pconnect('a', 'b', 'mysql', null, OCI_SYSDBA+OCI_SYSOPER+OCI_CRED_EXT);
if (!$c) {
    $m = oci_error();
    var_dump($m);
}
...
$c = oci_pconnect('/', '', 'mysql', null, OCI_SYSDBA+OCI_CRED_EXT);
if (!$c) {
    $m = oci_error();
    var_dump($m);
}
...
$c = oci_pconnect('/', '', 'mysql', null, OCI_SYSOPER+OCI_CRED_EXT);
if (!$c) {
    $m = oci_error();
    var_dump($m);
}
