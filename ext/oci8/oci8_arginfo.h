...
static void register_oci8_symbols(int module_number)
{
	...
	zend_string *attribute_name_SensitiveParameter_arginfo_oci_new_connect_arg1 = zend_string_init("SensitiveParameter", sizeof("SensitiveParameter") - 1, 1);
	zend_add_parameter_attribute(zend_hash_str_find_ptr(CG(function_table), "oci_new_connect", sizeof("oci_new_connect") - 1), 1, attribute_name_SensitiveParameter_arginfo_oci_new_connect_arg1, 0);
	zend_string_release(attribute_name_SensitiveParameter_arginfo_oci_new_connect_arg1);

	zend_string *attribute_name_SensitiveParameter_arginfo_ocinlogon_arg1 = zend_string_init("SensitiveParameter", sizeof("SensitiveParameter") - 1, 1);
	zend_add_parameter_attribute(zend_hash_str_find_ptr(CG(function_table), "ocinlogon", sizeof("ocinlogon") - 1), 1, attribute_name_SensitiveParameter_arginfo_ocinlogon_arg1, 0);
	zend_string_release(attribute_name_SensitiveParameter_arginfo_ocinlogon_arg1);

	zend_string *attribute_name_SensitiveParameter_arginfo_oci_connect_arg1 = zend_string_init("SensitiveParameter", sizeof("SensitiveParameter") - 1, 1);
	zend_add_parameter_attribute(zend_hash_str_find_ptr(CG(function_table), "oci_connect", sizeof("oci_connect") - 1), 1, attribute_name_SensitiveParameter_arginfo_oci_connect_arg1, 0);
	zend_string_release(attribute_name_SensitiveParameter_arginfo_oci_connect_arg1);

	zend_string *attribute_name_SensitiveParameter_arginfo_ocilogon_arg1 = zend_string_init("SensitiveParameter", sizeof("SensitiveParameter") - 1, 1);
	zend_add_parameter_attribute(zend_hash_str_find_ptr(CG(function_table), "ocilogon", sizeof("ocilogon") - 1), 1, attribute_name_SensitiveParameter_arginfo_ocilogon_arg1, 0);
	zend_string_release(attribute_name_SensitiveParameter_arginfo_ocilogon_arg1);

	zend_string *attribute_name_SensitiveParameter_arginfo_oci_pconnect_arg1 = zend_string_init("SensitiveParameter", sizeof("SensitiveParameter") - 1, 1);
	zend_add_parameter_attribute(zend_hash_str_find_ptr(CG(function_table), "oci_pconnect", sizeof("oci_pconnect") - 1), 1, attribute_name_SensitiveParameter_arginfo_oci_pconnect_arg1, 0);
	zend_string_release(attribute_name_SensitiveParameter_arginfo_oci_pconnect_arg1);

	zend_string *attribute_name_SensitiveParameter_arginfo_ociplogon_arg1 = zend_string_init("SensitiveParameter", sizeof("SensitiveParameter") - 1, 1);
	zend_add_parameter_attribute(zend_hash_str_find_ptr(CG(function_table), "ociplogon", sizeof("ociplogon") - 1), 1, attribute_name_SensitiveParameter_arginfo_ociplogon_arg1, 0);
	zend_string_release(attribute_name_SensitiveParameter_arginfo_ociplogon_arg1);
}
