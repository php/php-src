...
static zend_class_entry *register_class_OCILob(void)
{
	...
	zend_string *attribute_name_AllowDynamicProperties_class_OCILob_1 = zend_string_init_interned("AllowDynamicProperties", sizeof("AllowDynamicProperties") - 1, 1);
	zend_add_class_attribute(class_entry, attribute_name_AllowDynamicProperties_class_OCILob_1, 0);
	zend_string_release(attribute_name_AllowDynamicProperties_class_OCILob_1);
...
static zend_class_entry *register_class_OCICollection(void)
{
	...
	zend_string *attribute_name_AllowDynamicProperties_class_OCICollection_1 = zend_string_init_interned("AllowDynamicProperties", sizeof("AllowDynamicProperties") - 1, 1);
	zend_add_class_attribute(class_entry, attribute_name_AllowDynamicProperties_class_OCICollection_1, 0);
	zend_string_release(attribute_name_AllowDynamicProperties_class_OCICollection_1);
