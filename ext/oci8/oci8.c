...
static const zend_function_entry php_oci_lob_class_functions[] = {
	PHP_FALIAS(load,		oci_lob_load,			arginfo_class_OCI_Lob_load)
	PHP_FALIAS(tell,		oci_lob_tell,			arginfo_class_OCI_Lob_tell)
	PHP_FALIAS(truncate,	oci_lob_truncate,		arginfo_class_OCI_Lob_truncate)
	PHP_FALIAS(erase,		oci_lob_erase,			arginfo_class_OCI_Lob_erase)
	PHP_FALIAS(flush,		oci_lob_flush,			arginfo_class_OCI_Lob_flush)
	PHP_FALIAS(setbuffering,ocisetbufferinglob,		arginfo_class_OCI_Lob_setbuffering)
	PHP_FALIAS(getbuffering,ocigetbufferinglob,		arginfo_class_OCI_Lob_getbuffering)
	PHP_FALIAS(rewind,		oci_lob_rewind,			arginfo_class_OCI_Lob_rewind)
	PHP_FALIAS(read,		oci_lob_read,			arginfo_class_OCI_Lob_read)
	PHP_FALIAS(eof,			oci_lob_eof,			arginfo_class_OCI_Lob_eof)
	PHP_FALIAS(seek,		oci_lob_seek,			arginfo_class_OCI_Lob_seek)
	PHP_FALIAS(write,		oci_lob_write,			arginfo_class_OCI_Lob_write)
	PHP_FALIAS(append,		oci_lob_append,			arginfo_class_OCI_Lob_append)
	PHP_FALIAS(size,		oci_lob_size,			arginfo_class_OCI_Lob_size)
	PHP_FALIAS(writetofile, oci_lob_export,			arginfo_class_OCI_Lob_writetofile)
	PHP_FALIAS(export,		oci_lob_export,			arginfo_class_OCI_Lob_export)
	PHP_FALIAS(import,		oci_lob_import,			arginfo_class_OCI_Lob_import)
	PHP_FALIAS(writetemporary,	oci_lob_write_temporary,	arginfo_class_OCI_Lob_writetemporary)
	PHP_FALIAS(close,			oci_lob_close,				arginfo_class_OCI_Lob_close)
	PHP_FALIAS(save,		oci_lob_save,			arginfo_class_OCI_Lob_save)
	PHP_FALIAS(savefile,	oci_lob_import,			arginfo_class_OCI_Lob_savefile)
	PHP_FALIAS(free,		oci_free_descriptor,	arginfo_class_OCI_Lob_free)
	PHP_FE_END
};
...
static const zend_function_entry php_oci_coll_class_functions[] = {
	...
	PHP_FALIAS(getelem,		  oci_collection_element_get,		arginfo_class_OCI_Collection_getElem)
	PHP_FALIAS(assignelem,	  oci_collection_element_assign,	arginfo_class_OCI_Collection_assignelem)
	PHP_FALIAS(assign,		  oci_collection_assign,			arginfo_class_OCI_Collection_assign)
	PHP_FALIAS(size,		  oci_collection_size,				arginfo_class_OCI_Collection_size)
	PHP_FALIAS(max,			  oci_collection_max,				arginfo_class_OCI_Collection_max)
	PHP_FALIAS(trim,		  oci_collection_trim,				arginfo_class_OCI_Collection_trim)
	PHP_FALIAS(free,		  oci_free_collection,				arginfo_class_OCI_Collection_free)
	PHP_FE_END
};
