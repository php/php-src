...
function oci_new_connect(string $username, string $password, ?string $dsn = null, string $encoding = "", int $session_mode = OCI_DEFAULT) {}
 ...
 * @deprecated
 */
function ocinlogon(string $username, string $password, ?string $dsn = null, string $encoding = "", int $session_mode = OCI_DEFAULT) {}

/**
 * @return resource|false
 */
function oci_connect(string $username, string $password, ?string $dsn = null, string $encoding = "", int $session_mode = OCI_DEFAULT) {}
 ...
 * @deprecated
 */
function ocilogon(string $username, string $password, ?string $dsn = null, string $encoding = "", int $session_mode = OCI_DEFAULT) {}

/** @return resource|false */
function oci_pconnect(string $username, string $password, ?string $dsn = null, string $encoding = "", int $session_mode = OCI_DEFAULT) {}
 ...
 * @deprecated
 */
function ociplogon(string $username, string $password, ?string $dsn = null, string $encoding = "", int $session_mode = OCI_DEFAULT) {}
