...
<root xmlns:xmlns="http://www.w3.org/2000/xmlns/">
    <a:root1 xmlns:a="urn:y" xmlns:a="urn:a" xmlns:a="urn:a" a:foo="bar">
        <a:root2 xmlns:a="urn:b" xmlns:a="urn:b">
            <a:child xmlns:b="urn:b" xmlns:b="urn:b">
...
string(5) "a:foo"
string(5) "urn:y"
<a:root1 xmlns:a="urn:y" xmlns:xmlns="http://www.w3.org/2000/xmlns/" xmlns:a="urn:a" xmlns:a="urn:a" a:foo="bar">
        <a:root2 xmlns:a="urn:b" xmlns:a="urn:b">
            <a:child xmlns:b="urn:b">
                <b:child1 xmlns:b="urn:b" xmlns:a="urn:x">bar</b:child1>
            </a:child>
        </a:root2>
    </a:root1>
