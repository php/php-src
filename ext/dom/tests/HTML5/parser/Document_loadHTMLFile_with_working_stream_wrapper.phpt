...
$dom->loadHTMLFile("euw://<p>hello</p>");
echo $dom->saveHTML(), "\n";
...
$dom->loadHTMLFile("euw://<!doctype html><html>" . str_repeat("\n", 4096-22) . "<></html>");
echo $dom->saveHTML(), "\n";
...
Warning: DOM\HTML5Document::loadHTMLFile(): tree error unexpected-token-in-initial-mode in euw://<p>hello</p>, line: 1, column: 2 in %s on line %d
