...
$xml->loadXML('<?xml version="1.0"?><container xmlns="some:ns" xmlns:bar="another:ns"/>');
...
<container xmlns="some:ns" xmlns:bar="another:ns" foo:bar="value"><child></child></container>
