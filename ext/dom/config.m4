...
if test "$PHP_DOM" != "no"; then
  ...
  PHP_SETUP_LIBXML(DOM_SHARED_LIBADD, [
    ...
    LEXBOR_SOURCES="$LEXBOR_DIR/ports/posix/lexbor/core/memory.c \
      $LEXBOR_DIR/core/array_obj.c $LEXBOR_DIR/core/array.c $LEXBOR_DIR/core/avl.c $LEXBOR_DIR/core/bst.c $LEXBOR_DIR/core/diyfp.c $LEXBOR_DIR/core/conv.c $LEXBOR_DIR/core/dobject.c $LEXBOR_DIR/core/dtoa.c $LEXBOR_DIR/core/hash.c $LEXBOR_DIR/core/mem.c $LEXBOR_DIR/core/mraw.c $LEXBOR_DIR/core/plog.c  $LEXBOR_DIR/core/print.c $LEXBOR_DIR/core/serialize.c $LEXBOR_DIR/core/shs.c $LEXBOR_DIR/core/str.c $LEXBOR_DIR/core/strtod.c \
      ...
      $LEXBOR_DIR/unicode/idna.c $LEXBOR_DIR/unicode/unicode.c \
    ...
    PHP_ADD_BUILD_DIR($ext_builddir/$LEXBOR_DIR/punycode)
    PHP_ADD_BUILD_DIR($ext_builddir/$LEXBOR_DIR/unicode)
    PHP_ADD_BUILD_DIR($ext_builddir/$LEXBOR_DIR/url)
