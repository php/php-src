...
static zend_class_entry *register_class_DOMDocumentType(zend_class_entry *class_entry_DOMNode)
{
	...
	zend_string_release_ex(property_entities_name, 1);
	...
	zend_string_release_ex(property_notations_name, 1);
	...
	zend_string_release_ex(property_publicId_name, 1);
	...
	zend_string_release_ex(property_systemId_name, 1);
	...
	zend_string_release_ex(property_internalSubset_name, 1);
...
static zend_class_entry *register_class_DOMNode(void)
{
	...
	zend_string_release_ex(property_nodeName_name, 1);
	...
	zend_string_release_ex(property_nodeValue_name, 1);
	...
	zend_string_release_ex(property_parentNode_name, 1);
	...
	zend_string_release_ex(property_parentElement_name, 1);
	...
	zend_string_release_ex(property_childNodes_name, 1);
	...
	zend_string_release_ex(property_firstChild_name, 1);
	...
	zend_string_release_ex(property_lastChild_name, 1);
	...
	zend_string_release_ex(property_previousSibling_name, 1);
	...
	zend_string_release_ex(property_nextSibling_name, 1);
	...
	zend_string_release_ex(property_attributes_name, 1);
	...
	zend_string_release_ex(property_isConnected_name, 1);
	...
	zend_string_release_ex(property_ownerDocument_name, 1);
	...
	zend_string_release_ex(property_textContent_name, 1);
...
static zend_class_entry *register_class_DOMDocumentFragment(zend_class_entry *class_entry_DOMNode, zend_class_entry *class_entry_DOMParentNode)
{
	...
	zend_string_release_ex(property_firstElementChild_name, 1);
	...
	zend_string_release_ex(property_lastElementChild_name, 1);
	...
	zend_string_release_ex(property_childElementCount_name, 1);
...
static zend_class_entry *register_class_DOMNodeList(zend_class_entry *class_entry_IteratorAggregate, zend_class_entry *class_entry_Countable)
{
	...
	zend_string_release_ex(property_length_name, 1);
...
static zend_class_entry *register_class_DOMCharacterData(zend_class_entry *class_entry_DOMNode, zend_class_entry *class_entry_DOMChildNode)
{
	...
	zend_string_release_ex(property_previousElementSibling_name, 1);
	...
	zend_string_release_ex(property_nextElementSibling_name, 1);
...
static zend_class_entry *register_class_DOMAttr(zend_class_entry *class_entry_DOMNode)
{
	...
	zend_string_release_ex(property_specified_name, 1);
	...
	zend_string_release_ex(property_ownerElement_name, 1);
	...
	zend_string_release_ex(property_schemaTypeInfo_name, 1);
...
static zend_class_entry *register_class_DOMElement(zend_class_entry *class_entry_DOMNode, zend_class_entry *class_entry_DOMParentNode, zend_class_entry *class_entry_DOMChildNode)
{
	...
	zend_string_release_ex(property_tagName_name, 1);
	...
	zend_string_release_ex(property_className_name, 1);
...
static zend_class_entry *register_class_DOMDocument(zend_class_entry *class_entry_DOMNode, zend_class_entry *class_entry_DOMParentNode)
{
	...
	zend_string_release_ex(property_doctype_name, 1);
	...
	zend_string_release_ex(property_implementation_name, 1);
	...
	zend_string_release_ex(property_documentElement_name, 1);
	...
	zend_string_release_ex(property_actualEncoding_name, 1);
	...
	zend_string_release_ex(property_encoding_name, 1);
	...
	zend_string_release_ex(property_xmlEncoding_name, 1);
	...
	zend_string_release_ex(property_standalone_name, 1);
	...
	zend_string_release_ex(property_xmlStandalone_name, 1);
	...
	zend_string_release_ex(property_version_name, 1);
	...
	zend_string_release_ex(property_xmlVersion_name, 1);
	...
	zend_string_release_ex(property_strictErrorChecking_name, 1);
	...
	zend_string_release_ex(property_documentURI_name, 1);
	...
	zend_string_release_ex(property_config_name, 1);
	...
	zend_string_release_ex(property_formatOutput_name, 1);
	...
	zend_string_release_ex(property_validateOnParse_name, 1);
	...
	zend_string_release_ex(property_resolveExternals_name, 1);
	...
	zend_string_release_ex(property_preserveWhiteSpace_name, 1);
	...
	zend_string_release_ex(property_recover_name, 1);
	...
	zend_string_release_ex(property_substituteEntities_name, 1);
...
static zend_class_entry *register_class_DOMText(zend_class_entry *class_entry_DOMCharacterData)
{
	...
	zend_string_release_ex(property_wholeText_name, 1);
...
static zend_class_entry *register_class_DOMEntity(zend_class_entry *class_entry_DOMNode)
{
	...
	zend_string_release_ex(property_notationName_name, 1);
...
static zend_class_entry *register_class_DOMProcessingInstruction(zend_class_entry *class_entry_DOMNode)
{
	...
	zend_string_release_ex(property_target_name, 1);
...
static zend_class_entry *register_class_DOMXPath(void)
{
	...
	zend_string_release_ex(property_document_name, 1);
	...
	zend_string_release_ex(property_registerNodeNamespaces_name, 1);
...
static zend_class_entry *register_class_Dom_Element(zend_class_entry *class_entry_Dom_Node, zend_class_entry *class_entry_Dom_ParentNode, zend_class_entry *class_entry_Dom_ChildNode)
{
	...
	zend_string_release_ex(property_classList_name, 1);
	...
	zend_string_release_ex(property_innerHTML_name, 1);
	...
	zend_string_release_ex(property_outerHTML_name, 1);
	...
	zend_string_release_ex(property_substitutedNodeValue_name, 1);
...
static zend_class_entry *register_class_Dom_Document(zend_class_entry *class_entry_Dom_Node, zend_class_entry *class_entry_Dom_ParentNode)
{
	...
	zend_string_release_ex(property_URL_name, 1);
	...
	zend_string_release_ex(property_characterSet_name, 1);
	...
	zend_string_release_ex(property_charset_name, 1);
	...
	zend_string_release_ex(property_inputEncoding_name, 1);
	...
	zend_string_release_ex(property_body_name, 1);
	...
	zend_string_release_ex(property_head_name, 1);
	...
	zend_string_release_ex(property_title_name, 1);
...
static zend_class_entry *register_class_Dom_NamespaceInfo(void)
{
	...
	zend_string_release_ex(property_element_name, 1);
