...
static zend_class_entry *register_class_DOMDocumentType(zend_class_entry *class_entry_DOMNode)
{
	...
	zend_string *property_entities_name = zend_string_init_interned("entities", sizeof("entities") - 1, 1);
	...
	zend_string *property_notations_name = zend_string_init_interned("notations", sizeof("notations") - 1, 1);
	...
	zend_string *property_publicId_name = zend_string_init_interned("publicId", sizeof("publicId") - 1, 1);
	...
	zend_string *property_systemId_name = zend_string_init_interned("systemId", sizeof("systemId") - 1, 1);
	...
	zend_string *property_internalSubset_name = zend_string_init_interned("internalSubset", sizeof("internalSubset") - 1, 1);
...
static zend_class_entry *register_class_DOMNode(void)
{
	...
	zend_string *property_nodeName_name = zend_string_init_interned("nodeName", sizeof("nodeName") - 1, 1);
	...
	zend_string *property_nodeValue_name = zend_string_init_interned("nodeValue", sizeof("nodeValue") - 1, 1);
	...
	zend_string *property_parentNode_name = zend_string_init_interned("parentNode", sizeof("parentNode") - 1, 1);
	...
	zend_string *property_parentElement_name = zend_string_init_interned("parentElement", sizeof("parentElement") - 1, 1);
	...
	zend_string *property_childNodes_name = zend_string_init_interned("childNodes", sizeof("childNodes") - 1, 1);
	...
	zend_string *property_firstChild_name = zend_string_init_interned("firstChild", sizeof("firstChild") - 1, 1);
	...
	zend_string *property_lastChild_name = zend_string_init_interned("lastChild", sizeof("lastChild") - 1, 1);
	...
	zend_string *property_previousSibling_name = zend_string_init_interned("previousSibling", sizeof("previousSibling") - 1, 1);
	...
	zend_string *property_nextSibling_name = zend_string_init_interned("nextSibling", sizeof("nextSibling") - 1, 1);
	...
	zend_string *property_attributes_name = zend_string_init_interned("attributes", sizeof("attributes") - 1, 1);
	...
	zend_string *property_isConnected_name = zend_string_init_interned("isConnected", sizeof("isConnected") - 1, 1);
	...
	zend_string *property_ownerDocument_name = zend_string_init_interned("ownerDocument", sizeof("ownerDocument") - 1, 1);
	...
	zend_string *property_textContent_name = zend_string_init_interned("textContent", sizeof("textContent") - 1, 1);
...
static zend_class_entry *register_class_DOMDocumentFragment(zend_class_entry *class_entry_DOMNode, zend_class_entry *class_entry_DOMParentNode)
{
	...
	zend_string *property_firstElementChild_name = zend_string_init_interned("firstElementChild", sizeof("firstElementChild") - 1, 1);
	...
	zend_string *property_lastElementChild_name = zend_string_init_interned("lastElementChild", sizeof("lastElementChild") - 1, 1);
	...
	zend_string *property_childElementCount_name = zend_string_init_interned("childElementCount", sizeof("childElementCount") - 1, 1);
...
static zend_class_entry *register_class_DOMNodeList(zend_class_entry *class_entry_IteratorAggregate, zend_class_entry *class_entry_Countable)
{
	...
	zend_string *property_length_name = zend_string_init_interned("length", sizeof("length") - 1, 1);
...
static zend_class_entry *register_class_DOMCharacterData(zend_class_entry *class_entry_DOMNode, zend_class_entry *class_entry_DOMChildNode)
{
	...
	zend_string *property_previousElementSibling_name = zend_string_init_interned("previousElementSibling", sizeof("previousElementSibling") - 1, 1);
	...
	zend_string *property_nextElementSibling_name = zend_string_init_interned("nextElementSibling", sizeof("nextElementSibling") - 1, 1);
...
static zend_class_entry *register_class_DOMAttr(zend_class_entry *class_entry_DOMNode)
{
	...
	zend_string *property_specified_name = zend_string_init_interned("specified", sizeof("specified") - 1, 1);
	...
	zend_string *property_ownerElement_name = zend_string_init_interned("ownerElement", sizeof("ownerElement") - 1, 1);
	...
	zend_string *property_schemaTypeInfo_name = zend_string_init_interned("schemaTypeInfo", sizeof("schemaTypeInfo") - 1, 1);
...
static zend_class_entry *register_class_DOMElement(zend_class_entry *class_entry_DOMNode, zend_class_entry *class_entry_DOMParentNode, zend_class_entry *class_entry_DOMChildNode)
{
	...
	zend_string *property_tagName_name = zend_string_init_interned("tagName", sizeof("tagName") - 1, 1);
	...
	zend_string *property_className_name = zend_string_init_interned("className", sizeof("className") - 1, 1);
...
static zend_class_entry *register_class_DOMDocument(zend_class_entry *class_entry_DOMNode, zend_class_entry *class_entry_DOMParentNode)
{
	...
	zend_string *property_doctype_name = zend_string_init_interned("doctype", sizeof("doctype") - 1, 1);
	...
	zend_string *property_implementation_name = zend_string_init_interned("implementation", sizeof("implementation") - 1, 1);
	...
	zend_string *property_documentElement_name = zend_string_init_interned("documentElement", sizeof("documentElement") - 1, 1);
	...
	zend_string *property_actualEncoding_name = zend_string_init_interned("actualEncoding", sizeof("actualEncoding") - 1, 1);
	...
	zend_string *property_encoding_name = zend_string_init_interned("encoding", sizeof("encoding") - 1, 1);
	...
	zend_string *property_xmlEncoding_name = zend_string_init_interned("xmlEncoding", sizeof("xmlEncoding") - 1, 1);
	...
	zend_string *property_standalone_name = zend_string_init_interned("standalone", sizeof("standalone") - 1, 1);
	...
	zend_string *property_xmlStandalone_name = zend_string_init_interned("xmlStandalone", sizeof("xmlStandalone") - 1, 1);
	...
	zend_string *property_version_name = zend_string_init_interned("version", sizeof("version") - 1, 1);
	...
	zend_string *property_xmlVersion_name = zend_string_init_interned("xmlVersion", sizeof("xmlVersion") - 1, 1);
	...
	zend_string *property_strictErrorChecking_name = zend_string_init_interned("strictErrorChecking", sizeof("strictErrorChecking") - 1, 1);
	...
	zend_string *property_documentURI_name = zend_string_init_interned("documentURI", sizeof("documentURI") - 1, 1);
	...
	zend_string *property_config_name = zend_string_init_interned("config", sizeof("config") - 1, 1);
	...
	zend_string *property_formatOutput_name = zend_string_init_interned("formatOutput", sizeof("formatOutput") - 1, 1);
	...
	zend_string *property_validateOnParse_name = zend_string_init_interned("validateOnParse", sizeof("validateOnParse") - 1, 1);
	...
	zend_string *property_resolveExternals_name = zend_string_init_interned("resolveExternals", sizeof("resolveExternals") - 1, 1);
	...
	zend_string *property_preserveWhiteSpace_name = zend_string_init_interned("preserveWhiteSpace", sizeof("preserveWhiteSpace") - 1, 1);
	...
	zend_string *property_recover_name = zend_string_init_interned("recover", sizeof("recover") - 1, 1);
	...
	zend_string *property_substituteEntities_name = zend_string_init_interned("substituteEntities", sizeof("substituteEntities") - 1, 1);
...
static zend_class_entry *register_class_DOMText(zend_class_entry *class_entry_DOMCharacterData)
{
	...
	zend_string *property_wholeText_name = zend_string_init_interned("wholeText", sizeof("wholeText") - 1, 1);
...
static zend_class_entry *register_class_DOMEntity(zend_class_entry *class_entry_DOMNode)
{
	...
	zend_string *property_notationName_name = zend_string_init_interned("notationName", sizeof("notationName") - 1, 1);
...
static zend_class_entry *register_class_DOMProcessingInstruction(zend_class_entry *class_entry_DOMNode)
{
	...
	zend_string *property_target_name = zend_string_init_interned("target", sizeof("target") - 1, 1);
...
static zend_class_entry *register_class_DOMXPath(void)
{
	...
	zend_string *property_document_name = zend_string_init_interned("document", sizeof("document") - 1, 1);
	...
	zend_string *property_registerNodeNamespaces_name = zend_string_init_interned("registerNodeNamespaces", sizeof("registerNodeNamespaces") - 1, 1);
...
static zend_class_entry *register_class_Dom_Element(zend_class_entry *class_entry_Dom_Node, zend_class_entry *class_entry_Dom_ParentNode, zend_class_entry *class_entry_Dom_ChildNode)
{
	...
	zend_string *property_children_name = zend_string_init_interned("children", sizeof("children") - 1, 1);
	...
	zend_string *property_classList_name = zend_string_init_interned("classList", sizeof("classList") - 1, 1);
	...
	zend_string *property_innerHTML_name = zend_string_init_interned("innerHTML", sizeof("innerHTML") - 1, 1);
	...
	zend_string *property_outerHTML_name = zend_string_init_interned("outerHTML", sizeof("outerHTML") - 1, 1);
	...
	zend_string *property_substitutedNodeValue_name = zend_string_init_interned("substitutedNodeValue", sizeof("substitutedNodeValue") - 1, 1);
...
static zend_class_entry *register_class_Dom_Document(zend_class_entry *class_entry_Dom_Node, zend_class_entry *class_entry_Dom_ParentNode)
{
	...
	zend_string *property_URL_name = zend_string_init_interned("URL", sizeof("URL") - 1, 1);
	...
	zend_string *property_characterSet_name = zend_string_init_interned("characterSet", sizeof("characterSet") - 1, 1);
	...
	zend_string *property_charset_name = zend_string_init_interned("charset", sizeof("charset") - 1, 1);
	...
	zend_string *property_inputEncoding_name = zend_string_init_interned("inputEncoding", sizeof("inputEncoding") - 1, 1);
	...
	zend_string *property_body_name = zend_string_init_interned("body", sizeof("body") - 1, 1);
	...
	zend_string *property_head_name = zend_string_init_interned("head", sizeof("head") - 1, 1);
	...
	zend_string *property_title_name = zend_string_init_interned("title", sizeof("title") - 1, 1);
...
static zend_class_entry *register_class_Dom_NamespaceInfo(void)
{
	...
	zend_string *property_element_name = zend_string_init_interned("element", sizeof("element") - 1, 1);
