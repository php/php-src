...
/* {{{ arginfo */
ZEND_BEGIN_ARG_INFO(arginfo_dom_implementation_get_feature, 0)
...
ZEND_BEGIN_ARG_INFO(arginfo_dom_implementation_create_documenttype, 0)
	ZEND_ARG_INFO(0, qualifiedName)
	ZEND_ARG_INFO(0, publicId)
	ZEND_ARG_INFO(0, systemId)
ZEND_END_ARG_INFO();

ZEND_BEGIN_ARG_INFO(arginfo_dom_implementation_create_document, 0)
