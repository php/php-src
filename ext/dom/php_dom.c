...
PHP_MINIT_FUNCTION(dom)
{
	...
	dom_modern_nodelist_class_entry->default_object_handlers = &dom_nodelist_object_handlers;
	...
	dom_modern_namednodemap_class_entry->default_object_handlers = &dom_nnodemap_object_handlers;
