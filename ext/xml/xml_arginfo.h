...
static const zend_function_entry ext_functions[] = {
	...
	ZEND_RAW_FENTRY("xml_set_object", zif_xml_set_object, arginfo_xml_set_object, 0, NULL)
	...
	ZEND_RAW_FENTRY("xml_parser_free", zif_xml_parser_free, arginfo_xml_parser_free, 0, NULL)
