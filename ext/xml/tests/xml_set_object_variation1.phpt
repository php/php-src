...
Warning: xml_set_object() expects parameter 1 to be resource, int given in %s on line %d
NULL
...
Warning: xml_set_object() expects parameter 1 to be resource, bool given in %s on line %d
NULL
