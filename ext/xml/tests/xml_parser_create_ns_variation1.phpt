...
Warning: xml_parser_create_ns() expects parameter 1 to be binary string, array given in %s on line %d
bool(false)
...
Warning: xml_parser_create_ns() expects parameter 1 to be binary string, resource given in %s on line %d
bool(false)
