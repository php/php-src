...
ZEND_BEGIN_ARG_INFO(arginfo_xml_set_object, 0)
	ZEND_ARG_INFO(0, parser)
	ZEND_ARG_INFO(0, obj)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_xml_set_element_handler, 0)
	ZEND_ARG_INFO(0, parser)
	ZEND_ARG_INFO(0, shdl)
	ZEND_ARG_INFO(0, ehdl)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_xml_set_character_data_handler, 0)
	ZEND_ARG_INFO(0, parser)
	ZEND_ARG_INFO(0, hdl)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_xml_set_processing_instruction_handler, 0)
	ZEND_ARG_INFO(0, parser)
	ZEND_ARG_INFO(0, hdl)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_xml_set_default_handler, 0)
	ZEND_ARG_INFO(0, parser)
	ZEND_ARG_INFO(0, hdl)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_xml_set_unparsed_entity_decl_handler, 0)
	ZEND_ARG_INFO(0, parser)
	ZEND_ARG_INFO(0, hdl)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_xml_set_notation_decl_handler, 0)
	ZEND_ARG_INFO(0, parser)
	ZEND_ARG_INFO(0, hdl)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_xml_set_external_entity_ref_handler, 0)
	ZEND_ARG_INFO(0, parser)
	ZEND_ARG_INFO(0, hdl)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_xml_set_start_namespace_decl_handler, 0)
	ZEND_ARG_INFO(0, parser)
	ZEND_ARG_INFO(0, hdl)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_xml_set_end_namespace_decl_handler, 0)
	ZEND_ARG_INFO(0, parser)
	ZEND_ARG_INFO(0, hdl)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(arginfo_xml_parser_set_option, 0)
	ZEND_ARG_INFO(0, parser)
