...
PHPAPI char *xml_utf8_decode(const XML_Char *, php_size_t, php_size_t *, const XML_Char *);
PHPAPI char *xml_utf8_encode(const char *s, php_size_t len, php_size_t *newlen, const XML_Char *encoding);
