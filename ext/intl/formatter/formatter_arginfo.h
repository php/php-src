...
static const zend_function_entry class_NumberFormatter_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_NumberFormatter___construct, arginfo_class_NumberFormatter___construct, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("create", zif_numfmt_create, arginfo_class_NumberFormatter_create, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("format", zif_numfmt_format, arginfo_class_NumberFormatter_format, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("parse", zif_numfmt_parse, arginfo_class_NumberFormatter_parse, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("formatCurrency", zif_numfmt_format_currency, arginfo_class_NumberFormatter_formatCurrency, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("parseCurrency", zif_numfmt_parse_currency, arginfo_class_NumberFormatter_parseCurrency, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setAttribute", zif_numfmt_set_attribute, arginfo_class_NumberFormatter_setAttribute, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getAttribute", zif_numfmt_get_attribute, arginfo_class_NumberFormatter_getAttribute, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setTextAttribute", zif_numfmt_set_text_attribute, arginfo_class_NumberFormatter_setTextAttribute, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getTextAttribute", zif_numfmt_get_text_attribute, arginfo_class_NumberFormatter_getTextAttribute, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setSymbol", zif_numfmt_set_symbol, arginfo_class_NumberFormatter_setSymbol, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getSymbol", zif_numfmt_get_symbol, arginfo_class_NumberFormatter_getSymbol, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setPattern", zif_numfmt_set_pattern, arginfo_class_NumberFormatter_setPattern, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getPattern", zif_numfmt_get_pattern, arginfo_class_NumberFormatter_getPattern, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getLocale", zif_numfmt_get_locale, arginfo_class_NumberFormatter_getLocale, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getErrorCode", zif_numfmt_get_error_code, arginfo_class_NumberFormatter_getErrorCode, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getErrorMessage", zif_numfmt_get_error_message, arginfo_class_NumberFormatter_getErrorMessage, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};
