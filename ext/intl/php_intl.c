...
ZEND_BEGIN_ARG_INFO(collator_sort_with_sort_keys_args, 0)
...
ZEND_BEGIN_ARG_INFO(locale_1_arg, 0)
	ZEND_ARG_INFO(0, arg1)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(grapheme_1_arg, 0)
	ZEND_ARG_INFO(0, string)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(arginfo_numfmt_get_error_code, 0)
	ZEND_ARG_INFO(0, nf)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(arginfo_numfmt_format_currency, 0)
	ZEND_ARG_INFO(0, nf)
	ZEND_ARG_INFO(0, num)
	ZEND_ARG_INFO(0, currency)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_numfmt_get_attribute, 0)
	ZEND_ARG_INFO(0, nf)
	ZEND_ARG_INFO(0, attr)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_numfmt_set_attribute, 0)
	ZEND_ARG_INFO(0, nf)
	ZEND_ARG_INFO(0, attr)
	ZEND_ARG_INFO(0, value)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_numfmt_set_symbol, 0)
	ZEND_ARG_INFO(0, nf)
	ZEND_ARG_INFO(0, attr)
	ZEND_ARG_INFO(0, symbol)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_numfmt_set_pattern, 0)
	ZEND_ARG_INFO(0, nf)
	ZEND_ARG_INFO(0, pattern)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(arginfo_msgfmt_create, 0)
	ZEND_ARG_INFO(0, locale)
	ZEND_ARG_INFO(0, pattern)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_msgfmt_get_error_code, 0)
	ZEND_ARG_INFO(0, nf)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_msgfmt_get_error_message, 0)
	ZEND_ARG_INFO(0, coll)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_msgfmt_format, 0)
	ZEND_ARG_INFO(0, nf)
	ZEND_ARG_INFO(0, args)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_msgfmt_format_message, 0)
	ZEND_ARG_INFO(0, locale)
	ZEND_ARG_INFO(0, pattern)
	ZEND_ARG_INFO(0, args)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_msgfmt_parse, 0)
	ZEND_ARG_INFO(0, nf)
	ZEND_ARG_INFO(0, source)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_numfmt_parse_message, 0)
	ZEND_ARG_INFO(0, locale)
	ZEND_ARG_INFO(0, pattern)
	ZEND_ARG_INFO(0, source)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_msgfmt_set_pattern, 0)
	ZEND_ARG_INFO(0, mf)
	ZEND_ARG_INFO(0, pattern)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_msgfmt_get_locale, 0)
	ZEND_ARG_INFO(0, mf)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_datefmt_set_pattern, 0)
	ZEND_ARG_INFO(0, mf)
	ZEND_ARG_INFO(0, pattern)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_datefmt_set_timezone, 0)
	ZEND_ARG_INFO(0, mf)
	ZEND_ARG_INFO(0, timezone)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_datefmt_set_calendar, 0)
	ZEND_ARG_INFO(0, mf)
...
ZEND_BEGIN_ARG_INFO(arginfo_resourcebundle_count_proc, 0)
  ZEND_ARG_INFO( 0, bundle )
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_resourcebundle_locales_proc, 0)
	ZEND_ARG_INFO( 0, bundlename )
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_resourcebundle_get_error_code_proc, 0)
  ZEND_ARG_INFO( 0, bundle )
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_resourcebundle_get_error_message_proc, 0)
  ZEND_ARG_INFO( 0, bundle )
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(arginfo_transliterator_create_inverse, 0)
...
ZEND_BEGIN_ARG_INFO(arginfo_transliterator_error, 0)
...
ZEND_BEGIN_ARG_INFO(arginfo_tz_from_date_time_zone, 0)
...
ZEND_BEGIN_ARG_INFO(arginfo_tz_get_equivalent_id, 0)
	ZEND_ARG_INFO( 0, zoneId )
	ZEND_ARG_INFO( 0, index )
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_tz_get_offset, 0)
...
ZEND_BEGIN_ARG_INFO(arginfo_tz_only_tz, 0)
	ZEND_ARG_OBJ_INFO( 0, timeZone, IntlTimeZone, 0 )
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(ainfo_cal_only_cal, 0)
...
ZEND_BEGIN_ARG_INFO(ainfo_cal_field, 0)
	ZEND_ARG_OBJ_INFO( 0, calendar, IntlCalendar, 0 )
	ZEND_ARG_INFO( 0, field )
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(ainfo_cal_dow, 0)
	ZEND_ARG_OBJ_INFO( 0, calendar, IntlCalendar, 0 )
	ZEND_ARG_INFO( 0, dayOfWeek )
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(ainfo_cal_other_cal, 0)
	ZEND_ARG_OBJ_INFO( 0, calendar, IntlCalendar, 0 )
	ZEND_ARG_OBJ_INFO( 0, otherCalendar, IntlCalendar, 0 )
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(ainfo_cal_date, 0)
	ZEND_ARG_OBJ_INFO( 0, calendar, IntlCalendar, 0 )
	ZEND_ARG_INFO( 0, date )
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(ainfo_cal_date_optional, 0)
	ZEND_ARG_OBJ_INFO( 0, calendar, IntlCalendar, 0 )
	ZEND_ARG_INFO( 0, date )
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(ainfo_cal_get_keyword_values_for_locale, 0)
	ZEND_ARG_INFO( 0, key )
	ZEND_ARG_INFO( 0, locale )
	ZEND_ARG_INFO( 0, commonlyUsed )
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(ainfo_cal_add, 0)
	ZEND_ARG_OBJ_INFO( 0, calendar, IntlCalendar, 0 )
	ZEND_ARG_INFO( 0, field )
	ZEND_ARG_INFO( 0, amount )
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(ainfo_cal_set_time_zone, 0)
	ZEND_ARG_OBJ_INFO( 0, calendar, IntlCalendar, 0 )
	ZEND_ARG_INFO( 0, timeZone )
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(ainfo_cal_field_difference, 0)
	ZEND_ARG_OBJ_INFO( 0, calendar, IntlCalendar, 0 )
	ZEND_ARG_INFO( 0, when )
	ZEND_ARG_INFO( 0, field )
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(ainfo_cal_get_locale, 0)
	ZEND_ARG_OBJ_INFO( 0, calendar, IntlCalendar, 0 )
	ZEND_ARG_INFO( 0, localeType )
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(ainfo_cal_set_lenient, 0)
	ZEND_ARG_OBJ_INFO( 0, calendar, IntlCalendar, 0 )
	ZEND_ARG_INFO( 0, isLenient )
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(ainfo_cal_set_minimal_days_in_first_week, 0)
	ZEND_ARG_OBJ_INFO( 0, calendar, IntlCalendar, 0 )
	ZEND_ARG_INFO( 0, numberOfDays )
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(ainfo_cal_from_date_time, 0)
	ZEND_ARG_INFO(0, dateTime)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(ainfo_cal_wall_time_option, 0)
	ZEND_ARG_OBJ_INFO( 0, calendar, IntlCalendar, 0 )
...
ZEND_BEGIN_ARG_INFO(ainfo_gregcal_is_leap_year, 0)
	ZEND_ARG_OBJ_INFO( 0, calendar, IntlGregorianCalendar, 0 )
	ZEND_ARG_INFO( 0, year )
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(ainfo_gregcal_only_gregcal, 0)
	ZEND_ARG_OBJ_INFO( 0, calendar, IntlGregorianCalendar, 0 )
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(ainfo_gregcal_set_gregorian_change, 0)
	ZEND_ARG_OBJ_INFO( 0, calendar, IntlGregorianCalendar, 0 )
	ZEND_ARG_INFO( 0, date )
ZEND_END_ARG_INFO()
