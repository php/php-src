...
class IntlTimeZone
{
    ...
    /** @return IntlIterator|false */
    public static function createTimeZoneIDEnumeration(int $zoneType, ?string $region = null, ?int $rawOffset = 0) {}
    ...
    /** @return bool */
    public function getOffset(float $date, bool $local, &$rawOffset = null, &$dstOffset = null) {}
...
/** @return IntlIterator|false */
function intltz_create_time_zone_id_enumeration(int $zoneType, ?string $region = null, ?int $rawOffset = 0) {}
...
function intltz_get_offset(IntlTimeZone $tz, float $date, bool $local, &$rawOffset = null, &$dstOffset = null): bool {}
...
/** @return string|false */
function getIDForWindowsID(string $timezone, string $region = "") {}
#endif
