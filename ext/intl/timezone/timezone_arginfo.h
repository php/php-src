...
ZEND_BEGIN_ARG_INFO_EX(arginfo_class_IntlTimeZone_getOffset, 0, 0, 2)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_intltz_get_offset, 0, 3, _IS_BOOL, 0)
	ZEND_ARG_OBJ_INFO(0, tz, IntlTimeZone, 0)
	ZEND_ARG_TYPE_INFO(0, date, IS_DOUBLE, 0)
	ZEND_ARG_TYPE_INFO(0, local, _IS_BOOL, 0)
	ZEND_ARG_INFO(1, rawOffset)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_intltz_get_tz_data_version, 0, 0, IS_STRING, 0)
ZEND_END_ARG_INFO()
...
#if U_ICU_VERSION_MAJOR_NUM >= 52
#define arginfo_getIDForWindowsID arginfo_class_IntlTimeZone_getIDForWindowsID
#endif
