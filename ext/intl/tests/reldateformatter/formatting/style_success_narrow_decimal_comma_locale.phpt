--TEST--
Test IntlRelativeDateTimeFormatter formatting - narrow style - locale with a decimal comma
--EXTENSIONS--
intl
--FILE--
<?php
...
printRelativeDateTimeTable(
    new IntlRelativeDateTimeFormatter('de_DE', IntlRelativeDateTimeFormatter::STYLE_NARROW),
...
offset  format          formatNumeric
------  --------------  --------------
 -2.75  vor 2,75 m      vor 2,75 m
 -1.75  vor 1,75 m      vor 1,75 m
  -1.5  vor 1,5 m       vor 1,5 m
   1.5  in 1,5 m        in 1,5 m
  1.75  in 1,75 m       in 1,75 m
  2.75  in 2,75 m       in 2,75 m
