...
--EXPECT--
int(4096)
string(109) "Argument 1 passed to IntlTimeZone::hasSameRules() must be an instance of the class IntlTimeZone, string given"
int(2)
...
bool(false)
int(4096)
string(102) "Argument 1 passed to intltz_has_same_rules() must be an instance of the class IntlTimeZone, null given"
int(2)
