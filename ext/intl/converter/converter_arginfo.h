...
static const zend_function_entry class_UConverter_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_UConverter___construct, arginfo_class_UConverter___construct, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("convert", zim_UConverter_convert, arginfo_class_UConverter_convert, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fromUCallback", zim_UConverter_fromUCallback, arginfo_class_UConverter_fromUCallback, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getAliases", zim_UConverter_getAliases, arginfo_class_UConverter_getAliases, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("getAvailable", zim_UConverter_getAvailable, arginfo_class_UConverter_getAvailable, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("getDestinationEncoding", zim_UConverter_getDestinationEncoding, arginfo_class_UConverter_getDestinationEncoding, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getDestinationType", zim_UConverter_getDestinationType, arginfo_class_UConverter_getDestinationType, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getErrorCode", zim_UConverter_getErrorCode, arginfo_class_UConverter_getErrorCode, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getErrorMessage", zim_UConverter_getErrorMessage, arginfo_class_UConverter_getErrorMessage, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getSourceEncoding", zim_UConverter_getSourceEncoding, arginfo_class_UConverter_getSourceEncoding, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getSourceType", zim_UConverter_getSourceType, arginfo_class_UConverter_getSourceType, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getStandards", zim_UConverter_getStandards, arginfo_class_UConverter_getStandards, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("getSubstChars", zim_UConverter_getSubstChars, arginfo_class_UConverter_getSubstChars, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("reasonText", zim_UConverter_reasonText, arginfo_class_UConverter_reasonText, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("setDestinationEncoding", zim_UConverter_setDestinationEncoding, arginfo_class_UConverter_setDestinationEncoding, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setSourceEncoding", zim_UConverter_setSourceEncoding, arginfo_class_UConverter_setSourceEncoding, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setSubstChars", zim_UConverter_setSubstChars, arginfo_class_UConverter_setSubstChars, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("toUCallback", zim_UConverter_toUCallback, arginfo_class_UConverter_toUCallback, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("transcode", zim_UConverter_transcode, arginfo_class_UConverter_transcode, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_FE_END
};
