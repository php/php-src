...
/* {{{ arginfo */
ZEND_BEGIN_ARG_INFO(arginfo_messageformatter___construct, 0)
...
ZEND_BEGIN_ARG_INFO(arginfo_messageformatter_formatmessage, 0)
	ZEND_ARG_INFO(0, locale)
	ZEND_ARG_INFO(0, pattern)
	ZEND_ARG_INFO(0, args)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_messageformatter_format, 0)
	ZEND_ARG_INFO(0, args)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_messageformatter_setpattern, 0)
	ZEND_ARG_INFO(0, pattern)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_messageformatter_parse, 0)
