...
static const zend_function_entry class_MessageFormatter_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_MessageFormatter___construct, arginfo_class_MessageFormatter___construct, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("create", zif_msgfmt_create, arginfo_class_MessageFormatter_create, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("format", zif_msgfmt_format, arginfo_class_MessageFormatter_format, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("formatMessage", zif_msgfmt_format_message, arginfo_class_MessageFormatter_formatMessage, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("parse", zif_msgfmt_parse, arginfo_class_MessageFormatter_parse, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("parseMessage", zif_msgfmt_parse_message, arginfo_class_MessageFormatter_parseMessage, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("setPattern", zif_msgfmt_set_pattern, arginfo_class_MessageFormatter_setPattern, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getPattern", zif_msgfmt_get_pattern, arginfo_class_MessageFormatter_getPattern, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getLocale", zif_msgfmt_get_locale, arginfo_class_MessageFormatter_getLocale, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getErrorCode", zif_msgfmt_get_error_code, arginfo_class_MessageFormatter_getErrorCode, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getErrorMessage", zif_msgfmt_get_error_message, arginfo_class_MessageFormatter_getErrorMessage, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};
