...
static const zend_function_entry class_IntlCalendar_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_IntlCalendar___construct, arginfo_class_IntlCalendar___construct, ZEND_ACC_PRIVATE, NULL)
	ZEND_RAW_FENTRY("createInstance", zif_intlcal_create_instance, arginfo_class_IntlCalendar_createInstance, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("equals", zif_intlcal_equals, arginfo_class_IntlCalendar_equals, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fieldDifference", zif_intlcal_field_difference, arginfo_class_IntlCalendar_fieldDifference, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("add", zif_intlcal_add, arginfo_class_IntlCalendar_add, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("after", zif_intlcal_after, arginfo_class_IntlCalendar_after, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("before", zif_intlcal_before, arginfo_class_IntlCalendar_before, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("clear", zif_intlcal_clear, arginfo_class_IntlCalendar_clear, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fromDateTime", zif_intlcal_from_date_time, arginfo_class_IntlCalendar_fromDateTime, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("get", zif_intlcal_get, arginfo_class_IntlCalendar_get, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getActualMaximum", zif_intlcal_get_actual_maximum, arginfo_class_IntlCalendar_getActualMaximum, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getActualMinimum", zif_intlcal_get_actual_minimum, arginfo_class_IntlCalendar_getActualMinimum, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getAvailableLocales", zif_intlcal_get_available_locales, arginfo_class_IntlCalendar_getAvailableLocales, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("getDayOfWeekType", zif_intlcal_get_day_of_week_type, arginfo_class_IntlCalendar_getDayOfWeekType, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getErrorCode", zif_intlcal_get_error_code, arginfo_class_IntlCalendar_getErrorCode, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getErrorMessage", zif_intlcal_get_error_message, arginfo_class_IntlCalendar_getErrorMessage, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getFirstDayOfWeek", zif_intlcal_get_first_day_of_week, arginfo_class_IntlCalendar_getFirstDayOfWeek, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getGreatestMinimum", zif_intlcal_get_greatest_minimum, arginfo_class_IntlCalendar_getGreatestMinimum, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getKeywordValuesForLocale", zif_intlcal_get_keyword_values_for_locale, arginfo_class_IntlCalendar_getKeywordValuesForLocale, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("getLeastMaximum", zif_intlcal_get_least_maximum, arginfo_class_IntlCalendar_getLeastMaximum, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getLocale", zif_intlcal_get_locale, arginfo_class_IntlCalendar_getLocale, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getMaximum", zif_intlcal_get_maximum, arginfo_class_IntlCalendar_getMaximum, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getMinimalDaysInFirstWeek", zif_intlcal_get_minimal_days_in_first_week, arginfo_class_IntlCalendar_getMinimalDaysInFirstWeek, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setMinimalDaysInFirstWeek", zif_intlcal_set_minimal_days_in_first_week, arginfo_class_IntlCalendar_setMinimalDaysInFirstWeek, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getMinimum", zif_intlcal_get_minimum, arginfo_class_IntlCalendar_getMinimum, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getNow", zif_intlcal_get_now, arginfo_class_IntlCalendar_getNow, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("getRepeatedWallTimeOption", zif_intlcal_get_repeated_wall_time_option, arginfo_class_IntlCalendar_getRepeatedWallTimeOption, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getSkippedWallTimeOption", zif_intlcal_get_skipped_wall_time_option, arginfo_class_IntlCalendar_getSkippedWallTimeOption, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getTime", zif_intlcal_get_time, arginfo_class_IntlCalendar_getTime, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getTimeZone", zif_intlcal_get_time_zone, arginfo_class_IntlCalendar_getTimeZone, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getType", zif_intlcal_get_type, arginfo_class_IntlCalendar_getType, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getWeekendTransition", zif_intlcal_get_weekend_transition, arginfo_class_IntlCalendar_getWeekendTransition, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("inDaylightTime", zif_intlcal_in_daylight_time, arginfo_class_IntlCalendar_inDaylightTime, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("isEquivalentTo", zif_intlcal_is_equivalent_to, arginfo_class_IntlCalendar_isEquivalentTo, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("isLenient", zif_intlcal_is_lenient, arginfo_class_IntlCalendar_isLenient, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("isWeekend", zif_intlcal_is_weekend, arginfo_class_IntlCalendar_isWeekend, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("roll", zif_intlcal_roll, arginfo_class_IntlCalendar_roll, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("isSet", zif_intlcal_is_set, arginfo_class_IntlCalendar_isSet, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("set", zif_intlcal_set, arginfo_class_IntlCalendar_set, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setDate", zim_IntlCalendar_setDate, arginfo_class_IntlCalendar_setDate, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setDateTime", zim_IntlCalendar_setDateTime, arginfo_class_IntlCalendar_setDateTime, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setFirstDayOfWeek", zif_intlcal_set_first_day_of_week, arginfo_class_IntlCalendar_setFirstDayOfWeek, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setLenient", zif_intlcal_set_lenient, arginfo_class_IntlCalendar_setLenient, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setRepeatedWallTimeOption", zif_intlcal_set_repeated_wall_time_option, arginfo_class_IntlCalendar_setRepeatedWallTimeOption, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setSkippedWallTimeOption", zif_intlcal_set_skipped_wall_time_option, arginfo_class_IntlCalendar_setSkippedWallTimeOption, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setTime", zif_intlcal_set_time, arginfo_class_IntlCalendar_setTime, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setTimeZone", zif_intlcal_set_time_zone, arginfo_class_IntlCalendar_setTimeZone, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("toDateTime", zif_intlcal_to_date_time, arginfo_class_IntlCalendar_toDateTime, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};

static const zend_function_entry class_IntlGregorianCalendar_methods[] = {
	ZEND_RAW_FENTRY("createFromDate", zim_IntlGregorianCalendar_createFromDate, arginfo_class_IntlGregorianCalendar_createFromDate, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("createFromDateTime", zim_IntlGregorianCalendar_createFromDateTime, arginfo_class_IntlGregorianCalendar_createFromDateTime, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("__construct", zim_IntlGregorianCalendar___construct, arginfo_class_IntlGregorianCalendar___construct, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setGregorianChange", zif_intlgregcal_set_gregorian_change, arginfo_class_IntlGregorianCalendar_setGregorianChange, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getGregorianChange", zif_intlgregcal_get_gregorian_change, arginfo_class_IntlGregorianCalendar_getGregorianChange, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("isLeapYear", zif_intlgregcal_is_leap_year, arginfo_class_IntlGregorianCalendar_isLeapYear, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};
