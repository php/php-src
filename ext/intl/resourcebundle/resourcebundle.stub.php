...
{
    public function __construct(?string $locale, ?string $path, bool $fallback = true) {}

    /**
     * @return ResourceBundle|null
     * @alias resourcebundle_create
     */
    public static function create(?string $locale, ?string $path, bool $fallback = true) {}
     ...
     */
    public static function getLocales(string $path) {}
