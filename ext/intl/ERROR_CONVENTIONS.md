...
Objects store an intl_error structured in their private data. For instance:
...
by passing a pointer to the object's `intl_error` structured as the first parameter.
