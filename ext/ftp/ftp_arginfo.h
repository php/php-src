 ...
 * Stub hash: 42ce274f711a6db22d57cf8b1c689846fcb21118 */
...
static zend_class_entry *register_class_FTP_Connection(void)
{
	...
	zend_string *attribute_name_NonInstantiableClass_class_FTP_Connection_0 = zend_string_init_interned("NonInstantiableClass", sizeof("NonInstantiableClass") - 1, true);
	zend_attribute *attribute_NonInstantiableClass_class_FTP_Connection_0 = zend_add_class_attribute(class_entry, attribute_name_NonInstantiableClass_class_FTP_Connection_0, 1);
	zend_string_release_ex(attribute_name_NonInstantiableClass_class_FTP_Connection_0, true);
	zend_string *attribute_NonInstantiableClass_class_FTP_Connection_0_arg0_str = zend_string_init("Cannot directly construct FTP\\Connection, use ftp_connect() or ftp_ssl_connect() instead", strlen("Cannot directly construct FTP\\Connection, use ftp_connect() or ftp_ssl_connect() instead"), 1);
	ZVAL_STR(&attribute_NonInstantiableClass_class_FTP_Connection_0->args[0].value, attribute_NonInstantiableClass_class_FTP_Connection_0_arg0_str);
