...
static void register_ftp_symbols(int module_number)
{
	...
	zend_add_parameter_attribute((zend_function *)zend_hash_str_find_ptr(CG(function_table), "ftp_login", sizeof("ftp_login") - 1), 2, ZSTR_KNOWN(ZEND_STR_SENSITIVEPARAMETER), 0);
}
