 ...
 * Stub hash: dafab5db09b7346c71140a70c94a20cab172c428 */
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_ftp_fget, 0, 3, _IS_BOOL, 0)
	...
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, resume_position, IS_LONG, 0, "0")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_ftp_fput, 0, 3, _IS_BOOL, 0)
	...
	ZEND_ARG_INFO(0, stream)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, mode, IS_LONG, 0, "FTP_BINARY")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, start_position, IS_LONG, 0, "0")
ZEND_END_ARG_INFO()
