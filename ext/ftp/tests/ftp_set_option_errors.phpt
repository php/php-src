...
?>
--EXPECT--
ftp_set_option(): Argument #3 ($value) must be greater than 0
...
ftp_set_option(): Argument #2 ($option) must be either FTP_TIMEOUT_SEC, FTP_USEPASVADDRESS, or FTP_AUTOSEEK
