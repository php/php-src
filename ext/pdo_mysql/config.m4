...
if test "$PHP_PDO_MYSQL" != "no"; then
  ...
  PHP_NEW_EXTENSION(pdo_mysql, pdo_mysql.c pdo_mysql_class.c mysql_driver.c mysql_statement.c, $ext_shared,,-I$pdo_cv_inc_path -DZEND_ENABLE_STATIC_TSRMLS_CACHE=1)
