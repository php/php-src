...
?>
--EXPECTF--
Warning: PDO::exec(): SQLSTATE[HY000]: General error: 2068 LOAD DATA LOCAL INFILE DIRECTORY restriction in effect. Unable to open file in %s on line %d
done!
