--TEST--
Test session_set_serializer() function : variation1
--INI--
...
var_dump(session_set_serializer("no_encode", "decode"));
...
Recoverable fatal error: session_set_serializer(): Argument 1 is not a valid callback in %s on line 26