...
var_dump(session_set_serializer("bad_encode", "decode"));
...
Recoverable fatal error: session_write_close(): Session decode callback expects string or FALSE return value in %s on line 42
