...
$uri = \Uri\Uri::fromRfc3986("https://username:password@www.google.com:8080/pathname1/pathname2/pathname3?query=true#hash-exists");
callGetters($uri);

echo "\n";

$uri = Uri\Uri::fromWhatWg("https://username:password@www.google.com:8080/pathname1/pathname2/pathname3?query=true#hash-exists");
callGetters($uri);
