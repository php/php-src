 ...
 * Stub hash: f4a0b4c96a3c687f0113a7d55429adaac9d7e234 */
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_class_Uri_Uri___construct, 0, 0, 2)
	...
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, fragment, IS_STRING, 1, "null")
ZEND_END_ARG_INFO()
...
ZEND_METHOD(Uri_Uri, __construct);
...
static const zend_function_entry class_Uri_Uri_methods[] = {
	...
	ZEND_ME(Uri_Uri, __construct, arginfo_class_Uri_Uri___construct, ZEND_ACC_PUBLIC)
...
static zend_class_entry *register_class_Uri_Uri(zend_class_entry *class_entry_Stringable)
{
	zend_class_entry ce, *class_entry;
