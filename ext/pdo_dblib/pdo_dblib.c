...
PHP_MINIT_FUNCTION(pdo_dblib)
{
	...
	REGISTER_PDO_CLASS_CONST_LONG("DBLIB_ATTR_DATETIME_FORMAT", (long) PDO_DBLIB_ATTR_DATETIME_FORMAT);
	REGISTER_PDO_CLASS_CONST_LONG("DBLIB_DATETIME_FORMAT_DEFAULT", (long) PDO_DBLIB_DATETIME_FORMAT_DEFAULT);
	REGISTER_PDO_CLASS_CONST_LONG("DBLIB_DATETIME_FORMAT_MILLISECOND", (long) PDO_DBLIB_DATETIME_FORMAT_MILLISECOND);
	REGISTER_PDO_CLASS_CONST_LONG("DBLIB_DATETIME_FORMAT_CONVERT", (long) PDO_DBLIB_DATETIME_FORMAT_CONVERT);
