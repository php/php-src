...
static zend_class_entry *register_class_XSLTProcessor(void)
{
	...
	zend_string_release_ex(property_doXInclude_name, 1);
	...
	zend_string_release_ex(property_cloneDocument_name, 1);
	...
	zend_string_release_ex(property_maxTemplateDepth_name, 1);
	...
	zend_string_release_ex(property_maxTemplateVars_name, 1);
