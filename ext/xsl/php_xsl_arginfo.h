...
static zend_class_entry *register_class_XSLTProcessor(void)
{
	...
	zend_string *property_doXInclude_name = zend_string_init_interned("doXInclude", sizeof("doXInclude") - 1, 1);
	...
	zend_string *property_cloneDocument_name = zend_string_init_interned("cloneDocument", sizeof("cloneDocument") - 1, 1);
	...
	zend_string *property_maxTemplateDepth_name = zend_string_init_interned("maxTemplateDepth", sizeof("maxTemplateDepth") - 1, 1);
	...
	zend_string *property_maxTemplateVars_name = zend_string_init_interned("maxTemplateVars", sizeof("maxTemplateVars") - 1, 1);
