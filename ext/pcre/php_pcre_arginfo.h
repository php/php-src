 ...
 * Stub hash: 43d65e62a4c23a153957521e30eb0a7a12a3eb70 */
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_preg_filter, 0, 3, MAY_BE_STRING|MAY_BE_ARRAY|MAY_BE_NULL)
	ZEND_ARG_TYPE_MASK(0, pattern, MAY_BE_STRING|MAY_BE_ARRAY, NULL)
	ZEND_ARG_TYPE_MASK(0, replacement, MAY_BE_STRING|MAY_BE_ARRAY, NULL)
	ZEND_ARG_TYPE_MASK(0, subject, MAY_BE_STRING|MAY_BE_ARRAY, NULL)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, limit, IS_LONG, 0, "-1")
...
static void register_php_pcre_symbols(int module_number)
{
	...
	REGISTER_LONG_CONSTANT("PREG_REPLACE_COUNT_CHANGES", PREG_REPLACE_COUNT_CHANGES, CONST_PERSISTENT);
