 ...
 * Stub hash: 16921e0a916c7d2635ccbf691ce173a4a17aa6ea */
...
static void register_php_pcre_symbols(int module_number)
{
	...
	REGISTER_LONG_CONSTANT("PREG_THROW_ON_ERROR", PREG_THROW_ON_ERROR, CONST_PERSISTENT);
...
static zend_class_entry *register_class_PregException(zend_class_entry *class_entry_Exception)
{
	...
	INIT_CLASS_ENTRY(ce, "PregException", NULL);
