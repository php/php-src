...
Warning: date_sunrise() expects parameter 5 to be float (or integer, convertible string or boolean), array given in %s on line %d
bool(false)
...
Warning: date_sunrise() expects parameter 5 to be float (or integer, convertible string or boolean), non-numeric string given in %s on line %d
bool(false)
...
Warning: date_sunrise() expects parameter 5 to be float (or integer, convertible string or boolean), object given in %s on line %d
bool(false)
