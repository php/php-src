...
Warning: date_time_set() expects parameter 3 to be integer (or convertible float, convertible string or boolean), array given in %s on line %d
bool(false)
...
Warning: date_time_set() expects parameter 3 to be integer (or convertible float, convertible string or boolean), non-numeric string given in %s on line %d
bool(false)
...
Warning: date_time_set() expects parameter 3 to be integer (or convertible float, convertible string or boolean), object given in %s on line %d
bool(false)
...
Warning: date_time_set() expects parameter 3 to be integer (or convertible float, convertible string or boolean), resource given in %s on line %d
bool(false)
===DONE===
