...
Warning: date_default_timezone_set() expects parameter 1 to be string (or integer, float, boolean or convertible object), array given in %s on line %d
bool(false)
...
Warning: date_default_timezone_set() expects parameter 1 to be string (or integer, float, boolean or convertible object), resource given in %s on line %d
bool(false)
===Done===
