...
Warning: date_time_set() expects parameter 2 to be integer (or convertible float, convertible string or boolean), array given in %s
bool(false)
...
Warning: date_time_set() expects parameter 2 to be integer (or convertible float, convertible string or boolean), non-numeric string given in %s
bool(false)
...
Warning: date_time_set() expects parameter 2 to be integer (or convertible float, convertible string or boolean), object given in %s
bool(false)
...
Warning: date_time_set() expects parameter 2 to be integer (or convertible float, convertible string or boolean), resource given in %s
bool(false)
===DONE===
