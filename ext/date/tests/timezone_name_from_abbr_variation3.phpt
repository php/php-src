...
Warning: timezone_name_from_abbr() expects parameter 3 to be integer (or convertible float, convertible string or boolean), array given in %s on line %d
bool(false)
...
Warning: timezone_name_from_abbr() expects parameter 3 to be integer (or convertible float, convertible string or boolean), object given in %s on line %d
bool(false)
...
Warning: timezone_name_from_abbr() expects parameter 3 to be integer (or convertible float, convertible string or boolean), resource given in %s on line %d
bool(false)
===DONE===
