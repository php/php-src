...
Warning: timezone_transitions_get() expects parameter 3 to be integer (or convertible float, convertible string or boolean), array given in %s on line %d
string(7) "boolean"
...
Warning: timezone_transitions_get() expects parameter 3 to be integer (or convertible float, convertible string or boolean), object given in %s on line %d
string(7) "boolean"
...
Warning: timezone_transitions_get() expects parameter 3 to be integer (or convertible float, convertible string or boolean), resource given in %s on line %d
string(7) "boolean"
