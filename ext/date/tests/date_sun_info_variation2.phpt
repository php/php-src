...
Warning: date_sun_info() expects parameter 2 to be float (or integer, convertible string or boolean), array given in %s on line %d
bool(false)
...
Warning: date_sun_info() expects parameter 2 to be float (or integer, convertible string or boolean), resource given in %s on line %d
bool(false)
===Done===
