...
Warning: localtime() expects parameter 2 to be boolean (or integer, float or string), array given in %s on line %d
bool(false)
...
Warning: localtime() expects parameter 2 to be boolean (or integer, float or string), object given in %s on line %d
bool(false)
