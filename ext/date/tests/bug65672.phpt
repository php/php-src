...
Deprecated: Creation of dynamic property DatePeriod@anonymous%0%s:4$%x::$dynamic1 is deprecated in %s on line %d
string(7) "dynamic"

Deprecated: Creation of dynamic property DatePeriod@anonymous%0%s:4$%x::$dynamic2 is deprecated in %s on line %d
array(1) {
  [0]=>
  string(5) "array"
}

Deprecated: Creation of dynamic property DatePeriod@anonymous%0%s:4$%x::$dynamic3 is deprecated in %s on line %d
array(1) {
  [0]=>
  string(5) "array"
}
