...
foreach ($test_dates as $test_date)
{
    ...
    echo $d1->format(DATE_ATOM), PHP_EOL;
    echo $d2->format(DATE_ATOM), PHP_EOL;
    $tz = $d1->getTimeZone();
    $d2->setTimeZone($tz);
    echo $d1->format(DATE_ATOM), PHP_EOL;
    echo $d2->format(DATE_ATOM), PHP_EOL;
...
?>
--EXPECT--
2008-01-01T12:00:00-07:00
2008-01-01T12:00:00+00:00
2008-01-01T12:00:00-07:00
2008-01-01T05:00:00-07:00

2008-01-01T12:00:00+02:00
2008-01-01T12:00:00+00:00
2008-01-01T12:00:00+02:00
2008-01-01T14:00:00+02:00
