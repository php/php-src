...
static zend_class_entry *register_class_DatePeriod(zend_class_entry *class_entry_IteratorAggregate)
{
	...
	zend_string_release_ex(property_start_name, 1);
	...
	zend_string_release_ex(property_current_name, 1);
	...
	zend_string_release_ex(property_end_name, 1);
	...
	zend_string_release_ex(property_recurrences_name, 1);
	...
	zend_string_release_ex(property_include_start_date_name, 1);
	...
	zend_string_release_ex(property_include_end_date_name, 1);
