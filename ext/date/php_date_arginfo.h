...
static zend_class_entry *register_class_DatePeriod(zend_class_entry *class_entry_IteratorAggregate)
{
	...
	zend_string *property_start_name = zend_string_init_interned("start", sizeof("start") - 1, 1);
	...
	zend_string *property_current_name = zend_string_init_interned("current", sizeof("current") - 1, 1);
	...
	zend_string *property_end_name = zend_string_init_interned("end", sizeof("end") - 1, 1);
	...
	zend_string *property_interval_name = zend_string_init_interned("interval", sizeof("interval") - 1, 1);
	...
	zend_string *property_recurrences_name = zend_string_init_interned("recurrences", sizeof("recurrences") - 1, 1);
	...
	zend_string *property_include_start_date_name = zend_string_init_interned("include_start_date", sizeof("include_start_date") - 1, 1);
	...
	zend_string *property_include_end_date_name = zend_string_init_interned("include_end_date", sizeof("include_end_date") - 1, 1);
