...
#define DATE_FORMAT_ISO9075  "Y-m-d H:i:s"
 ...
 */
	...
	REGISTER_STRING_CONSTANT("DATE_ISO9075", DATE_FORMAT_ISO9075, CONST_CS | CONST_PERSISTENT);
...
#define REGISTER_DATE_INTERFACE_CONST_STRING(const_name, value) \
	...
	REGISTER_DATE_INTERFACE_CONST_STRING("ISO9075",          DATE_FORMAT_ISO9075);
