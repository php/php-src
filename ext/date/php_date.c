...
/*
 * https://dev.mysql.com/doc/en/datetime.html
 */
 ...
 */
	...
	REGISTER_STRING_CONSTANT("DATE_MYSQL",   DATE_FORMAT_MYSQL,   CONST_CS | CONST_PERSISTENT);
...
#define REGISTER_DATE_INTERFACE_CONST_STRING(const_name, value) \
	...
	REGISTER_DATE_INTERFACE_CONST_STRING("MYSQL",            DATE_FORMAT_MYSQL);
