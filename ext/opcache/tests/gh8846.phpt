...
bool(true)
<br />
<b>Fatal error</b>:  Cannot declare class Foo, because the name is already in use (previously declared in %sgh8846-2.inc:3) in <b>%sgh8846-2.inc</b> on line <b>%d</b><br />
