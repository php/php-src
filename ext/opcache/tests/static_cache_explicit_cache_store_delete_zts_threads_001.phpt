--TEST--
OPcache explicit volatile and stable delete frees payload memory across threads
--EXTENSIONS--
opcache
--SKIPIF--
<?php
...
if (PHP_OS_FAMILY === 'Windows') {
    die('skip non-Windows embed build required');
}
...
{
    $stdoutFile = tempnam(sys_get_temp_dir(), 'opcache-explicit-zts-out-');
    $stderrFile = tempnam(sys_get_temp_dir(), 'opcache-explicit-zts-err-');
...
$source = __DIR__ . '/helpers/explicit_cache_store_delete_zts_threads_001.c';
$binary = __DIR__ . '/helpers/explicit_cache_store_delete_zts_threads_001.out';
...
--CLEAN--
<?php
@unlink(__DIR__ . '/helpers/explicit_cache_store_delete_zts_threads_001.out');
?>
--EXPECT--
ok
