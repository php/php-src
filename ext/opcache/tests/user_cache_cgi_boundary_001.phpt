--TEST--
CGI/FastCGI: OPcache User Cache partitions cache data by boundary
--EXTENSIONS--
opcache
--CONFLICTS--
all
...
try {
    ...
    $checks = [
        [$alphaScript, $alphaRoot, 'alpha.local', 'action=seed', 'alpha.local:alpha.local-value:available'],
        [$alphaScript, $alphaRoot, 'alpha.local', 'action=fetch', 'alpha.local:alpha.local-value:available'],
        [$betaScript, $betaRoot, 'beta.local', 'action=fetch', 'beta.local:MISS:available'],
        [$betaScript, $betaRoot, 'beta.local', 'action=seed', 'beta.local:beta.local-value:available'],
        [$alphaScript, $alphaRoot, 'alpha.local', 'action=fetch', 'alpha.local:alpha.local-value:available'],
        [$betaScript, $betaRoot, 'beta.local', 'action=fetch', 'beta.local:beta.local-value:available'],
    ];
