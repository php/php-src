...
OPcache\StaticCacheInterface::fetchMultiple $default=?array static=0 params=1/2 return=?array
...
OPcache\VolatileCache::fetchMultiple $default=?array static=0 params=1/2 return=?array
...
OPcache\StableCache::fetchMultiple $default=?array static=0 params=1/2 return=?array
...
OPcache\StableCache::increment $step=int static=0 params=1/2 return=int
OPcache\StableCache::decrement $step=int static=0 params=1/2 return=int
