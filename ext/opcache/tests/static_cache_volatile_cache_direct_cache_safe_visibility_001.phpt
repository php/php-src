...
var_dump(OPcache\VolatileCache::getInstance('default')->store('hidden_safe_direct_datetime', $value));
var_dump(OPcache\VolatileCache::getInstance('default')->fetch('hidden_safe_direct_datetime')->format('Y-m-d H:i:s e'));
