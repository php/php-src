...
var_dump(OPcache\VolatileCache::set('hidden_safe_direct_datetime', $value));
var_dump(OPcache\VolatileCache::get('hidden_safe_direct_datetime')->format('Y-m-d H:i:s e'));
