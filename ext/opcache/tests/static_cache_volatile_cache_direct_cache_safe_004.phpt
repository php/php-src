...
var_dump(OPcache\volatile_store('safe_direct_plain_fixed', $plainFixed));

$plainFixedCopy = OPcache\volatile_fetch('safe_direct_plain_fixed');
...
var_dump(OPcache\volatile_store('safe_direct_empty_fixed', $emptyFixed));

$emptyFixedCopy = OPcache\volatile_fetch('safe_direct_empty_fixed');
...
var_dump(OPcache\volatile_store('safe_direct_array_props', $flagged));

$flaggedCopy = OPcache\volatile_fetch('safe_direct_array_props');
...
var_dump(OPcache\volatile_store('safe_direct_self_array_object', $selfBacked));

$selfBackedCopy = OPcache\volatile_fetch('safe_direct_self_array_object');
...
var_dump(OPcache\volatile_store('safe_direct_object_backed_iterator', $backedIterator));

$backedIteratorCopy = OPcache\volatile_fetch('safe_direct_object_backed_iterator');
