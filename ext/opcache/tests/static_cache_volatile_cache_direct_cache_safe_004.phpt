...
var_dump(OPcache\VolatileCache::getInstance('default')->store('safe_direct_plain_fixed', $plainFixed));

$plainFixedCopy = OPcache\VolatileCache::getInstance('default')->fetch('safe_direct_plain_fixed');
...
var_dump(OPcache\VolatileCache::getInstance('default')->store('safe_direct_empty_fixed', $emptyFixed));

$emptyFixedCopy = OPcache\VolatileCache::getInstance('default')->fetch('safe_direct_empty_fixed');
...
var_dump(OPcache\VolatileCache::getInstance('default')->store('safe_direct_array_props', $flagged));

$flaggedCopy = OPcache\VolatileCache::getInstance('default')->fetch('safe_direct_array_props');
...
var_dump(OPcache\VolatileCache::getInstance('default')->store('safe_direct_self_array_object', $selfBacked));

$selfBackedCopy = OPcache\VolatileCache::getInstance('default')->fetch('safe_direct_self_array_object');
...
var_dump(OPcache\VolatileCache::getInstance('default')->store('safe_direct_object_backed_iterator', $backedIterator));

$backedIteratorCopy = OPcache\VolatileCache::getInstance('default')->fetch('safe_direct_object_backed_iterator');
