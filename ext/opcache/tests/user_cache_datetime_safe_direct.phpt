--TEST--
OPcache User Cache: DateTime safe-direct state is restored for subclasses
--EXTENSIONS--
opcache
--INI--
opcache.enable=1
...
$cache = new Opcache\UserCache('datetime-safe-direct');
...
var_dump($fetched['selfHash']->cachedSelfHash() !== spl_object_hash($payload['selfHash']));
