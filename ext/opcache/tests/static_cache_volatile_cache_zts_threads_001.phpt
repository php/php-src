--TEST--
OPcache volatile cache is shared across threads on ZTS builds
--EXTENSIONS--
opcache
--SKIPIF--
<?php
...
if ($buildRoot === null && $root !== false && PHP_OS_FAMILY !== 'Windows' && (file_exists($root . '/.libs/libphp.a') || file_exists($root . '/libs/libphp.a'))) {
    $buildRoot = $root;
}

if ($root === false || $buildRoot === null) {
...
$source = __DIR__ . '/helpers/volatile_cache_zts_threads_001.c';
$binary = __DIR__ . '/helpers/volatile_cache_zts_threads_001' . (PHP_OS_FAMILY === 'Windows' ? '.exe' : '.out');
...
--CLEAN--
<?php
@unlink(__DIR__ . '/helpers/volatile_cache_zts_threads_001.out');
@unlink(__DIR__ . '/helpers/volatile_cache_zts_threads_001.exe');
?>
--EXPECT--
ok
