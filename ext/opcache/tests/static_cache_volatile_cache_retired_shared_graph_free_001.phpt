--TEST--
OPcache volatile cache frees retired shared graph payloads after releasing the read lock
--EXTENSIONS--
opcache
--SKIPIF--
<?php
...
{
    $stdoutFile = tempnam(sys_get_temp_dir(), 'opcache-retired-graph-out-');
    $stderrFile = tempnam(sys_get_temp_dir(), 'opcache-retired-graph-err-');
...
$source = __DIR__ . '/helpers/volatile_cache_retired_shared_graph_free_001.c';
$binary = __DIR__ . '/helpers/volatile_cache_retired_shared_graph_free_001.out';
...
--CLEAN--
<?php
@unlink(__DIR__ . '/helpers/volatile_cache_retired_shared_graph_free_001.out');
?>
--EXPECT--
ok
