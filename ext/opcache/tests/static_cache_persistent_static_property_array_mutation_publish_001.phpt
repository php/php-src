--TEST--
OPcache StableStatic publishes property array mutations immediately
--EXTENSIONS--
opcache
--CONFLICTS--
server
...
file_put_contents(__DIR__ . '/stable_static_004.php', <<<'PHP'
<?php
...
if ($action === 'seed') {
	...
	echo 'entries=', OPcache\StableCache::info()->entry_count, "\n";
	return;
}
...
$base = 'http://' . PHP_CLI_SERVER_ADDRESS . '/stable_static_004.php';
...
--CLEAN--
<?php
@unlink(__DIR__ . '/stable_static_004.php');
?>
--EXPECT--
reset
seed=1,2
