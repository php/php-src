...
var_dump(OPcache\VolatileCache::getInstance('default')->store('packed_graph_payload', $payload));
var_dump(OPcache\VolatileCache::getInstance('default')->store('packed_graph_root', $items));

$payloadCopy = OPcache\VolatileCache::getInstance('default')->fetch('packed_graph_payload');
$rootCopy = OPcache\VolatileCache::getInstance('default')->fetch('packed_graph_root');
