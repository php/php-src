--TEST--
OPcache volatile cache releases request-scoped shared graph refs across repeated ZTS requests
--EXTENSIONS--
opcache
--SKIPIF--
<?php
...
--CLEAN--
<?php
@unlink(__DIR__ . '/helpers/volatile_cache_zts_request_shared_graph_refs_001.out');
@unlink(__DIR__ . '/helpers/volatile_cache_zts_request_shared_graph_refs_001.exe');
?>
--EXPECT--
ok
