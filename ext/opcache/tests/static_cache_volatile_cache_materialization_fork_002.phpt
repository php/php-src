...
if ($pid === 0) {
	...
	$secondFetch = OPcache\VolatileCache::getInstance('default')->fetch('materialization_nested_payload');
...
if (!OPcache\VolatileCache::getInstance('default')->store('materialization_nested_payload', $payload)) {
