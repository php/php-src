...
$source = __DIR__ . '/helpers/volatile_cache_zts_threads_002.c';
$binary = __DIR__ . '/helpers/volatile_cache_zts_threads_002' . (PHP_OS_FAMILY === 'Windows' ? '.exe' : '.out');
...
runScenario($binary, __DIR__ . '/helpers/volatile_cache_zts_threads_002_safe_direct.inc', 'safe_direct');
runScenario($binary, __DIR__ . '/helpers/volatile_cache_zts_threads_002_materialization_plain.inc', 'materialization_plain');
runScenario($binary, __DIR__ . '/helpers/volatile_cache_zts_threads_002_materialization_nested.inc', 'materialization_nested');

?>
--CLEAN--
<?php
@unlink(__DIR__ . '/helpers/volatile_cache_zts_threads_002.out');
@unlink(__DIR__ . '/helpers/volatile_cache_zts_threads_002.exe');
?>
--EXPECT--
safe_direct: ok
materialization_plain: ok
materialization_nested: ok
