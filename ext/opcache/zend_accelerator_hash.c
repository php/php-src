 ...
 */
zend_accel_hash_entry* zend_accel_hash_update(zend_accel_hash *accel_hash, char *key, zend_size_t key_length, zend_bool indirect, void *data)
{
 ...
 */
void* zend_accel_hash_find(zend_accel_hash *accel_hash, char *key, zend_size_t key_length)
{
	zend_uint_t hash_value;
	zend_uint_t index;
	zend_accel_hash_entry *entry;
 ...
 */
zend_accel_hash_entry* zend_accel_hash_find_entry(zend_accel_hash *accel_hash, char *key, zend_size_t key_length)
{
	zend_uint_t hash_value;
	zend_uint_t index;
	zend_accel_hash_entry *entry;
...
int zend_accel_hash_unlink(zend_accel_hash *accel_hash, char *key, zend_size_t key_length)
{
    zend_uint_t hash_value;
    zend_uint_t index;
