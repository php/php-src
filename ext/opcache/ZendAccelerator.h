...
typedef struct _zend_opcache_static_cache_accelerator_handlers {
	void (*startup)(void);
	void (*post_startup)(void);
	zend_result (*rinit)(void);
	void (*invalidate_script)(zend_persistent_script *persistent_script);
} zend_opcache_static_cache_accelerator_handlers;
