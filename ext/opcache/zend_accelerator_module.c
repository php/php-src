...
ZEND_INI_BEGIN()
	...
	STD_PHP_INI_ENTRY("opcache.file_cache_permissions", S_IRUSR | S_IWUSR, PHP_INI_SYSTEM, OnUpdateLong, accel_directives.file_cache_permissions, zend_accel_globals, accel_globals)
