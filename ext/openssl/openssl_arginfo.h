 ...
 * Stub hash: d03bc83b2aeddc532155c93054003b5921ddbda6 */
...
static void register_openssl_symbols(int module_number)
{
	...
	REGISTER_LONG_CONSTANT("OPENSSL_CMS_DETACHED", OPENSSL_CMS_DETACHED, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("OPENSSL_CMS_TEXT", OPENSSL_CMS_TEXT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("OPENSSL_CMS_NOINTERN", OPENSSL_CMS_NOINTERN, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("OPENSSL_CMS_NOVERIFY", OPENSSL_CMS_NOVERIFY, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("OPENSSL_CMS_NOCERTS", OPENSSL_CMS_NOCERTS, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("OPENSSL_CMS_NOATTR", OPENSSL_CMS_NOATTR, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("OPENSSL_CMS_BINARY", OPENSSL_CMS_BINARY, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("OPENSSL_CMS_NOSIGS", OPENSSL_CMS_NOSIGS, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("OPENSSL_PKCS1_PADDING", OPENSSL_PKCS1_PADDING, CONST_CS | CONST_PERSISTENT);
#if defined(RSA_SSLV23_PADDING)
	REGISTER_LONG_CONSTANT("OPENSSL_SSLV23_PADDING", OPENSSL_SSLV23_PADDING, CONST_CS | CONST_PERSISTENT);
#endif
	REGISTER_LONG_CONSTANT("OPENSSL_NO_PADDING", OPENSSL_NO_PADDING, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("OPENSSL_PKCS1_OAEP_PADDING", OPENSSL_PKCS1_OAEP_PADDING, CONST_CS | CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("OPENSSL_DEFAULT_STREAM_CIPHERS", OPENSSL_DEFAULT_STREAM_CIPHERS, CONST_CS | CONST_PERSISTENT);
#if !defined(OPENSSL_NO_RC2)
	REGISTER_LONG_CONSTANT("OPENSSL_CIPHER_RC2_40", OPENSSL_CIPHER_RC2_40, CONST_CS | CONST_PERSISTENT);
#endif
#if !defined(OPENSSL_NO_RC2)
	REGISTER_LONG_CONSTANT("OPENSSL_CIPHER_RC2_128", OPENSSL_CIPHER_RC2_128, CONST_CS | CONST_PERSISTENT);
#endif
#if !defined(OPENSSL_NO_RC2)
	REGISTER_LONG_CONSTANT("OPENSSL_CIPHER_RC2_64", OPENSSL_CIPHER_RC2_64, CONST_CS | CONST_PERSISTENT);
#endif
#if !defined(OPENSSL_NO_DES)
	REGISTER_LONG_CONSTANT("OPENSSL_CIPHER_DES", OPENSSL_CIPHER_DES, CONST_CS | CONST_PERSISTENT);
#endif
#if !defined(OPENSSL_NO_DES)
	REGISTER_LONG_CONSTANT("OPENSSL_CIPHER_3DES", OPENSSL_CIPHER_3DES, CONST_CS | CONST_PERSISTENT);
#endif
#if !defined(OPENSSL_NO_AES)
	REGISTER_LONG_CONSTANT("OPENSSL_CIPHER_AES_128_CBC", OPENSSL_CIPHER_AES_128_CBC, CONST_CS | CONST_PERSISTENT);
#endif
#if !defined(OPENSSL_NO_AES)
	REGISTER_LONG_CONSTANT("OPENSSL_CIPHER_AES_192_CBC", OPENSSL_CIPHER_AES_192_CBC, CONST_CS | CONST_PERSISTENT);
#endif
#if !defined(OPENSSL_NO_AES)
	REGISTER_LONG_CONSTANT("OPENSSL_CIPHER_AES_256_CBC", OPENSSL_CIPHER_AES_256_CBC, CONST_CS | CONST_PERSISTENT);
#endif
