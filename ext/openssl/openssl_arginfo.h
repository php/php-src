...
ZEND_BEGIN_ARG_INFO_EX(arginfo_openssl_csr_sign, 0, 0, 4)
	...
	ZEND_ARG_TYPE_INFO(0, config_args, IS_ARRAY, 0)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_openssl_csr_new, 0, 0, 2)
	...
	ZEND_ARG_TYPE_INFO(0, configargs, IS_ARRAY, 0)
	ZEND_ARG_TYPE_INFO(0, extraattribs, IS_ARRAY, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_openssl_pkey_free, 0, 0, 1)
	ZEND_ARG_INFO(0, key)
ZEND_END_ARG_INFO()
...
#define arginfo_openssl_pkey_get_details arginfo_openssl_pkey_free
