...
function openssl_x509_export($x509 , string &$out, bool $notext = true): bool {}
...
/** @return bool|int */
function openssl_x509_checkpurpose($x509cert, int $purpose, array $cainfo, string $untrustedfile) {}
