...
array (
  ...
  'subjectAltName' => "DNS:altnull.python.org\000example.com, email:null@python.org\000user@example.org, URI:http://null.python.org\000http://example.org, IP Address:192.0.2.1, IP Address:2001:DB8:0:0:0:0:0:1
",
)
