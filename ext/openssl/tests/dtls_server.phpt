--TEST--
dtls:// server: accept a peer and exchange data with a dtls:// client
--EXTENSIONS--
openssl
--SKIPIF--
<?php
...
--FILE--
<?php
$certFile = __DIR__ . DIRECTORY_SEPARATOR . 'dtls_server.pem.tmp';
...
--CLEAN--
<?php
@unlink(__DIR__ . DIRECTORY_SEPARATOR . 'dtls_server.pem.tmp');
?>
--EXPECT--
bool(true)
string(4) "PING"
