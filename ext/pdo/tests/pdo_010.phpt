...
$db->exec("INSERT INTO classtypes010 VALUES(0, 'stdClass'), (1, 'Test1'), (2, 'Test2'));
$db->exec('CREATE TABLE test010(id int NOT NULL PRIMARY KEY, classtype int, val VARCHAR(10), grp VARCHAR(10))');
$db->exec("INSERT INTO test010 VALUES(1, 0, 'A', 'Group1'), (2, 1, 'B', 'Group1'), (3, 2, 'C', 'Group2'), (4, 3, 'D', 'Group2')");
...
require_once getenv('REDIR_TEST_DIR') . 'pdo_test.inc';
$db = PDOTest::factory();
PDOTest::dropTableIfExists($db, "test010");
PDOTest::dropTableIfExists($db, "classtypes010");
?>
--EXPECTF--
Test1::__construct()
Test2::__construct()
