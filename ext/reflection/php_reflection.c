...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_reflection__string0, 0, 0, IS_STRING, NULL, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_reflection__long0, 0, 0, IS_LONG, NULL, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_reflection__array0, 0, 0, IS_ARRAY, NULL, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_reflection__bool0, 0, 0, _IS_BOOL, NULL, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_reflection__class0, 0, 0, IS_OBJECT, "ReflectionClass", 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_reflection__type0, 0, 0, IS_OBJECT, "ReflectionType", 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_reflection__extension0, 0, 0, IS_OBJECT, "ReflectionExtension", 1)
ZEND_END_ARG_INFO()
...
static const zend_function_entry reflector_functions[] = {
	...
	ZEND_ABSTRACT_ME(reflector, __toString, arginfo_reflection__string0)
	PHP_FE_END
};
...
static const zend_function_entry reflection_function_abstract_functions[] = {
	...
	ZEND_ME(reflection_function, inNamespace, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_function, isClosure, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_function, isDeprecated, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_function, isInternal, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_function, isUserDefined, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_function, isGenerator, arginfo_reflection__bool0, 0)
	...
	ZEND_ME(reflection_function, getName, arginfo_reflection__string0, 0)
	ZEND_ME(reflection_function, getNamespaceName, arginfo_reflection__string0, 0)
	ZEND_ME(reflection_function, getNumberOfParameters, arginfo_reflection__long0, 0)
	ZEND_ME(reflection_function, getNumberOfRequiredParameters, arginfo_reflection__long0, 0)
	ZEND_ME(reflection_function, getParameters, arginfo_reflection__array0, 0)
	ZEND_ME(reflection_function, getShortName, arginfo_reflection__string0, 0)
	ZEND_ME(reflection_function, getStartLine, arginfo_reflection__void, 0)
	ZEND_ME(reflection_function, getStaticVariables, arginfo_reflection__array0, 0)
	ZEND_ME(reflection_function, returnsReference, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_function, hasReturnType, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_function, getReturnType, arginfo_reflection__type0, 0)
	PHP_FE_END
};
...
static const zend_function_entry reflection_function_functions[] = {
	...
	ZEND_ME(reflection_function, __toString, arginfo_reflection__string0, 0)
	ZEND_ME(reflection_function, export, arginfo_reflection_function_export, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
	ZEND_ME(reflection_function, isDisabled, arginfo_reflection__bool0, 0)
...
static const zend_function_entry reflection_generator_functions[] = {
	...
	ZEND_ME(reflection_generator, getExecutingLine, arginfo_reflection__long0, 0)
	ZEND_ME(reflection_generator, getExecutingFile, arginfo_reflection__string0, 0)
	ZEND_ME(reflection_generator, getTrace, arginfo_reflection_generator_trace, 0)
	ZEND_ME(reflection_generator, getFunction, arginfo_reflection_generator_getFunction, 0)
...
static const zend_function_entry reflection_method_functions[] = {
	...
	ZEND_ME(reflection_method, __toString, arginfo_reflection__string0, 0)
	ZEND_ME(reflection_method, isPublic, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_method, isPrivate, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_method, isProtected, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_method, isAbstract, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_method, isFinal, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_method, isStatic, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_method, isConstructor, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_method, isDestructor, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_method, getClosure, arginfo_reflection_method_getClosure, 0)
	ZEND_ME(reflection_method, getModifiers, arginfo_reflection__long0, 0)
	...
	ZEND_ME(reflection_method, getDeclaringClass, arginfo_reflection__class0, 0)
	ZEND_ME(reflection_method, getPrototype, arginfo_reflection__class0, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(arginfo_reflection_class_hasMethod, _IS_BOOL, NULL, 1)
	ZEND_ARG_INFO(0, name)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(arginfo_reflection_class_getMethod, IS_OBJECT, "ReflectionMethod", 1)
	ZEND_ARG_INFO(0, name)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_reflection_class_getMethods, 0, 0, IS_ARRAY, NULL, 1)
	ZEND_ARG_INFO(0, filter)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(arginfo_reflection_class_hasProperty, _IS_BOOL, NULL, 1)
	ZEND_ARG_INFO(0, name)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(arginfo_reflection_class_getProperty, IS_OBJECT, "ReflectionProperty", 1)
	ZEND_ARG_INFO(0, name)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_reflection_class_getProperties, 0, 0, IS_ARRAY, NULL, 1)
	ZEND_ARG_INFO(0, filter)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(arginfo_reflection_class_hasConstant, _IS_BOOL, NULL, 1)
	ZEND_ARG_INFO(0, name)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(arginfo_reflection_class_isInstance, _IS_BOOL, NULL, 1)
	ZEND_ARG_INFO(0, object)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(arginfo_reflection_class_isSubclassOf, _IS_BOOL, NULL, 1)
	ZEND_ARG_INFO(0, class)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(arginfo_reflection_class_implementsInterface, _IS_BOOL, NULL, 1)
...
static const zend_function_entry reflection_class_functions[] = {
	...
	ZEND_ME(reflection_class, __toString, arginfo_reflection__string0, 0)
	ZEND_ME(reflection_class, getName, arginfo_reflection__string0, 0)
	ZEND_ME(reflection_class, isInternal, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_class, isUserDefined, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_class, isAnonymous, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_class, isInstantiable, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_class, isCloneable, arginfo_reflection__bool0, 0)
	...
	ZEND_ME(reflection_class, getConstants, arginfo_reflection__array0, 0)
	ZEND_ME(reflection_class, getConstant, arginfo_reflection_class_getConstant, 0)
	ZEND_ME(reflection_class, getInterfaces, arginfo_reflection__array0, 0)
	ZEND_ME(reflection_class, getInterfaceNames, arginfo_reflection__array0, 0)
	ZEND_ME(reflection_class, isInterface, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_class, getTraits, arginfo_reflection__array0, 0)
	ZEND_ME(reflection_class, getTraitNames, arginfo_reflection__array0, 0)
	ZEND_ME(reflection_class, getTraitAliases, arginfo_reflection__array0, 0)
	ZEND_ME(reflection_class, isTrait, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_class, isAbstract, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_class, isFinal, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_class, getModifiers, arginfo_reflection__long0, 0)
	...
	ZEND_ME(reflection_class, getStaticProperties, arginfo_reflection__array0, 0)
	...
	ZEND_ME(reflection_class, getDefaultProperties, arginfo_reflection__array0, 0)
	ZEND_ME(reflection_class, isIterateable, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_class, implementsInterface, arginfo_reflection_class_implementsInterface, 0)
	ZEND_ME(reflection_class, getExtension, arginfo_reflection__extension0, 0)
	ZEND_ME(reflection_class, getExtensionName, arginfo_reflection__void, 0)
	ZEND_ME(reflection_class, inNamespace, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_class, getNamespaceName, arginfo_reflection__string0, 0)
	ZEND_ME(reflection_class, getShortName, arginfo_reflection__string0, 0)
	PHP_FE_END
};
...
static const zend_function_entry reflection_property_functions[] = {
	...
	ZEND_ME(reflection_property, __toString, arginfo_reflection__string0, 0)
	ZEND_ME(reflection_property, getName, arginfo_reflection__string0, 0)
	...
	ZEND_ME(reflection_property, isPublic, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_property, isPrivate, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_property, isProtected, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_property, isStatic, arginfo_reflection__bool0, 0)
...
static const zend_function_entry reflection_parameter_functions[] = {
	...
	ZEND_ME(reflection_parameter, __toString, arginfo_reflection__string0, 0)
	ZEND_ME(reflection_parameter, getName, arginfo_reflection__string0, 0)
	ZEND_ME(reflection_parameter, isPassedByReference, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_parameter, canBePassedByValue, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_parameter, getDeclaringFunction, arginfo_reflection_parameter_getDeclaringFunction, 0)
	ZEND_ME(reflection_parameter, getDeclaringClass, arginfo_reflection__class0, 0)
	ZEND_ME(reflection_parameter, getClass, arginfo_reflection__class0, 0)
	ZEND_ME(reflection_parameter, hasType, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_parameter, getType, arginfo_reflection__type0, 0)
	ZEND_ME(reflection_parameter, isArray, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_parameter, isCallable, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_parameter, allowsNull, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_parameter, getPosition, arginfo_reflection__long0, 0)
	ZEND_ME(reflection_parameter, isOptional, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_parameter, isDefaultValueAvailable, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_parameter, getDefaultValue, arginfo_reflection__void, 0)
	ZEND_ME(reflection_parameter, isDefaultValueConstant, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_parameter, getDefaultValueConstantName, arginfo_reflection__string0, 0)
	ZEND_ME(reflection_parameter, isVariadic, arginfo_reflection__bool0, 0)
	PHP_FE_END
};

static const zend_function_entry reflection_type_functions[] = {
	ZEND_ME(reflection, __clone, arginfo_reflection__void, ZEND_ACC_PRIVATE|ZEND_ACC_FINAL)
	ZEND_ME(reflection_type, allowsNull, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_type, isBuiltin, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_type, __toString, arginfo_reflection__string0, 0)
	PHP_FE_END
};
...
static const zend_function_entry reflection_extension_functions[] = {
	...
	ZEND_ME(reflection_extension, __toString, arginfo_reflection__string0, 0)
	ZEND_ME(reflection_extension, getName, arginfo_reflection__string0, 0)
	ZEND_ME(reflection_extension, getVersion, arginfo_reflection__string0, 0)
	ZEND_ME(reflection_extension, getFunctions, arginfo_reflection__array0, 0)
	ZEND_ME(reflection_extension, getConstants, arginfo_reflection__array0, 0)
	ZEND_ME(reflection_extension, getINIEntries, arginfo_reflection__array0, 0)
	ZEND_ME(reflection_extension, getClasses, arginfo_reflection__array0, 0)
	ZEND_ME(reflection_extension, getClassNames, arginfo_reflection__array0, 0)
	ZEND_ME(reflection_extension, getDependencies, arginfo_reflection__array0, 0)
	ZEND_ME(reflection_extension, info, arginfo_reflection__void, 0)
	ZEND_ME(reflection_extension, isPersistent, arginfo_reflection__bool0, 0)
	ZEND_ME(reflection_extension, isTemporary, arginfo_reflection__bool0, 0)
	PHP_FE_END
};
...
static const zend_function_entry reflection_zend_extension_functions[] = {
	...
	ZEND_ME(reflection_zend_extension, __toString, arginfo_reflection__string0, 0)
	ZEND_ME(reflection_zend_extension, getName, arginfo_reflection__string0, 0)
	ZEND_ME(reflection_zend_extension, getVersion, arginfo_reflection__string0, 0)
	ZEND_ME(reflection_zend_extension, getAuthor, arginfo_reflection__string0, 0)
	ZEND_ME(reflection_zend_extension, getURL, arginfo_reflection__string0, 0)
	ZEND_ME(reflection_zend_extension, getCopyright, arginfo_reflection__string0, 0)
	PHP_FE_END
};
/* }}} */
