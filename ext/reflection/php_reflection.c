...
static const zend_function_entry reflection_function_abstract_functions[] = {
	...
	ZEND_ME(reflection_function, getFileName, arginfo_reflection__string0, 0)
	...
	ZEND_ME(reflection_function, getStartLine, arginfo_reflection__long0, 0)
...
static const zend_function_entry reflection_class_functions[] = {
	...
	ZEND_ME(reflection_class, getExtensionName, arginfo_reflection__string0, 0)
...
static const zend_function_entry reflection_parameter_functions[] = {
	...
	ZEND_ME(reflection_parameter, getClass, arginfo_reflection_parameter_getClass, 0)
