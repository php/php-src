...
static const zend_function_entry reflection_parameter_functions[] = {
	...
	ZEND_DEP_ME(reflection_parameter, getClass, arginfo_class_ReflectionParameter_getClass, 0)
	...
	ZEND_DEP_ME(reflection_parameter, isArray, arginfo_class_ReflectionParameter_isArray, 0)
	ZEND_DEP_ME(reflection_parameter, isCallable, arginfo_class_ReflectionParameter_isCallable, 0)
