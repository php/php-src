...
ReflectionException: Parameter uses "self" as type but function is not a class member

Deprecated: Method ReflectionParameter::getClass() is deprecated since 8.0, use ReflectionParameter::getType() instead in %s on line %d
ReflectionException: Parameter uses "parent" as type but function is not a class member

Deprecated: Method ReflectionParameter::getClass() is deprecated since 8.0, use ReflectionParameter::getType() instead in %s on line %d
ReflectionException: Parameter uses "parent" as type although class does not have a parent
