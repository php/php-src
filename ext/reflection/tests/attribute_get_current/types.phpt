...
ReflectionEnumUnitCase -> ReflectionEnumUnitCase (on unit enum case)
...
ReflectionEnumUnitCase -> ReflectionEnumBackedCase (on backed enum case)
ReflectionEnumBackedCase -> ReflectionEnumBackedCase (on backed enum case)
