--TEST--
ReflectionTypes of relative class types (self, parent) from traits in classes, variadic parameter union types
--FILE--
<?php

trait TraitExample {
    public function bar(int|parent ...$o) { return $o[0]; }
    public function ping(int|self ...$o) { return $o[0]; }
}
	...
	Method: bar
		...
		Instance of: ReflectionRelativeClassType
			...
			Instance of: ReflectionNamedType
				C::bar(): Argument #1 must be of type B|int, A given, called in %s on line %d
	Method: ping
		Type: self
		Instance of: ReflectionRelativeClassType
			Resolved Type: C
			Instance of: ReflectionNamedType
				C::ping(): Argument #1 must be of type C|int, A given, called in %s on line %d
				C::ping(): Argument #1 must be of type C|int, B given, called in %s on line %d
Class: D
	Method: bar
		Type: parent
		Instance of: ReflectionRelativeClassType
