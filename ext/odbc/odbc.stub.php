 ...
 * @return resource|false
 */
function odbc_tables($connection_id, ?string $qualfier = null, ?string $schema = null, ?string $name = null, ?string $table_types = null) {}
 ...
 * @return resource|false
 */
function odbc_statistics($connection_id, ?string $qualfier, string $schema, string $name, int $unique, int $accuracy) {}
