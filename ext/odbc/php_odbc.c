...
ZEND_BEGIN_ARG_INFO(arginfo_odbc_setoption, 0)
...
ZEND_BEGIN_ARG_INFO(arginfo_odbc_primarykeys, 0)
	ZEND_ARG_INFO(0, connection_id)
	ZEND_ARG_INFO(0, qualifier)
	ZEND_ARG_INFO(0, owner)
...
ZEND_BEGIN_ARG_INFO(arginfo_odbc_foreignkeys, 0)
	ZEND_ARG_INFO(0, connection_id)
...
ZEND_BEGIN_ARG_INFO(arginfo_odbc_specialcolumns, 0)
	ZEND_ARG_INFO(0, connection_id)
...
ZEND_BEGIN_ARG_INFO(arginfo_odbc_statistics, 0)
	ZEND_ARG_INFO(0, connection_id)
	ZEND_ARG_INFO(0, qualifier)
	ZEND_ARG_INFO(0, owner)
	ZEND_ARG_INFO(0, name)
...
ZEND_BEGIN_ARG_INFO(arginfo_odbc_tableprivileges, 0)
	ZEND_ARG_INFO(0, connection_id)
	ZEND_ARG_INFO(0, qualifier)
	ZEND_ARG_INFO(0, owner)
	ZEND_ARG_INFO(0, name)
...
ZEND_BEGIN_ARG_INFO(arginfo_odbc_columnprivileges, 0)
	ZEND_ARG_INFO(0, connection_id)
