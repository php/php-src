...
static const zend_function_entry ext_functions[] = {
	ZEND_RAW_FENTRY("odbc_close_all", zif_odbc_close_all, arginfo_odbc_close_all, 0, NULL)
	ZEND_RAW_FENTRY("odbc_binmode", zif_odbc_binmode, arginfo_odbc_binmode, 0, NULL)
	ZEND_RAW_FENTRY("odbc_longreadlen", zif_odbc_longreadlen, arginfo_odbc_longreadlen, 0, NULL)
	ZEND_RAW_FENTRY("odbc_prepare", zif_odbc_prepare, arginfo_odbc_prepare, 0, NULL)
	ZEND_RAW_FENTRY("odbc_execute", zif_odbc_execute, arginfo_odbc_execute, 0, NULL)
	ZEND_RAW_FENTRY("odbc_cursor", zif_odbc_cursor, arginfo_odbc_cursor, 0, NULL)
#if defined(HAVE_SQLDATASOURCES)
	ZEND_RAW_FENTRY("odbc_data_source", zif_odbc_data_source, arginfo_odbc_data_source, 0, NULL)
#endif
	ZEND_RAW_FENTRY("odbc_exec", zif_odbc_exec, arginfo_odbc_exec, 0, NULL)
	ZEND_RAW_FENTRY("odbc_do", zif_odbc_exec, arginfo_odbc_do, 0, NULL)
#if defined(PHP_ODBC_HAVE_FETCH_HASH)
	ZEND_RAW_FENTRY("odbc_fetch_object", zif_odbc_fetch_object, arginfo_odbc_fetch_object, 0, NULL)
#endif
#if defined(PHP_ODBC_HAVE_FETCH_HASH)
	ZEND_RAW_FENTRY("odbc_fetch_array", zif_odbc_fetch_array, arginfo_odbc_fetch_array, 0, NULL)
#endif
	ZEND_RAW_FENTRY("odbc_fetch_into", zif_odbc_fetch_into, arginfo_odbc_fetch_into, 0, NULL)
	ZEND_RAW_FENTRY("odbc_fetch_row", zif_odbc_fetch_row, arginfo_odbc_fetch_row, 0, NULL)
	ZEND_RAW_FENTRY("odbc_result", zif_odbc_result, arginfo_odbc_result, 0, NULL)
	ZEND_RAW_FENTRY("odbc_result_all", zif_odbc_result_all, arginfo_odbc_result_all, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("odbc_free_result", zif_odbc_free_result, arginfo_odbc_free_result, 0, NULL)
	ZEND_RAW_FENTRY("odbc_connect", zif_odbc_connect, arginfo_odbc_connect, 0, NULL)
	ZEND_RAW_FENTRY("odbc_pconnect", zif_odbc_pconnect, arginfo_odbc_pconnect, 0, NULL)
	ZEND_RAW_FENTRY("odbc_close", zif_odbc_close, arginfo_odbc_close, 0, NULL)
	ZEND_RAW_FENTRY("odbc_num_rows", zif_odbc_num_rows, arginfo_odbc_num_rows, 0, NULL)
#if !defined(HAVE_SOLID) && !defined(HAVE_SOLID_30)
	ZEND_RAW_FENTRY("odbc_next_result", zif_odbc_next_result, arginfo_odbc_next_result, 0, NULL)
#endif
	ZEND_RAW_FENTRY("odbc_num_fields", zif_odbc_num_fields, arginfo_odbc_num_fields, 0, NULL)
	ZEND_RAW_FENTRY("odbc_field_name", zif_odbc_field_name, arginfo_odbc_field_name, 0, NULL)
	ZEND_RAW_FENTRY("odbc_field_type", zif_odbc_field_type, arginfo_odbc_field_type, 0, NULL)
	ZEND_RAW_FENTRY("odbc_field_len", zif_odbc_field_len, arginfo_odbc_field_len, 0, NULL)
	ZEND_RAW_FENTRY("odbc_field_precision", zif_odbc_field_len, arginfo_odbc_field_precision, 0, NULL)
	ZEND_RAW_FENTRY("odbc_field_scale", zif_odbc_field_scale, arginfo_odbc_field_scale, 0, NULL)
	ZEND_RAW_FENTRY("odbc_field_num", zif_odbc_field_num, arginfo_odbc_field_num, 0, NULL)
	ZEND_RAW_FENTRY("odbc_autocommit", zif_odbc_autocommit, arginfo_odbc_autocommit, 0, NULL)
	ZEND_RAW_FENTRY("odbc_commit", zif_odbc_commit, arginfo_odbc_commit, 0, NULL)
	ZEND_RAW_FENTRY("odbc_rollback", zif_odbc_rollback, arginfo_odbc_rollback, 0, NULL)
	ZEND_RAW_FENTRY("odbc_error", zif_odbc_error, arginfo_odbc_error, 0, NULL)
	ZEND_RAW_FENTRY("odbc_errormsg", zif_odbc_errormsg, arginfo_odbc_errormsg, 0, NULL)
	ZEND_RAW_FENTRY("odbc_setoption", zif_odbc_setoption, arginfo_odbc_setoption, 0, NULL)
	ZEND_RAW_FENTRY("odbc_tables", zif_odbc_tables, arginfo_odbc_tables, 0, NULL)
	ZEND_RAW_FENTRY("odbc_columns", zif_odbc_columns, arginfo_odbc_columns, 0, NULL)
	ZEND_RAW_FENTRY("odbc_gettypeinfo", zif_odbc_gettypeinfo, arginfo_odbc_gettypeinfo, 0, NULL)
	ZEND_RAW_FENTRY("odbc_primarykeys", zif_odbc_primarykeys, arginfo_odbc_primarykeys, 0, NULL)
#if !defined(HAVE_SOLID) && !defined(HAVE_SOLID_30) && !defined(HAVE_SOLID_35)
	ZEND_RAW_FENTRY("odbc_procedurecolumns", zif_odbc_procedurecolumns, arginfo_odbc_procedurecolumns, 0, NULL)
#endif
#if !defined(HAVE_SOLID) && !defined(HAVE_SOLID_30) && !defined(HAVE_SOLID_35)
	ZEND_RAW_FENTRY("odbc_procedures", zif_odbc_procedures, arginfo_odbc_procedures, 0, NULL)
#endif
#if !defined(HAVE_SOLID) && !defined(HAVE_SOLID_30) && !defined(HAVE_SOLID_35)
	ZEND_RAW_FENTRY("odbc_foreignkeys", zif_odbc_foreignkeys, arginfo_odbc_foreignkeys, 0, NULL)
#endif
	ZEND_RAW_FENTRY("odbc_specialcolumns", zif_odbc_specialcolumns, arginfo_odbc_specialcolumns, 0, NULL)
	ZEND_RAW_FENTRY("odbc_statistics", zif_odbc_statistics, arginfo_odbc_statistics, 0, NULL)
#if !defined(HAVE_DBMAKER) && !defined(HAVE_SOLID) && !defined(HAVE_SOLID_30) &&!defined(HAVE_SOLID_35)
	ZEND_RAW_FENTRY("odbc_tableprivileges", zif_odbc_tableprivileges, arginfo_odbc_tableprivileges, 0, NULL)
#endif
#if !defined(HAVE_DBMAKER) && !defined(HAVE_SOLID) && !defined(HAVE_SOLID_30) &&!defined(HAVE_SOLID_35)
	ZEND_RAW_FENTRY("odbc_columnprivileges", zif_odbc_columnprivileges, arginfo_odbc_columnprivileges, 0, NULL)
#endif
	ZEND_RAW_FENTRY("odbc_connection_string_is_quoted", zif_odbc_connection_string_is_quoted, arginfo_odbc_connection_string_is_quoted, 0, NULL)
	ZEND_RAW_FENTRY("odbc_connection_string_should_quote", zif_odbc_connection_string_should_quote, arginfo_odbc_connection_string_should_quote, 0, NULL)
	ZEND_RAW_FENTRY("odbc_connection_string_quote", zif_odbc_connection_string_quote, arginfo_odbc_connection_string_quote, 0, NULL)
	ZEND_FE_END
};
