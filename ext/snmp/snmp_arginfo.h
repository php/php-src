...
static const zend_function_entry class_SNMP_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_SNMP___construct, arginfo_class_SNMP___construct, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("close", zim_SNMP_close, arginfo_class_SNMP_close, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setSecurity", zim_SNMP_setSecurity, arginfo_class_SNMP_setSecurity, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("get", zim_SNMP_get, arginfo_class_SNMP_get, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getnext", zim_SNMP_getnext, arginfo_class_SNMP_getnext, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("walk", zim_SNMP_walk, arginfo_class_SNMP_walk, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("set", zim_SNMP_set, arginfo_class_SNMP_set, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getErrno", zim_SNMP_getErrno, arginfo_class_SNMP_getErrno, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getError", zim_SNMP_getError, arginfo_class_SNMP_getError, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};
