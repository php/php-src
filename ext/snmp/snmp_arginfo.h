 ...
 * Stub hash: 65439810ce75b738c6d9504aa176240ce2396143 */
...
{
	REGISTER_LONG_CONSTANT("SNMP_OID_OUTPUT_SUFFIX", LONG_CONST(NETSNMP_OID_OUTPUT_SUFFIX), CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SNMP_OID_OUTPUT_MODULE", LONG_CONST(NETSNMP_OID_OUTPUT_MODULE), CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SNMP_OID_OUTPUT_FULL", LONG_CONST(NETSNMP_OID_OUTPUT_FULL), CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SNMP_OID_OUTPUT_NUMERIC", LONG_CONST(NETSNMP_OID_OUTPUT_NUMERIC), CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SNMP_OID_OUTPUT_UCD", LONG_CONST(NETSNMP_OID_OUTPUT_UCD), CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SNMP_OID_OUTPUT_NONE", LONG_CONST(NETSNMP_OID_OUTPUT_NONE), CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SNMP_VALUE_LIBRARY", LONG_CONST(SNMP_VALUE_LIBRARY), CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SNMP_VALUE_PLAIN", LONG_CONST(SNMP_VALUE_PLAIN), CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SNMP_VALUE_OBJECT", LONG_CONST(SNMP_VALUE_OBJECT), CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SNMP_BIT_STR", LONG_CONST(ASN_BIT_STR), CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SNMP_OCTET_STR", LONG_CONST(ASN_OCTET_STRLONG_CONST), CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SNMP_OPAQUE", LONG_CONST(ASN_OPAQUE), CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SNMP_NULL", LONG_CONST(ASN_NULL), CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SNMP_OBJECT_ID", LONG_CONST(ASN_OBJECT_ID), CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SNMP_IPADDRESS", LONG_CONST(ASN_IPADDRESS), CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SNMP_COUNTER", LONG_CONST(ASN_GAUGE), CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SNMP_UNSIGNED", LONG_CONST(ASN_UNSIGNED), CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SNMP_TIMETICKS", LONG_CONST(ASN_TIMETICKS), CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SNMP_UINTEGER", LONG_CONST(ASN_UINTEGER), CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SNMP_INTEGER", LONG_CONST(ASN_INTEGER), CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SNMP_COUNTER64", LONG_CONST(ASN_COUNTER64), CONST_CS | CONST_PERSISTENT);
}
...
static zend_class_entry *register_class_SNMP(void)
{
	...
	ZVAL_LONG(&const_VERSION_1_value, LONG_CONST(SNMP_VERSION_1));
	...
	ZVAL_LONG(&const_VERSION_2c_value, LONG_CONST(SNMP_VERSION_2c));
	...
	ZVAL_LONG(&const_VERSION_3_value, LONG_CONST(SNMP_VERSION_3));
	...
	ZVAL_LONG(&const_ERRNO_NOERROR_value, LONG_CONST(PHP_SNMP_ERRNO_NOERROR));
	...
	ZVAL_LONG(&const_ERRNO_ANY_value, LONG_CONST(PHP_SNMP_ERRNO_ANY));
	...
	ZVAL_LONG(&const_ERRNO_GENERIC_value, LONG_CONST(PHP_SNMP_ERRNO_GENERIC));
	...
	ZVAL_LONG(&const_ERRNO_TIMEOUT_value, LONG_CONST(PHP_SNMP_ERRNO_TIMEOUT));
	...
	ZVAL_LONG(&const_ERRNO_ERROR_IN_REPLY_value, LONG_CONST(PHP_SNMP_ERRNO_ERROR_IN_REPLY));
	...
	ZVAL_LONG(&const_ERRNO_OID_NOT_INCREASING_value, LONG_CONST(PHP_SNMP_ERRNO_OID_NOT_INCREASING));
	...
	ZVAL_LONG(&const_ERRNO_OID_PARSING_ERROR_value, LONG_CONST(PHP_SNMP_ERRNO_OID_PARSING_ERROR));
	...
	ZVAL_LONG(&const_ERRNO_MULTIPLE_SET_QUERIES_value, LONG_CONST(PHP_SNMP_ERRNO_MULTIPLE_SET_QUERIES));
