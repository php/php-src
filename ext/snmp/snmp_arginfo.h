...
static zend_class_entry *register_class_SNMP(void)
{
	...
	zend_string_release_ex(property_max_oids_name, 1);
	...
	zend_string_release_ex(property_valueretrieval_name, 1);
	...
	zend_string_release_ex(property_quick_print_name, 1);
	...
	zend_string_release_ex(property_enum_print_name, 1);
	...
	zend_string_release_ex(property_oid_output_format_name, 1);
	...
	zend_string_release_ex(property_oid_increasing_check_name, 1);
	...
	zend_string_release_ex(property_exceptions_enabled_name, 1);
