...
static zend_class_entry *register_class_SNMP(void)
{
	...
	zend_string *property_max_oids_name = zend_string_init_interned("max_oids", sizeof("max_oids") - 1, 1);
	...
	zend_string *property_valueretrieval_name = zend_string_init_interned("valueretrieval", sizeof("valueretrieval") - 1, 1);
	...
	zend_string *property_quick_print_name = zend_string_init_interned("quick_print", sizeof("quick_print") - 1, 1);
	...
	zend_string *property_enum_print_name = zend_string_init_interned("enum_print", sizeof("enum_print") - 1, 1);
	...
	zend_string *property_oid_output_format_name = zend_string_init_interned("oid_output_format", sizeof("oid_output_format") - 1, 1);
	...
	zend_string *property_oid_increasing_check_name = zend_string_init_interned("oid_increasing_check", sizeof("oid_increasing_check") - 1, 1);
	...
	zend_string *property_exceptions_enabled_name = zend_string_init_interned("exceptions_enabled", sizeof("exceptions_enabled") - 1, 1);
