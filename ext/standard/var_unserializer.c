...
#line 668 "ext/standard/var_unserializer.c"
{
	YYCTYPE yych;
...
#line 962 "ext/standard/var_unserializer.c"
yy25:
	yych = *++YYCURSOR;
	if (yych <= ',') {
		if (yych != '+') goto yy18;
...
#line 1043 "ext/standard/var_unserializer.c"
yy39:
	yych = *++YYCURSOR;
	if (yych == '+') goto yy40;
	if (yych <= '/') goto yy18;
...
#line 1248 "ext/standard/var_unserializer.c"
yy65:
	yych = *++YYCURSOR;
	if (yych <= ',') {
		if (yych != '+') goto yy18;
...
#line 1496 "ext/standard/var_unserializer.c"
}
#line 1047 "ext/standard/var_unserializer.re"
