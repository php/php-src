...
#line 336 "ext/standard/url_scanner_ex.c"
{
	YYCTYPE yych;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
...
#line 349 "ext/standard/url_scanner_ex.c"
yy15:
	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
...
#line 361 "ext/standard/url_scanner_ex.c"
}
...
#line 369 "ext/standard/url_scanner_ex.c"
{
	YYCTYPE yych;
...
#line 442 "ext/standard/url_scanner_ex.c"
yy24:
	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
...
#line 623 "ext/standard/url_scanner_ex.c"
{
	YYCTYPE yych;
	if((YYLIMIT - YYCURSOR) < 2) YYFILL(2);
	yych = *YYCURSOR;
