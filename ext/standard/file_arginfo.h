 ...
 * Stub hash: c11e1ab842c8c617d5f155e393b21a1ee4bb7335 */
...
static void register_file_symbols(int module_number)
{
	...
	REGISTER_LONG_CONSTANT("STREAM_CRYPTO_METHOD_DTLS_CLIENT", STREAM_CRYPTO_METHOD_DTLS_CLIENT, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("STREAM_CRYPTO_METHOD_DTLSv1_2_CLIENT", STREAM_CRYPTO_METHOD_DTLSv1_2_CLIENT, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("STREAM_CRYPTO_METHOD_DTLS_SERVER", STREAM_CRYPTO_METHOD_DTLS_SERVER, CONST_PERSISTENT);
