 ...
 * Stub hash: 8033a99193900363685724e66c0f1d35de6a4d7e */
...
#if defined(HAVE_GLOB) && (defined(PHP_GLOB_BRACE) && PHP_GLOB_BRACE != 0)
	REGISTER_LONG_CONSTANT("GLOB_BRACE", PHP_GLOB_BRACE, CONST_PERSISTENT);
#endif
#if defined(HAVE_GLOB) && (defined(PHP_GLOB_ERR) && PHP_GLOB_ERR != 0)
	REGISTER_LONG_CONSTANT("GLOB_ERR", PHP_GLOB_ERR, CONST_PERSISTENT);
#endif
#if defined(HAVE_GLOB) && (defined(PHP_GLOB_MARK) && PHP_GLOB_MARK != 0)
	REGISTER_LONG_CONSTANT("GLOB_MARK", PHP_GLOB_MARK, CONST_PERSISTENT);
#endif
#if defined(HAVE_GLOB) && (defined(PHP_GLOB_NOCHECK) && PHP_GLOB_NOCHECK != 0)
	REGISTER_LONG_CONSTANT("GLOB_NOCHECK", PHP_GLOB_NOCHECK, CONST_PERSISTENT);
#endif
#if defined(HAVE_GLOB) && (defined(PHP_GLOB_NOESCAPE) && PHP_GLOB_NOESCAPE != 0)
	REGISTER_LONG_CONSTANT("GLOB_NOESCAPE", PHP_GLOB_NOESCAPE, CONST_PERSISTENT);
#endif
#if defined(HAVE_GLOB) && (defined(PHP_GLOB_NOSORT) && PHP_GLOB_NOSORT != 0)
