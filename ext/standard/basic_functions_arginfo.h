 ...
 * Stub hash: 54ed5dc64bedd68ca20e67338281508eac62a21b */
...
static void register_basic_functions_symbols(int module_number)
{
	...
	REGISTER_STRING_CONSTANT("CRYPT_STD_DES", "", CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("CRYPT_EXT_DES", "_", CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("CRYPT_MD5", "$1$", CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("CRYPT_BLOWFISH", "$2y$", CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("CRYPT_SHA256", "$5$", CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("CRYPT_SHA512", "$6$", CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("CRYPT_SCRYPT", "$7$", CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("CRYPT_GOST_YESCRYPT", "$gy$", CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("CRYPT_YESCRYPT", "$y$", CONST_PERSISTENT);
