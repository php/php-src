 ...
 * Stub hash: 2b46cff21a597937b990a1919d142e2351df28c8 */
...
{
	REGISTER_LONG_CONSTANT("POLL_READ", PHP_POLL_READ, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("POLL_WRITE", PHP_POLL_WRITE, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("POLL_ERROR", PHP_POLL_ERROR, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("POLL_HUP", PHP_POLL_HUP, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("POLL_RDHUP", PHP_POLL_RDHUP, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("POLL_ONESHOT", PHP_POLL_ONESHOT, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("POLL_ET", PHP_POLL_ET, CONST_PERSISTENT);
