...
static const php_password_algo* php_password_algo_find_zval_ex(
	zend_string *arg_str, zend_long arg_long, zend_bool arg_is_null, const php_password_algo* default_algo
) {
	if (arg_is_null) {
		return default_algo;
	}
