...
PHPAPI zend_string *php_strip_tags(zend_string *zend_string_r, size_t len, const char *allow, size_t allow_len);
PHPAPI zend_string *php_strip_tags_ex(zend_string *zend_string_r, size_t len, const char *allow, size_t allow_len, zend_bool allow_tag_spaces);
