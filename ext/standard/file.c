...
PHP_MINIT_FUNCTION(file)
{
	...
	REGISTER_LONG_CONSTANT("STREAM_CRYPTO_METHOD_NTLS_CLIENT",   STREAM_CRYPTO_METHOD_NTLS_CLIENT,    CONST_CS|CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("STREAM_CRYPTO_METHOD_NTSL_SERVER",   STREAM_CRYPTO_METHOD_NTLS_SERVER,    CONST_CS|CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("STREAM_CRYPTO_PROTO_NTLS",   STREAM_CRYPTO_METHOD_NTLS_SERVER,    CONST_CS|CONST_PERSISTENT);
