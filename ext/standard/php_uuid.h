 ...
 * // Do NOT be used in real-world applications!
 * php_random_bytes_silent(&uuid, PHP_UUID_LEN);
 * 
 * // Set version to future reserved, because we are using a custom UUID.
 * // Once more, do NOT use this in real-world applications!
 * uuid.bytes = (uuid.bytes[8] & 0x1F) | 0xE0;
 * 
 ...
 * ```
 *
 * @author [Richard Fussenegger](mailto:php@fleshgrinder.com)
 * @see [Wikipedia: Universally unique identifier][Wikipedia]
 * @see [RFC 4122]
 *
...
/**
 * UUID variants as defined in [RFC 4122](https://tools.ietf.org/html/rfc4122#section-4.1.1).
 */
typedef enum php_uuid_variant {
	/** Reserved, NCS backward compatibility: `0b0xx` */
	PHP_UUID_VARIANT_NCS = 0,

	/** The variant of this implementation and specified in RFC 4122: `0b10x` */
	PHP_UUID_VARIANT_RFC4122 = 1,

	/** Reserved, Microsoft Corporation backward compatibility: `0b110` */
 ...
 *
 * @see [RFC 4122: Section 4.2](https://tools.ietf.org/html/rfc4122#section-4.2)
 * @see [Wikipedia: Universally unique identifier (Version 1)][Wikipedia]
 * [Wikipedia]: https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_1_.28date-time_and_MAC_address.29
 */
 ...
 *
 * @see [RFC 4122: Section 4.2](https://tools.ietf.org/html/rfc4122#section-4.2)
 * @see [Wikipedia: Universally unique identifier (Version 2)][Wikipedia]
 * [Wikipedia]: https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_2_.28date-time_and_MAC_Address.2C_DCE_security_version.29
 */
 ...
 * @see [Wikipedia: Universally unique identifiers (versions 3 and 5)](https://en.wikipedia.org/wiki/Universally_unique_identifier#Versions_3_and_5_.28namespace_name-based.29)
 */
 ...
 * @see [Wikipedia: Universally unique identifiers (version 4)](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_.28random.29)
 */
 ...
 *
 * @warning
 * [RFC 4122] recommends [v5](@ref php_uuid_create_v5()) over this one and
 * states that version 3 UUIDs should be used if backwards compatibility is
 * required only. This is because MD5 has a higher collision probability
 * compared to SHA1, which is used by version 5; regardless of the truncation!
 *
 * Version 3 UUIDs are generated by [MD5](https://en.wikipedia.org/wiki/MD5)
 * hashing the concatenated namespace's byte representation and the given name.
 * The namespace itself must be another UUID. This can be any UUID, or one of
 * the predefined ones:
 *
 * - php_uuid_namespace_dns()
 * - php_uuid_namespace_oid()
 * - php_uuid_namespace_url()
 * - php_uuid_namespace_x500()
 *
 ...
 * [RFC 4122]: https://tools.ietf.org/html/rfc4122
 * @see [RFC 4122: Section 4.3](https://tools.ietf.org/html/rfc4122#section-4.3)
 * @see [Wikipedia: Universally unique identifier (Versions 3 and 5)](https://en.wikipedia.org/wiki/Universally_unique_identifier#Versions_3_and_5_.28namespace_name-based.29)
 ...
 * case, the php_uuid_create_v5() implementation should be used.
 *
 * ### Examples
 * 
 * ```c
 ...
 *
 * @see [RFC 4122: Section 4.4](https://tools.ietf.org/html/rfc4122#section-4.4)
 * @see [Wikipedia: Universally unique identifier (Version 4)](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_.28random.29)
 ...
 * @throws Exception if `throw` is set to true and it was not possible to gather
 ...
 *
 * Version 5 UUIDs are generated by [SHA-1](https://en.wikipedia.org/wiki/SHA-1)
 * hashing the concatenated namespace's byte representation and the given name.
 * The namespace itself must be another UUID. This can be any UUID, or one of
 * the predefined ones:
 *
 ...
 * implementation generates #PHP_UUID_VARIANT_RFC4122 UUIDs only, however,
 * parsing and construction of other variants is supported.
 *
 * @see [RFC 4122: Section 4.1.1](http://tools.ietf.org/html/rfc4122#section-4.1.1)
 * @see [Wikipedia: Universally unique identifier (Variants)](https://en.wikipedia.org/wiki/Universally_unique_identifier#Variants)
 ...
 * #PHP_UUID_VARIANT_RFC4122 was used to generate the UUID. This implementation
 * generates #PHP_UUID_VARIANT_RFC4122 UUIDs only, but allows parsing and
 * construction of other variants.
 *
 * @see [RFC 4122: Section 4.1.3](http://tools.ietf.org/html/rfc4122#section-4.1.3)
 * @see [Wikipedia: Universally unique identifier (Versions)](https://en.wikipedia.org/wiki/Universally_unique_identifier#Versions)
 ...
 *     values [1, 5] correspond to one of the version constants. The others are
 *     not defined in RFC 4122.
 */
 ...
 *
 * @see [RFC 4122: Appendix C](https://tools.ietf.org/html/rfc4122#appendix-C)
 * @see [Wikipedia: Domain Name System](https://en.wikipedia.org/wiki/Domain_Name_System)
 */
...
*
 * @see [RFC 4122: Appendix C](https://tools.ietf.org/html/rfc4122#appendix-C)
 * @see [Wikipedia: Object identifier](https://en.wikipedia.org/wiki/Object_identifier)
 */
 ...
 *
 * @see [RFC 4122: Appendix C](https://tools.ietf.org/html/rfc4122#appendix-C)
 * @see [Wikipedia: URL](https://en.wikipedia.org/wiki/URL)
 */
 ...
 *
 * @see [RFC 4122: Appendix C](https://tools.ietf.org/html/rfc4122#appendix-C)
 * @see [Wikipedia: X.500](https://en.wikipedia.org/wiki/X.500)
 * @see [Wikipedia: Lightweight Directory Access Protocol](https://en.wikipedia.org/wiki/Lightweight_Directory_Access_Protocol)
 */
 ...
 *
 * @see [RFC 4122: Section 4.1.7](https://tools.ietf.org/html/rfc4122#section-4.1.7)
 * @see [Wikipedia: Universally unique identifier (Nil UUID)](https://en.wikipedia.org/wiki/Universally_unique_identifier#Nil_UUID)
 */
 ...
 * @return `1` if the UUID contains the special nil UUID; `0` otherwise.
 */
 ...
 * @param[in] input_len
 * @return #SUCCESS() if the string was parsed as UUID; #FAILURE() otherwise.
 * @throws UUIDParseException if parsing fails.
 */
