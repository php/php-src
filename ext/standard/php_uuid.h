...
/** UUID representation lengths (without terminating NUL character). */
PHPAPI extern const uint8_t PHP_UUID_LEN;
PHPAPI extern const uint8_t PHP_UUID_HEX_LEN;
PHPAPI extern const uint8_t PHP_UUID_STRING_LEN;
