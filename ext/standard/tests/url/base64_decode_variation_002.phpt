...
-- Arg value array() --
Error: 2 - base64_decode() expects parameter 2 to be boolean (or integer, float or string), array given, %s(%d)
NULL
...
Error: 2 - base64_decode() expects parameter 2 to be boolean (or integer, float or string), object given, %s(%d)
NULL
...
-- Arg value resource --
Error: 2 - base64_decode() expects parameter 2 to be boolean (or integer, float or string), resource given, %s(%d)
NULL
===Done===
