...
Arg value 10.5
TypeError: get_class_methods(): Argument #1 ($object_or_class) must be an object or a valid class name, float given
...
Arg value Array
TypeError: get_class_methods(): Argument #1 ($object_or_class) must be an object or a valid class name, array given
Error: 2 - Array to string conversion
...
Arg value 
TypeError: get_class_methods(): Argument #1 ($object_or_class) must be an object or a valid class name, null given

Arg value 
TypeError: get_class_methods(): Argument #1 ($object_or_class) must be an object or a valid class name, null given

Arg value 1
TypeError: get_class_methods(): Argument #1 ($object_or_class) must be an object or a valid class name, true given

Arg value 
TypeError: get_class_methods(): Argument #1 ($object_or_class) must be an object or a valid class name, false given
