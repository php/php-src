...
Warning: interface_exists() expects parameter 2 to be boolean (or integer, float or string), array given in %sinterface_exists_variation2.php on line %d
NULL
...
Warning: interface_exists() expects parameter 2 to be boolean (or integer, float or string), object given in %sinterface_exists_variation2.php on line %d
NULL
