...
Arg value Array 
Error: 2 - trait_exists() expects parameter 2 to be boolean (or integer, float or string), array given, %s(81)
NULL
Error: 8 - Array to string conversion, %strait_exists_variation_002.php(%d)
...
Arg value  
Error: 2 - trait_exists() expects parameter 2 to be boolean (or integer, float or string), object given, %s(81)
NULL
