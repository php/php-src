...
--empty array--
Error: 2 - long2ip() expects parameter 1 to be integer (or convertible float, convertible string or boolean), array given, %slong2ip_variation1.php(%d)
NULL
...
Error: 2 - long2ip() expects parameter 1 to be integer (or convertible float, convertible string or boolean), object given, %slong2ip_variation1.php(%d)
NULL
...
--resource--
Error: 2 - long2ip() expects parameter 1 to be integer (or convertible float, convertible string or boolean), resource given, %slong2ip_variation1.php(%d)
NULL
===DONE===
