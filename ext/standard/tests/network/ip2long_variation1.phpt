...
--empty array--
Error: 2 - ip2long() expects parameter 1 to be string (or integer, float, boolean or convertible object), array given, %s(%d)
NULL
...
--resource--
Error: 2 - ip2long() expects parameter 1 to be string (or integer, float, boolean or convertible object), resource given, %s(%d)
NULL
===DONE===
