...
Warning: arsort() expects parameter 2 to be integer, string given in %s on line %d
bool(false)
array(3) {
  [1]=>
  int(10)
...
Warning: arsort() expects parameter 2 to be integer, object given in %s on line %d
bool(false)
array(3) {
  [1]=>
  int(10)
...
Warning: arsort() expects parameter 2 to be integer, resource given in %s on line %d
bool(false)
array(3) {
  [1]=>
  int(10)
