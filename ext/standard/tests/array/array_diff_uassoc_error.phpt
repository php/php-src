...
Warning: array_diff_uassoc() expects at least 3 parameters, 2 given in %s on line %d
NULL

-- Testing array_diff_uassoc() function with no arguments --

Warning: array_diff_uassoc() expects at least 3 parameters, 0 given in %s on line %d
NULL
===DONE===
