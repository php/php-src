--TEST--
Test array_merge_deep() function : usage variations - associative array with different keys
--FILE--
<?php
/*
 * Testing the functionality of array_merge_deep() by passing different
 * associative arrays having different keys to $arr1 argument.
*/

echo "*** Testing array_merge_deep() : assoc. array with diff. keys to \$arr1 argument ***\n";
...
// loop through each sub array of $arrays and check the behavior of array_merge_deep()
$iterator = 1;
...
?>
--EXPECTF--
*** Testing array_merge_deep() : assoc. array with diff. keys to $arr1 argument ***
