--TEST--
Test array_merge_deep() function : usage variations - different arrays for 'arr1' argument
--FILE--
<?php
/*
* Passing different arrays to $arr1 argument and testing whether
* array_merge_deep() behaves in an expected way.
*/

echo "*** Testing array_merge_deep() : Passing different arrays to \$arr1 argument ***\n";
...
?>
--EXPECT--
*** Testing array_merge_deep() : Passing different arrays to $arr1 argument ***
-- Iteration 1 --
-- With default argument --
array(2) {
  [0]=>
