...
Warning: array_slice() expects parameter 4 to be boolean (or integer, float or string), array given in %s on line %d
NULL
...
Warning: array_slice() expects parameter 4 to be boolean (or integer, float or string), object given in %s on line %d
NULL
