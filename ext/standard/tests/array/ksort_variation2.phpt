...
Warning: ksort() expects parameter 2 to be integer (or convertible float, convertible string or boolean), non-numeric string given in %s on line %d
bool(false)
array(3) {
  [10]=>
  int(10)
...
Warning: ksort() expects parameter 2 to be integer (or convertible float, convertible string or boolean), object given in %s on line %d
bool(false)
array(3) {
  [10]=>
  int(10)
...
Warning: ksort() expects parameter 2 to be integer (or convertible float, convertible string or boolean), resource given in %s on line %d
bool(false)
array(3) {
  [10]=>
  int(10)
