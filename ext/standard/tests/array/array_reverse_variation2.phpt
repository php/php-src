...
Warning: array_reverse() expects parameter 2 to be boolean (or integer, float or string), array given in %s on line %d
NULL
-- Iteration 11 --
...
Warning: array_reverse() expects parameter 2 to be boolean (or integer, float or string), object given in %s on line %d
NULL
-- Iteration 24 --
array(6) {
  [0]=>
...
Warning: array_reverse() expects parameter 2 to be boolean (or integer, float or string), resource given in %s on line %d
NULL
Done
