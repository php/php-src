--TEST--
Test array_merge_deep() function : usage variations - associative array with different values
--FILE--
<?php
/*
...
echo "*** Testing array_merge_deep() : assoc. array with diff. values to \$arr1 argument ***\n";
...
?>
--EXPECTF--
*** Testing array_merge_deep() : assoc. array with diff. values to $arr1 argument ***
-- Iteration 1 --
-- With default argument --
array(2) {
  [0]=>
