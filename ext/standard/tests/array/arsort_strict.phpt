--TEST--
Test arsort() function : SORT_STRICT flag
--FILE--
<?php
/*
 * Testing arsort() by providing object/array values to check the
 * "strict equality" sort order (SORT_STRICT).
 */

echo "*** Testing arsort() : SORT_STRICT flag ***\n";
...
$temp_array = [
	...
	'float' => &$pi,
	'callable' => fn($x) => $x + 1,
	// We expect all object type values to be first in the sorted result
	'obj1' => $obj1, 'obj2' => $obj2, 'obj3' => $obj3, 'obj4' => $obj4,
	'obj5' => $obj5, 'obj6' => $obj6, 'obj7' => $obj7, 'obj8' => $obj8,
	// We expect all array type values to follow them
	'arr1' => $arr1, 'arr2' => $arr2, 'arr3' => $arr3, 'arr4' => $arr4,
	'arr5' => $arr5, 'arr6' => $arr6, 'arr7' => $arr7, 'arr8' => $arr8,
];
var_dump( arsort($temp_array, SORT_STRICT) ); // expect : bool(true)
...
?>
--EXPECTF--
*** Testing arsort() : SORT_STRICT flag ***
