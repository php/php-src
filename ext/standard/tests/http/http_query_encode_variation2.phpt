--TEST--
Test http_query_encode() function: usage variations - first arguments as multidimensional array and second argument present/not present
--CREDITS--
...
echo http_query_encode($mDimensional) . PHP_EOL;
echo http_query_encode($mDimensional, [
