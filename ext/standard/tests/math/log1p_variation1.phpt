...
Warning: log1p() expects parameter 1 to be float (or integer, convertible string or boolean), array given in %s on line %d
NULL
...
Warning: log1p() expects parameter 1 to be float (or integer, convertible string or boolean), object given in %s on line %d
NULL
...
Warning: log1p() expects parameter 1 to be float (or integer, convertible string or boolean), resource given in %s on line %d
NULL
===Done===
