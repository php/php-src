...
Warning: hypot() expects parameter 1 to be float (or integer, convertible string or boolean), non-numeric string given in %s on line %d
NULL
...
Warning: hypot() expects parameter 1 to be float (or integer, convertible string or boolean), array given in %s on line %d
NULL
...
Warning: hypot() expects parameter 1 to be float (or integer, convertible string or boolean), object given in %s on line %d
NULL
...
Warning: hypot() expects parameter 1 to be float (or integer, convertible string or boolean), resource given in %s on line %d
NULL
===Done===
