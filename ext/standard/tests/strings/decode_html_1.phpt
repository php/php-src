...
$test_cases = array(
    array("Cats &amp; Dogs", HtmlContext::Text, 0, null),
    array('<abbr title="&lt;tags&gt;">', HtmlContext::Attribute, 13, 12),
    array('&notinyourcode', HtmlContext::Text, 0, null),
    array('&notinyourcode', HtmlContext::Attribute, 0, null),
    array('&#x000000000000000041', HtmlContext::Text, 0, null),
    array('&#x000000000000000041;', HtmlContext::Text, 0, null),
    array('&#x000000000000000041', HtmlContext::Attribute, 0, null),
    array('&#x000000000000000041;', HtmlContext::Attribute, 0, null),
    array('&#x4E&#117mbers &# can &bernou; &bernou weird', HtmlContext::Text, 0, null),
    array('&#00000', HtmlContext::Text, 0, null),
    array('&#00000;', HtmlContext::Text, 0, null),
    array('&#xd83c;', HtmlContext::Text, 0, null),
