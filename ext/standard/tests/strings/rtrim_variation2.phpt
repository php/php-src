...
Warning: rtrim() expects parameter 2 to be string (Unicode or binary), array given in %s on line %d
NULL
-- Iteration 11 --
...
Warning: rtrim() expects parameter 2 to be string (Unicode or binary), resource given in %s on line %d
NULL
-- Iteration 21 --
unicode(19) "!---Hello World---!"
-- Iteration 22 --
