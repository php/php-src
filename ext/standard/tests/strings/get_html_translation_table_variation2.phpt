...
Warning: get_html_translation_table() expects parameter 2 to be integer (or convertible float, convertible string or boolean), array given in %s on line %s
NULL
-- Iteration 2 --
...
Warning: get_html_translation_table() expects parameter 2 to be integer (or convertible float, convertible string or boolean), object given in %s on line %s
NULL
-- Iteration 13 --
...
Warning: get_html_translation_table() expects parameter 2 to be integer (or convertible float, convertible string or boolean), resource given in %s on line %s
NULL
-- Iteration 18 --
array(3) {
  ["&"]=>
