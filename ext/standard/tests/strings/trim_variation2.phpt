...
Warning: trim() expects parameter 2 to be string (or integer, float, boolean or convertible object), array given in %s on line %d
NULL
-- Iteration 11 --
...
Warning: trim() expects parameter 2 to be string (or integer, float, boolean or convertible object), resource given in %s on line %d
NULL
-- Iteration 21 --
string(19) "!---Hello World---!"
-- Iteration 22 --
