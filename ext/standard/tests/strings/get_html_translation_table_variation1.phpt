...
Warning: get_html_translation_table() expects parameter 1 to be integer (or convertible float, convertible string or boolean), array given in %s on line %d
NULL
...
Warning: get_html_translation_table() expects parameter 1 to be integer (or convertible float, convertible string or boolean), object given in %s on line %d
NULL
...
Warning: get_html_translation_table() expects parameter 1 to be integer (or convertible float, convertible string or boolean), resource given in %s on line %d
NULL
