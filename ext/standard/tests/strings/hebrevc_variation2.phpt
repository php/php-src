...
Warning: hebrevc() expects parameter 2 to be integer (or convertible float, convertible string or boolean), array given in %s on line %d
NULL
-- Iteration 11 --
...
Warning: hebrevc() expects parameter 2 to be integer (or convertible float, convertible string or boolean), object given in %s on line %d
NULL
-- Iteration 25 --

Warning: hebrevc() expects parameter 2 to be integer (or convertible float, convertible string or boolean), resource given in %s on line %d
NULL
-- Iteration 26 --
string(241) ".The hebrevcc function converts logical Hebrew text to visual text<br />
) This function is similar to hebrevc() with the difference that it converts newlines<br />
