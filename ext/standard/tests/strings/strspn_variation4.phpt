...
Warning: strspn() expects parameter 4 to be integer (or convertible float, convertible string or boolean), array given in %s on line %d
NULL
...
Warning: strspn() expects parameter 4 to be integer (or convertible float, convertible string or boolean), object given in %s on line %d
NULL
...
Warning: strspn() expects parameter 4 to be integer (or convertible float, convertible string or boolean), resource given in %s on line %d
NULL
Done
