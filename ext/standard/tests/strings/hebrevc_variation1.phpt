...
Warning: hebrevc() expects parameter 1 to be binary string, array given in %s on line %d
NULL
-- Iteration 11 --
...
Warning: hebrevc() expects parameter 1 to be binary string, resource given in %s on line %d
NULL
-- Iteration 21 --
bool(false)
-- Iteration 22 --
