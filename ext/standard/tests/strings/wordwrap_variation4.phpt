...
Warning: wordwrap() expects parameter 4 to be boolean (or integer, float or string), array given in %s on line %d
NULL
-- Iteration 11 --
...
Warning: wordwrap() expects parameter 4 to be boolean (or integer, float or string), object given in %s on line %d
NULL
-- Iteration 18 --
string(39) "testing<br />\nwordwrap<br />\nfunction"
-- Iteration 19 --
