...
Warning: getrusage() expects parameter 1 to be integer (or convertible float, convertible string or boolean), non-numeric string given in %s on line %d

-- Testing getrusage() function with invalid argument - ARRAY--

Warning: getrusage() expects parameter 1 to be integer (or convertible float, convertible string or boolean), array given in %s on line %d

-- Testing getrusage() function with invalid argument - OBJECT --

Warning: getrusage() expects parameter 1 to be integer (or convertible float, convertible string or boolean), object given in %s on line %d

-- Testing getrusage() function with invalid argument - RESOURCE --

Warning: getrusage() expects parameter 1 to be integer (or convertible float, convertible string or boolean), resource given in %s on line %d
===DONE===
