...
--empty array--
Error: 2 - mkdir() expects parameter 3 to be boolean (or integer, float or string), array given, %s(%d)
...
Error: 2 - mkdir() expects parameter 3 to be boolean (or integer, float or string), object given, %s(%d)
