...
Warning: disk_free_space() expects parameter 1 to be a valid path, null-byte-containing string given in %s on line %d
NULL

Warning: diskfreespace() expects parameter 1 to be a valid path, null-byte-containing string given in %s on line %d
NULL
