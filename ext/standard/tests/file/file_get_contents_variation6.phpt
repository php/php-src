...
--empty array--
Error: 2 - file_get_contents() expects parameter 5 to be integer (or convertible float, convertible string or boolean), array given, %s(%d)
NULL
...
Error: 2 - file_get_contents() expects parameter 5 to be integer (or convertible float, convertible string or boolean), object given, %s(%d)
NULL
