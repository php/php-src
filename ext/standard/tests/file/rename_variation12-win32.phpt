...
Warning: rename(): The system cannot find the path specified. (%s/renameVar11/renameVar11Sub/..///renameVar11Sub//..//../renameVar11Sub/renameMe.tmp) (code: 3) in %s on line %d
bool(false)

-- Iteration 6 --

Warning: rename(): The system cannot find the path specified. (%s/renameVar11/renameVar11Sub/BADDIR/renameMe.tmp) (code: 3) in %s on line %d
bool(false)
...
Warning: rename(): The system cannot find the path specified. (BADDIR/renameMe.tmp) (code: 3) in %s on line %d
bool(false)
