...
--empty array--
Error: 2 - fopen() expects parameter 3 to be boolean (or integer, float or string), array given, %s(%d)
bool(false)
...
Error: 2 - fopen() expects parameter 3 to be boolean (or integer, float or string), object given, %s(%d)
bool(false)
