...
--empty array--
Error: 2 - readfile() expects parameter 2 to be boolean (or integer, float or string), array given, %s(%d)
File not read
...
Error: 2 - readfile() expects parameter 2 to be boolean (or integer, float or string), object given, %s(%d)
File not read
