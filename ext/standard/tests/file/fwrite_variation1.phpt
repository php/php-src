...
Notice: fwrite(Resource id #%d, '222222222222222...'): Write of 1024 bytes failed with errno=9 Bad file descriptor in %s on line %d
bool(false)
int(0)
bool(false)
int(2)
...
Notice: fwrite(Resource id #%d, 'text text text ...'): Write of 1024 bytes failed with errno=9 Bad file descriptor in %s on line %d
bool(false)
int(0)
bool(false)
int(2)
...
Notice: fwrite(Resource id #%d, 'line\nline of te...'): Write of 1024 bytes failed with errno=9 Bad file descriptor in %s on line %d
bool(false)
int(0)
bool(false)
int(2)
...
Notice: fwrite(Resource id #%d, 'ab12 ab12 ab12 ...'): Write of 1024 bytes failed with errno=9 Bad file descriptor in %s on line %d
bool(false)
int(0)
bool(false)
int(2)
