...
Warning: stream_select(Array, NULL, NULL, 0): test_wrapper_base::stream_cast is not implemented! in %s on line %d

Warning: stream_select(Array, NULL, NULL, 0): Cannot represent a stream of type user-space as a select()able descriptor in %s on line %d
...
Warning: stream_select(Array, NULL, NULL, 0): test_wrapper::stream_cast must return a stream resource in %s on line %d
...
Warning: stream_select(Array, NULL, NULL, 0): test_wrapper::stream_cast must not return itself in %s on line %d
