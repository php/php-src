...
--empty array--
Error: 2 - file_get_contents() expects parameter 2 to be boolean (or integer, float or string), array given, %s(%d)
NULL
...
Error: 2 - file_get_contents() expects parameter 2 to be boolean (or integer, float or string), object given, %s(%d)
NULL
