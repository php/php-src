...
--empty array--
Error: 2 - parse_ini_file() expects parameter 2 to be boolean (or integer, float or string), array given, %s(%d)
bool(false)
...
Error: 2 - parse_ini_file() expects parameter 2 to be boolean (or integer, float or string), object given, %s(%d)
bool(false)
