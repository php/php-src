...
--empty array--
Error: 2 - chmod() expects parameter 2 to be integer (or convertible float, convertible string or boolean), array given, %s(%d)
NULL
...
Error: 2 - chmod() expects parameter 2 to be integer (or convertible float, convertible string or boolean), object given, %s(%d)
NULL
