...
Notice: fread(Resource id #%d, 1024): Read of 8192 bytes failed with errno=9 Bad file descriptor in %s on line %d
OK
int(0)
bool(false)
...
Notice: fread(Resource id #%d, 1000): Read of 8192 bytes failed with errno=9 Bad file descriptor in %s on line %d
OK
int(0)
bool(false)
