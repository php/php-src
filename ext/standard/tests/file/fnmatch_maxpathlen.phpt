...
?>
--EXPECTF--
Warning: fnmatch('blah', 'blah           ...'): Filename exceeds the maximum allowed length of 1024 characters in %s on line %d
bool(false)

Warning: fnmatch('blah           ...', 'blah'): Pattern exceeds the maximum allowed length of 1024 characters in %s on line %d
bool(false)
