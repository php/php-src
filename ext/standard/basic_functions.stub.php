...
namespace {
    ...
    */
     ...
     * @refcount 1
     */
    function proc_open(array|string $command, array $descriptor_spec, &$pipes, ?string $cwd = null, ?array $env_vars = null, ?array $options = null): Standard\Process|false {}

    function proc_close(Standard\Process $process): int {}

    function proc_terminate(Standard\Process $process, int $signal = 15): bool {}

    /**
     * @return array<string, bool|int|string>
     * @refcount 1
     */
    function proc_get_status(Standard\Process $process): array {}
    #endif
