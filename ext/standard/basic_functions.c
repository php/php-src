...
/* }}} */
/* {{{ operators.c */
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_add, 0, 0, 1)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_sub, 0, 0, 1)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_mul, 0, 0, 2)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_div, 0, 0, 2)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_mod, 0, 0, 2)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_bitwise_and, 0, 0, 2)
	...
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_bitwise_or, 0, 0, 2)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_bitwise_xor, 0, 0, 2)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_bitwise_not, 0, 0, 1)
	ZEND_ARG_INFO(0, a)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_shift_left, 0, 0, 2)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_shift_right, 0, 0, 2)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_equal, 0, 0, 2)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_identical, 0, 0, 2)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_not_equal, 0, 0, 2)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_not_identical, 0, 0, 2)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_less_than, 0, 0, 2)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_greater_than, 0, 0, 2)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_less_than_or_equal_to, 0, 0, 2)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_greater_than_or_equal_to, 0, 0, 2)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_spaceship, 0, 0, 2)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_boolean_and, 0, 0, 2)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_boolean_or, 0, 0, 2)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_boolean_xor, 0, 0, 2)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_boolean_not, 0, 0, 1)
	ZEND_ARG_INFO(0, a)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_operator_concat, 0, 0, 2)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
/* }}} */
...
# endif
	...
	/* functions from operators.c */
	PHP_NAMED_FE(+,			php_operator_add,								arginfo_operator_add)
	PHP_NAMED_FE(-,			php_operator_sub,								arginfo_operator_sub)
	PHP_NAMED_FE(*,			php_operator_mul,								arginfo_operator_mul)
	PHP_NAMED_FE(/,			php_operator_div,								arginfo_operator_div)
	PHP_NAMED_FE(%,			php_operator_mod,								arginfo_operator_mod)
	PHP_NAMED_FE(**,		php_operator_pow,								arginfo_operator_pow)
	PHP_NAMED_FE(&,			php_operator_bitwise_and,						arginfo_operator_bitwise_and)
	PHP_NAMED_FE(|,			php_operator_bitwise_or,						arginfo_operator_bitwise_or)
	PHP_NAMED_FE(^,			php_operator_bitwise_xor,						arginfo_operator_bitwise_xor)
	PHP_NAMED_FE(~,			php_operator_bitwise_not,						arginfo_operator_bitwise_not)
	PHP_NAMED_FE(<<,		php_operator_shift_left,						arginfo_operator_shift_left)
	PHP_NAMED_FE(>>,		php_operator_shift_right,						arginfo_operator_shift_right)
	PHP_NAMED_FE(==,		php_operator_equal,								arginfo_operator_equal)
	PHP_NAMED_FE(===,		php_operator_identical,							arginfo_operator_identical)
	PHP_NAMED_FE(!=,		php_operator_not_equal,							arginfo_operator_not_equal)
	PHP_NAMED_FE(<>,		php_operator_not_equal,							arginfo_operator_not_equal)
	PHP_NAMED_FE(!==,		php_operator_not_identical,						arginfo_operator_not_identical)
	PHP_NAMED_FE(<,			php_operator_less_than,							arginfo_operator_less_than)
	PHP_NAMED_FE(>,			php_operator_greater_than,						arginfo_operator_greater_than)
	PHP_NAMED_FE(<=,		php_operator_less_than_or_equal_to,				arginfo_operator_less_than_or_equal_to)
	PHP_NAMED_FE(>=,		php_operator_greater_than_or_equal_to,			arginfo_operator_greater_than_or_equal_to)
	PHP_NAMED_FE(<=>,		php_operator_spaceship,							arginfo_operator_spaceship)
	PHP_NAMED_FE(&&,		php_operator_boolean_and,						arginfo_operator_boolean_and)
	PHP_NAMED_FE(and,		php_operator_boolean_and,						arginfo_operator_boolean_and)
	PHP_NAMED_FE(||,		php_operator_boolean_or,						arginfo_operator_boolean_or)
	PHP_NAMED_FE(or,		php_operator_boolean_or,						arginfo_operator_boolean_or)
	PHP_NAMED_FE(xor,		php_operator_boolean_xor,						arginfo_operator_boolean_xor)
	PHP_NAMED_FE(!,			php_operator_boolean_not,						arginfo_operator_boolean_not)
	PHP_NAMED_FE(.,			php_operator_concat,							arginfo_operator_concat)
