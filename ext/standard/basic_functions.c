...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(arginfo_exp, IS_DOUBLE, 0)
	ZEND_ARG_INFO(0, number)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(arginfo_expm1, IS_DOUBLE, 0)
	ZEND_ARG_INFO(0, number)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(arginfo_log1p, IS_DOUBLE, 0)
	ZEND_ARG_INFO(0, number)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(arginfo_log10, IS_DOUBLE, 0)
	ZEND_ARG_INFO(0, number)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(arginfo_sqrt, IS_DOUBLE, 0)
	ZEND_ARG_INFO(0, number)
ZEND_END_ARG_INFO()
