...
ZEND_BEGIN_ARG_INFO(arginfo_array_value_first, 0)
	ZEND_ARG_INFO(0, arg) /* ARRAY_INFO(0, arg, 0) */
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_array_value_last, 0)
	ZEND_ARG_INFO(0, arg) /* ARRAY_INFO(0, arg, 0) */
ZEND_END_ARG_INFO()
...
# endif
	...
	PHP_FE(array_value_first,												arginfo_array_value_first)
	PHP_FE(array_value_last,												arginfo_array_value_last)
