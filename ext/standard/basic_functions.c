...
ZEND_BEGIN_ARG_INFO_EX(arginfo_str_ibegins, 0, 0, 2)
	ZEND_ARG_INFO(0, haystack)
	ZEND_ARG_INFO(0, needle)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_str_iends, 0, 0, 2)
	ZEND_ARG_INFO(0, haystack)
	ZEND_ARG_INFO(0, needle)
ZEND_END_ARG_INFO()
...
static const zend_function_entry basic_functions[] = { /* {{{ */
	...
	PHP_FE(str_begins,														arginfo_str_begins)
	PHP_FE(str_ibegins,														arginfo_str_ibegins)
	PHP_FE(str_ends,														arginfo_str_ends)
	PHP_FE(str_iends,														arginfo_str_iends)
