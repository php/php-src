...
ZEND_BEGIN_ARG_INFO_EX(arginfo_str_starts_with, 0, 0, 2)
	ZEND_ARG_INFO(0, haystack)
	ZEND_ARG_INFO(0, needle)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_str_starts_with_ci, 0, 0, 2)
	ZEND_ARG_INFO(0, haystack)
	ZEND_ARG_INFO(0, needle)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_str_ends_with_ci, 0, 0, 2)
	ZEND_ARG_INFO(0, haystack)
	ZEND_ARG_INFO(0, needle)
ZEND_END_ARG_INFO()
...
static const zend_function_entry basic_functions[] = { /* {{{ */
	...
	PHP_FE(str_starts_with_ci,												arginfo_str_starts_with_ci)
	PHP_FE(str_ends_with,													arginfo_str_ends_with)
	PHP_FE(str_ends_with_ci,												arginfo_str_ends_with_ci)
