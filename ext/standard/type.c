...
void register_type_constants(INIT_FUNC_ARGS)
{
	...
	REGISTER_STRING_CONSTANT("TYPE_FALSE",    TYPE_FALSE,    CONST_CS | CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("TYPE_INT",      TYPE_INT,      CONST_CS | CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("TYPE_ITERABLE", TYPE_ITERABLE, CONST_CS | CONST_PERSISTENT);
