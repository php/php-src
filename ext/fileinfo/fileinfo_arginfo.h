...
static void register_fileinfo_symbols(int module_number)
{
	...
	zval attribute_Deprecated_func_finfo_close_0_arg0;
	zend_string *attribute_Deprecated_func_finfo_close_0_arg0_str = zend_string_init("8.5", strlen("8.5"), 1);
	ZVAL_STR(&attribute_Deprecated_func_finfo_close_0_arg0, attribute_Deprecated_func_finfo_close_0_arg0_str);
	ZVAL_COPY_VALUE(&attribute_Deprecated_func_finfo_close_0->args[0].value, &attribute_Deprecated_func_finfo_close_0_arg0);
	attribute_Deprecated_func_finfo_close_0->args[0].name = ZSTR_KNOWN(ZEND_STR_SINCE);
	zval attribute_Deprecated_func_finfo_close_0_arg1;
	...
	ZVAL_STR(&attribute_Deprecated_func_finfo_close_0_arg1, attribute_Deprecated_func_finfo_close_0_arg1_str);
	ZVAL_COPY_VALUE(&attribute_Deprecated_func_finfo_close_0->args[1].value, &attribute_Deprecated_func_finfo_close_0_arg1);
