 ...
 * Stub hash: 6a3df5ee99ac76469ac239ba818aa579c07863fa */
...
static void register_com_extension_consts(int module_number)
{
    ...
    REGISTER_LONG_CONSTANT("VARCMP_LT", VARCMP_LT, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("VARCMP_EQ", VARCMP_EQ, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("VARCMP_GT", VARCMP_GT, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("VARCMP_NULL", VARCMP_NULL, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("LOCALE_SYSTEM_DEFAULT", LOCALE_SYSTEM_DEFAULT, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("LOCALE_NEUTRAL", LOCALE_NEUTRAL, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("NORM_IGNORECASE", NORM_IGNORECASE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("NORM_IGNORENONSPACE", NORM_IGNORENONSPACE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("NORM_IGNORESYMBOLS", NORM_IGNORESYMBOLS, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("NORM_IGNOREWIDTH", NORM_IGNOREWIDTH, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("NORM_IGNOREKANATYPE", NORM_IGNOREKANATYPE, CONST_CS | CONST_PERSISTENT);
#if defined(NORM_IGNOREKASHIDA)
    REGISTER_LONG_CONSTANT("NORM_IGNOREKASHIDA", NORM_IGNOREKASHIDA, CONST_CS | CONST_PERSISTENT);
#endif
    REGISTER_LONG_CONSTANT("DISP_E_DIVBYZERO", DISP_E_DIVBYZERO, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("DISP_E_OVERFLOW", DISP_E_OVERFLOW, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("DISP_E_BADINDEX", DISP_E_BADINDEX, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("MK_E_UNAVAILABLE", MK_E_UNAVAILABLE, CONST_CS | CONST_PERSISTENT);
#if SIZEOF_ZEND_LONG == 8
    REGISTER_LONG_CONSTANT("VT_UI8", VT_UI8, CONST_CS | CONST_PERSISTENT);
#endif
#if SIZEOF_ZEND_LONG == 8
    REGISTER_LONG_CONSTANT("VT_I8", VT_I8, CONST_CS | CONST_PERSISTENT);
#endif
}
