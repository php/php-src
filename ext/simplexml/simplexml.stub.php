...
class SimpleXMLElement {
    ...
    /** @return array */
    public function getNamespaces(bool $recursve = false) {}

    /** @return array|false */
    public function getDocNamespaces(bool $recursve = false, bool $from_root = true) {}
    ...
    public function __construct(string $data, int $options = 0, bool $data_is_url = false, string $ns = null, bool $is_prefix = false) {}
