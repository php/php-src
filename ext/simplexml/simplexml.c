...
static const zend_function_entry sxe_functions[] = { /* {{{ */
	...
	SXE_ME(attributes,             arginfo_SimpleXMLElement_attributes, ZEND_ACC_PUBLIC)
	...
	SXE_ME(getName,                arginfo_SimpleXMLElement_getName, ZEND_ACC_PUBLIC)
	SXE_ME(addChild,               arginfo_SimpleXMLElement_addChild, ZEND_ACC_PUBLIC)
	SXE_ME(addAttribute,           arginfo_SimpleXMLElement_addAttribute, ZEND_ACC_PUBLIC)
	SXE_ME(__toString,             arginfo_SimpleXMLElement___toString, ZEND_ACC_PUBLIC)
	SXE_ME(count,                  arginfo_SimpleXMLElement_count, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
/* }}} */
