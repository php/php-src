...
#define arginfo_SimpleXMLElement_saveXML arginfo_SimpleXMLElement_asXML

ZEND_BEGIN_ARG_INFO_EX(arginfo_SimpleXMLElement_getNamespaces, 0, 0, 0)
	ZEND_ARG_TYPE_INFO(0, recursve, _IS_BOOL, 0)
ZEND_END_ARG_INFO()
...
#define arginfo_SimpleXMLElement_attributes arginfo_SimpleXMLElement_children

ZEND_BEGIN_ARG_INFO_EX(arginfo_SimpleXMLElement___construct, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, data, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, options, IS_LONG, 0)
...
#define arginfo_SimpleXMLElement_addAttribute arginfo_SimpleXMLElement_addChild

ZEND_BEGIN_ARG_INFO_EX(arginfo_SimpleXMLElement_getName, 0, 0, 0)
ZEND_END_ARG_INFO()

#define arginfo_SimpleXMLElement___toString arginfo_SimpleXMLElement_getName

#define arginfo_SimpleXMLElement_count arginfo_SimpleXMLElement_getName
