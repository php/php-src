...
static zend_class_entry *register_class_SoapParam(void)
{
	...
	zend_string *property_param_name_name = zend_string_init_interned("param_name", sizeof("param_name") - 1, 1);
	...
	zend_string *property_param_data_name = zend_string_init_interned("param_data", sizeof("param_data") - 1, 1);
...
static zend_class_entry *register_class_SoapHeader(void)
{
	...
	zend_string *property_namespace_name = zend_string_init_interned("namespace", sizeof("namespace") - 1, 1);
	...
	zend_string *property_data_name = zend_string_init_interned("data", sizeof("data") - 1, 1);
	...
	zend_string *property_mustUnderstand_name = zend_string_init_interned("mustUnderstand", sizeof("mustUnderstand") - 1, 1);
	...
	zend_string *property_actor_name = zend_string_init_interned("actor", sizeof("actor") - 1, 1);
...
static zend_class_entry *register_class_SoapFault(zend_class_entry *class_entry_Exception)
{
	...
	zend_string *property_faultstring_name = zend_string_init_interned("faultstring", sizeof("faultstring") - 1, 1);
	...
	zend_string *property_faultcode_name = zend_string_init_interned("faultcode", sizeof("faultcode") - 1, 1);
	...
	zend_string *property_faultcodens_name = zend_string_init_interned("faultcodens", sizeof("faultcodens") - 1, 1);
	...
	zend_string *property_faultactor_name = zend_string_init_interned("faultactor", sizeof("faultactor") - 1, 1);
	...
	zend_string *property_detail_name = zend_string_init_interned("detail", sizeof("detail") - 1, 1);
	...
	zend_string *property__name_name = zend_string_init_interned("_name", sizeof("_name") - 1, 1);
	...
	zend_string *property_headerfault_name = zend_string_init_interned("headerfault", sizeof("headerfault") - 1, 1);
	...
	zend_string *property_lang_name = zend_string_init_interned("lang", sizeof("lang") - 1, 1);
...
static zend_class_entry *register_class_SoapVar(void)
{
	...
	zend_string *property_enc_type_name = zend_string_init_interned("enc_type", sizeof("enc_type") - 1, 1);
	...
	zend_string *property_enc_value_name = zend_string_init_interned("enc_value", sizeof("enc_value") - 1, 1);
	...
	zend_string *property_enc_stype_name = zend_string_init_interned("enc_stype", sizeof("enc_stype") - 1, 1);
	...
	zend_string *property_enc_ns_name = zend_string_init_interned("enc_ns", sizeof("enc_ns") - 1, 1);
	...
	zend_string *property_enc_name_name = zend_string_init_interned("enc_name", sizeof("enc_name") - 1, 1);
	...
	zend_string *property_enc_namens_name = zend_string_init_interned("enc_namens", sizeof("enc_namens") - 1, 1);
...
static zend_class_entry *register_class_SoapServer(void)
{
	...
	zend_string *property___soap_fault_name = zend_string_init_interned("__soap_fault", sizeof("__soap_fault") - 1, 1);
...
static zend_class_entry *register_class_SoapClient(void)
{
	...
	zend_string *property_uri_name = zend_string_init_interned("uri", sizeof("uri") - 1, 1);
	...
	zend_string *property_style_name = zend_string_init_interned("style", sizeof("style") - 1, 1);
	...
	zend_string *property_use_name = zend_string_init_interned("use", sizeof("use") - 1, 1);
	...
	zend_string *property_location_name = zend_string_init_interned("location", sizeof("location") - 1, 1);
	...
	zend_string *property_compression_name = zend_string_init_interned("compression", sizeof("compression") - 1, 1);
	...
	zend_string *property_sdl_name = zend_string_init_interned("sdl", sizeof("sdl") - 1, 1);
	...
	zend_string *property_typemap_name = zend_string_init_interned("typemap", sizeof("typemap") - 1, 1);
	...
	zend_string *property_httpsocket_name = zend_string_init_interned("httpsocket", sizeof("httpsocket") - 1, 1);
	...
	zend_string *property_httpurl_name = zend_string_init_interned("httpurl", sizeof("httpurl") - 1, 1);
	...
	zend_string *property__login_name = zend_string_init_interned("_login", sizeof("_login") - 1, 1);
	...
	zend_string *property__password_name = zend_string_init_interned("_password", sizeof("_password") - 1, 1);
	...
	zend_string *property__use_digest_name = zend_string_init_interned("_use_digest", sizeof("_use_digest") - 1, 1);
	...
	zend_string *property__digest_name = zend_string_init_interned("_digest", sizeof("_digest") - 1, 1);
	...
	zend_string *property__proxy_host_name = zend_string_init_interned("_proxy_host", sizeof("_proxy_host") - 1, 1);
	...
	zend_string *property__proxy_port_name = zend_string_init_interned("_proxy_port", sizeof("_proxy_port") - 1, 1);
	...
	zend_string *property__proxy_login_name = zend_string_init_interned("_proxy_login", sizeof("_proxy_login") - 1, 1);
	...
	zend_string *property__proxy_password_name = zend_string_init_interned("_proxy_password", sizeof("_proxy_password") - 1, 1);
	...
	zend_string *property__exceptions_name = zend_string_init_interned("_exceptions", sizeof("_exceptions") - 1, 1);
	...
	zend_string *property__encoding_name = zend_string_init_interned("_encoding", sizeof("_encoding") - 1, 1);
	...
	zend_string *property__classmap_name = zend_string_init_interned("_classmap", sizeof("_classmap") - 1, 1);
	...
	zend_string *property__features_name = zend_string_init_interned("_features", sizeof("_features") - 1, 1);
	...
	zend_string *property__connection_timeout_name = zend_string_init_interned("_connection_timeout", sizeof("_connection_timeout") - 1, 1);
	...
	zend_string *property__stream_context_name = zend_string_init_interned("_stream_context", sizeof("_stream_context") - 1, 1);
	...
	zend_string *property__user_agent_name = zend_string_init_interned("_user_agent", sizeof("_user_agent") - 1, 1);
	...
	zend_string *property__keep_alive_name = zend_string_init_interned("_keep_alive", sizeof("_keep_alive") - 1, 1);
	...
	zend_string *property__ssl_method_name = zend_string_init_interned("_ssl_method", sizeof("_ssl_method") - 1, 1);
	...
	zend_string *property__soap_version_name = zend_string_init_interned("_soap_version", sizeof("_soap_version") - 1, 1);
	...
	zend_string *property__use_proxy_name = zend_string_init_interned("_use_proxy", sizeof("_use_proxy") - 1, 1);
	...
	zend_string *property__cookies_name = zend_string_init_interned("_cookies", sizeof("_cookies") - 1, 1);
	...
	zend_string *property___default_headers_name = zend_string_init_interned("__default_headers", sizeof("__default_headers") - 1, 1);
	...
	zend_string *property___last_request_name = zend_string_init_interned("__last_request", sizeof("__last_request") - 1, 1);
	...
	zend_string *property___last_response_name = zend_string_init_interned("__last_response", sizeof("__last_response") - 1, 1);
	...
	zend_string *property___last_request_headers_name = zend_string_init_interned("__last_request_headers", sizeof("__last_request_headers") - 1, 1);
	...
	zend_string *property___last_response_headers_name = zend_string_init_interned("__last_response_headers", sizeof("__last_response_headers") - 1, 1);
