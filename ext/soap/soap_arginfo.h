 ...
 * Stub hash: 4b3f45c3d10b2cb66258a02faf50a34e20ee2f35 */
...
static zend_class_entry *register_class_SoapParam(void)
{
	...
	ZVAL_NULL(&property_param_name_default_value);
	zend_string *property_param_name_name = zend_string_init("param_name", sizeof("param_name") - 1, 1);
	zend_declare_property_ex(class_entry, property_param_name_name, &property_param_name_default_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release(property_param_name_name);

	zval property_param_data_default_value;
	ZVAL_NULL(&property_param_data_default_value);
...
static zend_class_entry *register_class_SoapHeader(void)
{
	...
	ZVAL_NULL(&property_namespace_default_value);
	zend_string *property_namespace_name = zend_string_init("namespace", sizeof("namespace") - 1, 1);
	zend_declare_property_ex(class_entry, property_namespace_name, &property_namespace_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	ZVAL_NULL(&property_mustUnderstand_default_value);
	zend_string *property_mustUnderstand_name = zend_string_init("mustUnderstand", sizeof("mustUnderstand") - 1, 1);
	zend_declare_property_ex(class_entry, property_mustUnderstand_name, &property_mustUnderstand_default_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release(property_mustUnderstand_name);

	zval property_actor_default_value;
	ZVAL_NULL(&property_actor_default_value);
	zend_string *property_actor_name = zend_string_init("actor", sizeof("actor") - 1, 1);
	zend_declare_property_ex(class_entry, property_actor_name, &property_actor_default_value, ZEND_ACC_PUBLIC, NULL);
...
static zend_class_entry *register_class_SoapVar(void)
{
	...
	ZVAL_NULL(&property_enc_type_default_value);
	zend_string *property_enc_type_name = zend_string_init("enc_type", sizeof("enc_type") - 1, 1);
	zend_declare_property_ex(class_entry, property_enc_type_name, &property_enc_type_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property_enc_stype_name, &property_enc_stype_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property_enc_ns_name, &property_enc_ns_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property_enc_name_name, &property_enc_name_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property_enc_namens_name, &property_enc_namens_default_value, ZEND_ACC_PUBLIC, NULL);
...
static zend_class_entry *register_class_SoapClient(void)
{
	...
	zend_declare_property_ex(class_entry, property_uri_name, &property_uri_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property_style_name, &property_style_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property_use_name, &property_use_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property_location_name, &property_location_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property__login_name, &property__login_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property__password_name, &property__password_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property__digest_name, &property__digest_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property__proxy_host_name, &property__proxy_host_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property__proxy_port_name, &property__proxy_port_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property__proxy_login_name, &property__proxy_login_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property__proxy_password_name, &property__proxy_password_default_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release(property__proxy_password_name);

	zval property_trace_default_value;
	ZVAL_NULL(&property_trace_default_value);
	zend_string *property_trace_name = zend_string_init("trace", sizeof("trace") - 1, 1);
	zend_declare_property_ex(class_entry, property_trace_name, &property_trace_default_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release(property_trace_name);

	zval property__exceptions_default_value;
	ZVAL_NULL(&property__exceptions_default_value);
	zend_string *property__exceptions_name = zend_string_init("_exceptions", sizeof("_exceptions") - 1, 1);
	zend_declare_property_ex(class_entry, property__exceptions_name, &property__exceptions_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property__classmap_name, &property__classmap_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property__features_name, &property__features_default_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release(property__features_name);

	zval property__connection_timeout_default_value;
	ZVAL_NULL(&property__connection_timeout_default_value);
	zend_string *property__connection_timeout_name = zend_string_init("_connection_timeout", sizeof("_connection_timeout") - 1, 1);
	zend_declare_property_ex(class_entry, property__connection_timeout_name, &property__connection_timeout_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property__user_agent_name, &property__user_agent_default_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release(property__user_agent_name);

	zval property__keep_alive_default_value;
	ZVAL_NULL(&property__keep_alive_default_value);
	zend_string *property__keep_alive_name = zend_string_init("_keep_alive", sizeof("_keep_alive") - 1, 1);
	zend_declare_property_ex(class_entry, property__keep_alive_name, &property__keep_alive_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property__ssl_method_name, &property__ssl_method_default_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release(property__ssl_method_name);

	zval property__soap_version_default_value;
	ZVAL_NULL(&property__soap_version_default_value);
	zend_string *property__soap_version_name = zend_string_init("_soap_version", sizeof("_soap_version") - 1, 1);
	zend_declare_property_ex(class_entry, property__soap_version_name, &property__soap_version_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property___last_request_name, &property___last_request_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property___last_response_name, &property___last_response_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property___last_request_headers_name, &property___last_request_headers_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property___default_headers_name, &property___default_headers_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property__use_proxy_name, &property__use_proxy_default_value, ZEND_ACC_PUBLIC, NULL);
