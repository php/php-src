...
static zend_class_entry *register_class_SoapParam(void)
{
	...
	zend_string_release_ex(property_param_name_name, 1);
	...
	zend_string_release_ex(property_param_data_name, 1);
...
static zend_class_entry *register_class_SoapHeader(void)
{
	...
	zend_string_release_ex(property_namespace_name, 1);
	...
	zend_string_release_ex(property_data_name, 1);
	...
	zend_string_release_ex(property_mustUnderstand_name, 1);
	...
	zend_string_release_ex(property_actor_name, 1);
...
static zend_class_entry *register_class_SoapFault(zend_class_entry *class_entry_Exception)
{
	...
	zend_string_release_ex(property_faultstring_name, 1);
	...
	zend_string_release_ex(property_faultcode_name, 1);
	...
	zend_string_release_ex(property_faultcodens_name, 1);
	...
	zend_string_release_ex(property_faultactor_name, 1);
	...
	zend_string_release_ex(property_detail_name, 1);
	...
	zend_string_release_ex(property__name_name, 1);
	...
	zend_string_release_ex(property_headerfault_name, 1);
...
static zend_class_entry *register_class_SoapVar(void)
{
	...
	zend_string_release_ex(property_enc_type_name, 1);
	...
	zend_string_release_ex(property_enc_value_name, 1);
	...
	zend_string_release_ex(property_enc_stype_name, 1);
	...
	zend_string_release_ex(property_enc_ns_name, 1);
	...
	zend_string_release_ex(property_enc_name_name, 1);
	...
	zend_string_release_ex(property_enc_namens_name, 1);
...
static zend_class_entry *register_class_SoapServer(void)
{
	...
	zend_string_release_ex(property___soap_fault_name, 1);
...
static zend_class_entry *register_class_SoapClient(void)
{
	...
	zend_string_release_ex(property_uri_name, 1);
	...
	zend_string_release_ex(property_style_name, 1);
	...
	zend_string_release_ex(property_use_name, 1);
	...
	zend_string_release_ex(property_location_name, 1);
	...
	zend_string_release_ex(property_compression_name, 1);
	...
	zend_string_release_ex(property_sdl_name, 1);
	...
	zend_string_release_ex(property_typemap_name, 1);
	...
	zend_string_release_ex(property_httpsocket_name, 1);
	...
	zend_string_release_ex(property_httpurl_name, 1);
	...
	zend_string_release_ex(property__login_name, 1);
	...
	zend_string_release_ex(property__password_name, 1);
	...
	zend_string_release_ex(property__use_digest_name, 1);
	...
	zend_string_release_ex(property__digest_name, 1);
	...
	zend_string_release_ex(property__proxy_host_name, 1);
	...
	zend_string_release_ex(property__proxy_port_name, 1);
	...
	zend_string_release_ex(property__proxy_login_name, 1);
	...
	zend_string_release_ex(property__proxy_password_name, 1);
	...
	zend_string_release_ex(property__exceptions_name, 1);
	...
	zend_string_release_ex(property__encoding_name, 1);
	...
	zend_string_release_ex(property__classmap_name, 1);
	...
	zend_string_release_ex(property__features_name, 1);
	...
	zend_string_release_ex(property__connection_timeout_name, 1);
	...
	zend_string_release_ex(property__stream_context_name, 1);
	...
	zend_string_release_ex(property__user_agent_name, 1);
	...
	zend_string_release_ex(property__keep_alive_name, 1);
	...
	zend_string_release_ex(property__ssl_method_name, 1);
	...
	zend_string_release_ex(property__soap_version_name, 1);
	...
	zend_string_release_ex(property__use_proxy_name, 1);
	...
	zend_string_release_ex(property__cookies_name, 1);
	...
	zend_string_release_ex(property___default_headers_name, 1);
	...
	zend_string_release_ex(property___last_request_name, 1);
	...
	zend_string_release_ex(property___last_response_name, 1);
	...
	zend_string_release_ex(property___last_request_headers_name, 1);
	...
	zend_string_release_ex(property___last_response_headers_name, 1);
