...
PHP_MINIT_FUNCTION(soap)
{
	...
	*/
	...
	REGISTER_LONG_CONSTANT("SOAP_SSL_METHOD_TLSv1_0", SOAP_SSL_METHOD_TLSv1_0, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SOAP_SSL_METHOD_TLSv1_1", SOAP_SSL_METHOD_TLSv1_1, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SOAP_SSL_METHOD_TLSv1_2", SOAP_SSL_METHOD_TLSv1_2, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SOAP_SSL_METHOD_TLSv1_3", SOAP_SSL_METHOD_TLSv1_3, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SOAP_SSL_METHOD_TLS_ANY", SOAP_SSL_METHOD_TLS_ANY, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SOAP_SSL_METHOD_ANY", SOAP_SSL_METHOD_ANY, CONST_CS | CONST_PERSISTENT);
