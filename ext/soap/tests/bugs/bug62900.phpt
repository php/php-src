...
?>
--EXPECTF--
Fatal error: Uncaught SoapFault exception: [WSDL] SoapClient::__construct(): Parsing Schema: can't import schema from '%s/ext/soap/tests/bugs/bug62900.xsd', unexpected 'targetNamespace'='http://www.w3.org/XML/1998/namespacex', expected 'http://www.w3.org/XML/1998/namespace' in %s:%d
Stack trace:
#0 %s(%d): SoapClient->__construct(%s)
#1 {main}
  thrown in %s on line %d

Fatal error: Uncaught SoapFault exception: [WSDL] SoapClient::__construct(): Parsing Schema: can't import schema from '%s/ext/soap/tests/bugs/bug62900.xsd', missing 'targetNamespace', expected 'http://www.w3.org/XML/1998/namespace' in %s:%d
Stack trace:
#0 %s(%d): SoapClient->__construct(%s)
#1 {main}
  thrown in %s on line %d

Fatal error: Uncaught SoapFault exception: [WSDL] SoapClient::__construct(): Parsing Schema: can't import schema from '%s/ext/soap/tests/bugs/bug62900.xsd', unexpected 'targetNamespace'='http://www.w3.org/XML/1998/namespacex', expected no 'targetNamespace' in %s:%d
Stack trace:
#0 %s(%d): SoapClient->__construct(%s)
#1 {main}
  thrown in %s on line %d

Fatal error: Uncaught SoapFault exception: [WSDL] SoapClient::__construct(): Parsing WSDL: Couldn't bind to service in %s:%d
Stack trace:
#0 %s(%d): SoapClient->__construct(%s)
#1 {main}
  thrown in %s on line %d
