...
#define float8get(V,M)    { ((float8get_union *)&(V))->m[0] = *((int32_t*) (M)); \
                            ((float8get_union *)&(V))->m[1] = *(((int32_t*) (M))+1); }
#define float8store(T,V) { *((int32_t *) (T))     = ((float8get_union *)&(V))->m[0]; \
                           *(((int32_t *) (T))+1) = ((float8get_union *)&(V))->m[1]; }
