...
static const zend_function_entry class_FFI_methods[] = {
	ZEND_RAW_FENTRY("cdef", zim_FFI_cdef, arginfo_class_FFI_cdef, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("load", zim_FFI_load, arginfo_class_FFI_load, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("scope", zim_FFI_scope, arginfo_class_FFI_scope, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("new", zim_FFI_new, arginfo_class_FFI_new, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("free", zim_FFI_free, arginfo_class_FFI_free, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("cast", zim_FFI_cast, arginfo_class_FFI_cast, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("type", zim_FFI_type, arginfo_class_FFI_type, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("typeof", zim_FFI_typeof, arginfo_class_FFI_typeof, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("arrayType", zim_FFI_arrayType, arginfo_class_FFI_arrayType, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("addr", zim_FFI_addr, arginfo_class_FFI_addr, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("sizeof", zim_FFI_sizeof, arginfo_class_FFI_sizeof, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("alignof", zim_FFI_alignof, arginfo_class_FFI_alignof, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("memcpy", zim_FFI_memcpy, arginfo_class_FFI_memcpy, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("memcmp", zim_FFI_memcmp, arginfo_class_FFI_memcmp, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("memset", zim_FFI_memset, arginfo_class_FFI_memset, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("string", zim_FFI_string, arginfo_class_FFI_string, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("isNull", zim_FFI_isNull, arginfo_class_FFI_isNull, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_FE_END
};
...
static const zend_function_entry class_FFI_CType_methods[] = {
	ZEND_RAW_FENTRY("getName", zim_FFI_CType_getName, arginfo_class_FFI_CType_getName, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getKind", zim_FFI_CType_getKind, arginfo_class_FFI_CType_getKind, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getSize", zim_FFI_CType_getSize, arginfo_class_FFI_CType_getSize, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getAlignment", zim_FFI_CType_getAlignment, arginfo_class_FFI_CType_getAlignment, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getAttributes", zim_FFI_CType_getAttributes, arginfo_class_FFI_CType_getAttributes, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getEnumKind", zim_FFI_CType_getEnumKind, arginfo_class_FFI_CType_getEnumKind, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getArrayElementType", zim_FFI_CType_getArrayElementType, arginfo_class_FFI_CType_getArrayElementType, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getArrayLength", zim_FFI_CType_getArrayLength, arginfo_class_FFI_CType_getArrayLength, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getPointerType", zim_FFI_CType_getPointerType, arginfo_class_FFI_CType_getPointerType, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getStructFieldNames", zim_FFI_CType_getStructFieldNames, arginfo_class_FFI_CType_getStructFieldNames, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getStructFieldOffset", zim_FFI_CType_getStructFieldOffset, arginfo_class_FFI_CType_getStructFieldOffset, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getStructFieldType", zim_FFI_CType_getStructFieldType, arginfo_class_FFI_CType_getStructFieldType, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getFuncABI", zim_FFI_CType_getFuncABI, arginfo_class_FFI_CType_getFuncABI, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getFuncReturnType", zim_FFI_CType_getFuncReturnType, arginfo_class_FFI_CType_getFuncReturnType, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getFuncParameterCount", zim_FFI_CType_getFuncParameterCount, arginfo_class_FFI_CType_getFuncParameterCount, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getFuncParameterType", zim_FFI_CType_getFuncParameterType, arginfo_class_FFI_CType_getFuncParameterType, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};
