...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_BcMath_Number_comp, 0, 1, IS_LONG, 0)
	ZEND_ARG_OBJ_TYPE_MASK(0, num, BcMath\\\116umber, MAY_BE_STRING|MAY_BE_LONG, NULL)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, scale, IS_LONG, 1, "null")
ZEND_END_ARG_INFO()
...
ZEND_METHOD(BcMath_Number, comp);
...
static const zend_function_entry class_BcMath_Number_methods[] = {
	...
	ZEND_ME(BcMath_Number, comp, arginfo_class_BcMath_Number_comp, ZEND_ACC_PUBLIC)
...
static zend_class_entry *register_class_BcMath_Number(zend_class_entry *class_entry_Stringable)
{
	...
	zend_declare_typed_property(class_entry, property_scale_name, &property_scale_default_value, ZEND_ACC_PUBLIC|ZEND_ACC_READONLY, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
