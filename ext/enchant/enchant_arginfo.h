...
static void register_enchant_symbols(int module_number)
{
	...
	zend_string *attribute_Deprecated_func_enchant_broker_free_0_arg0_str = zend_string_init("EnchantBroker object is freed automatically", strlen("EnchantBroker object is freed automatically"), 1);
	...
	attribute_Deprecated_func_enchant_broker_free_0->args[0].name = ZSTR_KNOWN(ZEND_STR_MESSAGE);
	zval attribute_Deprecated_func_enchant_broker_free_0_arg1;
	zend_string *attribute_Deprecated_func_enchant_broker_free_0_arg1_str = zend_string_init("8.1", strlen("8.1"), 1);
	...
	attribute_Deprecated_func_enchant_broker_free_0->args[1].name = ZSTR_KNOWN(ZEND_STR_SINCE);
	...
	zend_string *attribute_Deprecated_func_enchant_broker_set_dict_path_0_arg0_str = zend_string_init("8.1", strlen("8.1"), 1);
	...
	zend_string *attribute_Deprecated_func_enchant_broker_get_dict_path_0_arg0_str = zend_string_init("8.1", strlen("8.1"), 1);
	...
	zend_string *attribute_Deprecated_func_enchant_broker_free_dict_0_arg0_str = zend_string_init("EnchantDictionary object is freed automatically", strlen("EnchantDictionary object is freed automatically"), 1);
	...
	attribute_Deprecated_func_enchant_broker_free_dict_0->args[0].name = ZSTR_KNOWN(ZEND_STR_MESSAGE);
	zval attribute_Deprecated_func_enchant_broker_free_dict_0_arg1;
	zend_string *attribute_Deprecated_func_enchant_broker_free_dict_0_arg1_str = zend_string_init("8.1", strlen("8.1"), 1);
	...
	attribute_Deprecated_func_enchant_broker_free_dict_0->args[1].name = ZSTR_KNOWN(ZEND_STR_SINCE);

	zend_attribute *attribute_Deprecated_func_enchant_dict_add_to_personal_0 = zend_add_function_attribute(zend_hash_str_find_ptr(CG(function_table), "enchant_dict_add_to_personal", sizeof("enchant_dict_add_to_personal") - 1), ZSTR_KNOWN(ZEND_STR_DEPRECATED), 1);
	zval attribute_Deprecated_func_enchant_dict_add_to_personal_0_arg0;
	zend_string *attribute_Deprecated_func_enchant_dict_add_to_personal_0_arg0_str = zend_string_init("8.1", strlen("8.1"), 1);
	...
	zend_attribute *attribute_Deprecated_func_enchant_dict_is_in_session_0 = zend_add_function_attribute(zend_hash_str_find_ptr(CG(function_table), "enchant_dict_is_in_session", sizeof("enchant_dict_is_in_session") - 1), ZSTR_KNOWN(ZEND_STR_DEPRECATED), 1);
	zval attribute_Deprecated_func_enchant_dict_is_in_session_0_arg0;
	zend_string *attribute_Deprecated_func_enchant_dict_is_in_session_0_arg0_str = zend_string_init("8.1", strlen("8.1"), 1);
