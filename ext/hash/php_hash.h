...
typedef void (*php_hash_update_func_t)(void *context, const unsigned char *buf, php_size_t count);
...
typedef struct _php_hash_ops {
	...
	php_size_t digest_size;
	php_size_t block_size;
	php_size_t context_size;
} php_hash_ops;
...
static inline void php_hash_bin2hex(char *out, const unsigned char *in, php_size_t in_len)
{
