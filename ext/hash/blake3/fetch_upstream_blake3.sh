...
git clone --branch '1.5.5' -n --depth=1 --filter=tree:0 'https://github.com/BLAKE3-team/BLAKE3.git' 'upstream_blake3'
cd upstream_blake3
git sparse-checkout set --no-cone /LICENSE_CC0 /c/blake3.c /c/blake3.h  /c/blake3_avx2.c  /c/blake3_avx2_x86-64_unix.S \
