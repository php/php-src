...
/* {{{ RIPEMDDecode
   ...
   a multiple of 4.
 */
static void RIPEMDDecode(php_hash_uint32 *output, const unsigned char *input, php_size_t len)
{
	php_size_t i, j;
...
/* {{{ PHP_RIPEMD128Update
   ...
   context.
 */
PHP_HASH_API void PHP_RIPEMD128Update(PHP_RIPEMD128_CTX * context, const unsigned char *input, php_size_t inputLen)
{
...
/* {{{ PHP_RIPEMD256Update
   ...
   context.
 */
PHP_HASH_API void PHP_RIPEMD256Update(PHP_RIPEMD256_CTX * context, const unsigned char *input, php_size_t inputLen)
{
	unsigned int i, index, partLen;
...
/* {{{ PHP_RIPEMD160Update
   ...
   context.
 */
PHP_HASH_API void PHP_RIPEMD160Update(PHP_RIPEMD160_CTX * context, const unsigned char *input, php_size_t inputLen)
{
	unsigned int i, index, partLen;
...
/* {{{ PHP_RIPEMD320Update
   ...
   context.
 */
PHP_HASH_API void PHP_RIPEMD320Update(PHP_RIPEMD320_CTX * context, const unsigned char *input, php_size_t inputLen)
{
	unsigned int i, index, partLen;
