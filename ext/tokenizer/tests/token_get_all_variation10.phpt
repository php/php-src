 ...
 * integer const - T_LNUMBER(307)
 * float/double/real const - T_DNUMBER(308)
 * string cosnt - T_CONSTANT_ESCAPED_STRING(317)
 * bool const (no tokens specified) - T_UNKNOWN(309)
 * null const (no tokens specified) - T_UNKNOWN(309)
*/
