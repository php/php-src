...
void tokenizer_register_constants(INIT_FUNC_ARGS) {
	...
	REGISTER_LONG_CONSTANT("T_BINARY_DOUBLE", T_BINARY_DOUBLE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_BINARY_HEREDOC", T_BINARY_HEREDOC, CONST_CS | CONST_PERSISTENT);
...
char *get_token_type_name(int token_type)
{
	switch (token_type) {
		...
		case T_BINARY_CAST: return "T_BINARY_CAST";
		case T_UNICODE_CAST: return "T_UNICODE_CAST";
		...
		case T_BINARY_DOUBLE: return "T_BINARY_DOUBLE";
		case T_BINARY_HEREDOC: return "T_BINARY_HEREDOC";
