...
void tokenizer_register_constants(INIT_FUNC_ARGS) {
	...
	REGISTER_LONG_CONSTANT("T_COMMA", T_COMMA, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("T_EQUAL", T_EQUAL, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("T_QUESTION_MARK", T_QUESTION_MARK, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_COLON", T_COLON, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("T_BW_OR", T_BW_OR, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_BW_XOR", T_BW_XOR, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_BW_AND", T_BW_AND, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("T_IS_SMALLER", T_IS_SMALLER, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_IS_SMALLER_OR_EQUAL", T_IS_SMALLER_OR_EQUAL, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_IS_GREATER", T_IS_GREATER, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("T_PLUS", T_PLUS, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_MINUS", T_MINUS, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_DOT", T_DOT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_MULT", T_MULT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_DIV", T_DIV, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_MOD", T_MOD, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_BOOL_NOT", T_BOOL_NOT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_INSTANCEOF", T_INSTANCEOF, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_BW_NOT", T_BW_NOT, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("T_NUMERIC_CAST", T_NUMERIC_CAST, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_SCALAR_CAST", T_SCALAR_CAST, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("T_AT", T_AT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_RBRACKET", T_RBRACKET, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("T_INT_HINT", T_INT_HINT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_DOUBLE_HINT", T_DOUBLE_HINT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_RESOURCE_HINT", T_RESOURCE_HINT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_OBJECT_HINT", T_OBJECT_HINT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_SCALAR_HINT", T_SCALAR_HINT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_NUMERIC_HINT", T_NUMERIC_HINT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_DOLLAR", T_DOLLAR, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("T_T_DOLLAR", T_T_DOLLAR, CONST_CS | CONST_PERSISTENT);
...
char *get_token_type_name(int token_type)
{
	switch (token_type) {
		...
		case T_QUESTION_MARK: return "T_QUESTION_MARK";
		case T_COLON: return "T_COLON";
		case T_BOOLEAN_OR: return "T_BOOLEAN_OR";
		case T_BOOLEAN_AND: return "T_BOOLEAN_AND";
		case T_BW_OR: return "T_BW_OR";
		case T_BW_XOR: return "T_BW_XOR";
		case T_BW_AND: return "T_BW_AND";
		...
		case T_IS_SMALLER: return "T_IS_SMALLER";
		case T_IS_SMALLER_OR_EQUAL: return "T_IS_SMALLER_OR_EQUAL";
		case T_IS_GREATER: return "T_IS_GREATER";
		...
		case T_BOOL_NOT: return "T_BOOL_NOT";
		case T_INSTANCEOF: return "T_INSTANCEOF";
		case T_BW_NOT: return "T_BW_NOT";
