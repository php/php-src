...
void tokenizer_register_constants(INIT_FUNC_ARGS) {
	...
	REGISTER_LONG_CONSTANT("T_NULLABLE_INT_CAST", T_NULLABLE_INT_CAST, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_DOUBLE_CAST", T_DOUBLE_CAST, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_NULLABLE_DOUBLE_CAST", T_NULLABLE_DOUBLE_CAST, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_STRING_CAST", T_STRING_CAST, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_NULLABLE_STRING_CAST", T_NULLABLE_STRING_CAST, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_ARRAY_CAST", T_ARRAY_CAST, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_NULLABLE_ARRAY_CAST", T_NULLABLE_ARRAY_CAST, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_OBJECT_CAST", T_OBJECT_CAST, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_NULLABLE_OBJECT_CAST", T_NULLABLE_OBJECT_CAST, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_BOOL_CAST", T_BOOL_CAST, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_NULLABLE_BOOL_CAST", T_NULLABLE_BOOL_CAST, CONST_CS | CONST_PERSISTENT);
...
char *get_token_type_name(int token_type)
{
	switch (token_type) {
		...
		case T_NULLABLE_INT_CAST: return "T_NULLABLE_INT_CAST";
		case T_DOUBLE_CAST: return "T_DOUBLE_CAST";
		case T_NULLABLE_DOUBLE_CAST: return "T_NULLABLE_DOUBLE_CAST";
		case T_STRING_CAST: return "T_STRING_CAST";
		case T_NULLABLE_STRING_CAST: return "T_NULLABLE_STRING_CAST";
		case T_ARRAY_CAST: return "T_ARRAY_CAST";
		case T_NULLABLE_ARRAY_CAST: return "T_NULLABLE_ARRAY_CAST";
		case T_OBJECT_CAST: return "T_OBJECT_CAST";
		case T_NULLABLE_OBJECT_CAST: return "T_NULLABLE_OBJECT_CAST";
		case T_BOOL_CAST: return "T_BOOL_CAST";
		case T_NULLABLE_BOOL_CAST: return "T_NULLABLE_BOOL_CAST";
