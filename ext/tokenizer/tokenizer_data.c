...
void tokenizer_register_constants(INIT_FUNC_ARGS) {
	...
	REGISTER_LONG_CONSTANT("T_LOGICAL_OR_EQUAL", T_LOGICAL_OR_EQUAL, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_LOGICAL_AND_EQUAL", T_LOGICAL_AND_EQUAL, CONST_CS | CONST_PERSISTENT);
...
char *get_token_type_name(int token_type)
{
	switch (token_type) {
		...
		case T_LOGICAL_OR_EQUAL: return "T_LOGICAL_OR_EQUAL";
		case T_LOGICAL_AND_EQUAL: return "T_LOGICAL_AND_EQUAL";
