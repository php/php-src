...
static const zend_function_entry class_PhpToken_methods[] = {
	ZEND_RAW_FENTRY("tokenize", zim_PhpToken_tokenize, arginfo_class_PhpToken_tokenize, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("__construct", zim_PhpToken___construct, arginfo_class_PhpToken___construct, ZEND_ACC_PUBLIC|ZEND_ACC_FINAL, NULL)
	ZEND_RAW_FENTRY("is", zim_PhpToken_is, arginfo_class_PhpToken_is, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("isIgnorable", zim_PhpToken_isIgnorable, arginfo_class_PhpToken_isIgnorable, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getTokenName", zim_PhpToken_getTokenName, arginfo_class_PhpToken_getTokenName, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("__toString", zim_PhpToken___toString, arginfo_class_PhpToken___toString, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};
