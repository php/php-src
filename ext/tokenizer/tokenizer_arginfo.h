...
static zend_class_entry *register_class_PhpToken(zend_class_entry *class_entry_Stringable)
{
	...
	zend_string *property_text_name = zend_string_init_interned("text", sizeof("text") - 1, 1);
	...
	zend_string *property_pos_name = zend_string_init_interned("pos", sizeof("pos") - 1, 1);
