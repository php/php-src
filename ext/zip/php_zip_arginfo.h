...
static zend_class_entry *register_class_ZipArchive(zend_class_entry *class_entry_Countable)
{
	...
	zend_string *property_lastId_name = zend_string_init_interned("lastId", sizeof("lastId") - 1, 1);
	...
	zend_string *property_status_name = zend_string_init_interned("status", sizeof("status") - 1, 1);
	...
	zend_string *property_statusSys_name = zend_string_init_interned("statusSys", sizeof("statusSys") - 1, 1);
	...
	zend_string *property_numFiles_name = zend_string_init_interned("numFiles", sizeof("numFiles") - 1, 1);
	...
	zend_string *property_filename_name = zend_string_init_interned("filename", sizeof("filename") - 1, 1);
	...
	zend_string *property_comment_name = zend_string_init_interned("comment", sizeof("comment") - 1, 1);
