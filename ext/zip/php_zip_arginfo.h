...
static zend_class_entry *register_class_ZipArchive(zend_class_entry *class_entry_Countable)
{
	...
	zend_string_release_ex(property_lastId_name, 1);
	...
	zend_string_release_ex(property_status_name, 1);
	...
	zend_string_release_ex(property_statusSys_name, 1);
	...
	zend_string_release_ex(property_numFiles_name, 1);
	...
	zend_string_release_ex(property_filename_name, 1);
	...
	zend_string_release_ex(property_comment_name, 1);
