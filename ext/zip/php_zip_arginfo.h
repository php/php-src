...
static const zend_function_entry ext_functions[] = {
	ZEND_RAW_FENTRY("zip_open", zif_zip_open, arginfo_zip_open, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("zip_close", zif_zip_close, arginfo_zip_close, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("zip_read", zif_zip_read, arginfo_zip_read, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("zip_entry_open", zif_zip_entry_open, arginfo_zip_entry_open, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("zip_entry_close", zif_zip_entry_close, arginfo_zip_entry_close, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("zip_entry_read", zif_zip_entry_read, arginfo_zip_entry_read, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("zip_entry_name", zif_zip_entry_name, arginfo_zip_entry_name, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("zip_entry_compressedsize", zif_zip_entry_compressedsize, arginfo_zip_entry_compressedsize, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("zip_entry_filesize", zif_zip_entry_filesize, arginfo_zip_entry_filesize, ZEND_ACC_DEPRECATED, NULL)
	ZEND_RAW_FENTRY("zip_entry_compressionmethod", zif_zip_entry_compressionmethod, arginfo_zip_entry_compressionmethod, ZEND_ACC_DEPRECATED, NULL)
	ZEND_FE_END
};

static const zend_function_entry class_ZipArchive_methods[] = {
	ZEND_RAW_FENTRY("open", zim_ZipArchive_open, arginfo_class_ZipArchive_open, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setPassword", zim_ZipArchive_setPassword, arginfo_class_ZipArchive_setPassword, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("close", zim_ZipArchive_close, arginfo_class_ZipArchive_close, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("count", zim_ZipArchive_count, arginfo_class_ZipArchive_count, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getStatusString", zim_ZipArchive_getStatusString, arginfo_class_ZipArchive_getStatusString, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("clearError", zim_ZipArchive_clearError, arginfo_class_ZipArchive_clearError, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("addEmptyDir", zim_ZipArchive_addEmptyDir, arginfo_class_ZipArchive_addEmptyDir, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("addFromString", zim_ZipArchive_addFromString, arginfo_class_ZipArchive_addFromString, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("addFile", zim_ZipArchive_addFile, arginfo_class_ZipArchive_addFile, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("replaceFile", zim_ZipArchive_replaceFile, arginfo_class_ZipArchive_replaceFile, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("addGlob", zim_ZipArchive_addGlob, arginfo_class_ZipArchive_addGlob, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("addPattern", zim_ZipArchive_addPattern, arginfo_class_ZipArchive_addPattern, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("renameIndex", zim_ZipArchive_renameIndex, arginfo_class_ZipArchive_renameIndex, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("renameName", zim_ZipArchive_renameName, arginfo_class_ZipArchive_renameName, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setArchiveComment", zim_ZipArchive_setArchiveComment, arginfo_class_ZipArchive_setArchiveComment, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getArchiveComment", zim_ZipArchive_getArchiveComment, arginfo_class_ZipArchive_getArchiveComment, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setArchiveFlag", zim_ZipArchive_setArchiveFlag, arginfo_class_ZipArchive_setArchiveFlag, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getArchiveFlag", zim_ZipArchive_getArchiveFlag, arginfo_class_ZipArchive_getArchiveFlag, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setCommentIndex", zim_ZipArchive_setCommentIndex, arginfo_class_ZipArchive_setCommentIndex, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setCommentName", zim_ZipArchive_setCommentName, arginfo_class_ZipArchive_setCommentName, ZEND_ACC_PUBLIC, NULL)
#if defined(HAVE_SET_MTIME)
	ZEND_RAW_FENTRY("setMtimeIndex", zim_ZipArchive_setMtimeIndex, arginfo_class_ZipArchive_setMtimeIndex, ZEND_ACC_PUBLIC, NULL)
#endif
#if defined(HAVE_SET_MTIME)
	ZEND_RAW_FENTRY("setMtimeName", zim_ZipArchive_setMtimeName, arginfo_class_ZipArchive_setMtimeName, ZEND_ACC_PUBLIC, NULL)
#endif
	ZEND_RAW_FENTRY("getCommentIndex", zim_ZipArchive_getCommentIndex, arginfo_class_ZipArchive_getCommentIndex, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getCommentName", zim_ZipArchive_getCommentName, arginfo_class_ZipArchive_getCommentName, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("deleteIndex", zim_ZipArchive_deleteIndex, arginfo_class_ZipArchive_deleteIndex, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("deleteName", zim_ZipArchive_deleteName, arginfo_class_ZipArchive_deleteName, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("statName", zim_ZipArchive_statName, arginfo_class_ZipArchive_statName, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("statIndex", zim_ZipArchive_statIndex, arginfo_class_ZipArchive_statIndex, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("locateName", zim_ZipArchive_locateName, arginfo_class_ZipArchive_locateName, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getNameIndex", zim_ZipArchive_getNameIndex, arginfo_class_ZipArchive_getNameIndex, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("unchangeArchive", zim_ZipArchive_unchangeArchive, arginfo_class_ZipArchive_unchangeArchive, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("unchangeAll", zim_ZipArchive_unchangeAll, arginfo_class_ZipArchive_unchangeAll, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("unchangeIndex", zim_ZipArchive_unchangeIndex, arginfo_class_ZipArchive_unchangeIndex, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("unchangeName", zim_ZipArchive_unchangeName, arginfo_class_ZipArchive_unchangeName, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("extractTo", zim_ZipArchive_extractTo, arginfo_class_ZipArchive_extractTo, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getFromName", zim_ZipArchive_getFromName, arginfo_class_ZipArchive_getFromName, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getFromIndex", zim_ZipArchive_getFromIndex, arginfo_class_ZipArchive_getFromIndex, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getStreamIndex", zim_ZipArchive_getStreamIndex, arginfo_class_ZipArchive_getStreamIndex, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getStreamName", zim_ZipArchive_getStreamName, arginfo_class_ZipArchive_getStreamName, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getStream", zim_ZipArchive_getStream, arginfo_class_ZipArchive_getStream, ZEND_ACC_PUBLIC, NULL)
#if defined(ZIP_OPSYS_DEFAULT)
	ZEND_RAW_FENTRY("setExternalAttributesName", zim_ZipArchive_setExternalAttributesName, arginfo_class_ZipArchive_setExternalAttributesName, ZEND_ACC_PUBLIC, NULL)
#endif
#if defined(ZIP_OPSYS_DEFAULT)
	ZEND_RAW_FENTRY("setExternalAttributesIndex", zim_ZipArchive_setExternalAttributesIndex, arginfo_class_ZipArchive_setExternalAttributesIndex, ZEND_ACC_PUBLIC, NULL)
#endif
#if defined(ZIP_OPSYS_DEFAULT)
	ZEND_RAW_FENTRY("getExternalAttributesName", zim_ZipArchive_getExternalAttributesName, arginfo_class_ZipArchive_getExternalAttributesName, ZEND_ACC_PUBLIC, NULL)
#endif
#if defined(ZIP_OPSYS_DEFAULT)
	ZEND_RAW_FENTRY("getExternalAttributesIndex", zim_ZipArchive_getExternalAttributesIndex, arginfo_class_ZipArchive_getExternalAttributesIndex, ZEND_ACC_PUBLIC, NULL)
#endif
	ZEND_RAW_FENTRY("setCompressionName", zim_ZipArchive_setCompressionName, arginfo_class_ZipArchive_setCompressionName, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setCompressionIndex", zim_ZipArchive_setCompressionIndex, arginfo_class_ZipArchive_setCompressionIndex, ZEND_ACC_PUBLIC, NULL)
#if defined(HAVE_ENCRYPTION)
	ZEND_RAW_FENTRY("setEncryptionName", zim_ZipArchive_setEncryptionName, arginfo_class_ZipArchive_setEncryptionName, ZEND_ACC_PUBLIC, NULL)
#endif
#if defined(HAVE_ENCRYPTION)
	ZEND_RAW_FENTRY("setEncryptionIndex", zim_ZipArchive_setEncryptionIndex, arginfo_class_ZipArchive_setEncryptionIndex, ZEND_ACC_PUBLIC, NULL)
#endif
#if defined(HAVE_PROGRESS_CALLBACK)
	ZEND_RAW_FENTRY("registerProgressCallback", zim_ZipArchive_registerProgressCallback, arginfo_class_ZipArchive_registerProgressCallback, ZEND_ACC_PUBLIC, NULL)
#endif
#if defined(HAVE_CANCEL_CALLBACK)
	ZEND_RAW_FENTRY("registerCancelCallback", zim_ZipArchive_registerCancelCallback, arginfo_class_ZipArchive_registerCancelCallback, ZEND_ACC_PUBLIC, NULL)
#endif
#if defined(HAVE_METHOD_SUPPORTED)
	ZEND_RAW_FENTRY("isCompressionMethodSupported", zim_ZipArchive_isCompressionMethodSupported, arginfo_class_ZipArchive_isCompressionMethodSupported, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
#endif
#if defined(HAVE_METHOD_SUPPORTED)
	ZEND_RAW_FENTRY("isEncryptionMethodSupported", zim_ZipArchive_isEncryptionMethodSupported, arginfo_class_ZipArchive_isEncryptionMethodSupported, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
#endif
	ZEND_FE_END
};
