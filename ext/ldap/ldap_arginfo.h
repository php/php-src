 ...
 * Stub hash: 0e1cee8f1b466ee251ff637ed0fc17f31ca701b9 */

#if defined(HAVE_ORALDAP)
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(arginfo_ldap_connect, 0, 0, LDAP\\LDAP, MAY_BE_FALSE)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_ldap_unbind, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_OBJ_INFO(0, ldap, LDAP\\LDAP, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_ldap_set_option, 0, 3, _IS_BOOL, 0)
	ZEND_ARG_OBJ_INFO(0, ldap, LDAP\\LDAP, 1)
	ZEND_ARG_TYPE_INFO(0, option, IS_LONG, 0)
...
static const zend_function_entry class_LDAP_LDAP_methods[] = {
	ZEND_FE_END
};
...
static zend_class_entry *register_class_LDAP_LDAP(void)
{
	zend_class_entry ce, *class_entry;

	INIT_NS_CLASS_ENTRY(ce, "LDAP", "LDAP", class_LDAP_LDAP_methods);
