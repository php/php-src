...
#if defined(HAVE_ORALDAP)
	ZEND_RAW_FENTRY("ldap_connect", zif_ldap_connect, arginfo_ldap_connect, 0, NULL)
#endif
#if defined(HAVE_ORALDAP) && defined(LDAP_API_FEATURE_X_OPENLDAP)
	ZEND_RAW_FENTRY("ldap_connect_wallet", zif_ldap_connect_wallet, arginfo_ldap_connect_wallet, 0, NULL)
#endif
#if !(defined(HAVE_ORALDAP))
	ZEND_RAW_FENTRY("ldap_connect", zif_ldap_connect, arginfo_ldap_connect, 0, NULL)
#endif
	ZEND_RAW_FENTRY("ldap_unbind", zif_ldap_unbind, arginfo_ldap_unbind, 0, NULL)
	ZEND_RAW_FENTRY("ldap_close", zif_ldap_unbind, arginfo_ldap_close, 0, NULL)
	ZEND_RAW_FENTRY("ldap_bind", zif_ldap_bind, arginfo_ldap_bind, 0, NULL)
	ZEND_RAW_FENTRY("ldap_bind_ext", zif_ldap_bind_ext, arginfo_ldap_bind_ext, 0, NULL)
#if defined(HAVE_LDAP_SASL)
	ZEND_RAW_FENTRY("ldap_sasl_bind", zif_ldap_sasl_bind, arginfo_ldap_sasl_bind, 0, NULL)
#endif
	ZEND_RAW_FENTRY("ldap_read", zif_ldap_read, arginfo_ldap_read, 0, NULL)
	ZEND_RAW_FENTRY("ldap_list", zif_ldap_list, arginfo_ldap_list, 0, NULL)
	ZEND_RAW_FENTRY("ldap_search", zif_ldap_search, arginfo_ldap_search, 0, NULL)
	ZEND_RAW_FENTRY("ldap_free_result", zif_ldap_free_result, arginfo_ldap_free_result, 0, NULL)
	ZEND_RAW_FENTRY("ldap_count_entries", zif_ldap_count_entries, arginfo_ldap_count_entries, 0, NULL)
	ZEND_RAW_FENTRY("ldap_first_entry", zif_ldap_first_entry, arginfo_ldap_first_entry, 0, NULL)
	ZEND_RAW_FENTRY("ldap_next_entry", zif_ldap_next_entry, arginfo_ldap_next_entry, 0, NULL)
	ZEND_RAW_FENTRY("ldap_get_entries", zif_ldap_get_entries, arginfo_ldap_get_entries, 0, NULL)
	ZEND_RAW_FENTRY("ldap_first_attribute", zif_ldap_first_attribute, arginfo_ldap_first_attribute, 0, NULL)
	ZEND_RAW_FENTRY("ldap_next_attribute", zif_ldap_next_attribute, arginfo_ldap_next_attribute, 0, NULL)
	ZEND_RAW_FENTRY("ldap_get_attributes", zif_ldap_get_attributes, arginfo_ldap_get_attributes, 0, NULL)
	ZEND_RAW_FENTRY("ldap_get_values_len", zif_ldap_get_values_len, arginfo_ldap_get_values_len, 0, NULL)
	ZEND_RAW_FENTRY("ldap_get_values", zif_ldap_get_values_len, arginfo_ldap_get_values, 0, NULL)
	ZEND_RAW_FENTRY("ldap_get_dn", zif_ldap_get_dn, arginfo_ldap_get_dn, 0, NULL)
	ZEND_RAW_FENTRY("ldap_explode_dn", zif_ldap_explode_dn, arginfo_ldap_explode_dn, 0, NULL)
	ZEND_RAW_FENTRY("ldap_dn2ufn", zif_ldap_dn2ufn, arginfo_ldap_dn2ufn, 0, NULL)
	ZEND_RAW_FENTRY("ldap_add", zif_ldap_add, arginfo_ldap_add, 0, NULL)
	ZEND_RAW_FENTRY("ldap_add_ext", zif_ldap_add_ext, arginfo_ldap_add_ext, 0, NULL)
	ZEND_RAW_FENTRY("ldap_delete", zif_ldap_delete, arginfo_ldap_delete, 0, NULL)
	ZEND_RAW_FENTRY("ldap_delete_ext", zif_ldap_delete_ext, arginfo_ldap_delete_ext, 0, NULL)
	ZEND_RAW_FENTRY("ldap_modify_batch", zif_ldap_modify_batch, arginfo_ldap_modify_batch, 0, NULL)
	ZEND_RAW_FENTRY("ldap_mod_add", zif_ldap_mod_add, arginfo_ldap_mod_add, 0, NULL)
	ZEND_RAW_FENTRY("ldap_mod_add_ext", zif_ldap_mod_add_ext, arginfo_ldap_mod_add_ext, 0, NULL)
	ZEND_RAW_FENTRY("ldap_mod_replace", zif_ldap_mod_replace, arginfo_ldap_mod_replace, 0, NULL)
	ZEND_RAW_FENTRY("ldap_modify", zif_ldap_mod_replace, arginfo_ldap_modify, 0, NULL)
	ZEND_RAW_FENTRY("ldap_mod_replace_ext", zif_ldap_mod_replace_ext, arginfo_ldap_mod_replace_ext, 0, NULL)
	ZEND_RAW_FENTRY("ldap_mod_del", zif_ldap_mod_del, arginfo_ldap_mod_del, 0, NULL)
	ZEND_RAW_FENTRY("ldap_mod_del_ext", zif_ldap_mod_del_ext, arginfo_ldap_mod_del_ext, 0, NULL)
	ZEND_RAW_FENTRY("ldap_errno", zif_ldap_errno, arginfo_ldap_errno, 0, NULL)
	ZEND_RAW_FENTRY("ldap_error", zif_ldap_error, arginfo_ldap_error, 0, NULL)
	ZEND_RAW_FENTRY("ldap_err2str", zif_ldap_err2str, arginfo_ldap_err2str, 0, NULL)
	ZEND_RAW_FENTRY("ldap_compare", zif_ldap_compare, arginfo_ldap_compare, 0, NULL)
#if (LDAP_API_VERSION > 2000) || defined(HAVE_ORALDAP)
	ZEND_RAW_FENTRY("ldap_rename", zif_ldap_rename, arginfo_ldap_rename, 0, NULL)
#endif
#if (LDAP_API_VERSION > 2000) || defined(HAVE_ORALDAP)
	ZEND_RAW_FENTRY("ldap_rename_ext", zif_ldap_rename_ext, arginfo_ldap_rename_ext, 0, NULL)
#endif
#if (LDAP_API_VERSION > 2000) || defined(HAVE_ORALDAP)
	ZEND_RAW_FENTRY("ldap_get_option", zif_ldap_get_option, arginfo_ldap_get_option, 0, NULL)
#endif
#if (LDAP_API_VERSION > 2000) || defined(HAVE_ORALDAP)
	ZEND_RAW_FENTRY("ldap_set_option", zif_ldap_set_option, arginfo_ldap_set_option, 0, NULL)
#endif
#if (LDAP_API_VERSION > 2000) || defined(HAVE_ORALDAP)
	ZEND_RAW_FENTRY("ldap_count_references", zif_ldap_count_references, arginfo_ldap_count_references, 0, NULL)
#endif
#if (LDAP_API_VERSION > 2000) || defined(HAVE_ORALDAP)
	ZEND_RAW_FENTRY("ldap_first_reference", zif_ldap_first_reference, arginfo_ldap_first_reference, 0, NULL)
#endif
#if (LDAP_API_VERSION > 2000) || defined(HAVE_ORALDAP)
	ZEND_RAW_FENTRY("ldap_next_reference", zif_ldap_next_reference, arginfo_ldap_next_reference, 0, NULL)
#endif
#if (LDAP_API_VERSION > 2000) || defined(HAVE_ORALDAP) && defined(HAVE_LDAP_PARSE_REFERENCE)
	ZEND_RAW_FENTRY("ldap_parse_reference", zif_ldap_parse_reference, arginfo_ldap_parse_reference, 0, NULL)
#endif
#if (LDAP_API_VERSION > 2000) || defined(HAVE_ORALDAP) && defined(HAVE_LDAP_PARSE_RESULT)
	ZEND_RAW_FENTRY("ldap_parse_result", zif_ldap_parse_result, arginfo_ldap_parse_result, 0, NULL)
#endif
#if (defined(LDAP_API_FEATURE_X_OPENLDAP) && defined(HAVE_3ARG_SETREBINDPROC))
	ZEND_RAW_FENTRY("ldap_set_rebind_proc", zif_ldap_set_rebind_proc, arginfo_ldap_set_rebind_proc, 0, NULL)
#endif
#if defined(HAVE_LDAP_START_TLS_S)
	ZEND_RAW_FENTRY("ldap_start_tls", zif_ldap_start_tls, arginfo_ldap_start_tls, 0, NULL)
#endif
	ZEND_RAW_FENTRY("ldap_escape", zif_ldap_escape, arginfo_ldap_escape, 0, NULL)
#if defined(STR_TRANSLATION)
	ZEND_RAW_FENTRY("ldap_t61_to_8859", zif_ldap_t61_to_8859, arginfo_ldap_t61_to_8859, 0, NULL)
#endif
#if defined(STR_TRANSLATION)
	ZEND_RAW_FENTRY("ldap_8859_to_t61", zif_ldap_8859_to_t61, arginfo_ldap_8859_to_t61, 0, NULL)
#endif
#if defined(HAVE_LDAP_EXTENDED_OPERATION_S)
	ZEND_RAW_FENTRY("ldap_exop", zif_ldap_exop, arginfo_ldap_exop, 0, NULL)
#endif
#if defined(HAVE_LDAP_EXTENDED_OPERATION_S)
	ZEND_RAW_FENTRY("ldap_exop_sync", zif_ldap_exop_sync, arginfo_ldap_exop_sync, 0, NULL)
#endif
#if defined(HAVE_LDAP_PASSWD)
	ZEND_RAW_FENTRY("ldap_exop_passwd", zif_ldap_exop_passwd, arginfo_ldap_exop_passwd, 0, NULL)
#endif
#if defined(HAVE_LDAP_WHOAMI_S)
	ZEND_RAW_FENTRY("ldap_exop_whoami", zif_ldap_exop_whoami, arginfo_ldap_exop_whoami, 0, NULL)
#endif
#if defined(HAVE_LDAP_REFRESH_S)
	ZEND_RAW_FENTRY("ldap_exop_refresh", zif_ldap_exop_refresh, arginfo_ldap_exop_refresh, 0, NULL)
#endif
#if defined(HAVE_LDAP_PARSE_EXTENDED_RESULT)
	ZEND_RAW_FENTRY("ldap_parse_exop", zif_ldap_parse_exop, arginfo_ldap_parse_exop, 0, NULL)
#endif
	ZEND_FE_END
};
