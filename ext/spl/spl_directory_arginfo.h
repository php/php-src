...
static const zend_function_entry class_SplFileInfo_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_SplFileInfo___construct, arginfo_class_SplFileInfo___construct, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getPath", zim_SplFileInfo_getPath, arginfo_class_SplFileInfo_getPath, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getFilename", zim_SplFileInfo_getFilename, arginfo_class_SplFileInfo_getFilename, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getExtension", zim_SplFileInfo_getExtension, arginfo_class_SplFileInfo_getExtension, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getBasename", zim_SplFileInfo_getBasename, arginfo_class_SplFileInfo_getBasename, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getPathname", zim_SplFileInfo_getPathname, arginfo_class_SplFileInfo_getPathname, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getPerms", zim_SplFileInfo_getPerms, arginfo_class_SplFileInfo_getPerms, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getInode", zim_SplFileInfo_getInode, arginfo_class_SplFileInfo_getInode, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getSize", zim_SplFileInfo_getSize, arginfo_class_SplFileInfo_getSize, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getOwner", zim_SplFileInfo_getOwner, arginfo_class_SplFileInfo_getOwner, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getGroup", zim_SplFileInfo_getGroup, arginfo_class_SplFileInfo_getGroup, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getATime", zim_SplFileInfo_getATime, arginfo_class_SplFileInfo_getATime, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getMTime", zim_SplFileInfo_getMTime, arginfo_class_SplFileInfo_getMTime, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getCTime", zim_SplFileInfo_getCTime, arginfo_class_SplFileInfo_getCTime, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getType", zim_SplFileInfo_getType, arginfo_class_SplFileInfo_getType, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("isWritable", zim_SplFileInfo_isWritable, arginfo_class_SplFileInfo_isWritable, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("isReadable", zim_SplFileInfo_isReadable, arginfo_class_SplFileInfo_isReadable, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("isExecutable", zim_SplFileInfo_isExecutable, arginfo_class_SplFileInfo_isExecutable, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("isFile", zim_SplFileInfo_isFile, arginfo_class_SplFileInfo_isFile, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("isDir", zim_SplFileInfo_isDir, arginfo_class_SplFileInfo_isDir, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("isLink", zim_SplFileInfo_isLink, arginfo_class_SplFileInfo_isLink, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getLinkTarget", zim_SplFileInfo_getLinkTarget, arginfo_class_SplFileInfo_getLinkTarget, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getRealPath", zim_SplFileInfo_getRealPath, arginfo_class_SplFileInfo_getRealPath, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getFileInfo", zim_SplFileInfo_getFileInfo, arginfo_class_SplFileInfo_getFileInfo, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getPathInfo", zim_SplFileInfo_getPathInfo, arginfo_class_SplFileInfo_getPathInfo, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("openFile", zim_SplFileInfo_openFile, arginfo_class_SplFileInfo_openFile, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setFileClass", zim_SplFileInfo_setFileClass, arginfo_class_SplFileInfo_setFileClass, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setInfoClass", zim_SplFileInfo_setInfoClass, arginfo_class_SplFileInfo_setInfoClass, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("__toString", zim_SplFileInfo_getPathname, arginfo_class_SplFileInfo___toString, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("__debugInfo", zim_SplFileInfo___debugInfo, arginfo_class_SplFileInfo___debugInfo, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("_bad_state_ex", zim_SplFileInfo__bad_state_ex, arginfo_class_SplFileInfo__bad_state_ex, ZEND_ACC_PUBLIC|ZEND_ACC_FINAL|ZEND_ACC_DEPRECATED, NULL)
	ZEND_FE_END
};

static const zend_function_entry class_DirectoryIterator_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_DirectoryIterator___construct, arginfo_class_DirectoryIterator___construct, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getFilename", zim_DirectoryIterator_getFilename, arginfo_class_DirectoryIterator_getFilename, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getExtension", zim_DirectoryIterator_getExtension, arginfo_class_DirectoryIterator_getExtension, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getBasename", zim_DirectoryIterator_getBasename, arginfo_class_DirectoryIterator_getBasename, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("isDot", zim_DirectoryIterator_isDot, arginfo_class_DirectoryIterator_isDot, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("rewind", zim_DirectoryIterator_rewind, arginfo_class_DirectoryIterator_rewind, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("valid", zim_DirectoryIterator_valid, arginfo_class_DirectoryIterator_valid, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("key", zim_DirectoryIterator_key, arginfo_class_DirectoryIterator_key, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("current", zim_DirectoryIterator_current, arginfo_class_DirectoryIterator_current, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("next", zim_DirectoryIterator_next, arginfo_class_DirectoryIterator_next, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("seek", zim_DirectoryIterator_seek, arginfo_class_DirectoryIterator_seek, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("__toString", zim_DirectoryIterator_getFilename, arginfo_class_DirectoryIterator___toString, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};

static const zend_function_entry class_FilesystemIterator_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_FilesystemIterator___construct, arginfo_class_FilesystemIterator___construct, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("rewind", zim_FilesystemIterator_rewind, arginfo_class_FilesystemIterator_rewind, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("key", zim_FilesystemIterator_key, arginfo_class_FilesystemIterator_key, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("current", zim_FilesystemIterator_current, arginfo_class_FilesystemIterator_current, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getFlags", zim_FilesystemIterator_getFlags, arginfo_class_FilesystemIterator_getFlags, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setFlags", zim_FilesystemIterator_setFlags, arginfo_class_FilesystemIterator_setFlags, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};

static const zend_function_entry class_RecursiveDirectoryIterator_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_RecursiveDirectoryIterator___construct, arginfo_class_RecursiveDirectoryIterator___construct, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("hasChildren", zim_RecursiveDirectoryIterator_hasChildren, arginfo_class_RecursiveDirectoryIterator_hasChildren, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getChildren", zim_RecursiveDirectoryIterator_getChildren, arginfo_class_RecursiveDirectoryIterator_getChildren, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getSubPath", zim_RecursiveDirectoryIterator_getSubPath, arginfo_class_RecursiveDirectoryIterator_getSubPath, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getSubPathname", zim_RecursiveDirectoryIterator_getSubPathname, arginfo_class_RecursiveDirectoryIterator_getSubPathname, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};

#if defined(HAVE_GLOB)
static const zend_function_entry class_GlobIterator_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_GlobIterator___construct, arginfo_class_GlobIterator___construct, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("count", zim_GlobIterator_count, arginfo_class_GlobIterator_count, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};
#endif

static const zend_function_entry class_SplFileObject_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_SplFileObject___construct, arginfo_class_SplFileObject___construct, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("rewind", zim_SplFileObject_rewind, arginfo_class_SplFileObject_rewind, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("eof", zim_SplFileObject_eof, arginfo_class_SplFileObject_eof, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("valid", zim_SplFileObject_valid, arginfo_class_SplFileObject_valid, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fgets", zim_SplFileObject_fgets, arginfo_class_SplFileObject_fgets, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fread", zim_SplFileObject_fread, arginfo_class_SplFileObject_fread, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fgetcsv", zim_SplFileObject_fgetcsv, arginfo_class_SplFileObject_fgetcsv, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fputcsv", zim_SplFileObject_fputcsv, arginfo_class_SplFileObject_fputcsv, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setCsvControl", zim_SplFileObject_setCsvControl, arginfo_class_SplFileObject_setCsvControl, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getCsvControl", zim_SplFileObject_getCsvControl, arginfo_class_SplFileObject_getCsvControl, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("flock", zim_SplFileObject_flock, arginfo_class_SplFileObject_flock, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fflush", zim_SplFileObject_fflush, arginfo_class_SplFileObject_fflush, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("ftell", zim_SplFileObject_ftell, arginfo_class_SplFileObject_ftell, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fseek", zim_SplFileObject_fseek, arginfo_class_SplFileObject_fseek, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fgetc", zim_SplFileObject_fgetc, arginfo_class_SplFileObject_fgetc, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fpassthru", zim_SplFileObject_fpassthru, arginfo_class_SplFileObject_fpassthru, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fscanf", zim_SplFileObject_fscanf, arginfo_class_SplFileObject_fscanf, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fwrite", zim_SplFileObject_fwrite, arginfo_class_SplFileObject_fwrite, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("fstat", zim_SplFileObject_fstat, arginfo_class_SplFileObject_fstat, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("ftruncate", zim_SplFileObject_ftruncate, arginfo_class_SplFileObject_ftruncate, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("current", zim_SplFileObject_current, arginfo_class_SplFileObject_current, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("key", zim_SplFileObject_key, arginfo_class_SplFileObject_key, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("next", zim_SplFileObject_next, arginfo_class_SplFileObject_next, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setFlags", zim_SplFileObject_setFlags, arginfo_class_SplFileObject_setFlags, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getFlags", zim_SplFileObject_getFlags, arginfo_class_SplFileObject_getFlags, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setMaxLineLen", zim_SplFileObject_setMaxLineLen, arginfo_class_SplFileObject_setMaxLineLen, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getMaxLineLen", zim_SplFileObject_getMaxLineLen, arginfo_class_SplFileObject_getMaxLineLen, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("hasChildren", zim_SplFileObject_hasChildren, arginfo_class_SplFileObject_hasChildren, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getChildren", zim_SplFileObject_getChildren, arginfo_class_SplFileObject_getChildren, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("seek", zim_SplFileObject_seek, arginfo_class_SplFileObject_seek, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getCurrentLine", zim_SplFileObject_fgets, arginfo_class_SplFileObject_getCurrentLine, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("__toString", zim_SplFileObject___toString, arginfo_class_SplFileObject___toString, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};

static const zend_function_entry class_SplTempFileObject_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_SplTempFileObject___construct, arginfo_class_SplTempFileObject___construct, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};
