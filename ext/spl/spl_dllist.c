...
static bool spl_dllist_object_allows_user_cache_state(zend_class_entry *ce)
{
		...
		zend_opcache_user_cache_safe_direct_clone_value_func_t clone_value)
{
	...
	if (clone_value == NULL ||
		!spl_dllist_object_allows_user_cache_state(old_object->ce) ||
		!spl_dllist_object_allows_user_cache_state(new_object->ce)
	) {
		return false;
	}
		...
		zend_opcache_user_cache_safe_direct_value_has_unstorable_func_t value_has_unstorable)
{
	...
	if (!spl_dllist_object_allows_user_cache_state(Z_OBJCE_P(object))) {
		return true;
	}
...
static bool spl_dllist_object_serialize_user_cache_state(const zval *object, zval *state)
{
	spl_dllist_object *intern;
	spl_ptr_llist_element *current;
	zval tmp;
...
static const zend_opcache_user_cache_safe_direct_handlers *spl_dllist_object_get_user_cache_handlers(void)
{
	static const zend_opcache_user_cache_safe_direct_handlers handlers = {
		false,
		spl_dllist_object_copy_user_cache_state,
		spl_dllist_object_user_cache_state_has_unstorable,
...
PHP_MINIT_FUNCTION(spl_dllist) /* {{{ */
{
	...
	zend_opcache_user_cache_safe_direct_register_class(
		...
		spl_dllist_object_get_user_cache_handlers()
	);
