...
?>
--EXPECTF--
Warning: SplDoublyLinkedList::setIteratorMode() expects parameter 1 to be integer (or convertible float, convertible string or boolean), object given in %s on line %d
