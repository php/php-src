...
static const zend_function_entry class_ArrayObject_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_ArrayObject___construct, arginfo_class_ArrayObject___construct, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("offsetExists", zim_ArrayObject_offsetExists, arginfo_class_ArrayObject_offsetExists, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("offsetGet", zim_ArrayObject_offsetGet, arginfo_class_ArrayObject_offsetGet, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("offsetSet", zim_ArrayObject_offsetSet, arginfo_class_ArrayObject_offsetSet, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("offsetUnset", zim_ArrayObject_offsetUnset, arginfo_class_ArrayObject_offsetUnset, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("append", zim_ArrayObject_append, arginfo_class_ArrayObject_append, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getArrayCopy", zim_ArrayObject_getArrayCopy, arginfo_class_ArrayObject_getArrayCopy, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("count", zim_ArrayObject_count, arginfo_class_ArrayObject_count, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getFlags", zim_ArrayObject_getFlags, arginfo_class_ArrayObject_getFlags, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setFlags", zim_ArrayObject_setFlags, arginfo_class_ArrayObject_setFlags, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("asort", zim_ArrayObject_asort, arginfo_class_ArrayObject_asort, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("ksort", zim_ArrayObject_ksort, arginfo_class_ArrayObject_ksort, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("uasort", zim_ArrayObject_uasort, arginfo_class_ArrayObject_uasort, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("uksort", zim_ArrayObject_uksort, arginfo_class_ArrayObject_uksort, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("natsort", zim_ArrayObject_natsort, arginfo_class_ArrayObject_natsort, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("natcasesort", zim_ArrayObject_natcasesort, arginfo_class_ArrayObject_natcasesort, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("unserialize", zim_ArrayObject_unserialize, arginfo_class_ArrayObject_unserialize, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("serialize", zim_ArrayObject_serialize, arginfo_class_ArrayObject_serialize, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("__serialize", zim_ArrayObject___serialize, arginfo_class_ArrayObject___serialize, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("__unserialize", zim_ArrayObject___unserialize, arginfo_class_ArrayObject___unserialize, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getIterator", zim_ArrayObject_getIterator, arginfo_class_ArrayObject_getIterator, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("exchangeArray", zim_ArrayObject_exchangeArray, arginfo_class_ArrayObject_exchangeArray, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setIteratorClass", zim_ArrayObject_setIteratorClass, arginfo_class_ArrayObject_setIteratorClass, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getIteratorClass", zim_ArrayObject_getIteratorClass, arginfo_class_ArrayObject_getIteratorClass, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("__debugInfo", zim_ArrayObject___debugInfo, arginfo_class_ArrayObject___debugInfo, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};

static const zend_function_entry class_ArrayIterator_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_ArrayIterator___construct, arginfo_class_ArrayIterator___construct, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("offsetExists", zim_ArrayObject_offsetExists, arginfo_class_ArrayIterator_offsetExists, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("offsetGet", zim_ArrayObject_offsetGet, arginfo_class_ArrayIterator_offsetGet, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("offsetSet", zim_ArrayObject_offsetSet, arginfo_class_ArrayIterator_offsetSet, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("offsetUnset", zim_ArrayObject_offsetUnset, arginfo_class_ArrayIterator_offsetUnset, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("append", zim_ArrayObject_append, arginfo_class_ArrayIterator_append, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getArrayCopy", zim_ArrayObject_getArrayCopy, arginfo_class_ArrayIterator_getArrayCopy, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("count", zim_ArrayObject_count, arginfo_class_ArrayIterator_count, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getFlags", zim_ArrayObject_getFlags, arginfo_class_ArrayIterator_getFlags, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("setFlags", zim_ArrayObject_setFlags, arginfo_class_ArrayIterator_setFlags, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("asort", zim_ArrayObject_asort, arginfo_class_ArrayIterator_asort, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("ksort", zim_ArrayObject_ksort, arginfo_class_ArrayIterator_ksort, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("uasort", zim_ArrayObject_uasort, arginfo_class_ArrayIterator_uasort, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("uksort", zim_ArrayObject_uksort, arginfo_class_ArrayIterator_uksort, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("natsort", zim_ArrayObject_natsort, arginfo_class_ArrayIterator_natsort, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("natcasesort", zim_ArrayObject_natcasesort, arginfo_class_ArrayIterator_natcasesort, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("unserialize", zim_ArrayObject_unserialize, arginfo_class_ArrayIterator_unserialize, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("serialize", zim_ArrayObject_serialize, arginfo_class_ArrayIterator_serialize, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("__serialize", zim_ArrayObject___serialize, arginfo_class_ArrayIterator___serialize, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("__unserialize", zim_ArrayObject___unserialize, arginfo_class_ArrayIterator___unserialize, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("rewind", zim_ArrayIterator_rewind, arginfo_class_ArrayIterator_rewind, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("current", zim_ArrayIterator_current, arginfo_class_ArrayIterator_current, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("key", zim_ArrayIterator_key, arginfo_class_ArrayIterator_key, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("next", zim_ArrayIterator_next, arginfo_class_ArrayIterator_next, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("valid", zim_ArrayIterator_valid, arginfo_class_ArrayIterator_valid, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("seek", zim_ArrayIterator_seek, arginfo_class_ArrayIterator_seek, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("__debugInfo", zim_ArrayObject___debugInfo, arginfo_class_ArrayIterator___debugInfo, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};

static const zend_function_entry class_RecursiveArrayIterator_methods[] = {
	ZEND_RAW_FENTRY("hasChildren", zim_RecursiveArrayIterator_hasChildren, arginfo_class_RecursiveArrayIterator_hasChildren, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getChildren", zim_RecursiveArrayIterator_getChildren, arginfo_class_RecursiveArrayIterator_getChildren, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};
