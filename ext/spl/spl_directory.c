...
static zval *spl_filesystem_dir_it_current_key(zend_object_iterator *iter TSRMLS_DC);
...
static zval *spl_filesystem_tree_it_current_key(zend_object_iterator *iter TSRMLS_DC)
{
	spl_filesystem_object *object = spl_filesystem_iterator_to_object((spl_filesystem_iterator *)iter);
	zval *key;
	MAKE_STD_ZVAL(key);
