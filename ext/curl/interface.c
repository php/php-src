...
PHP_MINIT_FUNCTION(curl)
{
	...
	REGISTER_LONG_CONSTANT("CURLOPT_ENCODING", CURLOPT_ACCEPT_ENCODING, CONST_PERSISTENT | CONST_DEPRECATED);
	...
	REGISTER_LONG_CONSTANT("CURLE_BAD_PASSWORD_ENTERED", 46, CONST_PERSISTENT | CONST_DEPRECATED);
	...
	REGISTER_LONG_CONSTANT("CURLE_FTP_ACCESS_DENIED", CURLE_REMOTE_ACCESS_DENIED, CONST_PERSISTENT | CONST_DEPRECATED);
	REGISTER_LONG_CONSTANT("CURLE_FTP_BAD_DOWNLOAD_RESUME", CURLE_BAD_DOWNLOAD_RESUME, CONST_PERSISTENT | CONST_DEPRECATED);
	REGISTER_CURL_CONSTANT(CURLE_FTP_CANT_GET_HOST);
	REGISTER_LONG_CONSTANT("CURLE_FTP_CANT_RECONNECT", 16, CONST_PERSISTENT | CONST_DEPRECATED);
	REGISTER_LONG_CONSTANT("CURLE_FTP_COULDNT_GET_SIZE", 32, CONST_PERSISTENT | CONST_DEPRECATED);
	REGISTER_CURL_CONSTANT(CURLE_FTP_COULDNT_RETR_FILE);
	REGISTER_LONG_CONSTANT("CURLE_FTP_COULDNT_SET_ASCII", 29, CONST_PERSISTENT | CONST_DEPRECATED);
	REGISTER_LONG_CONSTANT("CURLE_FTP_COULDNT_SET_BINARY", CURLE_FTP_COULDNT_SET_TYPE, CONST_PERSISTENT | CONST_DEPRECATED);
	REGISTER_LONG_CONSTANT("CURLE_FTP_COULDNT_STOR_FILE", CURLE_UPLOAD_FAILED, CONST_PERSISTENT | CONST_DEPRECATED);
	REGISTER_CURL_CONSTANT(CURLE_FTP_COULDNT_USE_REST);
	REGISTER_LONG_CONSTANT("CURLE_FTP_PARTIAL_FILE", CURLE_PARTIAL_FILE, CONST_PERSISTENT | CONST_DEPRECATED);
	REGISTER_CURL_CONSTANT(CURLE_FTP_PORT_FAILED);
	REGISTER_LONG_CONSTANT("CURLE_FTP_QUOTE_ERROR", CURLE_QUOTE_ERROR, CONST_PERSISTENT | CONST_DEPRECATED);
	REGISTER_LONG_CONSTANT("CURLE_FTP_USER_PASSWORD_INCORRECT", 10, CONST_PERSISTENT | CONST_DEPRECATED);
	...
	REGISTER_LONG_CONSTANT("CURLE_FTP_WEIRD_SERVER_REPLY", 8, CONST_PERSISTENT | CONST_DEPRECATED);
	REGISTER_LONG_CONSTANT("CURLE_FTP_WEIRD_USER_REPLY", 12, CONST_PERSISTENT | CONST_DEPRECATED);
	REGISTER_LONG_CONSTANT("CURLE_FTP_WRITE_ERROR", 20, CONST_PERSISTENT | CONST_DEPRECATED);
	REGISTER_CURL_CONSTANT(CURLE_FUNCTION_NOT_FOUND);
	REGISTER_CURL_CONSTANT(CURLE_GOT_NOTHING);
	REGISTER_CURL_CONSTANT("CURLE_HTTP_NOT_FOUND", CURLE_HTTP_RETURNED_ERROR, CONST_PERSISTENT | CONST_DEPRECATED);
	REGISTER_CURL_CONSTANT("CURLE_HTTP_PORT_FAILED", CURLE_INTERFACE_FAILED, CONST_PERSISTENT | CONST_DEPRECATED);
	REGISTER_CURL_CONSTANT(CURLE_HTTP_POST_ERROR);
	REGISTER_LONG_CONSTANT("CURLE_HTTP_RANGE_ERROR", CURLE_RANGE_ERROR, CONST_PERSISTENT | CONST_DEPRECATED);
	...
	REGISTER_LONG_CONSTANT("CURLE_LIBRARY_NOT_FOUND", 40, CONST_PERSISTENT | CONST_DEPRECATED);
	REGISTER_LONG_CONSTANT("CURLE_MALFORMAT_USER", 24, CONST_PERSISTENT | CONST_DEPRECATED);
	REGISTER_LONG_CONSTANT("CURLE_OBSOLETE", 50, CONST_PERSISTENT | CONST_DEPRECATED);
	REGISTER_CURL_CONSTANT(CURLE_OK);
	REGISTER_CURL_CONSTANT(CURLE_OPERATION_TIMEDOUT);
	REGISTER_LONG_CONSTANT("CURLE_OPERATION_TIMEOUTED", CURLE_OPERATION_TIMEDOUT, CONST_PERSISTENT | CONST_DEPRECATED);
	...
	REGISTER_LONG_CONSTANT("CURLE_SHARE_IN_USE", 57, CONST_PERSISTENT | CONST_DEPRECATED);
	REGISTER_LONG_CONSTANT("CURLE_SSL_CACERT", 60, CONST_PERSISTENT | CONST_DEPRECATED);
	...
	REGISTER_LONG_CONSTANT("CURLE_SSL_PEER_CERTIFICATE", 60, CONST_PERSISTENT | CONST_DEPRECATED);
	...
	REGISTER_LONG_CONSTANT("CURLE_UNKNOWN_TELNET_OPTION", CURLE_UNKNOWN_OPTION, CONST_PERSISTENT | CONST_DEPRECATED);
	REGISTER_CURL_CONSTANT(CURLE_UNSUPPORTED_PROTOCOL);
	REGISTER_CURL_CONSTANT(CURLE_URL_MALFORMAT);
	REGISTER_LONG_CONSTANT("CURLE_URL_MALFORMAT_USER", CURLE_NOT_BUILT_IN, CONST_PERSISTENT | CONST_DEPRECATED);
	...
	REGISTER_LONG_CONSTANT("CURLE_FTP_SSL_FAILED", CURLE_USE_SSL_FAILED, CONST_PERSISTENT | CONST_DEPRECATED);
