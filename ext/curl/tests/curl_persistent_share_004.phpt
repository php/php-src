...
?>
--EXPECTF--
Fatal error: Uncaught ValueError: curl_share_init_persistent(): Argument #1 ($share_options) must not contain CURL_LOCK_DATA_COOKIE because it is unsafe in %scurl_persistent_share_004.php:3
Stack trace:
