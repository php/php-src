...
static zend_class_entry *register_class_CURLFile(void)
{
	...
	zend_string *property_mime_name = zend_string_init_interned("mime", sizeof("mime") - 1, 1);
	...
	zend_string *property_postname_name = zend_string_init_interned("postname", sizeof("postname") - 1, 1);
