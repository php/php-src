...
PHP_MINIT_FUNCTION(filter)
{
	...
	REGISTER_LONG_CONSTANT("FILTER_VALIDATE_INTEGER", FILTER_VALIDATE_INT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("FILTER_VALIDATE_BOOLEAN", FILTER_VALIDATE_BOOLEAN, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("FILTER_VALIDATE_BOOL", FILTER_VALIDATE_BOOLEAN, CONST_CS | CONST_PERSISTENT);
