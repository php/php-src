--TEST--
validate_var() and FILTER_VALIDATE_URL
--SKIPIF--
...
foreach ($values as $value) {
    try {
        var_dump(validate_var($value, FILTER_VALIDATE_URL));
    } catch (Exception $e) {
...
try {
    var_dump(validate_var("qwe", FILTER_VALIDATE_URL, FILTER_FLAG_SCHEME_REQUIRED));
} catch (Exception $e) {
    var_dump($e->getMessage());
}
try {
    var_dump(validate_var("http://qwe", FILTER_VALIDATE_URL, FILTER_FLAG_SCHEME_REQUIRED));
} catch (Exception $e) {
    var_dump($e->getMessage());
}
try {
    var_dump(validate_var("http://", FILTER_VALIDATE_URL, FILTER_FLAG_HOST_REQUIRED));
} catch (Exception $e) {
    var_dump($e->getMessage());
}
try {
    var_dump(validate_var("/tmp/test", FILTER_VALIDATE_URL, FILTER_FLAG_HOST_REQUIRED));
} catch (Exception $e) {
    var_dump($e->getMessage());
}
try {
    var_dump(validate_var("http://www.example.com", FILTER_VALIDATE_URL, FILTER_FLAG_HOST_REQUIRED));
} catch (Exception $e) {
    var_dump($e->getMessage());
}
try {
    var_dump(validate_var("http://www.example.com", FILTER_VALIDATE_URL, FILTER_FLAG_PATH_REQUIRED));
} catch (Exception $e) {
    var_dump($e->getMessage());
}
try {
    var_dump(validate_var("http://www.example.com/path/at/the/server/", FILTER_VALIDATE_URL, FILTER_FLAG_PATH_REQUIRED));
} catch (Exception $e) {
    var_dump($e->getMessage());
}
try {
    var_dump(validate_var("http://www.example.com/index.html", FILTER_VALIDATE_URL, FILTER_FLAG_QUERY_REQUIRED));
} catch (Exception $e) {
    var_dump($e->getMessage());
}
try {
    var_dump(validate_var("http://www.example.com/index.php?a=b&c=d", FILTER_VALIDATE_URL, FILTER_FLAG_QUERY_REQUIRED));
} catch (Exception $e) {
    var_dump($e->getMessage());
}
