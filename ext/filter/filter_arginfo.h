 ...
 * Stub hash: d89ed62cac193f7eb155dc952c4e0ac5b657654c */
...
static void register_filter_symbols(int module_number)
{
	...
	REGISTER_LONG_CONSTANT("FILTER_FLAG_NO_SCIENTIFIC", FILTER_FLAG_NO_SCIENTIFIC, CONST_CS | CONST_PERSISTENT);
