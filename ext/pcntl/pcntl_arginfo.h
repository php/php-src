 ...
 * Stub hash: d36a985d8960a6afc84285b12b4e72ed3807ce35 */
...
#endif
	REGISTER_LONG_CONSTANT("SIG_IGN", LONG_CONST((intptr_t)SIG_IGN), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIG_DFL", LONG_CONST((intptr_t)SIG_DFL), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIG_ERR", LONG_CONST((intptr_t)SIG_ERR), CONST_PERSISTENT);
