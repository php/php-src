...
{
#if defined(WNOHANG)
	REGISTER_LONG_CONSTANT("WNOHANG", ZEND_PTR_TO_ZEND_LONG(WNOHANG), CONST_PERSISTENT);
#endif
#if defined(WUNTRACED)
	REGISTER_LONG_CONSTANT("WUNTRACED", ZEND_PTR_TO_ZEND_LONG(WUNTRACED), CONST_PERSISTENT);
#endif
#if defined(HAVE_WCONTINUED)
	REGISTER_LONG_CONSTANT("WCONTINUED", ZEND_PTR_TO_ZEND_LONG(WCONTINUED), CONST_PERSISTENT);
#endif
	...
	REGISTER_LONG_CONSTANT("WSTOPPED", ZEND_PTR_TO_ZEND_LONG(WSTOPPED), CONST_PERSISTENT);
#endif
#if defined (HAVE_DECL_WNOWAIT) && HAVE_DECL_WNOWAIT== 1
	REGISTER_LONG_CONSTANT("WNOWAIT", ZEND_PTR_TO_ZEND_LONG(WNOWAIT), CONST_PERSISTENT);
#endif
#if defined(HAVE_WAITID) && defined(HAVE_POSIX_IDTYPES)
	REGISTER_LONG_CONSTANT("P_ALL", ZEND_PTR_TO_ZEND_LONG(P_ALL), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("P_PID", ZEND_PTR_TO_ZEND_LONG(P_PID), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("P_PGID", ZEND_PTR_TO_ZEND_LONG(P_PGID), CONST_PERSISTENT);
#endif
#if defined(HAVE_WAITID) && defined(HAVE_LINUX_IDTYPES)
	REGISTER_LONG_CONSTANT("P_PIDFD", ZEND_PTR_TO_ZEND_LONG(P_PIDFD), CONST_PERSISTENT);
#endif
#if defined(HAVE_WAITID) && defined(HAVE_NETBSD_IDTYPES)
	REGISTER_LONG_CONSTANT("P_UID", ZEND_PTR_TO_ZEND_LONG(P_UID), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("P_GID", ZEND_PTR_TO_ZEND_LONG(P_GID), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("P_SID", ZEND_PTR_TO_ZEND_LONG(P_SID), CONST_PERSISTENT);
#endif
#if defined(HAVE_WAITID) && defined(HAVE_FREEBSD_IDTYPES)
	REGISTER_LONG_CONSTANT("P_JAILID", ZEND_PTR_TO_ZEND_LONG(P_JAILID), CONST_PERSISTENT);
#endif
	REGISTER_LONG_CONSTANT("SIG_IGN", ZEND_PTR_TO_ZEND_LONG(SIG_IGN), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIG_DFL", ZEND_PTR_TO_ZEND_LONG(SIG_DFL), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIG_ERR", ZEND_PTR_TO_ZEND_LONG(SIG_ERR), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGHUP", ZEND_PTR_TO_ZEND_LONG(SIGHUP), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGINT", ZEND_PTR_TO_ZEND_LONG(SIGINT), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGQUIT", ZEND_PTR_TO_ZEND_LONG(SIGQUIT), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGILL", ZEND_PTR_TO_ZEND_LONG(SIGILL), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGTRAP", ZEND_PTR_TO_ZEND_LONG(SIGTRAP), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGABRT", ZEND_PTR_TO_ZEND_LONG(SIGABRT), CONST_PERSISTENT);
#if defined(SIGIOT)
	REGISTER_LONG_CONSTANT("SIGIOT", ZEND_PTR_TO_ZEND_LONG(SIGIOT), CONST_PERSISTENT);
#endif
	REGISTER_LONG_CONSTANT("SIGBUS", ZEND_PTR_TO_ZEND_LONG(SIGBUS), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGFPE", ZEND_PTR_TO_ZEND_LONG(SIGFPE), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGKILL", ZEND_PTR_TO_ZEND_LONG(SIGKILL), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGUSR1", ZEND_PTR_TO_ZEND_LONG(SIGUSR1), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGSEGV", ZEND_PTR_TO_ZEND_LONG(SIGSEGV), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGUSR2", ZEND_PTR_TO_ZEND_LONG(SIGUSR2), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGPIPE", ZEND_PTR_TO_ZEND_LONG(SIGPIPE), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGALRM", ZEND_PTR_TO_ZEND_LONG(SIGALRM), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGTERM", ZEND_PTR_TO_ZEND_LONG(SIGTERM), CONST_PERSISTENT);
#if defined(SIGSTKFLT)
	REGISTER_LONG_CONSTANT("SIGSTKFLT", ZEND_PTR_TO_ZEND_LONG(SIGSTKFLT), CONST_PERSISTENT);
#endif
#if defined(SIGCLD)
	REGISTER_LONG_CONSTANT("SIGCLD", ZEND_PTR_TO_ZEND_LONG(SIGCLD), CONST_PERSISTENT);
#endif
#if defined(SIGCHLD)
	REGISTER_LONG_CONSTANT("SIGCHLD", ZEND_PTR_TO_ZEND_LONG(SIGCHLD), CONST_PERSISTENT);
#endif
	REGISTER_LONG_CONSTANT("SIGCONT", ZEND_PTR_TO_ZEND_LONG(SIGCONT), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGSTOP", ZEND_PTR_TO_ZEND_LONG(SIGSTOP), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGTSTP", ZEND_PTR_TO_ZEND_LONG(SIGTSTP), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGTTIN", ZEND_PTR_TO_ZEND_LONG(SIGTTIN), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGTTOU", ZEND_PTR_TO_ZEND_LONG(SIGTTOU), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGURG", ZEND_PTR_TO_ZEND_LONG(SIGURG), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGXCPU", ZEND_PTR_TO_ZEND_LONG(SIGXCPU), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGXFSZ", ZEND_PTR_TO_ZEND_LONG(SIGXFSZ), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGVTALRM", ZEND_PTR_TO_ZEND_LONG(SIGVTALRM), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGPROF", ZEND_PTR_TO_ZEND_LONG(SIGPROF), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGWINCH", ZEND_PTR_TO_ZEND_LONG(SIGWINCH), CONST_PERSISTENT);
#if defined(SIGPOLL)
	REGISTER_LONG_CONSTANT("SIGPOLL", ZEND_PTR_TO_ZEND_LONG(SIGPOLL), CONST_PERSISTENT);
#endif
#if defined(SIGIO)
	REGISTER_LONG_CONSTANT("SIGIO", ZEND_PTR_TO_ZEND_LONG(SIGIO), CONST_PERSISTENT);
#endif
#if defined(SIGPWR)
	REGISTER_LONG_CONSTANT("SIGPWR", ZEND_PTR_TO_ZEND_LONG(SIGPWR), CONST_PERSISTENT);
#endif
#if defined(SIGINFO)
	REGISTER_LONG_CONSTANT("SIGINFO", ZEND_PTR_TO_ZEND_LONG(SIGINFO), CONST_PERSISTENT);
#endif
#if defined(SIGSYS)
	REGISTER_LONG_CONSTANT("SIGSYS", ZEND_PTR_TO_ZEND_LONG(SIGSYS), CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SIGBABY", ZEND_PTR_TO_ZEND_LONG(SIGSYS), CONST_PERSISTENT);
#endif
#if defined(SIGCKPT)
	REGISTER_LONG_CONSTANT("SIGCKPT", ZEND_PTR_TO_ZEND_LONG(SIGCKPT), CONST_PERSISTENT);
#endif
#if defined(SIGCKPTEXIT)
	REGISTER_LONG_CONSTANT("SIGCKPTEXIT", ZEND_PTR_TO_ZEND_LONG(SIGCKPTEXIT), CONST_PERSISTENT);
#endif
#if defined(SIGRTMIN)
