...
{
	REGISTER_LONG_CONSTANT("TIDY_NODETYPE_ROOT", TidyNode_Root, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_NODETYPE_DOCTYPE", TidyNode_DocType, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_NODETYPE_COMMENT", TidyNode_Comment, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_NODETYPE_PROCINS", TidyNode_ProcIns, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_NODETYPE_TEXT", TidyNode_Text, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_NODETYPE_START", TidyNode_Start, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_NODETYPE_END", TidyNode_End, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_NODETYPE_STARTEND", TidyNode_StartEnd, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_NODETYPE_CDATA", TidyNode_CDATA, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_NODETYPE_SECTION", TidyNode_Section, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_NODETYPE_ASP", TidyNode_Asp, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_NODETYPE_JSTE", TidyNode_Jste, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_NODETYPE_PHP", TidyNode_Php, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_NODETYPE_XMLDECL", TidyNode_XmlDecl, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_UNKNOWN", TidyTag_UNKNOWN, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_A", TidyTag_A, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_ABBR", TidyTag_ABBR, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_ACRONYM", TidyTag_ACRONYM, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_ADDRESS", TidyTag_ADDRESS, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_ALIGN", TidyTag_ALIGN, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_APPLET", TidyTag_APPLET, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_AREA", TidyTag_AREA, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_B", TidyTag_B, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_BASE", TidyTag_BASE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_BASEFONT", TidyTag_BASEFONT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_BDO", TidyTag_BDO, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_BGSOUND", TidyTag_BGSOUND, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_BIG", TidyTag_BIG, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_BLINK", TidyTag_BLINK, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_BLOCKQUOTE", TidyTag_BLOCKQUOTE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_BODY", TidyTag_BODY, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_BR", TidyTag_BR, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_BUTTON", TidyTag_BUTTON, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_CAPTION", TidyTag_CAPTION, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_CENTER", TidyTag_CENTER, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_CITE", TidyTag_CITE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_CODE", TidyTag_CODE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_COL", TidyTag_COL, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_COLGROUP", TidyTag_COLGROUP, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_COMMENT", TidyTag_COMMENT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_DD", TidyTag_DD, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_DEL", TidyTag_DEL, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_DFN", TidyTag_DFN, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_DIR", TidyTag_DIR, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_DIV", TidyTag_DIV, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_DL", TidyTag_DL, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_DT", TidyTag_DT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_EM", TidyTag_EM, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_EMBED", TidyTag_EMBED, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_FIELDSET", TidyTag_FIELDSET, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_FONT", TidyTag_FONT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_FORM", TidyTag_FORM, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_FRAME", TidyTag_FRAME, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_FRAMESET", TidyTag_FRAMESET, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_H1", TidyTag_H1, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_H2", TidyTag_H2, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_H3", TidyTag_H3, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_H4", TidyTag_H4, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_H5", TidyTag_H5, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_H6", TidyTag_H6, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_HEAD", TidyTag_HEAD, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_HR", TidyTag_HR, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_HTML", TidyTag_HTML, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_I", TidyTag_I, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_IFRAME", TidyTag_IFRAME, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_ILAYER", TidyTag_ILAYER, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_IMG", TidyTag_IMG, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_INPUT", TidyTag_INPUT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_INS", TidyTag_INS, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_ISINDEX", TidyTag_ISINDEX, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_KBD", TidyTag_KBD, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_KEYGEN", TidyTag_KEYGEN, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_LABEL", TidyTag_LABEL, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_LAYER", TidyTag_LAYER, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_LEGEND", TidyTag_LEGEND, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_LI", TidyTag_LI, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_LINK", TidyTag_LINK, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_LISTING", TidyTag_LISTING, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_MAP", TidyTag_MAP, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_MARQUEE", TidyTag_MARQUEE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_MENU", TidyTag_MENU, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_META", TidyTag_META, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_MULTICOL", TidyTag_MULTICOL, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_NOBR", TidyTag_NOBR, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_NOEMBED", TidyTag_NOEMBED, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_NOFRAMES", TidyTag_NOFRAMES, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_NOLAYER", TidyTag_NOLAYER, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_NOSAVE", TidyTag_NOSAVE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_NOSCRIPT", TidyTag_NOSCRIPT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_OBJECT", TidyTag_OBJECT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_OL", TidyTag_OL, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_OPTGROUP", TidyTag_OPTGROUP, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_OPTION", TidyTag_OPTION, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_P", TidyTag_P, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_PARAM", TidyTag_PARAM, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_PLAINTEXT", TidyTag_PLAINTEXT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_PRE", TidyTag_PRE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_Q", TidyTag_Q, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_RB", TidyTag_RB, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_RBC", TidyTag_RBC, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_RP", TidyTag_RP, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_RT", TidyTag_RT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_RTC", TidyTag_RTC, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_RUBY", TidyTag_RUBY, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_S", TidyTag_S, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_SAMP", TidyTag_SAMP, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_SCRIPT", TidyTag_SCRIPT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_SELECT", TidyTag_SELECT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_SERVER", TidyTag_SERVER, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_SERVLET", TidyTag_SERVLET, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_SMALL", TidyTag_SMALL, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_SPACER", TidyTag_SPACER, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_SPAN", TidyTag_SPAN, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_STRIKE", TidyTag_STRIKE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_STRONG", TidyTag_STRONG, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_STYLE", TidyTag_STYLE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_SUB", TidyTag_SUB, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_SUP", TidyTag_SUP, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_TABLE", TidyTag_TABLE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_TBODY", TidyTag_TBODY, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_TD", TidyTag_TD, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_TEXTAREA", TidyTag_TEXTAREA, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_TFOOT", TidyTag_TFOOT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_TH", TidyTag_TH, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_THEAD", TidyTag_THEAD, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_TITLE", TidyTag_TITLE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_TR", TidyTag_TR, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_TT", TidyTag_TT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_U", TidyTag_U, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_UL", TidyTag_UL, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_VAR", TidyTag_VAR, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_WBR", TidyTag_WBR, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIDY_TAG_XMP", TidyTag_XMP, CONST_CS | CONST_PERSISTENT);
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_ARTICLE", TidyTag_ARTICLE, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_ASIDE", TidyTag_ASIDE, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_AUDIO", TidyTag_AUDIO, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_BDI", TidyTag_BDI, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_CANVAS", TidyTag_CANVAS, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_COMMAND", TidyTag_COMMAND, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_DATALIST", TidyTag_DATALIST, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_DETAILS", TidyTag_DETAILS, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_DIALOG", TidyTag_DIALOG, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_FIGCAPTION", TidyTag_FIGCAPTION, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_FIGURE", TidyTag_FIGURE, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_FOOTER", TidyTag_FOOTER, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_HEADER", TidyTag_HEADER, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_HGROUP", TidyTag_HGROUP, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_MAIN", TidyTag_MAIN, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_MARK", TidyTag_MARK, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_MENUITEM", TidyTag_MENUITEM, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_METER", TidyTag_METER, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_NAV", TidyTag_NAV, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_OUTPUT", TidyTag_OUTPUT, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_PROGRESS", TidyTag_PROGRESS, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_SECTION", TidyTag_SECTION, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_SOURCE", TidyTag_SOURCE, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_SUMMARY", TidyTag_SUMMARY, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_TEMPLATE", TidyTag_TEMPLATE, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_TIME", TidyTag_TIME, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_TRACK", TidyTag_TRACK, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(HAVE_TIDYBUFFIO_H)
	REGISTER_LONG_CONSTANT("TIDY_TAG_VIDEO", TidyTag_VIDEO, CONST_CS | CONST_PERSISTENT);
#endif
}
