...
static const zend_function_entry ext_functions[] = {
	ZEND_RAW_FENTRY("tidy_parse_string", zif_tidy_parse_string, arginfo_tidy_parse_string, 0, NULL)
	ZEND_RAW_FENTRY("tidy_get_error_buffer", zif_tidy_get_error_buffer, arginfo_tidy_get_error_buffer, 0, NULL)
	ZEND_RAW_FENTRY("tidy_get_output", zif_tidy_get_output, arginfo_tidy_get_output, 0, NULL)
	ZEND_RAW_FENTRY("tidy_parse_file", zif_tidy_parse_file, arginfo_tidy_parse_file, 0, NULL)
	ZEND_RAW_FENTRY("tidy_clean_repair", zif_tidy_clean_repair, arginfo_tidy_clean_repair, 0, NULL)
	ZEND_RAW_FENTRY("tidy_repair_string", zif_tidy_repair_string, arginfo_tidy_repair_string, 0, NULL)
	ZEND_RAW_FENTRY("tidy_repair_file", zif_tidy_repair_file, arginfo_tidy_repair_file, 0, NULL)
	ZEND_RAW_FENTRY("tidy_diagnose", zif_tidy_diagnose, arginfo_tidy_diagnose, 0, NULL)
	ZEND_RAW_FENTRY("tidy_get_release", zif_tidy_get_release, arginfo_tidy_get_release, 0, NULL)
#if defined(HAVE_TIDYOPTGETDOC)
	ZEND_RAW_FENTRY("tidy_get_opt_doc", zif_tidy_get_opt_doc, arginfo_tidy_get_opt_doc, 0, NULL)
#endif
	ZEND_RAW_FENTRY("tidy_get_config", zif_tidy_get_config, arginfo_tidy_get_config, 0, NULL)
	ZEND_RAW_FENTRY("tidy_get_status", zif_tidy_get_status, arginfo_tidy_get_status, 0, NULL)
	ZEND_RAW_FENTRY("tidy_get_html_ver", zif_tidy_get_html_ver, arginfo_tidy_get_html_ver, 0, NULL)
	ZEND_RAW_FENTRY("tidy_is_xhtml", zif_tidy_is_xhtml, arginfo_tidy_is_xhtml, 0, NULL)
	ZEND_RAW_FENTRY("tidy_is_xml", zif_tidy_is_xml, arginfo_tidy_is_xml, 0, NULL)
	...
	ZEND_RAW_FENTRY("tidy_getopt", zif_tidy_getopt, arginfo_tidy_getopt, 0, NULL)
	ZEND_RAW_FENTRY("tidy_get_root", zif_tidy_get_root, arginfo_tidy_get_root, 0, NULL)
	ZEND_RAW_FENTRY("tidy_get_html", zif_tidy_get_html, arginfo_tidy_get_html, 0, NULL)
	ZEND_RAW_FENTRY("tidy_get_head", zif_tidy_get_head, arginfo_tidy_get_head, 0, NULL)
	ZEND_RAW_FENTRY("tidy_get_body", zif_tidy_get_body, arginfo_tidy_get_body, 0, NULL)
	ZEND_FE_END
};

static const zend_function_entry class_tidy_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_tidy___construct, arginfo_class_tidy___construct, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getOpt", zif_tidy_getopt, arginfo_class_tidy_getOpt, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("cleanRepair", zif_tidy_clean_repair, arginfo_class_tidy_cleanRepair, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("parseFile", zim_tidy_parseFile, arginfo_class_tidy_parseFile, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("parseString", zim_tidy_parseString, arginfo_class_tidy_parseString, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("repairString", zif_tidy_repair_string, arginfo_class_tidy_repairString, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("repairFile", zif_tidy_repair_file, arginfo_class_tidy_repairFile, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC, NULL)
	ZEND_RAW_FENTRY("diagnose", zif_tidy_diagnose, arginfo_class_tidy_diagnose, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getRelease", zif_tidy_get_release, arginfo_class_tidy_getRelease, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getConfig", zif_tidy_get_config, arginfo_class_tidy_getConfig, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getStatus", zif_tidy_get_status, arginfo_class_tidy_getStatus, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getHtmlVer", zif_tidy_get_html_ver, arginfo_class_tidy_getHtmlVer, ZEND_ACC_PUBLIC, NULL)
#if defined(HAVE_TIDYOPTGETDOC)
	ZEND_RAW_FENTRY("getOptDoc", zif_tidy_get_opt_doc, arginfo_class_tidy_getOptDoc, ZEND_ACC_PUBLIC, NULL)
#endif
	ZEND_RAW_FENTRY("isXhtml", zif_tidy_is_xhtml, arginfo_class_tidy_isXhtml, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("isXml", zif_tidy_is_xml, arginfo_class_tidy_isXml, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("root", zif_tidy_get_root, arginfo_class_tidy_root, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("head", zif_tidy_get_head, arginfo_class_tidy_head, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("html", zif_tidy_get_html, arginfo_class_tidy_html, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("body", zif_tidy_get_body, arginfo_class_tidy_body, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};

static const zend_function_entry class_tidyNode_methods[] = {
	ZEND_RAW_FENTRY("__construct", zim_tidyNode___construct, arginfo_class_tidyNode___construct, ZEND_ACC_PRIVATE, NULL)
	ZEND_RAW_FENTRY("hasChildren", zim_tidyNode_hasChildren, arginfo_class_tidyNode_hasChildren, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("hasSiblings", zim_tidyNode_hasSiblings, arginfo_class_tidyNode_hasSiblings, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("isComment", zim_tidyNode_isComment, arginfo_class_tidyNode_isComment, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("isHtml", zim_tidyNode_isHtml, arginfo_class_tidyNode_isHtml, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("isText", zim_tidyNode_isText, arginfo_class_tidyNode_isText, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("isJste", zim_tidyNode_isJste, arginfo_class_tidyNode_isJste, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("isAsp", zim_tidyNode_isAsp, arginfo_class_tidyNode_isAsp, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("isPhp", zim_tidyNode_isPhp, arginfo_class_tidyNode_isPhp, ZEND_ACC_PUBLIC, NULL)
	ZEND_RAW_FENTRY("getParent", zim_tidyNode_getParent, arginfo_class_tidyNode_getParent, ZEND_ACC_PUBLIC, NULL)
	ZEND_FE_END
};
