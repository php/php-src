...
static zend_class_entry *register_class_tidy(void)
{
	...
	zend_string_release_ex(property_errorBuffer_name, 1);
...
static zend_class_entry *register_class_tidyNode(void)
{
	...
	zend_string_release_ex(property_column_name, 1);
	...
	zend_string_release_ex(property_proprietary_name, 1);
	...
	zend_string_release_ex(property_id_name, 1);
	...
	zend_string_release_ex(property_attribute_name, 1);
	...
	zend_string_release_ex(property_child_name, 1);
