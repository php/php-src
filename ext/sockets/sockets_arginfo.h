...
static void register_sockets_symbols(int module_number)
{
	...
	REGISTER_LONG_CONSTANT("SOL_PACKET", SOL_PACKET, CONST_PERSISTENT);
#endif
...
#endif
#if defined(PACKET_FANOUT_ROLLOVER)
	REGISTER_LONG_CONSTANT("PACKET_FANOUT_ROLLOVER", PACKET_FANOUT_ROLLOVER, CONST_PERSISTENT);
#endif
#if defined(PACKET_FANOUT_RND)
	REGISTER_LONG_CONSTANT("PACKET_FANOUT_RND", PACKET_FANOUT_RND, CONST_PERSISTENT);
#endif
#if defined(PACKET_FANOUT_QM)
	REGISTER_LONG_CONSTANT("PACKET_FANOUT_QM", PACKET_FANOUT_QM, CONST_PERSISTENT);
#endif
