 ...
 * Stub hash: d02abe91af533b84cd0ae6fb10835ccba6f4a505 */
...
static zend_class_entry *register_class_Socket_EthernetPacket(zend_class_entry *class_entry_Socket_Packet)
{
	...
	class_entry = zend_register_internal_class_with_flags(&ce, class_entry_Socket_Packet, ZEND_ACC_FINAL|ZEND_ACC_READONLY_CLASS);
	...
	zend_declare_typed_property(class_entry, property_srcMac_name, &property_srcMac_default_value, ZEND_ACC_PUBLIC|ZEND_ACC_READONLY, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_STRING));
	...
	zend_declare_typed_property(class_entry, property_dstMac_name, &property_dstMac_default_value, ZEND_ACC_PUBLIC|ZEND_ACC_READONLY, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_STRING));
	...
	zend_declare_typed_property(class_entry, property_payload_name, &property_payload_default_value, ZEND_ACC_PUBLIC|ZEND_ACC_READONLY, NULL, (zend_type) ZEND_TYPE_INIT_CLASS(property_payload_class_Socket_Packet, 0, MAY_BE_NULL));
...
static zend_class_entry *register_class_Socket_UdpPacket(zend_class_entry *class_entry_Socket_Packet)
{
	...
	ZVAL_UNDEF(&property_srcPort_default_value);
	zend_string *property_srcPort_name = zend_string_init("srcPort", sizeof("srcPort") - 1, 1);
	zend_declare_typed_property(class_entry, property_srcPort_name, &property_srcPort_default_value, ZEND_ACC_PUBLIC|ZEND_ACC_READONLY, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(property_srcPort_name);
