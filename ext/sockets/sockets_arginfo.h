 ...
 * Stub hash: e3d05b2f0e972e7e9f8c8d7b90ce4f621aa49714 */
...
#endif
#if defined(AF_VSOCK)
	REGISTER_LONG_CONSTANT("AF_VSOCK", AF_VSOCK, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("VMADDR_CID_ANY", VMADDR_CID_ANY, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("VMADDR_CID_HYPERVISOR", VMADDR_CID_HYPERVISOR, CONST_PERSISTENT);
#endif
#if defined(AF_VSOCK) && defined(VMADDR_CID_LOCAL)
	REGISTER_LONG_CONSTANT("VMADDR_CID_LOCAL", VMADDR_CID_LOCAL, CONST_PERSISTENT);
#endif
#if defined(AF_VSOCK)
	REGISTER_LONG_CONSTANT("VMADDR_CID_HOST", VMADDR_CID_HOST, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("VMADDR_PORT_ANY", VMADDR_PORT_ANY, CONST_PERSISTENT);
#endif
