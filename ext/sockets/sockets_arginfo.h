 ...
 * Stub hash: e395a47dbff5d85d8d65b4036ad180550f9f5895 */
...
static void register_sockets_symbols(int module_number)
{
	...
	REGISTER_LONG_CONSTANT("IPPROTO_UDP", IPPROTO_UDP, CONST_PERSISTENT);
#endif
#if defined(IPPROTO_RAW)
	REGISTER_LONG_CONSTANT("IPPROTO_RAW", IPPROTO_RAW, CONST_PERSISTENT);
#endif
...
#endif
#if defined(HAVE_IPV6) && defined(IPV6_RECVPKTINFO)
...
#endif
#if defined(HAVE_IPV6) && defined(IPV6_RECVHOPLIMIT)
...
#endif
#if defined(HAVE_IPV6) && defined(IPV6_RECVTCLASS)
...
#endif
#if defined(HAVE_IPV6) && defined(IPV6_RECVHOPOPTS)
	REGISTER_LONG_CONSTANT("IPV6_RECVHOPOPTS", IPV6_RECVHOPOPTS, CONST_PERSISTENT);
#endif
#if defined(HAVE_IPV6) && defined(IPV6_RECVHOPOPTS)
	REGISTER_LONG_CONSTANT("IPV6_HOPOPTS", IPV6_HOPOPTS, CONST_PERSISTENT);
#endif
#if defined(HAVE_IPV6) && defined(IPV6_RECVDSTOPTS)
	REGISTER_LONG_CONSTANT("IPV6_RECVDSTOPTS", IPV6_RECVDSTOPTS, CONST_PERSISTENT);
#endif
#if defined(HAVE_IPV6) && defined(IPV6_RECVDSTOPTS)
	REGISTER_LONG_CONSTANT("IPV6_DSTOPTS", IPV6_DSTOPTS, CONST_PERSISTENT);
#endif
