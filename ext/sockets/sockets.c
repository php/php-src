...
ZEND_BEGIN_ARG_INFO(arginfo_socket_create, 0)
...
ZEND_BEGIN_ARG_INFO(arginfo_socket_recv, 0)
	ZEND_ARG_INFO(0, socket)
	ZEND_ARG_INFO(1, buf)
	ZEND_ARG_INFO(0, len)
...
ZEND_BEGIN_ARG_INFO(arginfo_socket_send, 0)
	ZEND_ARG_INFO(0, socket)
	ZEND_ARG_INFO(0, buf)
	ZEND_ARG_INFO(0, len)
	ZEND_ARG_INFO(0, flags)
...
ZEND_BEGIN_ARG_INFO(arginfo_socket_get_option, 0)
	ZEND_ARG_INFO(0, socket)
	ZEND_ARG_INFO(0, level)
	ZEND_ARG_INFO(0, optname)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_socket_set_option, 0)
	ZEND_ARG_INFO(0, socket)
	ZEND_ARG_INFO(0, level)
	ZEND_ARG_INFO(0, optname)
...
ZEND_BEGIN_ARG_INFO(arginfo_socket_create_pair, 0)
	ZEND_ARG_INFO(0, domain)
	ZEND_ARG_INFO(0, type)
	ZEND_ARG_INFO(0, protocol)
	ZEND_ARG_INFO(1, fd)
...
ZEND_BEGIN_ARG_INFO(arginfo_socket_sendmsg, 0)
	ZEND_ARG_INFO(0, socket)
	ZEND_ARG_INFO(0, msghdr)
	ZEND_ARG_INFO(0, flags)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_socket_recvmsg, 0)
	ZEND_ARG_INFO(0, socket)
