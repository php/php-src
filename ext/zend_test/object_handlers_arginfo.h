...
static zend_class_entry *register_class_DoOperationNoCast(void)
{
	...
	zend_string *property_val_name = zend_string_init_interned("val", sizeof("val") - 1, 1);
...
static zend_class_entry *register_class_DimensionHandlersNoArrayAccess(void)
{
	...
	zend_string *property_read_name = zend_string_init_interned("read", sizeof("read") - 1, 1);
	...
	zend_string *property_write_name = zend_string_init_interned("write", sizeof("write") - 1, 1);
	...
	zend_string *property_has_name = zend_string_init_interned("has", sizeof("has") - 1, 1);
	...
	zend_string *property_unset_name = zend_string_init_interned("unset", sizeof("unset") - 1, 1);
	...
	zend_string *property_readType_name = zend_string_init_interned("readType", sizeof("readType") - 1, 1);
	...
	zend_string *property_hasOffset_name = zend_string_init_interned("hasOffset", sizeof("hasOffset") - 1, 1);
	...
	zend_string *property_checkEmpty_name = zend_string_init_interned("checkEmpty", sizeof("checkEmpty") - 1, 1);
	...
	zend_string *property_offset_name = zend_string_init_interned("offset", sizeof("offset") - 1, 1);
