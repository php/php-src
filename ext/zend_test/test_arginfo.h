 ...
 * Stub hash: a9608a69831b04190b7025cd5a5b002cc65d3146 */
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_zend_string_or_object, 0, 1, MAY_BE_STRING|MAY_BE_OBJECT)
	ZEND_ARG_TYPE_MASK(0, param, MAY_BE_STRING|MAY_BE_OBJECT, NULL)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_zend_string_or_object_or_null, 0, 1, MAY_BE_STRING|MAY_BE_OBJECT|MAY_BE_NULL)
	ZEND_ARG_TYPE_MASK(0, param, MAY_BE_STRING|MAY_BE_OBJECT|MAY_BE_NULL, NULL)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(arginfo_zend_string_or_stdclass, 0, 1, stdClass, MAY_BE_STRING|MAY_BE_NULL)
	ZEND_ARG_INFO(0, param)
ZEND_END_ARG_INFO()

#define arginfo_zend_string_or_stdclass_or_null arginfo_zend_string_or_stdclass
